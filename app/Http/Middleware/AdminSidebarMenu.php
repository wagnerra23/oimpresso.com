...
//CTE
if (in_array('ctes', $enabled_modules) && (auth()->user()->can('ctes.view') || auth()->user()->can('purchase.create'))) {
    ...
    $menu->dropdown(
        ...
        function ($sub) {
            ...
            $sub->url(
                '/veiculos',
                'Veiculos',
                ['icon' => 'fa fas fa-truck', 'active' => request()->segment(1) == 'cte' && request()->segment(2) == null]
            );
