        ...
        try {
            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if (count($value) < 48) {    // tem 48 campos no modelo brasileiro
                        $is_valid =  false;
                    ...
                    if (!empty($unit_name)) {
                        ...
                        if (!empty($unit)) {
                            ...
                            $is_valid = false;
                            $error_msg = "Unidade com nome $unit_nome não encontrado na linha nº. $row_no. Você pode adicionar unidade a partir de Produtos > Unidades";
                            break;
                        }
                    } else {
                        $is_valid =  false;
