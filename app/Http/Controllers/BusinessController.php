    ...
    */
    ...
    public function postBusinessSettings(Request $request)
    {
        ...
        try {
            ...
            $business_details = $request->only(['name', 'start_date', 'currency_id', 'tax_label_1', 'tax_number_1', 'tax_label_2', 'tax_number_2', 'default_profit_percent', 'default_sales_tax', 'default_sales_discount', 'sell_price_tax', 'sku_prefix', 'time_zone', 'fy_start_month', 'accounting_method', 'transaction_edit_days', 'sales_cmsn_agnt', 'item_addition_method', 'currency_symbol_placement', 'on_product_expiry',
                ...
                'ultimo_numero_cte', 'numero_serie_nfe', 'numero_serie_nfce', 'ambiente', 'regime', 'cst_csosn_padrao', 'cst_pis_padrao',
                'cst_cofins_padrao', 'cst_ipi_padrao', 'csc', 'csc_id', 'perc_icms_padrao', 'perc_pis_padrao', 'perc_cofins_padrao', 'perc_ipi_padrao', 
                'ncm_padrao', 'cfop_saida_estadual_padrao', 'cfop_saida_inter_estadual_padrao','officeimpresso_bloqueado' ]);
            ...
            $business_details['officeimpresso_bloqueado'] = !empty($request->input('officeimpresso_bloqueado')) ? $request->input('officeimpresso_bloqueado') : 0;
    ...
    private function _validate(Request $request){
        ...
        $messages = [
            ...
            'razao_social.min' => 'digite no minimo 5 caractes.'
        ];
