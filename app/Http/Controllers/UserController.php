...
class UserController extends Controller
{
    ...
    */
    ...
    function getUserIdFromOfficeImpressoCodigo($officeimpresso_codigo, $business_id)
    {
        // Busca o usuário com o código fornecido e associado ao business_id
        $user = User::where('officeimpresso_codigo', $officeimpresso_codigo)
        ...
        // Retorna null ou lança uma exceção caso o usuário não seja encontrado
        return null;
    }
