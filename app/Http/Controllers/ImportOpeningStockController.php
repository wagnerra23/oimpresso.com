                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if (!empty($value[0])) {
                        ...
                        if (empty($product_info)) {
                            $is_valid =  false;
                            $error_msg = "Produto com códogo sku $sku não encontrado na linha no. $row_no";
                            break;
                        } elseif ($product_info->enable_stock == 0) {
                            $is_valid =  false;
                            $error_msg = "Gerencia de estoque não habilitado para o produto com código $sku na linha no. $row_no";
                            break;
                        }
                    } else {
                        $is_valid =  false;
                    ...
                    if (!empty(trim($value[1]))) {
                        ...
                        if (empty($location)) {
                            $is_valid = false;
                            $error_msg = "Local de estoque com o nome '$location_name' não encontrado na linha no. $row_no";
                            break;
                        }
                    } else {
