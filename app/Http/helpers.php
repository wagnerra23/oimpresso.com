...
if (! function_exists('isMobile')) {
    function isMobile()
    {
        // `?? ''`: request sem User-Agent (teste HTTP, healthcheck, curl cru) NAO e erro —
        // e "nao e mobile". Sem a guarda, o `app.blade.php` estourava
        // "Undefined array key HTTP_USER_AGENT" e derrubava a pagina inteira.
        // Ate aqui o defeito era CONTORNADO caso a caso nos testes (LogsBaselineTest.php:64 e
        // LicencasAcessoPermissionTest.php:77 injetam `$_SERVER[...] ??=`); este e o conserto
        // na ORIGEM, pra nao existir um 3o contorno.
