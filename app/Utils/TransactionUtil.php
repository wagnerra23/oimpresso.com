...
class TransactionUtil extends Util
{
    ...
    public function createSellTransaction($business_id, $input, $invoice_total, $user_id, $uf_data = true)
    {
        ...
        $transaction = Transaction::create([
            ...
            'balance_used' => !empty($input['balance']) ? $input['balance'] : 0
        ]);
     ...
     * @return void
     */
    public function createAdvancePayment($transaction, $input, $business_id, $user_id, $uf_data = true)
    {
        ...
        $ref_number = $this->generateReferenceNumber($prefix_type, $ref_count);
        ...
        $transaction_payment = [
            ...
            'payment_ref_no' => $ref_number
        ];

        TransactionPayment::create($transaction_payment);
    }
    ...
    */
    ...
    public function addSellReturn($input, $business_id, $user_id, $uf_number = true)
    {
        ...
        $sell_return_data = [
            ...
            'check_credit' => $input['check_credit']
        ];
