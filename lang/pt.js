LANG = {
    ...
    'table_infoEmpty':'Mostrando 0 a 0 de 0 registros',
    ...
    'pos_max_qty_error': 'Só :max_val :unit_name disponível',
    'lot_max_qty_error': 'Só :max_val :unit_name disponível no lote selecionado',
    'email_taken': 'Este e-mail já foi enviado',
    'loading': 'Carregando',
    ...
    'view' : 'Ver',
    'customer' : 'Cliente',
    'this_card_has_a_due_date' : 'Este cartão tem uma data de vencimento',
    'this_card_has_a_end_date' : 'Este cartão tem uma data de término',
    'this_card_has_a_description' : 'Este cartão tem uma descrição',
    'this_card_has_comments' : 'Este cartão contém comentários',
    'more' : ' Mais',
    'lead' : 'Lead',
    'project' : 'Projeto',
    'overview' : 'Overview',
    ...
    'task' : 'Tarefas',
    'time_logs' : 'Time Logs',
    'documents_and_notes' : 'Notas e Documentos',
    'invoices': 'Faturas',
    'settings' : 'Configurações',
    'advance_payment_cannot_be_more_than_once': 'O pagamento com <strong>Crédito</strong> não pode ser selecionado mais de uma vez.',	
};