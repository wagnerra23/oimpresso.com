...
/*!50001 VIEW `copiloto_business_profile` AS select `oimpresso_staging`.`jana_business_profile`.`id` AS `id`,`oimpresso_staging`.`jana_business_profile`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_business_profile`.`profile_text` AS `profile_text`,`oimpresso_staging`.`jana_business_profile`.`tokens_estimated` AS `tokens_estimated`,`oimpresso_staging`.`jana_business_profile`.`raw_context_tokens` AS `raw_context_tokens`,`oimpresso_staging`.`jana_business_profile`.`gerado_em` AS `gerado_em`,`oimpresso_staging`.`jana_business_profile`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_business_profile`.`updated_at` AS `updated_at` from `jana_business_profile` */;
...
/*!50001 VIEW `copiloto_cache_semantico` AS select `oimpresso_staging`.`jana_cache_semantico`.`id` AS `id`,`oimpresso_staging`.`jana_cache_semantico`.`cache_key` AS `cache_key`,`oimpresso_staging`.`jana_cache_semantico`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_cache_semantico`.`user_id` AS `user_id`,`oimpresso_staging`.`jana_cache_semantico`.`query_original` AS `query_original`,`oimpresso_staging`.`jana_cache_semantico`.`query_normalizada` AS `query_normalizada`,`oimpresso_staging`.`jana_cache_semantico`.`query_embedding` AS `query_embedding`,`oimpresso_staging`.`jana_cache_semantico`.`resposta` AS `resposta`,`oimpresso_staging`.`jana_cache_semantico`.`metadata` AS `metadata`,`oimpresso_staging`.`jana_cache_semantico`.`hits` AS `hits`,`oimpresso_staging`.`jana_cache_semantico`.`ultimo_hit_em` AS `ultimo_hit_em`,`oimpresso_staging`.`jana_cache_semantico`.`tokens_in` AS `tokens_in`,`oimpresso_staging`.`jana_cache_semantico`.`tokens_out` AS `tokens_out`,`oimpresso_staging`.`jana_cache_semantico`.`custo_brl_original` AS `custo_brl_original`,`oimpresso_staging`.`jana_cache_semantico`.`expira_em` AS `expira_em`,`oimpresso_staging`.`jana_cache_semantico`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_cache_semantico`.`updated_at` AS `updated_at` from `jana_cache_semantico` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_conversas`*/;
...
/*!50001 VIEW `copiloto_conversas` AS select `oimpresso_staging`.`jana_conversas`.`id` AS `id`,`oimpresso_staging`.`jana_conversas`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_conversas`.`user_id` AS `user_id`,`oimpresso_staging`.`jana_conversas`.`titulo` AS `titulo`,`oimpresso_staging`.`jana_conversas`.`status` AS `status`,`oimpresso_staging`.`jana_conversas`.`iniciada_em` AS `iniciada_em`,`oimpresso_staging`.`jana_conversas`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_conversas`.`updated_at` AS `updated_at` from `jana_conversas` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_memoria_facts`*/;
...
/*!50001 VIEW `copiloto_memoria_facts` AS select `oimpresso_staging`.`jana_memoria_facts`.`id` AS `id`,`oimpresso_staging`.`jana_memoria_facts`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_memoria_facts`.`user_id` AS `user_id`,`oimpresso_staging`.`jana_memoria_facts`.`fato` AS `fato`,`oimpresso_staging`.`jana_memoria_facts`.`metadata` AS `metadata`,`oimpresso_staging`.`jana_memoria_facts`.`valid_from` AS `valid_from`,`oimpresso_staging`.`jana_memoria_facts`.`valid_until` AS `valid_until`,`oimpresso_staging`.`jana_memoria_facts`.`hits_count` AS `hits_count`,`oimpresso_staging`.`jana_memoria_facts`.`ultimo_hit_em` AS `ultimo_hit_em`,`oimpresso_staging`.`jana_memoria_facts`.`core_memory` AS `core_memory`,`oimpresso_staging`.`jana_memoria_facts`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_memoria_facts`.`updated_at` AS `updated_at`,`oimpresso_staging`.`jana_memoria_facts`.`deleted_at` AS `deleted_at` from `jana_memoria_facts` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_memoria_gabarito`*/;
...
/*!50001 VIEW `copiloto_memoria_gabarito` AS select `oimpresso_staging`.`jana_memoria_gabarito`.`id` AS `id`,`oimpresso_staging`.`jana_memoria_gabarito`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_memoria_gabarito`.`categoria` AS `categoria`,`oimpresso_staging`.`jana_memoria_gabarito`.`subcategoria` AS `subcategoria`,`oimpresso_staging`.`jana_memoria_gabarito`.`pergunta` AS `pergunta`,`oimpresso_staging`.`jana_memoria_gabarito`.`memoria_esperada_keys` AS `memoria_esperada_keys`,`oimpresso_staging`.`jana_memoria_gabarito`.`resposta_esperada_pattern` AS `resposta_esperada_pattern`,`oimpresso_staging`.`jana_memoria_gabarito`.`contexto_setup` AS `contexto_setup`,`oimpresso_staging`.`jana_memoria_gabarito`.`dificuldade` AS `dificuldade`,`oimpresso_staging`.`jana_memoria_gabarito`.`ativo` AS `ativo`,`oimpresso_staging`.`jana_memoria_gabarito`.`notas` AS `notas`,`oimpresso_staging`.`jana_memoria_gabarito`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_memoria_gabarito`.`updated_at` AS `updated_at` from `jana_memoria_gabarito` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_memoria_metricas`*/;
...
/*!50001 VIEW `copiloto_memoria_metricas` AS select `oimpresso_staging`.`jana_memoria_metricas`.`id` AS `id`,`oimpresso_staging`.`jana_memoria_metricas`.`apurado_em` AS `apurado_em`,`oimpresso_staging`.`jana_memoria_metricas`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_memoria_metricas`.`recall_at_3` AS `recall_at_3`,`oimpresso_staging`.`jana_memoria_metricas`.`precision_at_3` AS `precision_at_3`,`oimpresso_staging`.`jana_memoria_metricas`.`mrr` AS `mrr`,`oimpresso_staging`.`jana_memoria_metricas`.`latencia_p95_ms` AS `latencia_p95_ms`,`oimpresso_staging`.`jana_memoria_metricas`.`tokens_medio_interacao` AS `tokens_medio_interacao`,`oimpresso_staging`.`jana_memoria_metricas`.`memory_bloat_ratio` AS `memory_bloat_ratio`,`oimpresso_staging`.`jana_memoria_metricas`.`taxa_contradicoes_pct` AS `taxa_contradicoes_pct`,`oimpresso_staging`.`jana_memoria_metricas`.`cross_tenant_violations` AS `cross_tenant_violations`,`oimpresso_staging`.`jana_memoria_metricas`.`faithfulness` AS `faithfulness`,`oimpresso_staging`.`jana_memoria_metricas`.`answer_relevancy` AS `answer_relevancy`,`oimpresso_staging`.`jana_memoria_metricas`.`context_precision` AS `context_precision`,`oimpresso_staging`.`jana_memoria_metricas`.`total_interacoes_dia` AS `total_interacoes_dia`,`oimpresso_staging`.`jana_memoria_metricas`.`total_memorias_ativas` AS `total_memorias_ativas`,`oimpresso_staging`.`jana_memoria_metricas`.`detalhes` AS `detalhes`,`oimpresso_staging`.`jana_memoria_metricas`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_memoria_metricas`.`updated_at` AS `updated_at` from `jana_memoria_metricas` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_mensagens`*/;
...
/*!50001 VIEW `copiloto_mensagens` AS select `oimpresso_staging`.`jana_mensagens`.`id` AS `id`,`oimpresso_staging`.`jana_mensagens`.`conversa_id` AS `conversa_id`,`oimpresso_staging`.`jana_mensagens`.`role` AS `role`,`oimpresso_staging`.`jana_mensagens`.`content` AS `content`,`oimpresso_staging`.`jana_mensagens`.`tokens_in` AS `tokens_in`,`oimpresso_staging`.`jana_mensagens`.`tokens_out` AS `tokens_out`,`oimpresso_staging`.`jana_mensagens`.`created_at` AS `created_at` from `jana_mensagens` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_meta_apuracoes`*/;
...
/*!50001 VIEW `copiloto_meta_apuracoes` AS select `oimpresso_staging`.`jana_meta_apuracoes`.`id` AS `id`,`oimpresso_staging`.`jana_meta_apuracoes`.`meta_id` AS `meta_id`,`oimpresso_staging`.`jana_meta_apuracoes`.`data_ref` AS `data_ref`,`oimpresso_staging`.`jana_meta_apuracoes`.`valor_realizado` AS `valor_realizado`,`oimpresso_staging`.`jana_meta_apuracoes`.`calculado_em` AS `calculado_em`,`oimpresso_staging`.`jana_meta_apuracoes`.`fonte_query_hash` AS `fonte_query_hash`,`oimpresso_staging`.`jana_meta_apuracoes`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_meta_apuracoes`.`updated_at` AS `updated_at` from `jana_meta_apuracoes` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_meta_fontes`*/;
...
/*!50001 VIEW `copiloto_meta_fontes` AS select `oimpresso_staging`.`jana_meta_fontes`.`id` AS `id`,`oimpresso_staging`.`jana_meta_fontes`.`meta_id` AS `meta_id`,`oimpresso_staging`.`jana_meta_fontes`.`driver` AS `driver`,`oimpresso_staging`.`jana_meta_fontes`.`config_json` AS `config_json`,`oimpresso_staging`.`jana_meta_fontes`.`cadencia` AS `cadencia`,`oimpresso_staging`.`jana_meta_fontes`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_meta_fontes`.`updated_at` AS `updated_at` from `jana_meta_fontes` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_meta_periodos`*/;
...
/*!50001 VIEW `copiloto_meta_periodos` AS select `oimpresso_staging`.`jana_meta_periodos`.`id` AS `id`,`oimpresso_staging`.`jana_meta_periodos`.`meta_id` AS `meta_id`,`oimpresso_staging`.`jana_meta_periodos`.`tipo_periodo` AS `tipo_periodo`,`oimpresso_staging`.`jana_meta_periodos`.`data_ini` AS `data_ini`,`oimpresso_staging`.`jana_meta_periodos`.`data_fim` AS `data_fim`,`oimpresso_staging`.`jana_meta_periodos`.`valor_alvo` AS `valor_alvo`,`oimpresso_staging`.`jana_meta_periodos`.`trajetoria` AS `trajetoria`,`oimpresso_staging`.`jana_meta_periodos`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_meta_periodos`.`updated_at` AS `updated_at` from `jana_meta_periodos` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_metas`*/;
...
/*!50001 VIEW `copiloto_metas` AS select `oimpresso_staging`.`jana_metas`.`id` AS `id`,`oimpresso_staging`.`jana_metas`.`business_id` AS `business_id`,`oimpresso_staging`.`jana_metas`.`slug` AS `slug`,`oimpresso_staging`.`jana_metas`.`nome` AS `nome`,`oimpresso_staging`.`jana_metas`.`unidade` AS `unidade`,`oimpresso_staging`.`jana_metas`.`tipo_agregacao` AS `tipo_agregacao`,`oimpresso_staging`.`jana_metas`.`ativo` AS `ativo`,`oimpresso_staging`.`jana_metas`.`criada_por_user_id` AS `criada_por_user_id`,`oimpresso_staging`.`jana_metas`.`origem` AS `origem`,`oimpresso_staging`.`jana_metas`.`created_at` AS `created_at`,`oimpresso_staging`.`jana_metas`.`updated_at` AS `updated_at` from `jana_metas` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!50001 DROP VIEW IF EXISTS `copiloto_sugestoes`*/;
