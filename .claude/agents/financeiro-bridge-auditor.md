...
- **`sintoma`** (opcional) — descrição do drift reportado pelo cliente (ex "vejo R$ [redacted Tier 0]k a receber mas real é R$ [redacted Tier 0]k")
...
- Q1: 15.932 payments biz=4 (R$ [redacted Tier 0]M)
...
Fases 2-pre/2a/2b/2c executadas → 17.467 titulos + 15.412 baixas + R$ [redacted Tier 0] a receber visível pra ela. Tier 0 respeitado em todas as queries.
