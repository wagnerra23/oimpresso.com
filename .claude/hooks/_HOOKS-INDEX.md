...
| SessionStart | `*` | ds-preview-materialize.mjs | node | sessão (início — injeção de contexto) | — |
...
| PreToolUse | `Write/Edit/MultiEdit` | memory-schema-guard.mjs | node | geração (pré-Write/Edit) | deny |
...
| PreToolUse | `Write/Edit/MultiEdit` | whats-active-troca-de-alvo.mjs | node | geração (pré-Write/Edit) | — |
