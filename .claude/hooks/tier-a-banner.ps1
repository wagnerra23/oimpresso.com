...
Write-Host ""
Write-Host "  DESIGN v2 (ADR 0282 + PROTOCOL 0.1): Code E o designer-agente - acesso"
Write-Host "    completo (prototipo repo | DesignSync | plugin Claude Design). Falta"
Write-Host "    fonte visual? GERA e valida por CI. NUNCA 'precisa vir do Cowork' /"
Write-Host "    'me autorize a desenhar'. Soberania [W] = merge/produto/token novo."
Write-Host ""
