...
Write-Host ""
Write-Host "=== CONSTITUIÇÃO v2 — 8 SKILLS TIER A (always-on) ==="
Write-Host ""
...
Write-Host "  7. charter-first   DORMENTE — ativa quando S4 entregar charter-fetch"
Write-Host "  8. ads-route       DORMENTE — ativa quando S5 entregar decide()"
Write-Host ""
