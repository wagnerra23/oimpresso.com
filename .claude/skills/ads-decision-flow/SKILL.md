...
- **HITL extendido pra blast radius administrativo:** valor <R$ [redacted Tier 0] = L0; R$ [redacted Tier 0]-R$ [redacted Tier 0] = L1; >R$ [redacted Tier 0] OR VIP OR primeira cobrança mês = L2; bloqueio/cancelamento = L3. Per-agent declarado em `config/ads.php`.
