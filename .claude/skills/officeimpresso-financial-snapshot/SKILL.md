...
- **Feature comercial** (`feature-financial-snapshot-multi-cliente.md`): vira produto pago R$ 99/m por cliente analisado mensalmente
...
6. Tier comercial: oferecer pra clientes legacy "vamos te dar este dashboard de graça por 30d, depois R$ 99/m" (lead magnet pra migração)

## Histórico

- 2026-05-09: skill draft criada após análise piloto em ServidorWR2 revelar déficit -R$ 68k 12m + R$ 868k em atrasos. Wagner pediu rotina multi-cliente.
