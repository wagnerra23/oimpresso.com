...
description: ATIVAR quando Wagner pedir para baixar, comparar, aplicar ou sincronizar protótipo Cowork/Claude Design, inclusive shell completo, bundle, handoff ou várias telas. A skill não mantém cópia das fases; política em prototipo-ui/PROTOCOL.md e execução exclusivamente em scripts/design/protocolo.config.mjs.
trigger_intensity: B
tier: B
---
