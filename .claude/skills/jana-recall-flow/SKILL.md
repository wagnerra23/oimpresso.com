...
**Por que importa:** Larissa (biz=4) testou 3 perguntas distintas em prod e recebeu o MESMO valor R$ 31.513,29. Causa-raiz: `faturamento90d` retornava 1 número só. Fix em commit `fac96a19`. Princípio formalizado em ADR 0052 — quando métrica admite múltiplos recortes legítimos, expor TODOS.
