...
//        _cowork-handoff-staging, Downloads). O único endereço legítimo é prototipo-ui/cowork/Wagner/.
//   R2 — ÂNCORA VIVA: todo path prototipo-ui/cowork/Wagner/<arquivo> citado numa âncora tem que EXISTIR.
//
...
// Extrai um path prototipo-ui/cowork/Wagner/xxx.(jsx|html|css|tsx) da string da âncora.
...
function selftest() {
  const existsFn = (p) => p === 'prototipo-ui/cowork/Wagner/oimpresso.com.html' || p === 'prototipo-ui/cowork/Wagner/compras-page.jsx';
  const casos = [
    { nome: 'lugar fixo + existe → OK', itens: [{ rel: 'a.charter.md', conteudo: 'related_prototype: prototipo-ui/cowork/Wagner/oimpresso.com.html (canon)' }], esperado: 0 },
    ...
    { nome: 'lugar fixo mas INEXISTENTE → 1', itens: [{ rel: 'e.charter.md', conteudo: 'related_prototype: prototipo-ui/cowork/Wagner/fantasma.jsx' }], esperado: 1 },
