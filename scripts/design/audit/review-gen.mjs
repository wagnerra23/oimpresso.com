...
//
// Uso:
//   node scripts/design/audit/review-gen.mjs Jana/Pro          # 1 tela (lógico)
//   node scripts/design/audit/review-gen.mjs resources/js/Pages/Jana/Pro.tsx
//   node scripts/design/audit/review-gen.mjs --missing-live    # bootstrap: só telas live sem review
...
function renderRound(round, report, ctx) {
  ...
  if (round === 1) {
    ...
    L.push('> Gerado por `scripts/design/audit/review-gen.mjs` (Fase 1 mecanizada). Fase 2 (juiz LLM) refina R5/R8/R10 + nota holística.');
    L.push('');
  }
