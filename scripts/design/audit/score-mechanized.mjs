...
//
// Uso: node scripts/design/audit/score-mechanized.mjs [--limit N] [--only <substr>]
...
function main() {
  ...
  console.log(`[score] reports em scripts/design/audit/reports/ — rode consolidate.mjs pro placar`);
}
