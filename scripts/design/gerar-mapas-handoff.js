/* ═══════════════════════════════════════════════════════════════════
   ...
   Como rodar (run_script):
     const gen = eval(await readFile('scripts/design/gerar-mapas-handoff.js'));
...
async function gerarMapasHandoff({ readFile, ls }) {
  ...
  const telas = [
    ...
    '',
    '> ⚙️ **GERADO por `scripts/design/gerar-mapas-handoff.js` — NÃO editar à mão.** Última geração: ' + hoje + '.',
  ...
  const tokens = [
    ...
    '',
    '> ⚙️ **GERADO por `scripts/design/gerar-mapas-handoff.js` — a seção INVENTÁRIO é da máquina.** Última geração: ' + hoje + '.',
