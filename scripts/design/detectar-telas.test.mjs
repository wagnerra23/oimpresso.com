...
// ─────────────────────────────────────────────────────────────────────────────
{
  const fxStaging = resolve(HERE, '../../tests/Design/fixtures/detectar-telas', 'staging');
  const fxRepo = resolve(HERE, '../../tests/Design/fixtures/detectar-telas', 'repo');
