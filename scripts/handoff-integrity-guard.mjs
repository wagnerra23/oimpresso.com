...
// (memory/reference/prototipo-ui/PROMPT_PARA_CODE_*.md) têm que casar. Dois apodrecimentos invisíveis que ninguém
...
const HANDOFF_DIR = abs('--handoff-dir', 'memory/reference/prototipo-ui');
