...
> O veredito depende do `--baseline`: BAD grandfathera só um decoy US-SLEB-999, então
> US-SLEB-001 é mentira NOVA e MORDE (exit 1). (GOOD grandfathera US-SLEB-001 → exit 0.) Prova o no-new-lie.
