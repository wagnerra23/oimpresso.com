...
it('AppShellV2 escreve --accent inline com os L/C do canon nos DOIS temas', function () {
    ...
    // --accent e --accent-2 eram `dark_absent` e tinham UM valor só. A ADR UI-0030 deu par escuro
    ...
    // par escuro ausente era justamente o bug que a UI-0030 fechou.
    expect($src)->toContain('0.55 0.15')  // --accent claro (ADR 0190) + --bubble-me
        ->and($src)->toContain('0.62 0.15')  // --accent-2 claro
        ->and($src)->toContain('0.70 0.15')  // --accent escuro (UI-0030)
...
it('--accent-soft inline carrega os DOIS pares, e a escolha depende do tema', function () {
    ...
    // O par escuro saiu de 0.32 0.06 para 0.33 0.09 na ADR UI-0030 (valor do protótipo Cowork).
    expect($src)->toContain('0.95 0.04')    // par claro, canon DTCG
        ->and($src)->toContain('0.33 0.09')  // par escuro, canon DTCG (UI-0030)
