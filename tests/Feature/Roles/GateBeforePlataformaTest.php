...
/**
 * D-GATE (ADR 0414) — o papel `Admin#{business_id}` NÃO herda permissão de PLATAFORMA.
 *
 ...
 * @see memory/decisions/0414-gate-before-permissoes-de-plataforma-fora-do-bypass.md
 */
