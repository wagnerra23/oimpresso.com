...
it('ExtrairFatosAgent define schema com 5 categorias e relevancia 1-10', function () {
    $agent = new ExtrairFatosAgent('ROTA LIVRE', 'USER: meta de R$ [redacted Tier 0]k\nASSISTANT: registrado.');
