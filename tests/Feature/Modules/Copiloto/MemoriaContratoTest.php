...
it('NullMemoriaDriver lembra e busca fato no scope do user', function () {
    ...
    $persistida = $driver->lembrar(
        businessId: 1,
        userId: 12,
        fato: 'Larissa quer meta de R$ [redacted Tier 0]k/mês',
    ...
    expect($persistida->fato)->toBe('Larissa quer meta de R$ [redacted Tier 0]k/mês');
    ...
    expect($resultados[0]->fato)->toBe('Larissa quer meta de R$ [redacted Tier 0]k/mês');
});
