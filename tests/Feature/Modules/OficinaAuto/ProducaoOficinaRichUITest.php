...
it('valor_em_curso soma valor_receber das colunas locada + aguardando', function () {
    ...
    // Caçamba locada no prazo: 3 dias × R$ [redacted Tier 0]/dia = R$ [redacted Tier 0] (em locada)
    ...
    // Caçamba locada overdue: 7 dias × R$ [redacted Tier 0]/dia = R$ [redacted Tier 0] (em aguardando)
...
it('V3 fallback — vehicle locada SEM current_rental_id pega rental órfão pra cair em aguardando se overdue', function () {
    ...
    expect($cardAguardando['valor_receber'])->toBeGreaterThan(0); // 15d × R$ [redacted Tier 0] = R$ [redacted Tier 0]
