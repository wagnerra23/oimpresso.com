...
5. Estado atual: **comercialmente um ERP genérico bonito sem cliente** (56 cadastros / 7 ativos / 99% volume num cliente só). Pra R$ [redacted Tier 0]mi/ano em 24 meses, precisa **escolher entre virar vertical de comunicação visual OU virar plataforma IA-first sobre UltimatePOS**.
