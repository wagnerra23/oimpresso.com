...
- **Alias:** `writebot`
- **Versão:** ?
- **Path:** `D:\oimpresso.com\Modules/Writebot`
- **Status:** ⚪ inativo
- **Providers:** Modules\Writebot\Providers\WritebotServiceProvider
...
- **Seeders:** `WritebotDatabaseSeeder`
...
- **Primeiros arquivos alterados:**
  ...
  - `Database/Seeders/WritebotDatabaseSeeder.php`
  ...
  - `Providers/.gitkeep`
  - `Providers/.htaccess`
  - `Providers/WritebotServiceProvider.php`
  - `Resources/.htaccess`
...
**Reaxecutar com:** `php artisan module:spec Writebot`
