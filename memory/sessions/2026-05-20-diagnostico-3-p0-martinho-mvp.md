...
| **(b) Conciliação VENDA↔FINANCEIRO** — detector 374 vendas 12m sem lançamento (R$ [redacted Tier 0]M drift) | **PARCIAL** — `OficinaAutoSanityCheckCommand.php` (239 linhas) faz sanity check CLI; mas é diagnóstico, NÃO conciliação interativa | `Modules/OficinaAuto/Console/Commands/OficinaAutoSanityCheckCommand.php` |
