...
| 4 | [#1779→#1780](https://github.com/wagnerra23/oimpresso.com/pull/1780) | **R$ 25,00 virou R$ 25.000** (parser ponto vs vírgula) | `numberPtBR.ts` + `NumericInputPtBR.tsx` paridade Blade `__read_number` |
...
- **R$ 2.059 vs R$ 205,90 na calça jeans:** produtos cadastrados no DB com preço em BRL inteiro (R$ 2.059) ao invés de centavos (205.90). Provável import errado OR Larissa cadastrou os 3 produtos com mesmo padrão. Fix = Larissa edita cadastro produto, não código.
