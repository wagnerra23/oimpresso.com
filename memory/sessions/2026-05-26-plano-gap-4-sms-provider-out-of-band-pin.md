...
2. **Zenvia** — CPaaS brasileiro publico, R$ 0.08-0.12/SMS, Pix billing, suporte PT-BR. Lider LatAm.
...
**Para o caso oimpresso (PIN 4d, ~30 mensagens/mes biz=164 piloto):** custo desprezivel R$ 3-5/mes. **Decisao key NAO eh provider, eh ARQUITETURA: single-driver agora vs multi-driver-strategy ja preparado pra fallback.**
...
| Custo | R$ 0 (WhatsApp Meta free tier) | R$ 0.08-0.12/PIN biz=164 (~R$ 3-5/mes) |
