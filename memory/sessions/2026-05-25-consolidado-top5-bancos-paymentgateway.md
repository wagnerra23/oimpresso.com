...
Razão #4 REST: calendário pior (3-5 sem humano + Gerente PJ libera API por tipo de operação + cert A1 ICP-Brasil cliente compra R$ [redacted Tier 0]-400/ano). Sandbox deprecado — flag `environment=Teste` no prod.
