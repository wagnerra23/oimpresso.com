...
status: concluido
authors: [C]
related_adrs: ["0230-metodo-governance-scorecard", "0232-modelo-peso-real-classificacao-por-meta", "0264-governanca-executavel-trio-dominio-e2e", "0320-programa-ondas-regua-correcao"]
...
**Check B: 221 → 0.** 217 telas stale re-graduadas + 4 scorecards órfãos removidos.
125 subiram, 92 mantiveram, **0 caíram** (under-counting do baseline, não maquiagem).
Ratchet + coverage verdes. 5 telas ainda `<70` catalogadas pro Wagner. Entregue em 12
PRs ≤300 (#3835–#3846).
