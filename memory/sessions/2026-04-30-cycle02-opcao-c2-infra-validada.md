...
| Custo | R$ [redacted Tier 0] | ~R$ [redacted Tier 0]/1M tokens |
| **Speedup** | **17×** | baseline |
...
### Custo desta sessão
- Tempo: ~6h trabalho
- Hardware: R$ [redacted Tier 0] (Proxmox empresa ocioso)
- Software: R$ [redacted Tier 0] (Ollama, MySQL, Docker, Tailscale free tier)
...
- OpenAI embedder: ~R$ [redacted Tier 0]/mês → R$ [redacted Tier 0]
- Eval batch caso continuasse OpenAI LLM-judge: ~R$ [redacted Tier 0]/mês → R$ [redacted Tier 0] (Cycle 04+ Ollama LLM)
- **Total economizado:** R$ [redacted Tier 0]/mês = R$ [redacted Tier 0]/ano (sem perder qualidade Larissa-grade)
