...
| **Quota grátis** | Cliente PJ Bradesco com contrato cobrança paga tarifa por boleto registrado (tabela varia por relacionamento, ~R$2-5 por boleto pago) — API não tem custo adicional |
| **Preço PIX recebido** | Boleto Híbrido: tarifa fixa por boleto (~R$2-5) · PIX cob puro: **1.4% até max R$9, min R$1.65** (gotcha: MEI/EI tem isenção por resolução BCB) |
...
| **Tarifa por transação** | PIX PJ: gratuito | PIX cob: 1.4% (max R$9) | **Inter >> Bradesco** ($ matters) |
