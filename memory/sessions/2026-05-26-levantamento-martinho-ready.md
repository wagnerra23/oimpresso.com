...
| # | Item | Módulo | Onde (path) | Esforço h-humano | Status atual |
|---|---|---|---|---|---|
| T1 | **OficinaAuto AprovacaoPublica.tsx** charter `status: draft` — pacote WhatsApp R$ 99 prometeu aprovação OS via PIN mas charter não chegou em `live`. | OficinaAuto | `resources/js/Pages/OficinaAuto/AprovacaoPublica.tsx` + charter | 7h (US-OFICINA-014 já estimada) | charter draft · bloqueada por US-OFICINA-006 FSM wire-up |
...
- [P0] **US-OFICINA-005-B** · OficinaAuto/Financeiro — Conciliação VENDA↔FINANCEIRO drift detector (374 vendas 12m sem lançamento R$ 1.64M Martinho) · 4h
