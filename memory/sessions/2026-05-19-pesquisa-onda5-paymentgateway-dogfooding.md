...
Wagner (biz=1) usa o próprio ERP pra cobrar tenants
  ...
  RecurringBilling::Plan "SaaS Oimpresso Premium R$ [redacted Tier 0]/mês"
...
| 7 | Plan "SaaS Oimpresso Premium R$ [redacted Tier 0]" cadastrado em biz=1 | ❌ **Wagner ação manual** — `/recurring-billing/plans` |
