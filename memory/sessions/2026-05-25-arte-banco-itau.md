...
- 💰 **Tarifa PIX recebido: 1,45% (mín R$ 1,75 / máx R$ 10,00)** — boleto registrado custa à parte (~R$ 1,90-2,50 por boleto liquidado, varia por contrato PJ)
...
| **PIX recebido (tarifa Itaú)** | **1,45%** do valor recebido · mínimo **R$ 1,75** · máximo **R$ 10,00** por transação | [Tarifas PSPs Pix](https://github.com/bacen/pix-api/discussions/266) |
| **Boleto registrado** | ~R$ 1,90-2,50 por boleto liquidado (varia contrato PJ, sem tarifa por emissão) | Tabela tarifas Itaú PJ |
...
| **Tarifa PIX recebido** | 0,99% (até R$ 4) | 1,45% (mín R$ 1,75 / máx R$ 10) | 🔴 Inter mais barato |
...
- Notificação WhatsApp por client/ano → 1× ano × N clientes × R$ 0,05 = irrelevante
- **TOTAL: < R$ 5/mês mesmo com 100 clientes Itaú**
