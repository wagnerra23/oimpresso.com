...
| Quota grátis | n/a — convênio cobra por boleto registrado (~R$ 2,50-4,00 título) | PIX recebimento **grátis pra MEI/EI** no Caixa, [tabela PJ Caixa](https://www.caixa.gov.br/Downloads/tabelas-tarifas-pessoa-fisica-pessoa-juridica/tabela-de-tarifas-pj.pdf) — outras PJ negociam |
...
- **Boleto Cloud / Kobana / Boleto Simples** — agregadores que abstraem Caixa pra REST por debaixo, cobrando ~R$ 1-2/boleto extra. Indicam que ninguém integra Caixa direto se puder evitar ([Kobana — Visão Geral Caixa](https://developers.kobana.com.br/reference/caixa-econ%C3%B4mica-federal)).
...
- **Custo:** mensalidade convênio R$ 30-80/mês + R$ 2,50-4,00 por boleto registrado liquidado (varia por relacionamento).
