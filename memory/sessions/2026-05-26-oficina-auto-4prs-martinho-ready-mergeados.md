...
- [ ] Tinker biz=164: criar OS manutenção, lançar 3 items (peça R$ [redacted Tier 0] + 3h MO + serviço R$ [redacted Tier 0]), transicionar status='concluida', verificar `Transaction.final_total = 6010.00`
