...
- [ ] Clica "+Item DVI", Sheet abre, escolhe categoria "freios" + severity "critico" + descricao "Pastilhas a 10% de vida util" + valor R$ [redacted Tier 0] salva, item aparece com dot vermelho
- [ ] Clica "Enviar pro cliente", confirmacao modal, WhatsApp dispara, URL publico salvo
- [ ] Mobile real 360px `/aprovar-dvi/{token}`: cliente Martinho ve lista, marca aprovar 2 items, total dinamico atualiza R$ [redacted Tier 0] → R$ [redacted Tier 0]
