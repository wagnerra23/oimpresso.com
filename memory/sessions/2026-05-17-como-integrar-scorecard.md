...
| [proposal feature-financial-snapshot-multi-cliente](../decisions/proposals/feature-financial-snapshot-multi-cliente.md) | proposed 2026-05-09 | **Produto pago** Tier 1-3 R$ 99-599/m baseado em Firebird OfficeImpresso legacy. Domínio adjacente — Scorecard SaaS interno pode virar base do "Financial Pro Tier 2" futuro |
...
- Inadimplência subiu >R$ 5k semana → alerta cliente + Wagner
...
5. **Snapshot drift detection** — MRR queda >10% MoM, inadimplência >R$ 5k semana → mcp_alertas
...
2. **Decidir prioridade vs outras iniciativas** (Vestuario/ComVis/OficinaAuto verticais; OfficeImpressoSnapshot pago R$ 99-599/m)
