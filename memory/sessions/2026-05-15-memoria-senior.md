...
- **vs oimpresso:** oimpresso self-host CT 100 = R$ [redacted Tier 0]/mês marginal. Cloud só vale se CT 100 RAM ≥80% sustentado ([ADR 0132](../decisions/0132-langfuse-self-host-ct100.md) review_trigger).
...
Custo IA mensal Jana real    : ~R$ [redacted Tier 0]/mês (DailyBrief gpt-4o-mini ~R$ [redacted Tier 0]/mês + kb-answer ~R$ [redacted Tier 0]/mês + Jana chat ~R$ [redacted Tier 0]/mês — abaixo review_trigger ADR 0132)
```
...
| **AWS Bedrock KB + S3 Vectors** (dez/2025+) | -90% vs OS | Titan $0.0002/M | Amazon-rerank $1/1k queries | 100-400ms | **~R$ [redacted Tier 0]-400/mês** |
| **AWS Bedrock KB + OpenSearch** | $701/mês min | igual | igual | igual | **~R$ [redacted Tier 0]/mês** |
...
| **Notion AI Business tier** (não compara direto) | included | included | included | 6-25ms (L1: 0,0045ms) | $20/user × 5 = **~R$ [redacted Tier 0]/mês** |
| **Self-hosted oimpresso atual** | R$ [redacted Tier 0] (CT 100 ~R$ [redacted Tier 0]/mês total dividido por 8 stacks) | Ollama free | BGE CT 100 free | 50-300ms hybrid + 100-300ms BGE | **~R$ [redacted Tier 0]/mês marginal infra + R$ [redacted Tier 0]/mês IA = ~R$ [redacted Tier 0]/mês** |

### 4.3 Sweet spot por dimensão

- **Custo absoluto:** oimpresso self-host (R$ [redacted Tier 0]/mês total) — 2-30× menor que cloud.
...
2. Custo IA Jana >R$ [redacted Tier 0]/mês (review_trigger [ADR 0132](../decisions/0132-langfuse-self-host-ct100.md))
...
**Receita potencial:** SaaS B2B add-on R$ [redacted Tier 0]/mês × N clientes Verticals.
