...
| Quota grátis | **API gratuita** — custo é o boleto/PIX em si (tarifa BB padrão por convênio CIP) — varia ~R$ [redacted Tier 0]-3,50 por boleto, PIX zero recebimento até 2024 (mudou em 2025 com Pix Automático tarifa BCB) | [bacen/pix-api discussion #266](https://github.com/bacen/pix-api/discussions/266) |
