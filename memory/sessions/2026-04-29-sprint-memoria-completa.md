...
FATURAMENTO ÚLTIMOS 90 DIAS (por mês):
  2026-01: R$  4.140,82
  2026-02: R$ [redacted Tier 0]
  2026-03: R$ [redacted Tier 0]
  2026-04: R$ [redacted Tier 0]
```
...
| **A4** Validar Larissa | 0.5d | "qual meu faturamento de março?" → R$ [redacted Tier 0] |
...
| # | Item | Estado |
|---|------|--------|
| A4 | Validar Larissa "qual meu faturamento" → R$ [redacted Tier 0] | ⏳ aguarda Larissa |
