...
25 cópias com o literal, em worktrees com trabalho real que rodam hooks antigos — some conforme fecharem. Dois worktrees fora da poda (um com handle preso, um com estado ambíguo). E uma pergunta que é do [W]: o `cc-watcher` desligado com autostart `.off` é definitivo ou contenção até ele ganhar redação? A resposta muda o registro — ADR/lápide contra task com conserto nomeado.
