...
- **Por boleto registrado** (cobrado mesmo se cliente não pagar): geralmente R$ [redacted Tier 0] a R$ [redacted Tier 0] — negociável.
- **Por liquidação** (quando cliente paga): às vezes tem taxa adicional ~R$ [redacted Tier 0]
