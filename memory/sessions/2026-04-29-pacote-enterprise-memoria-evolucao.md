...
- ConversationSummarizer (conv #3 Larissa, 48 msgs):
  ...
  - Summary preserva: *"R$ [redacted Tier 0] abril"* + *"R$ [redacted Tier 0] março maior venda"*
...
**Decisão:** híbrido recomendado — começa com **MEM-CC-1 self-host (R$ [redacted Tier 0])** + decide
Anthropic Team plan quando 4+ devs ativos (R$ [redacted Tier 0]/mês).
