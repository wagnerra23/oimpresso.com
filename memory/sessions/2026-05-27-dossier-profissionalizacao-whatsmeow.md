...
| Item | Custo |
|---|---|
| CT 100 daemon whatsmeow | R$ [redacted Tier 0] (já alocado) |
| Restic backup container (~50MB RAM) | R$ [redacted Tier 0] (mesma CT 100) |
| Backup storage Hostinger / volume CT | R$ [redacted Tier 0] (~100MB/mês esperado) |
| Renovate.io PR automation | R$ [redacted Tier 0] (free plan, ≤ 10 repos) |
| **TOTAL incremental** | **R$ [redacted Tier 0]/mês** |
...
**Margem segurança 2x:** R$ [redacted Tier 0] total LLM. Trivial vs valor entregue.
