...
|------|-------|------------|
| **Setup Enterprise** | R$ 5.000 (one-time) | Inclui migração até **5.000 clientes + 2.000 produtos + saldos AR/AP + 5 integrações simples** |
| Migração custom adicional | R$ 1.200/dia dev | Comum: 5-15 dias adicional |
| **Treinamento 4h síncrono + 2h por papel** (comercial/financeiro/produção/campo) | R$ 1.500 (até 4 papéis) | Maiara [M] + Felipe [F] |
| Treinamento extra | R$ 400/h | Após D+45 |
| **Mensalidade Enterprise** | **R$ 1.499/mês** | 25 usuários inclusos. R$ 49/usuário extra/mês |
| Setup integrações banco (Asaas/Inter/C6) | R$ 500/banco | Até 3 bancos |
| Re-construção integração custom (CRM/BI/etc) | R$ 1.200/dia dev | Estimar fase 0 |
| **DAM minimum viable (S3 wrap)** | R$ 8.000 (one-time) | Apenas se cliente migra MubiDrive — **avisar gap 6-8 sem desenvolvimento** |
| **Garantia 90d** com cláusula rollback | Incluso | Devolução 100% setup se cliente sair em 90d |
| Cert A1 multi-empresa (até 3 CNPJs) | Incluso | Acima disso, R$ 200/CNPJ |

**Comparação com pricing-tiers oficial:** consultar [`memory/sales/2026-05/06-pricing-tiers.md`](06-pricing-tiers.md). Enterprise R$ 1.499/mês alinhado.
...
| **Uptime alvo** | **99.5%** (não 99.9% — honestidade) | Hostinger shared hosting + CT 100. **Se cliente exige 99.9% → custo infra dedicada R$ 800-1.500/mês adicional** |
...
4. **Primeiro lote de boletos pagos → N NFes emitidas em paralelo** sem clique humano. Cliente médio Mubisys emite >100 NFe/dia — economia 30-60min/dia operador financeiro = **R$ 3-6k/mês** salário.
...
|-----|------------------------|---------------------|---------|
| **DAM nativo equiv MubiDrive** | Alto (cliente médio tem 10-150GB de arte) | 3 opções acima (manter MubiDrive / migrar S3 / Drive externo) | **Construir DAM minimum viable é R$ 80k+ dev. Adiar até 2º cliente Mubisys ou cobrar antecipado** |
...
4. **Visita presencial 1 dia** (Wagner [W] vai) — cliente >R$ 500k/mês merece
...
7. **Fase 0 paga (R$ 2k descontado se contrato fechar)** — discovery + escopo formal
...
| Faturamento | R$ 30-200k/m | R$ 200k-2M/m |
| Volume migração | Baixo (até 1k/500) | Médio-Alto (5k/2k+) |
| Tempo migração | 1-2 semanas | 4-6 semanas faseado |
| Setup price | R$ 2.500 | R$ 5.000+custom |
| Mensalidade | R$ 499/m (Pro) | R$ 1.499/m (Enterprise) |
| Garantia | 60d | 90d |
