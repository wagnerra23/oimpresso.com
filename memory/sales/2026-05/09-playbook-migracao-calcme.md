...
- **Faturamento:** R$ [redacted Tier 0]k-200k/mês
...
**Necessidade (N):**
10. Se eu te mostrasse uma demo onde vc fala "aumenta 5% em todo lona 440g" e o sistema atualiza 80 produtos sozinho, e onde a IA te responde "essa semana faturou R$ [redacted Tier 0]k, 2 clientes atrasaram" no chat sem você abrir relatório — isso resolve o que tá te incomodando hoje?
...
|------|-------|------------|
| **Setup standard Pro** | R$ [redacted Tier 0] (one-time) | Inclui migração até **1.000 clientes + 500 produtos + saldos AR/AP** |
| Migração custom (>1k clientes ou >500 SKUs) | R$ [redacted Tier 0]/dia dev | Estimar D-7 |
| **Treinamento 4h síncrono** | Incluso no setup | Maiara [M] grava |
| **Treinamento extra 2h (operador novo)** | R$ [redacted Tier 0] | Após D+30 |
| **Mensalidade Pro 60 dias garantia** | R$ [redacted Tier 0]/mês | Escalonamento R$ [redacted Tier 0] mês 1 → R$ [redacted Tier 0] mês 2 → R$ [redacted Tier 0] mês 3+ se cliente quiser amortecer (negociável Wagner [W]) |
| Setup Asaas (re-emissão boletos) | R$ [redacted Tier 0] | Já incluso (oimpresso tem RecurringBilling US-RB-044) |
| Cert A1 (se cliente precisar emitir novo) | repasse + R$ [redacted Tier 0] | Não obrigatório se .pfx já existe |

**Comparação com pricing-tiers oficial:** consultar [`memory/sales/2026-05/06-pricing-tiers.md`](06-pricing-tiers.md) — alinhamento Pro R$ [redacted Tier 0]/mês mantido.
