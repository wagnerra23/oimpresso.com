...
- **Comissão:** 10% do MRR primeiros 12 meses
  - Ex Pro R$ [redacted Tier 0]/m × 12 = R$ [redacted Tier 0] → afiliado recebe R$ [redacted Tier 0] ao longo de 12m (R$ [redacted Tier 0]/m)
  - Ex Starter R$ [redacted Tier 0]/m × 12 = R$ [redacted Tier 0] → afiliado recebe R$ [redacted Tier 0] (R$ [redacted Tier 0]/m)
...
- **Comissão:**
  ...
  - Ex 3 clientes Pro: 3 × R$ [redacted Tier 0] × 12 × 20% = R$ [redacted Tier 0] + R$ [redacted Tier 0] bônus = R$ [redacted Tier 0]
...
- **Comissão:**
  ...
  - Reseller retém 100% do markup acima do wholesale (se vender Pro a R$ [redacted Tier 0] cheio, fica com R$ [redacted Tier 0] - R$ [redacted Tier 0] = R$ [redacted Tier 0]/m + os R$ [redacted Tier 0] que pagou já têm margem de oimpresso embutida)
...
|---|---|---|---|---|
| **Contador 5-30 gráficas** | Silver | 2-4 clientes/ano | R$ [redacted Tier 0]-48k MRR adicionado | 30%/ano (afiliado some se não fecha) |
| **Consultor gestão PME** | Silver | 1-3 clientes/ano | R$ [redacted Tier 0]-36k MRR | 40%/ano |
| **Cliente atual indicando** | Bronze | 0-2 clientes/ano | R$ [redacted Tier 0]-14k MRR | 60%/ano (esquece o link) |
| **Influenciador LinkedIn** | Bronze ou Silver | 1-5 clientes/ano (se conteúdo bom) | R$ [redacted Tier 0]-60k MRR | 50%/ano |
| **Fornecedor complementar** (insumos/máquinas) | Silver ou Gold | 3-8 clientes/ano | R$ [redacted Tier 0]-96k MRR | 20%/ano (relacionamento longo) |
...
- CAC via afiliado < R$ [redacted Tier 0] (vs CAC outbound atual desconhecido — provavelmente R$ [redacted Tier 0]-5k)
