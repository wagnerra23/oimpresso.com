...
gmv_ano: R$ [redacted Tier 0]M (snapshot oimpresso Insights)
priority: P0
...
- GMV ano anterior: **R$ [redacted Tier 0]M** (oimpresso Insights snapshot)
- Receita histórica WR Sistemas estimada: R$ [redacted Tier 0]-850/m (confirmar via skill `officeimpresso-financial-snapshot` antes de mandar)
...
- 🔴 **2º maior cliente do top** (atrás só de Vargas R$ [redacted Tier 0]M) — perda dói. Tom da carta tem que ser **respeitoso da relação**, não comercial-agressivo
