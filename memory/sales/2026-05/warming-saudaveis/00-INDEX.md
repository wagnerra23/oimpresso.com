...
|---|---------|---:|---:|:---:|:---:|:---:|---|
| 1 | **Extreme** ("EXTREMA LED") | R$ 6,36M | 1472 (novo) | **P0** | WhatsApp → call Zoom 45min | **Q3/26 set** | concorrência Mubisys pode contatar antes |
| 2 | **Zoom** | R$ 3,18M | 1474 (mais novo do parque) | P1 | WhatsApp → call Zoom 60min | Q4/26 out | comitê interno (não dono-único); satisfeito demais |
| 3 | **Fixar** | R$ 1,23M | 1421 (meio parque) | P2 | email + WhatsApp follow-up | Q1/27 fev | versão sem update = churn latente; margem aperta R$ 1.499 |
| 4 | **Mhundo** | R$ 754k | 1429 | P3 | email + WhatsApp | Q1/27 mar | GMV pequeno; vertical exato a confirmar |
| 5 | **Produart** | R$ 733k | 1472 ("banco antigo") | P3 | email direto | Q2/27 abr | "banco antigo" = candidato a churn natural |

> **Nota GMV:** os valores acima vêm do snapshot oimpresso Insights (canon do PLANO). User briefing mencionou aproximações diferentes (Fixar ~R$ 2,5M / Mhundo ~R$ 2M) — mantive PLANO como fonte. Wagner valida ou ajusta no review.
...
1. [01-extreme.md](01-extreme.md) — P0 — "EXTREMA LED" R$ 6,36M GMV
2. [02-zoom.md](02-zoom.md) — P1 — Zoom R$ 3,18M GMV
3. [03-fixar.md](03-fixar.md) — P2 — Fixar R$ 1,23M GMV
4. [04-mhundo.md](04-mhundo.md) — P3 — Mhundo R$ 754k GMV
5. [05-produart.md](05-produart.md) — P3 — Produart R$ 733k GMV
