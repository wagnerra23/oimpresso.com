...
> Premissa: meta R$ 5M/ano (ADR 0022). Take rate alvo + assinatura recorrente.
...
|---|---|---|---|
| **Mensal** | R$ 299 `[draft]` | R$ 599 `[draft]` | R$ 1.499 `[draft]` |
| **Setup fee** | R$ 0 | R$ 2.500 `[draft]` | R$ 5.000 `[draft]` |
...
| Jana IA | ❌ (add-on R$ 199/mês) | ✅ (500 perguntas/mês) | ilimitado + memória cross-business |
...
|---|---|---|---|---|---|
| Mensal | R$ 599 | R$ 150-450 | R$ 280 + 1% boleto | `[validar]` | `[validar]` |
...
- **MEI/microempresa (faturamento <R$ 30k/mês):** Starter R$ 199 `[draft]` (vs R$ 299) — entrada qualificada
...
- **Enterprise é caro de propósito** — só faz sentido pra gráfica >R$ 200k/mês ou rede multi-loja.
- **Não competir por preço com Bling.** Bling é genérico R$ 150. oimpresso é vertical R$ 599. **Não é mesmo produto.**
- **Não dar preço sem demo.** Tabela acima vai pra interno — pra prospect, sempre pacote escrito após demo.

---

**Refs internas:** ADR 0022 (meta R$ 5M/ano), `reference_revenue_thesis_modulos.md` (auto-mem), `reference_concorrentes_com_visual.md` (auto-mem).
