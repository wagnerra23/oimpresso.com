...
- **Investimento ano 1 estimado:** R$ [redacted Tier 0]-40k caixa (taxa 2 programas ISV + 1 viagem ExpoPrint + dev integração export-only) + 120-180h Wagner+dev
...
- **ONYX é o líder de fato em large format premium.** Toda gráfica acima de R$ [redacted Tier 0]k/m fatura tem ONYX rodando. Integração "envia OS → entra na fila do RIP" + "RIP avisa oimpresso quando arrancou impressão" é diferencial brutal — operador não precisa duplicar dado.
- **Caldera é o segundo lugar premium**, com base instalada menor mas tickets maiores (gráficas de R$ [redacted Tier 0]k+/m).
...
|---|---|---|---|---|---|---|
| 1 | **CorelDraw — Tech Partner + plugin GMS** | ~80% gráficas BR | Plugin "enviar OS pro oimpresso" + export PDF | 4-6 sprints | R$ [redacted Tier 0]-12k | 5-10 leads via marketing co-branded |
| 2 | **ONYX RIP — ISV Connect program** | ~40% large format BR | Hot folder + API status produção | 3-4 sprints | R$ [redacted Tier 0]-8k (taxa) | 3-5 leads gráfica média/grande |
| 3 | **3M Commercial Graphics + Avery Dennison** | Vinil premium | Portal B2B (pedido via API) | 4-6 sprints | R$ [redacted Tier 0]-10k | Co-marketing case + comissão pedido |
| 4 | **SAi (Flexi + PhotoPRINT)** | Cutting universal + entry RIP | Hot folder | 2-3 sprints | R$ [redacted Tier 0]-5k | Cobre 2 categorias com 1 partnership |
| 5 | **Heytex / Endutex (lonas BR)** | Lonas premium BR | Portal B2B + cadastro produto + comissão | 3-4 sprints | R$ [redacted Tier 0]-5k | Marketplace BR pioneer |
...
- **Investimento:** R$ [redacted Tier 0]-12k (dev + 1 demo no Corel UserMeet BR)
...
- **Investimento:** R$ [redacted Tier 0]-8k (taxa programa + dev + 1 demo ExpoPrint)
- **ROI:** 3-5 leads/ano gráfica média/grande (R$ [redacted Tier 0]k+/m fatura — ticket alto pro oimpresso)
...
- **Investimento:** R$ [redacted Tier 0]-10k (dev + abertura conta revendedor + capital giro pequeno pra estoque mínimo se exigido)
- **ROI:** comissão 5-15% sobre pedido + take rate oimpresso
- **KPI:** R$ [redacted Tier 0]-100k/ano em pedidos via plataforma → R$ [redacted Tier 0]-15k receita oimpresso
...
- **Investimento:** R$ [redacted Tier 0]-5k (taxa + dev)
...
- **Investimento:** R$ [redacted Tier 0]-5k (dev + reunião comercial fornecedor)
- **ROI:** marketplace BR pioneer — sem concorrente Mubisys/Zênite/Calcgraf nesse espaço
- **KPI:** 3 fornecedores cadastrados em 12m (Heytex + Endutex + Multi); R$ [redacted Tier 0]-80k/ano GMV → R$ [redacted Tier 0]-8k receita comissão
