...
> **Objetivo:** empacotar resultado da skill `officeimpresso-financial-snapshot` em PDF profissional pra wedge comercial (prospect Martinho, R$ [redacted Tier 0]/m).
...
- **Objetivo:** entregável recorrente (mensal/trimestral) pro cliente pago do oimpresso. Vendido como add-on R$ [redacted Tier 0]/mês.
...
Por quê:
- Prospect Martinho **não sabe quanto está perdendo em inadimplência ativa** — sistema atual só mostra contas em aberto, sem cobrança automatizada. Nossa página 5 mostra o número real (ex "R$ [redacted Tier 0]k em atraso, top 5: Cliente A, B, C..."). Ele lê e pensa "como o Wagner sabe isso?".
