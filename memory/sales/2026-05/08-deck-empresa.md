...
- **IA acessível.** O custo de um agente conversacional caiu ~10x em 18 meses (gpt-4o-mini classe). Ficou viável colocar IA dentro de um ERP de R$ [redacted Tier 0]/mês.
...
|---|---|---|---|
| Mensal `[draft]` | R$ [redacted Tier 0] | R$ [redacted Tier 0] | R$ [redacted Tier 0] |
| Setup fee `[draft]` | R$ [redacted Tier 0] | R$ [redacted Tier 0] | R$ [redacted Tier 0] |
| Compromisso | mensal | 12 meses | 24 meses |
| Usuários | até 3 | até 10 | ilimitado |
| Jana IA | add-on R$ [redacted Tier 0]/mês | inclusa (500 perguntas) | ilimitada |
| NFe auto-emissão | ❌ | ✅ | ✅ + contingência SVC |

Add-ons: +business adicional (R$ [redacted Tier 0]), customização de tela (R$ [redacted Tier 0] one-shot), migração assistida.
...
**Wedge primário:** dono de gráfica/comunicação visual de 1-10 funcionários, faturamento R$ [redacted Tier 0]-200k/mês `[validar — placeholder]`, hoje rodando **Bling+planilha** OU **Calcme/Mubisys frustrado pós-trial**.
...
- **SAM (Serviceable Addressable Market):** gráficas com 1-30 funcionários (ICP), faturamento R$ [redacted Tier 0]-500k/mês — `[validar — placeholder]` empresas.
...
- **Ticket médio Pro:** R$ [redacted Tier 0]/mês × 12 = R$ [redacted Tier 0]/ano `[draft pricing]`. Multiplicar pelo SOM realista 24m pra chegar no run-rate alvo.
- **Meta R$ [redacted Tier 0]M/ano** (ADR 0022) — exige `[validar — placeholder, ~700 clientes Pro pagantes]` em 24-36m.
...
- ADR 0022 (meta R$ [redacted Tier 0]M/ano), ADR 0093 (multi-tenant Tier 0), ADR 0094 (Constituição v2), ADR 0105 (cliente como sinal), ADR 0106 (recalibração 10x IA-pair).
