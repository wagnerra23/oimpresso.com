...
> **Status:** prospect REAL reportado por Wagner — cliente do sistema atual há 26 anos pagando R$ [redacted Tier 0]/mês, **trocando de sistema agora**. Provavelmente cliente histórico OfficeImpresso (Delphi WR Sistemas) — a confirmar com Wagner.
...
- Paga R$ [redacted Tier 0]/mês há 26 anos = OfficeImpresso plano base/médio. Provável **5-12 funcionários** (sweet spot persona João Mecânico).
...
6. Budget real — R$ [redacted Tier 0] atual está confortável, apertado, ou queria pagar menos?
...
- **Pricing pioneer**: R$ [redacted Tier 0]/m (vs R$ [redacted Tier 0] atual = economia R$ [redacted Tier 0]/ano) por 12 meses, sem setup, sem fidelidade
...
>
> Mas queria te pedir 20 minutos antes de fechar com outro: tô construindo o **oimpresso**, sucessor moderno do OfficeImpresso, com IA + app mobile + nuvem. Se servir pra ti, faço pioneer R$ [redacted Tier 0]/m (economiza R$ [redacted Tier 0]/mês vs hoje) com compromisso escrito de entregar tudo em 90d.
>
