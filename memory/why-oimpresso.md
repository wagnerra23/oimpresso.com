...
> ⚠️ ROTA LIVRE não é exceção — é o **caso piloto Modules/Vestuario** validado em produção há 2+ anos. Outros módulos verticais (ComunicacaoVisual, OficinaAuto) ainda em construção/sinal qualificado.
...
| **Modules/OficinaAuto** | 4520-0/01 | ⏸️ aguardando sinal qualificado | candidato: Martinho Caçambas (a confirmar) |
...
- **Modules/OficinaAuto** vs Mecânico, Auto Manager, Lokoz — pendente sinal qualificado pra ativar

## Meta financeira
**R$ 5 milhões/ano** ([ADR 0022](decisions/0022-meta-5mi-ano-financeira.md)). Crescimento via diversificação modular (~1M+ empresas BR endereçáveis) + aprofundamento por vertical onde tem cliente real.
