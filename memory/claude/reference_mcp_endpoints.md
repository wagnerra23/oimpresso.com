...
| `oimpresso.com/api/mcp` | Hostinger shared | nginx + PHP-FPM | Fallback dev / CRUD admin | ✅ pós-pull `4feed564` |
...
Acesso só via console Proxmox web (porta 22 não exposta) — ver `reference_proxmox_acesso_2026_04_29.md`.
...
- **DNS Hostinger API** (não painel hPanel) — receita em `reference_hostinger_dns_api.md`.
