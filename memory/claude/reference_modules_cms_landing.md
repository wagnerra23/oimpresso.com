...
description: A landing pública e o blog/CMS do oimpresso.com são servidos pelo Modules/Cms (não-existente no worktree atual, vive na produção). Tem rotas /, /c/page/{page}, /c/blogs, /c/blog/{slug}-{id}, /c/contact-us; backoffice em /cms/cms-page e /cms/site-details (auth+superadmin). Tabelas: cms_pages, cms_page_metas, cms_site_details. Editar páginas/landing pela UI superadmin, NÃO pelo welcome.blade.php.
type: reference
