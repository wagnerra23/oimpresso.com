...
Pesquisa profunda em 2026-04-26 sessão 18 sobre estado-da-arte de RAG / agent memory. Aplica à Jana do oimpresso.
...
- **Meilisearch (atual):** sub-50ms, hybrid search, **bring-your-own embeddings**. OK pra MVP. Self-hosted R$ [redacted Tier 0]/mês.
...
- Quando Wagner perguntar "como evoluir" / "próximo sprint" da Jana → abrir ADR 0037
