...
| **Jana** | 3 (multiplier add-on) | "A Jana de IA do seu negócio — ele olha os números, sugere metas e te avisa quando algo sai da rota" | Starter R$ [redacted Tier 0] / Pro R$ [redacted Tier 0] / Enterprise R$ [redacted Tier 0] (add-on) | n/a (subscription puro) |
...
- **Jana** é o próprio **orquestrador** dessa meta — ver `memory/requisitos/Jana/` e `project_modulo_copiloto.md`. É simultaneamente produto e ferramenta interna (eat-your-own-dog-food: oimpresso usa a Jana pra monitorar R$ [redacted Tier 0]mi/ano via meta de plataforma, `business_id = null`).

**Posicionamento comercial da Jana** (diferencial vs. LaravelAI):
