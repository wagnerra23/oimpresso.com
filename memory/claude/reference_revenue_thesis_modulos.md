...
| **Jana** | 3 (multiplier add-on) | "O Jana de IA do seu negócio — ele olha os números, sugere metas e te avisa quando algo sai da rota" | Starter R$ 99 / Pro R$ 299 / Enterprise R$ 799 (add-on) | n/a (subscription puro) |
...
- **Jana** é o próprio **orquestrador** dessa meta — ver `memory/requisitos/Jana/` e `project_modulo_copiloto.md`. É simultaneamente produto e ferramenta interna (eat-your-own-dog-food: oimpresso usa o Jana pra monitorar R$ 5mi/ano via meta de plataforma, `business_id = null`).
