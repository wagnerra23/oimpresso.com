...
> ⚙️ **Gerado por máquina** (`system-map.mjs`) em **2026-07-30**. NÃO edite à mão — a próxima geração sobrescreve.
...
- Scorecard: **12/13** métricas medidas · floor full-suite = **332**.
...
- **364** ADRs no total. Índice gerado: [`_INDEX-GENERATED.md`](../decisions/_INDEX-GENERATED.md) · lifecycle: [`_INDEX-LIFECYCLE.md`](../decisions/_INDEX-LIFECYCLE.md).
...
- **345** handoffs · **565** session logs. Índice: [`memory/08-handoff.md`](../08-handoff.md).
- Sessions recentes:
  ...
  - `2026-07-29-srs-e2-phpdoc-deprecated`
