...
> ⚙️ **Gerado por máquina** (`system-map.mjs`) em **2026-09-19**. NÃO edite à mão — a próxima geração sobrescreve.
...
---
_Gerado por `scripts/governance/system-map.mjs` · 2026-09-19 · deriva das fontes canônicas, não as substitui._
