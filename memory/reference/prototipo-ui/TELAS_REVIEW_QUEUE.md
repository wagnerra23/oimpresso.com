...
| `[x]` | ``Forja/Board`` (arquivo histórico removido) | charter live, last_validated 2026-05-08, ADR 0070 PMG |
...
|---|---|---|---|
| `[~]` | `Cliente/Index` (a criar) | [`clientes-page.jsx`](../../../prototipo-ui/cowork/Wagner/clientes-page.jsx) (10 KB) | [draft](../../../resources/js/Pages/Cliente/Index.charter.md) — Wagner aprova Non-Goals + Anti-hooks |
| `[~]` | `Produto/Unificado/Index` (a criar) | ``produto-app.jsx`` (arquivo histórico removido) (60 KB) + `screenshot-06` (arquivo histórico removido) + [pino F1](prototipos/produto-unificado/) | [draft](../../../resources/js/Pages/Produto/Unificado/Index.charter.md) — decisões pendentes (multiplier schema → ADR `Produto/arq/0001`, MfgRecipe namespace, cache strategy) |
| `[~]` | `Produto/Index` (a criar) | ``prod-page.jsx`` (arquivo histórico removido) (6.5 KB) | [draft](../../../resources/js/Pages/Produto/Index.charter.md) — decisão pendente: simples vs unificado coexistem? |
| `[~]` | `Orcamento/Index` (a criar) | [`orc-page.jsx`](../../../prototipo-ui/cowork/Wagner/orc-page.jsx) (6.3 KB) | [draft](../../../memory/requisitos/Orcamento/_arquivo/Index.charter.md) — decisão pendente: Model `App\Transaction` (`type: quotation`) vs dedicado |
...
| `[ ]` | `Inventario/Index` | A referência histórica consolidada está em [`cowork/Wagner/legado/inventario-migracao/index.html`](../../../prototipo-ui/cowork/Wagner/legado/inventario-migracao/index.html). Charter precisa nascer com escopo claro (lista vs entradas/saídas vs ajuste). |
...
> **Fonte única do placar:** [`audit/CONSOLIDADO.md`](../../../scripts/design/audit/CONSOLIDADO.md) (GERADO por `score-mechanized.mjs` + `consolidate.mjs` — rodar a cada onda; não duplicar números aqui).
> Run 2026-06-10 @main `c8caaec01`: **242 telas · média 87/100 · 16 abaixo de 70 · golden validado (cache Cowork dizia 86, real 87)**.
> Regra: **toda tela <90 (=nota 9) entra na fila** com o gap nomeado (R# do [`audit/GOLDEN-REFERENCE.md`](../../../scripts/design/audit/GOLDEN-REFERENCE.md)). Identidade única: `--accent` fora do roxo 250–330 = **ZERO sobrou** (conformance-gate `--all` verde 2026-06-10 — item 3 do PR-4 já conforme).
