...
- [`protocolo.config.mjs`](../../../scripts/design/protocolo.config.mjs) para IDs, destinos, fases e comandos executáveis;
- o RUNBOOK por tela indicado pelo `protocolo.config.mjs` para a implementação de uma tela.

Para obter o painel vigente, execute `node scripts/design/protocolo.config.mjs`. A história anterior
