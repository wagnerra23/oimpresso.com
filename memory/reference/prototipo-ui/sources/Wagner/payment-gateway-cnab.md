...
- `prototipo-ui/cowork/Wagner/boletos-page.jsx:509` — sheet 560px, lista de arquivos REM/RET (`REMESSAS_CNAB` em `:75`)
- `prototipo-ui/cowork/Wagner/pg-cobranca-page.jsx:863` — o mesmo componente, dentro da Cobrança do PaymentGateway
...
- precedente de forma: [`prototipos/nfe-tributacao/SOURCE.md`](nfe-tributacao.md) ([#7145](https://github.com/wagnerra23/oimpresso.com/pull/7145))
