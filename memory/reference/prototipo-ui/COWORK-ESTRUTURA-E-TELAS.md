...
|---|---|---|---|
| **Seu export visual** | `prototipo-ui/cowork/Wagner/` (atualizado atomicamente) | **Cowork** | exporta build e dependências, preservando o path relativo |
...
|---|---|---|
| `*-page.jsx`/`.tsx`/`.css`/`.html` (build da tela) | `prototipo-ui/cowork/Wagner/` | design SSOT (build) |
