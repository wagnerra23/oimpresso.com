...
> **Append em:** `memory/reference/prototipo-ui/COWORK_NOTES.md` → seção "Pendentes" (topo, append-only).
...
4. Devolve em `memory/reference/prototipo-ui/AUDITORIA_ROTINAS_DESIGN.md` + linha no `SYNC_LOG.md`.
