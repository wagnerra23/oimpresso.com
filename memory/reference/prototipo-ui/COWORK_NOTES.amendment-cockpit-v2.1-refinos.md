...
E no JSX `chat-jana.jsx:169` substituir emoji por letra:
...
**Reescrever** `onSend` em `chat-jana.jsx:395`:
...
**Atual**: só `kind: "list-card"` (`chat-jana.jsx:412-433`).
...
**Atual** (`chat-jana.jsx:436-443`) — composer simples sem PII check.
...
- `Cockpit.charter.md V2` (arquivo histórico removido) — destino arquitetural (NOVO 2026-05-15)
- ``_cowork-export-2026-05-15/CRITIQUE-chat-jana-vs-amendment.md`` — score F1.5 78/100 + 19 divergências detalhadas
- ``_cowork-export-2026-05-15/_SNAPSHOT.md`` — contexto do export
