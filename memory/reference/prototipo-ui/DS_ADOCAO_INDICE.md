...
> Gerado por `npm run ds:report -- --write` · 2026-09-11 13:44 UTC · **total `ds/*` = 1476** · fila 2/10 ✅.
...
|---|---|---:|---|
| 1 | Sells | 57 | ☐ pendente |
| 2 | RecurringBilling | 42 | ☐ pendente |
...
**Fora da fila (pendentes · ordem por contagem):** PaymentGateway (178) · Produto (115) · governance (111) · StockTransfer (45) · StockAdjustment (36) · Ponto (28) · Forja (21) · Fiscal (19) · Compras (14) · NfeBrasil (10) · kb (9) · Modules (2) · Superadmin (1) · ConsultaOs (1) · Home (1) · Jana (1) · Nfse (1) · Site (1)
...
| **`ds-v6/`** (kit DS v6) | A **régua visual** aprovada [W] (2026-06-03): [`showcase.html`](../../../prototipo-ui/cowork/Wagner/legado/ds-v6/showcase.html) (11 componentes em token, claro/escuro) · [`receita.html`](../../../prototipo-ui/cowork/Wagner/legado/ds-v6/receita.html) (montar tela em 6 passos) · [`gabarito-vendas.html`](../../../prototipo-ui/cowork/Wagner/legado/ds-v6/gabarito-vendas.html) (kit aplicado) · ``REUSE_MAPPING.md`` (arquivo histórico removido) (kit `c-*` → React no repo) | **8/11 reusam** o REGISTRY; 3 são buraco do DS (Tier-0) |
