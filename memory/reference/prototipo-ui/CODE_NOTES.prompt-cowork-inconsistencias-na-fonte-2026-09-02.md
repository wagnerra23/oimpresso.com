...
`node scripts/governance/replica-inconsistencias.mjs --modulo Forja --prototipo prototipo-ui/cowork/Wagner/forja-*.jsx prototipo-ui/cowork/Wagner/forja-page.css`.
