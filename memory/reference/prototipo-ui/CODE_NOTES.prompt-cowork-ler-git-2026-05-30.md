...
2. **`memory/reference/prototipo-ui/PROTOCOL.md`** — 6 papéis × 7 fases, gates.
3. **`memory/reference/prototipo-ui/CLAUDE_DESIGN_BRIEFING.md`** — leia o bloco **CANON ATUAL (2026-05-30)** no topo primeiro. Tokens, proibições.
...
6. **`memory/reference/prototipo-ui/LICOES_F3_FINANCEIRO_REJEITADO.md`** — anti-padrões.
