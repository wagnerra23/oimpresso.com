...
2. **Camada de design** (jsx/tsx/css/html/charters/casos) → `prototipo-ui/cowork/Wagner/` (overwrite + commit = linhagem de diff). Ver [ADR-proposta SSOT](../../../memory/decisions/proposals/2026-06-23-prototipo-ssot-unico-com-historico.md).
