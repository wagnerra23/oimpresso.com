...
(`prototipo-ui/design-system/` + `ds-mirror-build.mjs`, ADR 0239). Por isso o `--exclude`.
...
do que já está em `prototipo-ui/design-system/_ds_bundle.js`**. Ou seja: aplicar o pacote
