...
- **`memory/reference/prototipo-ui/PROTOCOL.md`** — 6 papéis × 7 fases, gates, overrides, métricas de saúde, anti-padrões.
- **`memory/reference/prototipo-ui/CLAUDE_DESIGN_BRIEFING.md`** — tokens canônicos (shadcn + warm), personas, 15 dimensões, proibições.
