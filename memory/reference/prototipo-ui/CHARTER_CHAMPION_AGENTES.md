...
related: [CHARTER_GOVERNANCA_W.md, STATUS.md, memory/reference/prototipo-ui/PROTOCOL.md, CARTA_DESIGN_CC.md]
...
- memory/reference/prototipo-ui/PROTOCOL.md §2 (overlay autônomo) · §10.2 (retorno) · §10.4 (gate)
