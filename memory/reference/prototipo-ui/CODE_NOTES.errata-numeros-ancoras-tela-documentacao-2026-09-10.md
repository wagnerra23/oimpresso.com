...
| afirmação | veredito |
|---|---|
| tabela **Âncoras 1:1** | ✅ **12 de 12** resolvem pelo `scripts/design/ancora.mjs` exatamente como escrito |
...
porta viva (`node scripts/design/ancora.mjs <Mod/Tela>` para o par, `git grep` para o censo) em vez
