...
| **Valor total nominal** | **R$ [redacted Tier 0]** | inclui quitados + abertos histórico completo |
| **Total quitado** | R$ [redacted Tier 0] (71.673 títulos) | |
| **Total aberto** | R$ [redacted Tier 0] (3.867 títulos) | |
...
| **TOTAL** | **3.867** | **R$ [redacted Tier 0]** |

**Bala mágica da demo:**

> "Vocês têm **R$ [redacted Tier 0] milhões em aberto na contabilidade**.
> Mas só **R$ [redacted Tier 0] mil são clientes que devem AGORA**.
> Os outros **R$ [redacted Tier 0] milhões (90%) é histórico fóssil pré-2020** — não existe mais cliente nem cobrança real.
...
- [ ] **Cleanup tool** US-OFICINA-005 — UI pra batch write-off dos R$ [redacted Tier 0]M fóssil
