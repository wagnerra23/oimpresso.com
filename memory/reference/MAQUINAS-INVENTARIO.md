...
| `contrato-de-tela.mjs` | ci, npm, script | 🟢 só lê | test | `memory/decisions/0290-fidelity-lock-v0-recusado.md` +36 | Gate "Contrato de Tela" (a perna de fidelidade visual do trio-de-tela). |
