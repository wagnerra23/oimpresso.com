...
|---|---|---|---|---|
| `kb-answer` (G3) | gpt-4o-mini | R$ [redacted Tier 0] | sob demanda | ~R$ [redacted Tier 0] |
| `handoff-fetch-summarized` (G4) | gpt-4o-mini | R$ [redacted Tier 0]/handoff | retomada | ~R$ [redacted Tier 0] |
| `handoff-diff` (H3) | gpt-4o-mini | R$ [redacted Tier 0] | retomada | ~R$ [redacted Tier 0] |
| `jana:weekly-digest` (H6) | gpt-4o-mini | R$ [redacted Tier 0] | semanal cron | R$ [redacted Tier 0]/ano |
| RAGAS gate (H4) | gpt-4o-mini judge | $0.02/run | weekly+manual | R$ [redacted Tier 0] |

**Total acréscimo IA hoje:** ~R$ [redacted Tier 0]/mês max. Cumpre Princípio 4 ADR 0094 (loop fechado por métrica).
