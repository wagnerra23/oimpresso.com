---
name: PLANTA-IA — topologia e inventário gerados
description: Página documental da IA do oimpresso, derivada do código por system-map.mjs. Separa inventário versionado de estado vivo.
type: reference
authority: generated
lifecycle: ativo
---

# Onde a IA vive no oimpresso
...
> Resumo do sistema inteiro: [`PAINEL-SISTEMA.md`](PAINEL-SISTEMA.md). Decisões donas: [ADR 0035](../decisions/0035-stack-ai-canonica-wagner-2026-04-26.md), [ADR 0048](../decisions/0048-framework-agentes-laravel-ai-vizra-rejeitada.md) e [ADR 0062](../decisions/0062-separacao-runtime-hostinger-ct100.md).
...
---
_Gerado por `scripts/governance/system-map.mjs` · 2026-07-28 · referência derivada, não substitui os donos canônicos._
