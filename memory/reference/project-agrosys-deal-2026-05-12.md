---
name: Deal Agrosys — R$ 2.4M/ano + R$ 500k upfront (em negociação 2026-05-12)
...
type: project
---
# Deal Agrosys — pipeline R$ 2.65M ano 1

## Estado inicial 2026-05-12

**Cliente potencial**: **Agrosys Sistemas** (não plug.co, não Pluga.co — confusão inicial corrigida)
- Criciúma/SC, ~R$ 25M receita 2025, ~160 funcionários
- Adquirida pela **Aliare** em 2026 (R$ 150M, big tech agro)
...
| Item | Valor |
|---|---|
| **Taxa de implantação** (one-shot) | **R$ 500.000** |
| **MRR Agrosys → Wagner** (4000 × R$ 97) | **R$ 388.000/mês** |
| **MRR líquido Wagner** (4000 × R$ 50) | **R$ 200.000/mês** = **R$ 2,4M/ano** |
| **MRR Agrosys cobra cliente final** (4000 × R$ 200) | R$ 800.000/mês (margem deles R$ 412k) |
| **Total ano 1 Wagner** | **~R$ 2,65 milhões** |

Resolve metade da meta ADR 0022 (R$ 5M/ano) em 1 deal.
...
- **Total: ~$522/mês ≈ R$ 2.700/mês**
- **Com fiscal BR (+20%): R$ 3.240/mês**
- **Margem Wagner: 98,4%** (R$ 200k receita – R$ 3,2k custo)
...
5. **Modelo billing** — Agrosys MoR (cobra clientes finais, repassa Wagner) OU Wagner MoR? Quem emite NF dos R$ 50?
