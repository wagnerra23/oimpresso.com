...
- `DEV_LOGIN_USERNAME=WR23` (user dev — fixo)
- `DEV_LOGIN_PASSWORD=<valor no Vaultwarden item wr23-dev-login>` no .env

## Worktrees git

- `D:/oimpresso.com` — principal, servido pelo Herd (branch canônica: `main` desde 2026-04-27 ADR 0038)
