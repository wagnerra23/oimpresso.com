...
- **Cliente piloto:** **Martinho Caçambas LTDA** (Cliente_731814, biz=164 prod, **Tubarão/SC · Humaitá de Cima** · Location BL0001 — errata endereço 2026-05-26 pós-smoke prod; pré-correção dizia Capivari de Baixo via WebSearch que apontou entidade diferente) — 91 placas de caminhões de CLIENTES + 44.709 vendas Firebird + R$ [redacted Tier 0]M+/mês estimado
