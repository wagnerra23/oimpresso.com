...
**Surpresa estratégica do sênior:** Anthropic prompt caching eleva A1 de P2 → P1 (Brief 06:00 + retomada 07:00 + meeting prep 10:00 = 3 cache hits = economia ~R$ 42/mês). **Não estava no GAP-ANALYSIS original** — descoberto na pesquisa profunda do sênior.
...
- BGE-v2-m3 self-host CT 100: +6pp NDCG@10 vs RRF, ~80-150ms latência CPU, R$ 0 (self-host)
...
- **Bryntum:** R$ 22.500 upfront (custo proibitivo)
