...
**Tech Provider direto** elimina BSP markup e mantém margem 98%+ no modelo R$ [redacted Tier 0]/número.
...
|---|---|---|---|
| **Utility** (NFe emitida, OTP, status pedido) | $0,0068 | ~R$ [redacted Tier 0] | empresa → cliente |
| **Authentication** (OTP login) | $0,0068 | ~R$ [redacted Tier 0] | empresa → cliente |
| **Marketing** (promo, divulgação) | $0,0625 | ~R$ [redacted Tier 0] | empresa → cliente |
...
### Fiscal Brasil
Meta fatura via **Irlanda** → triggera **ISS + IRRF + CIDE + PIS + COFINS** = ~15-25% adicional. R$ [redacted Tier 0]/msg vira efetivo R$ [redacted Tier 0]-0,043.
...
| Provider | Custo utility | Fee fixo/número/mês | Margem deal Agrosys (R$ [redacted Tier 0] líquido) |
|---|---|---|---|
| **Tech Provider Meta direto** | R$ [redacted Tier 0] | **R$ [redacted Tier 0]** | **98%** |
| 360dialog | R$ [redacted Tier 0] + markup | €49-99 (~R$ [redacted Tier 0]-600) | **NEGATIVA** |
| Take Blip | sob contrato (premium) | sob contrato | concorrente, não usar |
| Twilio WhatsApp | R$ [redacted Tier 0] + $0,005 | sem fee fixo | ~90% |
| Gupshup | R$ [redacted Tier 0] + markup | varia | ~90% mas BR fraco |
