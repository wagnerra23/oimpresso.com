...
- [crm-e-o-modulo-de-cliente.md](crm-e-o-modulo-de-cliente.md) — **`Modules/Crm` É o módulo de Cliente/contatos do cliente** (UPOS legacy naming; NÃO existe Modules/Cliente). requisitos/Crm canônico · requisitos/Cliente legado. Desambiguação pra parar a confusão CRM↔Cliente
