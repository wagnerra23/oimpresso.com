...
**Conexão com meta R$ 5mi/ano** (ADR 0022):
...
- **Copiloto** é o próprio **orquestrador** dessa meta — ver `memory/requisitos/Copiloto/`. É simultaneamente produto e ferramenta interna (eat-your-own-dog-food: oimpresso usa o Copiloto pra monitorar R$ 5mi/ano via meta de plataforma, `business_id = null`).
