...
| **2026-04-19** | Inventário da instância UltimatePOS capturado (base herdada: Crm, Manufacturing, Repair, Superadmin, Woocommerce, Connector, **Officeimpresso** — o módulo-ponte pro Delphi — etc.). | inventário vivo em [`reference/PAINEL-SISTEMA.md`](reference/PAINEL-SISTEMA.md) §"Módulos & verticais" _(era `09-modulos-ultimatepos.md`, lápide removida em 2026-08-10 — o corpo já tinha saído antes; o inventário hoje é **derivado da árvore**, não escrito à mão)_ |
