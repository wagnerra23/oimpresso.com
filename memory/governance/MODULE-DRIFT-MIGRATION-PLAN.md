...
|---|---|---|---|---|---|
| 1 | `Modules/Copiloto/Http/Controllers/MemoriaController.php` | `Modules/KB/Http/Controllers/` | Browse/admin de `mcp_memory_documents` é função do KB, não do chat | 3.7 | baixo |
| 2 | `Modules/Copiloto/Http/Controllers/FontesController.php` | `Modules/KB/Http/Controllers/` | Knowledge sources são parte do KB | 3.7 | baixo |
| 3 | `Modules/Copiloto/Http/Controllers/Mcp/CcIngestController.php` | `Modules/TeamMcp/Http/Controllers/` | Ingest de Claude Code sessions é admin do MCP server | 3.7 | médio (webhook) |
| 4 | `Modules/Copiloto/Http/Controllers/Mcp/HealthController.php` | `Modules/TeamMcp/Http/Controllers/` | Health check do MCP server pertence ao admin do MCP | 3.7 | baixo |
| 5 | `Modules/Copiloto/Http/Controllers/Mcp/SyncMemoryWebhookController.php` | `Modules/TeamMcp/Http/Controllers/` | Webhook sync git→DB é função do MCP server admin | 3.7 | **alto** (webhook GitHub aponta pra URL atual) |
| 6 | `Modules/Copiloto/Http/Controllers/Admin/GovernancaController.php` | `Modules/Governance/Http/Controllers/` (NOVO Fase 5) | Governança consolidada vai pra módulo dedicado | 5 | baixo |
...
|---|---|
| 6 SCOPE.md críticos criados | ✅ ADS, Copiloto, KB, MemCofre, TeamMcp, ProjectMgmt |
