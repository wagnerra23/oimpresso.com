---
id: governance-design-requests-req-001
req: REQ-001
data: 2026-06-18
...
- **arquivo:** `Modules/Whatsapp/Resources/js/Pages/Atendimento/CaixaUnificada/_components/reconnectState.ts`  *(frontend — trata o vocabulário)*
