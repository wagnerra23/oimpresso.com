...
> **Rótulo honesto:** lista o que foi **mergeado em `main`** em `2026-05-31..2026-07-16` (BRT). Merge ≠ deploy ≠ funciona em produção.
...
- **2167 PRs** mergeados em `main` · 1074 de produto · 1093 de manutenção (docs/chore/test/ci/build)
...
### produto — 0 (+6 manutenção)

### programa-ondas — 0 (+1 manutenção)

### proibicoes — 0 (+6 manutenção)
