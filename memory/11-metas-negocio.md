...
**Gap até a meta (se pura recorrência SaaS):** R$ [redacted Tier 0]mi/ano ÷ 12 = **R$ [redacted Tier 0]k/mês de MRR**.

## 2. Cenários de composição para chegar a R$ [redacted Tier 0]k/mês

Três caminhos pra chegar na mesma receita, cada um com operação/funil/preço diferente:

### Cenário A — Massa (long tail)
- **1.000 clientes × R$ [redacted Tier 0]/mês**
...
### Cenário B — Médio (SMB)
- **250 clientes × R$ [redacted Tier 0]/mês**
...
- **50 clientes × R$ [redacted Tier 0]/mês** (faixa de ERP mid-market)
...
- 30 enterprise × R$ [redacted Tier 0]k = R$ [redacted Tier 0]k/mês
- 120 médios × R$ [redacted Tier 0]k = R$ [redacted Tier 0]k/mês
- 200 pequenos × R$ [redacted Tier 0] = R$ [redacted Tier 0]k/mês
- **Total: ~R$ [redacted Tier 0]k/mês** — diversificado, reduz dependência.
...
- [ ] Meta conservadora: 10 reativações × R$ [redacted Tier 0]/mês = **+R$ [redacted Tier 0]k MRR** (primeiros 90 dias).
...
**Prioridade: MÉDIA-ALTA** — retorno rápido mas receita adicional é pequena (6 clientes × 2 módulos × R$ [redacted Tier 0] = +R$ [redacted Tier 0]k MRR).
...
| Wagner operar sozinho não escala | Ao atingir ~R$ [redacted Tier 0]k MRR, contratar/terceirizar CS |
