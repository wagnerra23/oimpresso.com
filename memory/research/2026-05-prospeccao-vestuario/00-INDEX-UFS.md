...
**ICP comum:** lojas vestuário (CNAE 4781-4/00) — moda feminina/masculina/infantil/jeans/plus size · 5–50 funcionários · R$ 50k-1M/m · multi-loja é sweet spot · validação WebFetch real para Tier 1 · sem invenção (`?` para desconhecido) · sem PII pessoal.
...
ROTA LIVRE = **LARISSA COMERCIO DE ARTIGOS DO VESTUARIO LTDA** · biz=4 · Termas do Gravatal/SC · ~3 lojas físicas + WhatsApp + monitor 1280px · faturamento R$ 130k/m. Casos análogos:
