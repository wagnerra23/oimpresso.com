...
> **Companion docs:**
> - [stack_agente_php_vizra_prism_mem0_capterra_2026_04_26.md](./stack-agente-php-vizra-prism-mem0-capterra-2026-04-26.md)
> - [copiloto_runtime_memory_vs_mem0_langgraph_letta_zep_capterra_2026_04_26.md](./copiloto-runtime-memory-vs-mem0-langgraph-letta-zep-capterra-2026-04-26.md)
...
2. **Custo recorrente atual: R$ [redacted Tier 0]/mês** (Meilisearch self-hosted + Boost/Telescope/Pail/Horizon todos gratuitos) — fiel ao ROI prometido pelo ADR 0036.
...
| **Risco** | 4 (baixo, R$ [redacted Tier 0]/mês) | 3 (commercial bugs caros) | 4 | 3 (lock-in $) | **5** (zero risco) |
...
### V2 — R$ [redacted Tier 0]/mês recorrente sustentado
...
> *"Stack canônica pronta + R$ [redacted Tier 0]/mês recorrente. Antes de otimizar, validamos demanda com 1 cliente real (Larissa do ROTA LIVRE). 1 dia de validação > 4 semanas de engenharia em vácuo."*

---

## 8. Math da meta R$ [redacted Tier 0]mi/ano (ADR 0022)

Pressupostos:
- Cliente Tier 1A: R$ [redacted Tier 0]-599/mês
...
|---|---|---|---|
| **A → atual** | 5 (sprints 7-11) | ~6 | R$ [redacted Tier 0]-2k (sem ainda Jana comercial) |
| **B → pivot comercial** | 4 (PricingFpv + CT-e/MDF-e) | ~3-4 | R$ [redacted Tier 0]-50k |
...
### Internas
- [_TEMPLATE_capterra_oimpresso.md](./template-capterra-oimpresso.md) v1.0
- [stack_agente_php_vizra_prism_mem0_capterra_2026_04_26.md](./stack-agente-php-vizra-prism-mem0-capterra-2026-04-26.md)
- [copiloto_runtime_memory_vs_mem0_langgraph_letta_zep_capterra_2026_04_26.md](./copiloto-runtime-memory-vs-mem0-langgraph-letta-zep-capterra-2026-04-26.md)
...
- [x] Math da meta R$ [redacted Tier 0]mi/ano
