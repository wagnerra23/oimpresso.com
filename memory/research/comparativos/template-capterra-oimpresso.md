...
> substitui `[PLACEHOLDERS]`, mantém a estrutura. Atualiza `memory/research/index.md` da pasta com o novo doc.
>
...
Sempre conectar com **ADR 0022** (R$ [redacted Tier 0]mi/ano).
...
Ser explícito sobre **assunções não validadas** (ex: "ticket médio R$ [redacted Tier 0] ainda não validado em prospect real").
...
- [ ] Math da meta R$ [redacted Tier 0]mi feito?
