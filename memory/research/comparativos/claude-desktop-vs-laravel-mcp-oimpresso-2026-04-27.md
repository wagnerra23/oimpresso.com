...
> **Companion docs:** [ENTERPRISE.md](../requisitos/Jana/ENTERPRISE.md) · [revisao_caminho_2026_04_27_capterra.md](./revisao-caminho-2026-04-27-capterra.md)
...
**Por que é vantagem:** **nenhum** concorrente vertical tem MCP server. Comprador grande (>R$ [redacted Tier 0]mi/ano) prefere "ERP que conversa pelo Claude Desktop" vs ERP que abre 15 telas.
...
Pressupostos:
- 1 sprint Wagner = ~80h
- Custo recorrente: R$ [redacted Tier 0] (laravel/mcp é OSS, MCP roda no mesmo servidor)
...
- Conversão típica B2B: 5-10% → **0.5-2 clientes Tier 1A** (R$ [redacted Tier 0]-599/mês × 12 = R$ [redacted Tier 0]-7k/cliente Y1)
...
- [revisao_caminho_2026_04_27_capterra.md](./revisao-caminho-2026-04-27-capterra.md)
...
- [x] Math da meta (R$ [redacted Tier 0]-7k/cliente Y1, break-even 1 cliente)
