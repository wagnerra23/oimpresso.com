...
> **Objetivo:** subsidiar decisão de roadmap pra atingir meta R$ [redacted Tier 0]mi/ano (ADR 0022).
> **Companion:** [`memory/research/site-marketing-concorrentes-comunicacao-visual-2026-04-25.md`](./site-marketing-concorrentes-comunicacao-visual-2026-04-25.md) (research anterior, foco em copy/visual)
...
| Custo-benefício | ❓ (sem tabela pública) | 4.5 (300+ reviews) | 3.8 (premium) | 4.0 | 3.8 | 4.0 | 4.7 (R$ [redacted Tier 0]/mês) | 4.2 |
...
## Math da meta R$ [redacted Tier 0]mi/ano (24 meses)

R$ [redacted Tier 0]mi/ano = **R$ [redacted Tier 0]k/mês de MRR**.

Combinando com revenue thesis dos módulos (ARQ-0004 Financeiro):
- **Cenário B (recomendado em 11-metas-negocio.md):** 250 clientes × R$ [redacted Tier 0]/mês
- **Cenário D Misto:** 50 ent × R$ [redacted Tier 0]k + 120 médios × R$ [redacted Tier 0]k + 200 peq × R$ [redacted Tier 0] = R$ [redacted Tier 0]k/mês

Pra ticket médio R$ [redacted Tier 0]/mês (entre Mubisys e Bling premium): **838 clientes ativos**. Com churn 3%/mês e CAC payback 6 meses, funil de **~50 leads qualificados/mês**.

**Realidade hoje:** 7 clientes ativos, ROTA LIVRE concentra 99%. Gap de 800+ clientes em 24 meses = **33 clientes novos/mês líquidos**. Wagner sozinho não escala — **pressupõe contratação a partir de R$ [redacted Tier 0]k MRR** (memória 11-metas-negocio.md).
