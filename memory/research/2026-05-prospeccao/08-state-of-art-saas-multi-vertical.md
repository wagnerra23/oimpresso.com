...
| **5** | **Embedded Analytics como produto monetizável** | Stripe Sigma model: cliente paga R$ 99-199/mês adicional pra ter dashboard avançado (cohort dele próprio + benchmark vs setor). Vertical com.visual pode ter "Sigma do plotter" |
...
- **Sem embedded analytics monetizável** — pode existir tier "Pro" R$ 99/mês com dashboards avançados que cobre custo de infra
...
| **S2 (jun/2026)** | **RFM segmentation** dos clientes da Rota Livre como feature paga R$ 49/mês add-on | 1 sprint | Alto — primeira receita add-on, valida hipótese pricing |
...
### Métricas de monetização (add-on R$ 49/mês RFM + R$ 99/mês embedded BI)
