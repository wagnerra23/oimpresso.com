...
|---|---------|----------|------------:|--------------:|-------------------:|-----------------:|----------:|-----------------:|------:|
| 1 | [`Cliente_874398`](02-vargas-recapagem/03-financeiro-2026-05-11.md) | recapagem caminhao | R$ [redacted Tier 0] M | + R$ [redacted Tier 0] M | R$ [redacted Tier 0] M | R$ [redacted Tier 0] M | R$ [redacted Tier 0] | 0 | 🟡 2 |
| 2 | [`Cliente_6928E8`](03-extreme-grafica/03-financeiro-2026-05-11.md) | grafica industrial PCP | R$ [redacted Tier 0] M | + R$ [redacted Tier 0] M | R$ [redacted Tier 0] M | R$ [redacted Tier 0] M | R$ [redacted Tier 0] | 0 | 🟡 3 |
| 3 | [`Cliente_09FEB1`](04-gold-comvis/03-financeiro-2026-05-11.md) | comunicacao visual | R$ [redacted Tier 0] M | **- R$ [redacted Tier 0] M** | R$ [redacted Tier 0] M | R$ [redacted Tier 0] M | R$ [redacted Tier 0] | 0 | 🔴 3 |
| 4 | [`Cliente_731814`](05-martinho-cacambas/03-financeiro-2026-05-11.md) | mecanica pesada caminhao basculante (ADR 0194) | R$ [redacted Tier 0] M | + R$ [redacted Tier 0] M | **R$ [redacted Tier 0] M** | R$ [redacted Tier 0] M | R$ [redacted Tier 0] | 0 | 🔴 2 |

**Total agregado:** receita combinada 12m ≈ R$ [redacted Tier 0] M · resultado combinado ≈ + R$ [redacted Tier 0] M (com 1 cliente em deficit).

### Observacao MRR / contratos ativos

**Todos os 4 clientes apresentam MRR = R$ [redacted Tier 0] e zero contratos ativos** na tabela `CONTRATO`. Isso confirma o que [01-wr-sistemas/01-perfil.md](01-wr-sistemas/01-perfil.md) ja indicava: **OfficeImpresso legacy nao tem feature de recurring billing implantada nesses 4 clientes** — toda receita vem de OS/vendas avulsas via tabela `FINANCEIRO` com `TIPO='RECEBIDA'`. **Implicacao comercial:** nenhum dos 4 tera "MRR perdido" durante migracao — sao operacoes 100% transacionais (sells + financeiro), o que **simplifica o cutover** (sem precisar mapear recorrencias).
...
|---------|------|----------------------|
| **`Cliente_09FEB1` (Gold)** | `deficit_operacional` — Resultado 12m = -R$ [redacted Tier 0] M | Negocio com pressao de caixa atual. Migracao pode ser bem-recebida se reduzir custos operacionais (planos mensais vs licenca Delphi), mas **negociar com cautela sobre prazo de pagamento** |
| **`Cliente_731814` (Martinho)** | `inadimplencia_alta` — 76.7% da receita 12m em a_receber vencidas | **R$ [redacted Tier 0] M em titulos vencidos vs R$ [redacted Tier 0] M de receita anual = lastreio operacional fragil**. Resultado +R$ [redacted Tier 0] M nao reflete realidade se titulos sao incobraveis. Migracao deve **priorizar feature de cobranca/inadimplencia automatica** (Asaas integration US-RB-044) |

### 3.2 Amarelas (monitorar)

| Cliente | Flag |
|---------|------|
| `Cliente_874398` (Vargas) | `pagar_maior_que_receber` — A pagar vencidas (R$ [redacted Tier 0] M) > A receber vencidas (R$ [redacted Tier 0] M) |
...
- Receita 12m: R$ [redacted Tier 0] M (maior do sample)
- Resultado: + R$ [redacted Tier 0] M (operacao saudavel)
...
- Receita 12m: R$ [redacted Tier 0] M
- Resultado: + R$ [redacted Tier 0] M (melhor margem do sample)
...
- Receita 12m: R$ [redacted Tier 0] M (similar Extreme/Martinho)
- Resultado: **- R$ [redacted Tier 0] M** (deficit operacional 12m)
...
- Receita 12m: R$ [redacted Tier 0] M
- Resultado: + R$ [redacted Tier 0] M (aparente lucro)
- **MAS** inadimplencia critica: R$ [redacted Tier 0] M em titulos vencidos = **76.7% da receita anual**
- **Flags:** 1 vermelha
...
|------:|---------|------|---------|----------------|------------|
| 1 | Vargas (recapagem) | S | R$ [redacted Tier 0] M | dinamica fluxo caixa | Pitch premium tier — modulo OficinaAuto especializado |
| 2 | Extreme (grafica industrial) | S | R$ [redacted Tier 0] M | concentracao 49% | Pitch premium + setup PCP separado como projeto |
| 3 | Martinho (cacambas) | B | R$ [redacted Tier 0] M | inadimplencia 76,7% | Pitch focado em **cobranca automatica** (Asaas) como ROI principal |
| 4 | Gold (comvis) | A | R$ [redacted Tier 0] M | deficit 12m | Pitch ROI redutor de custo + canary Modules/ComunicacaoVisual |

**Total receita ARR potencial dos 4:** ~R$ [redacted Tier 0] M cobertos. Se take rate medio for 0.5% (proposito SaaS conservador), receita anual potencial dos 4 ≈ R$ [redacted Tier 0]k/ano = R$ [redacted Tier 0]k/mes (apenas desses 4 clientes).
...
- [ ] Para Martinho: investigar com cliente se R$ [redacted Tier 0] M em vencidas e realidade ou uso ruim do sistema
