...
**ICP comum:** mecânica geral / centro automotivo / especialista (CNAE 4520-0/01) · 5–50 funcionários · 1-3 elevadores · R$ 30k-500k/mês (estimado por sinais públicos) · validação WebFetch real para Tier 1 · sem invenção (`?` para desconhecido) · sem PII pessoal.
