...
### 1.2 ICP-faixa (5-50 funcionários, R$ 30k-500k/m, 1-3 elevadores)
...
- Oficinas com 1-3 elevadores e faturamento R$ 50-300k/m representam o "miolo" — estimativa **~40-60k estabelecimentos** no BR. `[validar — não há fonte pública direta; cruzar Sindirepa + Receita]`
...
3. **Não rastreia margem por OS** — peça comprada R$ 80, vendida R$ 120, mão-de-obra "cobrada na canetada". Sem visão de lucro real.
...
|---|---|---|---|
| **Mecânico** (Officina) | SaaS | R$ 99-299 | Forte em SP, marketing pesado |
| **ManagerOS** | SaaS | R$ 149-399 | Inclui app cliente |
| **Auto Manager** | Desktop + cloud | R$ 100-250 | Tradicional, base instalada grande |
| **Lokoz** | SaaS moderno | R$ 89-249 | Mais recente, UI moderna |
| **Olho Vivo** | Desktop legado | R$ 80-180 | Comum em oficinas tradicionais |
| **OficinaMaster** | SaaS | R$ 99-249 | Foco em centro automotivo |
| **Carros2** | SaaS | R$ 99-199 | Foco em mecânica geral |
| **Sti3** | SaaS | R$ 149-349 | Forte em pesados/frota |
| **GP Office** | Desktop+cloud | R$ 100-300 | Tradicional |
| **Mais Oficina** | SaaS | R$ 99-249 | Mid-market |
...
| Ticket médio software/m | R$ 200-500 | R$ 100-400 | Margem unitária menor mas volume compensa |
...
1. **Universo 10-30x maior** que gráfica — mesmo capturando 0.05% do ICP refinado, são 10-15 clientes pagantes (~R$ 30-60k MRR).
...
- Aceite formal: contrato R$ 199-399/m por 6 meses + feedback semanal estruturado.
