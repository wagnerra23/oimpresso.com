...
|---|---|---|---|---|---|
| 1 | `CODNF_CFOP_ENTRADA` | `VARCHAR(9)` | NULL | v25 | v25 |
| 2 | `CODNF_CFOP_ENTRADA_FORA` | `VARCHAR(9)` | NULL | v25 | v25 |
...
| 23 | `CODNF_CEST` | `VARCHAR(7)` | NULL | v382 | v382 |
...
| 40 | `CODNF_NATUREZA_OPERACAO` | `INTEGER` | NULL | v662 | v662 |
...
| 49 | `CODPLANOCONTAS` | `VARCHAR(15)` | NULL | v955 | v955 |
