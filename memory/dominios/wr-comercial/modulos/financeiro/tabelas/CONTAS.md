...
|---|---|---|---|---|---|
| 1 | `CODEMPRESA` | `INTEGER` | NULL | v147 | v147 |
...
| 16 | `CODCONTA_VINCULADA` | `integer` | NULL | v303 | v303 |
...
| 38 | `CODEMAIL_MODELO` | `integer` | NULL | v561 | v561 |
| 39 | `TIPO_CONVENIO` | `VARCHAR(50)` | NULL | v623 | v623 |
| 40 | `CODBANCO_CONFIGURACAO` | `INTEGER` | NULL | v679 | v679 |
...
| 45 | `CODCONTA_TRANSFERENCIA_AUTO` | `INTEGER` | NULL | v701 | v701 |
