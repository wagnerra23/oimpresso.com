...
|---|---|---|---|---|---|
| 1 | `CODPRODUTO_TABELA` | `INTEGER` | NOT NULL | v827 | v827 |
| 2 | `CODNF_ENTRADA` | `VARCHAR(10)` | NOT NULL | v827 | v827 |
| 3 | `CODNF_ENTRADA_PRODUTOS` | `INTEGER` | NOT NULL | v827 | v827 |
...
| 9 | `CODCLIENTE` | `VARCHAR(30)` | NULL | v827 | v827 |
| 10 | `PARENT` | `INTEGER` | NULL | v863 | v863 |
| 11 | `CODPRODUTO` | `VARCHAR(15)` | NULL | v1371 | v1371 |
