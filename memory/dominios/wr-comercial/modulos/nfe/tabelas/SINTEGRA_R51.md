...
| 7 | `SERIE` | `VARCHAR(3)` | NULL |  | v583 | v583 |
| 8 | `NUMERO` | `VARCHAR(6)` | NULL |  | v583 | v583 |
| 9 | `CFOP` | `VARCHAR(4)` | NULL |  | v583 | v583 |
| 10 | `VALOR_TOTAL` | `DOUBLE PRECISION` | NULL |  | v583 | v583 |
| 11 | `IPI_VALOR` | `DOUBLE PRECISION` | NULL |  | v583 | v583 |
| 12 | `VALOR_ISENTAS` | `DOUBLE PRECISION` | NULL |  | v583 | v583 |
| 13 | `VALOR_OUTRAS` | `DOUBLE PRECISION` | NULL |  | v583 | v583 |
| 14 | `SITUACAO` | `VARCHAR(1)` | NULL |  | v583 | v583 |

## Evolução

| UPDATE N; | Operação | Detalhe |
|---|---|---|
| 583 | CREATE | CREATE TABLE com 14 colunas |
