...
| 2 | `CODNF_ENTRADA` | `VARCHAR(10)` | NOT NULL | v565 | v565 |
| 3 | `CODFABRICA` | `VARCHAR(60)` | NULL | v565 | v565 |
| 4 | `CODFORNECEDOR` | `VARCHAR(10)` | NULL | v565 | v565 |
| 5 | `CODPRODUTO` | `VARCHAR(15)` | NOT NULL | v565 | v565 |
| 6 | `CODPRODUTO_COMPOSICAO` | `VARCHAR(15)` | NULL | v565 | v565 |
...
| 19 | `CODPRODUTO_GRUPO` | `VARCHAR(15)` | NULL | v565 | v565 |
| 20 | `DT_ALTERACAO` | `TIMESTAMP` | NULL | v565 | v565 |
| 21 | `FRETE` | `DOUBLE PRECISION` | NULL | v565 | v565 |
| 22 | `CODPRODUTO_LOTE` | `INTEGER` | NULL | v565 | v565 |
...
| 31 | `CODNF_ENTRADA_PRODUTOS` | `INTEGER` | NULL | v673 | v673 |
...
| 36 | `CODFORMULA_PERFIL` | `INTEGER` | NULL | v679 | v679 |
