...
|---|---|---|---|---|---|
| 1 | `CODNF_NATUREZA_OPERACAO` | `INTEGER` | NOT NULL | v1135 | v1135 |
| 2 | `CODPRODUTO_GRUPO` | `VARCHAR(15)` | NOT NULL | v1135 | v1135 |
| 3 | `CODNF_CST` | `VARCHAR(4)` | NULL | v1135 | v1135 |
| 4 | `CODNF_CFOP` | `VARCHAR(9)` | NULL | v1135 | v1135 |
| 5 | `CODNF_CFOP_FORA` | `VARCHAR(9)` | NULL | v1135 | v1135 |
...
| 52 | `CODNF_CFOP_ENTRADA` | `VARCHAR(9)` | NULL | v1135 | v1135 |
| 53 | `CODNF_CFOP_ENTRADA_FORA` | `VARCHAR(9)` | NULL | v1135 | v1135 |
...
| 75 | `CODNF_CEST` | `VARCHAR(7)` | NULL | v1135 | v1135 |
| 76 | `CODVENDA_TIPO` | `INTEGER` | NULL | v1135 | v1135 |
...
| 101 | `CODPLANOCONTAS` | `VARCHAR(15)` | NULL | v1135 | v1135 |
