...
| 22 | `CODCLIENTE` | `VARCHAR(15)` | NULL | v12 | v12 |
...
| 26 | `CODFINANCEIRO` | `VARCHAR(10)` | NULL | v12 | v12 |
| 27 | `CODEMPRESA` | `VARCHAR(10)` | NULL | v12 | v12 |
| 28 | `DT_FATURAMENTO` | `TIMESTAMP` | NULL | v12 | v12 |
| 29 | `CODUSUARIO` | `VARCHAR(10)` | NULL | v12 | v12 |
| 30 | `BLOQUEIO` | `VARCHAR(1)` | NULL | v12 | v12 |
| 31 | `CODFUNCIONARIO` | `VARCHAR(15)` | NULL | v12 | v12 |
...
| 38 | `CODVENDA` | `VARCHAR(15)` | NULL | v12 | v12 |
...
| 46 | `CODUSUARIO_RESPONSAVEL` | `INTEGER` | NULL | v113 | v113 |
| 47 | `CODPRODUTO` | `VARCHAR(15)` | NULL | v114 | v114 |
| 48 | `PRODUTO` | `varchar (300)` | NULL | v114 | v163 |
| 49 | `CODUSUARIO_CRIADOR` | `INTEGER` | NULL | v115 | v115 |
| 50 | `CODUSUARIO_ALTERADO` | `INTEGER` | NULL | v115 | v115 |
...
| 56 | `CODAGENDA_COMPOSICAO` | `VARCHAR(40)` | NULL | v123 | v123 |
...
| 66 | `CODEMAIL_ANEXO` | `integer` | NULL | v231 | v231 |
...
| 72 | `CODVENDA_ORIGINAL` | `VARCHAR(15)` | NULL | v349 | v349 |
| 73 | `CODVENDA_PRODUTO_ORIGINAL` | `INTEGER` | NULL | v349 | v349 |
...
| 83 | `CODEMAIL` | `integer` | NULL | v396 | v396 |
| 84 | `CODEMAIL_CRM_DATABASE` | `integer` | NULL | v396 | v396 |
...
| 92 | `CODAGENDA_FAQ` | `VARCHAR(15)` | NULL | v402 | v402 |
| 93 | `CODLOTE` | `integer` | NULL | v417 | v417 |
| 94 | `TIPO_IMPRESSAO` | `VARCHAR(100)` | NULL | v432 | v432 |
| 95 | `ACABAMENTO` | `VARCHAR(150)` | NULL | v456 | v456 |
| 96 | `CODPRODUCAO` | `INTEGER` | NULL | v519 | v519 |
| 97 | `CODCENTRO_TRABALHO` | `INTEGER` | NULL | v519 | v519 |
