...
| 2 | `CODPRODUCAO` | `INTEGER` | NULL | v1050 | v1050 |
| 3 | `CODUSUARIO` | `INTEGER` | NULL | v1050 | v1050 |
| 4 | `DATA_INICIO` | `TIMESTAMP` | NULL | v56 | v56 |
| 5 | `DATA_FIM` | `TIMESTAMP` | NULL | v56 | v56 |
| 6 | `CODSETOR` | `INTEGER` | NULL | v136 | v136 |
| 7 | `CODCENTRO_TRABALHO` | `INTEGER` | NULL | v1050 | v1050 |
| 8 | `CODESTAGIO` | `INTEGER` | NULL | v1050 | v1050 |
| 9 | `CODPRODUCAO_OS` | `INTEGER` | NULL | v1050 | v1050 |
