...
| 2 | `CODVENDA` | `VARCHAR(10)` | NOT NULL | v57 | v57 |
| 3 | `CODVENDA_PRODUTO` | `INTEGER` | NOT NULL | v57 | v57 |
| 4 | `PRODUTO` | `varchar (300)` | NULL | v57 | v163 |
| 5 | `CODPRODUTO` | `VARCHAR(15)` | NULL | v57 | v57 |
...
| 19 | `CODPRODUTO_GRUPO` | `VARCHAR(15)` | NULL | v123 | v123 |
...
| 25 | `CODLOCAL` | `integer` | NULL | v321 | v321 |
...
| 96 | `CODPRODUTO_ORIGEM` | `VARCHAR(15)` | NULL | v749 | v749 |
