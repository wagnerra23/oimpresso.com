---
id: dominios-wr-comercial-modulos-vendas-tabelas-venda-produto-prerequisito
table: VENDA_PRODUTO_PREREQUISITO
module: vendas
...
foreign_keys:
  ...
  CODVENDA_ETAPA_PREREQUISITO: VENDA
...
| `CODVENDA_ETAPA_PREREQUISITO` | [`VENDA`](../../vendas/tabelas/VENDA.md) |
...
| 8 | `CODVENDA_ETAPA_PREREQUISITO` | `INTEGER` | NULL | → `VENDA` | v1232 | v1232 |
...
| 1232 | ADD_COL | + CODVENDA_ETAPA_PREREQUISITO INTEGER |
