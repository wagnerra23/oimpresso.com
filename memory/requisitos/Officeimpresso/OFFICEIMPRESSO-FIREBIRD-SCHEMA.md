...
- **2026-05-09**: schema descoberto via Python firebird-driver, 441 tabelas listadas, 9 críticas mapeadas, queries-template validadas em ServidorWR2:Banco produção. Conexão LAN 192.168.0.55:3050. Análise rendeu R$ 487k ARR + déficit operacional 12m revelado.
