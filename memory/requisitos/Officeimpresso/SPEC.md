...
**Implementado em:** `Modules/Officeimpresso/Http/Controllers/LicencaLogController.php`
**Testado em:** `Modules/Officeimpresso/Tests/Feature/LogsBaselineTest.php`
**Aceite:**
...
- A extração de `buildMaquinasPayload()`/`buildKpisPayload()` não muda uma linha da consulta: os dois caminhos consomem o mesmo payload
