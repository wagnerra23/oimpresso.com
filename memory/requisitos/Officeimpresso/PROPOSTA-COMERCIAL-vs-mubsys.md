...
| Cert A1 digital | por conta do cliente | ~R$ 200/ano (terceiros) |
...
- **R$ 599/mês** — ilimitado + MDF-e + CT-e + SPED + cert gerenciado
...
**Economia estimada:** ~10h/mês de operação. À R$ 50/h = **R$ 500/mês economia operacional**.
...
Se tem manifestação **e** emissão NF-e 55: pacote único Plano Enterprise R$ 599/mês (incluso) ou on-prem one-time conforme Opção A do corpo principal.
