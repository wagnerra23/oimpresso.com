...
| Estado vazio | "Nenhum acesso registrado para esta máquina." + explicação de que ela está cadastrada mas o Delphi nunca chamou dali (`Timeline.tsx:129-131`) | Nada — vivo à frente. O protótipo tem um vazio genérico no lugar (`officeimpresso-page.jsx:741`). |
