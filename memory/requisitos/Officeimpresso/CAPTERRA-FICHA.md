...
|---|---|---|---|
| **Mubisys** | R$ [redacted Tier 0]-800 | gráficas rápidas | sem bridge legado, migração custosa |
| **Sigma Soft** | R$ [redacted Tier 0]-600 | sistemas gráficos legacy | sem stack moderna paralela |
| **Calcgraf** | R$ [redacted Tier 0]-600 | calculadora nicho | só cálculo |
