# StockAdjustment — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/StockAdjustment/`

## Resumo

- Telas Inertia tsx: **2**
- Charters `.charter.md`: **2** (cobertura: 100%)
...
| `Index.tsx` | OK | - | charter-WIP | 1 | sim |
