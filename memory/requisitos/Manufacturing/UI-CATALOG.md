# Manufacturing — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Manufacturing/`

## Resumo

- Telas Inertia tsx: **1**
- Charters `.charter.md`: **1** (cobertura: 100%)
- Blade legacy do modulo (Modules/<X>/Resources/views): **20**
...
`Modules/Manufacturing/Resources/views/` — 20 arquivos

## Migracao planejada (MWART — [ADR 0104](../../decisions/0104-processo-mwart-canonico-unico-caminho.md))

- Estimativa de telas Blade alvo MWART: **20**
- Prioridade: **media — Blade legacy presente (20)**
