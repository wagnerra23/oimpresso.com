...
- [ ] **Dia 8-14 (dispatch L0 e L1 só):** mensagens reais saem mas só pra valores baixos (<R$ 500), Wagner aprova L2+
- [ ] **Dia 15-30 (full HITL ladder):** L0/L1 auto, L2 Wagner aprova 1-click, L3 Wagner + Eliana aprovam
- [ ] **Gate GA pra outros biz (escrever ADR retro):** 90%+ taxa resposta ≥média anterior; 0 incidente LGPD; <2 escalation/dia média; custo Brain B <R$ 150/mês; Pest cobertura ≥80% mantida
- [ ] **Aborto automático:** Larissa pede desligar 2× em 30d OR 5+ falsos positivos OR custo Brain B >R$ 500/mês OR Tier 0 violado OR Wagner >10 overrides/dia → flag `COBRADORA_ATIVA_BIZ_4=false` + ADR retro
