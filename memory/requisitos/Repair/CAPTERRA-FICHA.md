...
|---|---|---|---|
| **Cellity OS** | R$ 150-400 | celular/assistência | UI legacy, sem FSM auditável |
| **Sistema OS** | R$ 100-300 | small assistance | sem multi-tenant Tier 0 |
| **Smart OS** | R$ 250-500 | médio porte | sem FSM canon, portal cliente fraco |
| **Mecanizou** | R$ 200-450 | oficinas em geral | sem portal público sem login |
