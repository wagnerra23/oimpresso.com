...
1. **Pattern reuse**: blueprint `prototipo-ui/cowork/Wagner/repair-page.jsx` — listagem OS com tabs stage, KPIs (Abertas / Atrasadas / Valor) e filtros. Adaptado pra contexto JobSheet (status legacy via `RepairStatus` + futuro FSM `current_stage_id`).
