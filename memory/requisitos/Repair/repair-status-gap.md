...
|---|---|---|
| Header e ação primária | `PageHeader` "Status de OS (Repair)" + "Novo status" → `/repair/status/create` (Index.tsx:29-41). O gate de permissão é do Controller (RepairStatusController.php:44; UC-RSTIDX-06) | Nada — paridade com título／descrição e "Adicionar status" gated por `repair_status.access` (repair-page.jsx:307-311, 330-331). |
