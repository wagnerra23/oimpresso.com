...
>
> **Origem:** decisão estratégica pós-estudo protocol-level (Cloud API ganha 71% no comparativo % vs Baileys 6.7.9 endurecido 58%). Custo R$ [redacted Tier 0]-120/mês ROTA LIVRE cabe na meta R$ [redacted Tier 0]mi/ano ([ADR 0022](../../../decisions/0022-meta-5mi-ano-financeira.md)).
>
...
- [ ] Adicionar número de **TESTE** (NÃO o número de ROTA LIVRE). Opções:
  - Comprar SIM card BR R$ [redacted Tier 0]-50 dedicado ao teste
...
11. Custo real medido via dashboard Meta Business — comparar com estimativa R$ [redacted Tier 0]-120/mês

### Dia 30+: Decisão Wagner

12. Se uptime >99% E custo real ≤R$ [redacted Tier 0]/mês E zero cross-contact incident → **promover Cloud API a primary driver futuro biz=1** (ADR formal nova)
...
| Custo explode acima R$ [redacted Tier 0]/mês | OTel alarme `whatsapp_meta_canary_msgs_sent_total >50/dia` → para envio automático |
