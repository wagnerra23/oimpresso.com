# Whatsapp — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Whatsapp/`

## Resumo

- Telas Inertia tsx: **1**
- Charters `.charter.md`: **0** (cobertura: 0%)
- Blade legacy do modulo (Modules/<X>/Resources/views): **1**

## Telas Inertia tsx

| Tela | Charter | review.md | Status | Round | Smoke pendente |
|---|:---:|:---:|---|---:|:---:|
| `Templates/Index.tsx` | - | - | legacy | 0 | sim |


## Blade legacy restantes

`Modules/Whatsapp/Resources/views/` — 1 arquivos

## Migracao planejada (MWART — [ADR 0104](../../decisions/0104-processo-mwart-canonico-unico-caminho.md))

- Estimativa de telas Blade alvo MWART: **1**
- Prioridade: **baixa — pouco Blade restante (1)**
