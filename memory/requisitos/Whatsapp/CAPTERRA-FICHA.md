...
|---|---|---|---|---|
| **Meta Cloud API direto** | R$ [redacted Tier 0] | Free 1k/mês utility; após R$ [redacted Tier 0] utility / R$ [redacted Tier 0] marketing | **R$ [redacted Tier 0]** | baseline |
| Twilio | $0 (pay-go) | $0,005/msg + Meta fee + ~30% markup | ~R$ [redacted Tier 0] | 50× mais caro |
| Take Blip | R$ [redacted Tier 0] | + R$ [redacted Tier 0]/msg utility | **R$ [redacted Tier 0]** | 1.518× mais caro |
| Zenvia | R$ [redacted Tier 0] | + R$ [redacted Tier 0]/msg utility | R$ [redacted Tier 0] | 515× mais caro |
| 360dialog | EUR 49 (~R$ [redacted Tier 0]) | + Meta fee bruto | R$ [redacted Tier 0] | 280× mais caro |
| Wati | $39 (~R$ [redacted Tier 0]) | + Meta fee bruto | R$ [redacted Tier 0] | 210× mais caro |
| Gupshup | $20 (~R$ [redacted Tier 0]) | + Meta fee bruto | R$ [redacted Tier 0] | 120× mais caro |
...
- **Z-API** (~R$ [redacted Tier 0]/mês) — wrapper Whatsapp Web, marketing como "API simples"
- **Evolution API** (~R$ [redacted Tier 0] self-host) — open-source Brazilian (BR fork de Baileys), popular em integradores
