...
> **Pitch para o tenant:** _Whatsapp transacional no ERP, ligado em 5 minutos._ Liga via Z-API (R$ 99/mês, scan QR Code, freeform sem janela 24h). Em paralelo cadastra Meta Cloud (1-3 dias, free tier) como rede de segurança automática — se Z-API for bloqueado, sistema troca sozinho sem interrupção. Status de OS, boleto pago, NFe, lembrete e dunning entram no canal que o cliente abre 95% das vezes.
