...
- Material visual: `ui_kits/cowork-2026-05-09/orc-page.jsx` (6.3 KB) + `data-orc-prod.jsx` _(alvo não resolve no repo — proveniência não determinada)_
...
- [LICOES_F3_FINANCEIRO_REJEITADO.md](../../../../memory/reference/prototipo-ui/LICOES_F3_FINANCEIRO_REJEITADO.md) — pré-flight obrigatório (NÃO inventar `App\Quotation`)
