...
prototype_source: prototipo-ui/prototipos/clientes/ (KB-9.75 9,4/10 — Refinos #1 + #2 + #3) — removido em 2026-09-11, PR #7224
...
**Evidência:** `prototipo-ui/prototipos/clientes/clientes-icons.jsx::avatarFor`, `clientes-listagem.jsx::TagChip`, `clientes-975.jsx::FrescorPill`. _(removido em 2026-09-11, PR #7224)_
...
- [ ] Wagner roda `design:design-critique` no protótipo `prototipo-ui/prototipos/clientes/Oimpresso ERP - Clientes.html` _(removido em 2026-09-11, PR #7224)_
...
- HANDOFF `prototipo-ui/prototipos/clientes/HANDOFF_CLIENTES.md` (spec protótipo 9,4/10 KB-9.75 — schema BR completo) _(removido em 2026-09-11, PR #7224)_
