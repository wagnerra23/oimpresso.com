# Cliente — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Cliente/`

## Resumo

- Telas Inertia tsx: **7**
- Charters `.charter.md`: **7** (cobertura: 100%)
...
| `Import.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Index.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Ledger.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Map.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
