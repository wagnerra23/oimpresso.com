...
- [ ] Ler `prototipo-ui/prototipos/clientes/HANDOFF_CLIENTES.md` (removido em 2026-09-11, PR #7224) (381 linhas — schema BR + 4 endpoints IA + checklist KB-9.75 9,4/10)
...
- [ ] HANDOFF append `prototipo-ui/prototipos/clientes/HANDOFF_CLIENTES.md` (removido em 2026-09-11, PR #7224) — entrada final "Wave A-Z concluída 2026-05-XX, drawer 760 em prod biz=1+biz=4"
...
- `HANDOFF_CLIENTES.md` (removido em 2026-09-11, PR #7224) — spec protótipo KB-9.75 9,4/10 (381 linhas — schema BR + 4 endpoints IA + checklist)
