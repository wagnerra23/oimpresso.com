...
>
> **Versão pre-implementação:** `prototipo-ui/prototipos/clientes/HANDOFF_CLIENTES.md` (removido em 2026-09-11, PR #7224) (380 linhas, mockup era spec; pós Wave A-G entregue, este HANDOFF assume o pattern como canon).
...
- `HANDOFF_CLIENTES.md` original (removido em 2026-09-11, PR #7224) — Versão pre-implementação (mockup era spec); o pattern virou canon NESTE documento
