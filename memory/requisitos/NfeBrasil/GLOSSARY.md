...
- **MEI** — Microempreendedor Individual. Limite R$ [redacted Tier 0]k/ano. Usa CSOSN 102/300.
- **Simples Nacional** — PME até R$ [redacted Tier 0]M/ano. Usa CSOSN.
- **Lucro Presumido** — Empresas até R$ [redacted Tier 0]M/ano. Usa CST.
- **Lucro Real** — Empresas > R$ [redacted Tier 0]M ou setores específicos. Usa CST.
