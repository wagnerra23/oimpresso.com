...
| **Vargas** (Autopecas) | Sinal qualificado real R$ 7,9M GMV | Modules/Autopecas em construção; arquitetura ainda não cobre OS auto |
...
- [ ] Selecionar `<CLIENTE_TESTE_ID>` + 1 produto baixo valor (R$ 10-50, minimizar exposição fiscal)
