---
id: requisitos-nfe-brasil-comparativo-concorrencia
---
...
- 💰 **Preço planejado:** R$ [redacted Tier 0] Pro / R$ [redacted Tier 0] Enterprise
...
- 💰 R$ [redacted Tier 0]-0,40 por nota emitida (volume) ou pacotes R$ [redacted Tier 0]+
...
- 💰 R$ [redacted Tier 0]-0,35 por nota
...
- 💰 R$ [redacted Tier 0] por nota (mais barato)
...
- 💰 Bundle Conta Azul (a partir de R$ [redacted Tier 0])
...
### Preço
- Pacote bundle UPos+NfeBrasil = R$ [redacted Tier 0]/mês ilimitado (até 500 notas/mês)
- Pay-per-note R$ [redacted Tier 0] acima de 500 (vs FocusNFE R$ [redacted Tier 0])
