---
id: requisitos-nfe-brasil-readme
module: NfeBrasil
alias: nfe-brasil
status: ativo
...
revenue_tier: 1B
revenue_pricing:
  starter: "R$ [redacted Tier 0]/mês — NFC-e Simples Nacional, 1 UF, até 500 docs/mês"
  pro: "R$ [redacted Tier 0]/mês — NF-e + NFC-e completas, multi-UF, ICMS-ST, contingência, até 5.000 docs/mês"
  enterprise: "R$ [redacted Tier 0]/mês — + MDF-e + CT-e + SPED Fiscal/EFD + cert digital gerenciado, ilimitado"
...
|---|---|---|---:|
| **Starter** | R$ [redacted Tier 0] | 500 NFC-e/mês, 1 UF, Simples Nacional | 75% |
| **Pro** | R$ [redacted Tier 0] | 5.000 docs/mês, multi-UF, todos regimes, contingência | 80% |
| **Enterprise** | R$ [redacted Tier 0] | Ilimitado + MDF-e + CT-e + SPED + cert gerenciado | 85% |
| **Cert digital A1 anual gerenciado** | R$ [redacted Tier 0]/ano (add-on) | Renovação automática + storage | 60% |
