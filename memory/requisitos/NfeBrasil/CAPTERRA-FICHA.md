...
- **Concorrentes-alvo direto** (4 + UPos integrado é o diferencial):
  - **TecnoSpeed** — tecnospeed.com.br — robusto, R$ 0,15-0,40/nota, foco em médios+
  - **PlugNotas** — plugnotas.com.br — multi-CNPJ, R$ 0,12-0,35/nota
  - **FocusNFE** — focusnfe.com.br — API-first, R$ 0,10/nota, dev-friendly
