...
|---|---|---|---|
| **Cert A1 (.pfx)** | Padrão fiscal, mesmo cert que NF-e (futuro) | Renovação anual, custo R$ [redacted Tier 0]-400/ano | ⭐ **escolhido** — alinha com NfeBrasil futuro |
...
**Diferença crítica pra SPEC:** custo per-emissão = **zero** (governo federal). Antes estimávamos R$ [redacted Tier 0]-1.50/emissão com Focus. Economia: 100%.
