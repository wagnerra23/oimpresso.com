...
**Causa possível #3**: `MemCofre: false` em `modules_statuses.json`.

**Correção**: abra o JSON e ative, ou rode `php artisan module:enable MemCofre`.
...
php artisan docvault:audit-module MemCofre --save
