...
- **Fase 2 · Estrutura por módulo** ✅ — formato pasta (`README/ARCHITECTURE/SPEC/CHANGELOG/GLOSSARY/RUNBOOK/adr/`) com fallback automático pra formato plano (`{Modulo}.md`); 2 pilotos migrados (PontoWr2 + Essentials) + MemCofre
