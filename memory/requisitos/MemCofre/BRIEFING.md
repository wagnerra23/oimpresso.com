...
>
> - **MemCofre = DocVault (nome antigo) → o código viveu em `Modules/SRS/`, e NÃO existe mais** (removido em 2026-07-29, [ADR 0357](../../decisions/0357-deprecar-srs-sucessor-kb-jana-governance.md)).
...
- Os 33 docs aqui são **anteriores ao rename pra SRS** (2026-05-06) → ainda falavam do nome morto da pasta `MemCofre`, e foram corrigidos na época pelo codemod ghost-fix (P11 KL-E2) para o nome que então era o real: `Modules/SRS/`. Esse caminho **deixou de existir em 2026-07-29** ([ADR 0357](../../decisions/0357-deprecar-srs-sucessor-kb-jana-governance.md)) — os `Modules/SRS/...` citados nesta pasta são **históricos**, descrevem código removido.
