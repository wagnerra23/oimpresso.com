...
**Status:** Aceito
**Data:** 2026-04-24
**Contexto de aplicação:** MemCofre · documentação de módulos
...
- Entrada no MemCofre CHANGELOG referenciando o arquivo de memória.
...
- Incluir entrada no CHANGELOG MemCofre toda vez que arquivo é alterado (rastreabilidade)
...
- MemCofre CHANGELOG 0.4.0 — primeira aplicação deste padrão
