# MemCofre — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/MemCofre/`
...
|---|:---:|:---:|---|---:|:---:|
| `Chat.tsx` | - | - | legacy | 0 | sim |
| `Dashboard.tsx` | - | - | legacy | 0 | sim |
| `Inbox.tsx` | - | - | legacy | 0 | sim |
| `Ingest.tsx` | - | - | legacy | 0 | sim |
| `Memoria.tsx` | - | - | legacy | 0 | sim |
| `Modulo.tsx` | - | - | legacy | 0 | sim |
