...
- Tabela com placas reais BR + clientes fictícios — "essa é a tela que você vai usar todo dia. Veja a CC-003 destacada em vermelho — locação atrasada há 15 diárias, R$ [redacted Tier 0] a receber. **O sistema avisa antes de você perder dinheiro**."
...
- Pricing tier sugerido (~R$ [redacted Tier 0]-500/mês baseado em 91 caçambas + 1 atendente WhatsApp + módulos OficinaAuto + Financeiro + WhatsApp + Jana básico)
