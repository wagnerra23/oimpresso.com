...
| **US-OFICINA-030** | 4h | felipe | Cleanup §B — conciliação VENDA↔FINANCEIRO drift detector (374 vendas R$ 1,64M biz=164) |
...
- **Add-on faturável separado** ([ADR 0171](../../decisions/0171-oficinaauto-ativacao-piloto-martinho-faseada.md)) — WhatsApp R$ 99/instância paridade ZapBoss + diferencial multi-tenant + auto-link CRM + Jana IA sem cobrança per-seat
