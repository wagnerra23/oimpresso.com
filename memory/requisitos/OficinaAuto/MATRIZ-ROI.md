...
|---|---|---|---|---|
| **Ultracar** | BH/MG 31a | R$ [redacted Tier 0]-494 | 430+ features, blog SEO, base instalada | NFS-e travada (RA reclamação 1 ano cliente), suporte despreparado, sem IA |
| **Oficina Integrada** | Viçosa/MG 23a | R$ [redacted Tier 0]-339 | "1º 100% online", app Android, NFC-e/NFSe ilim | Reclamação acesso bloqueado pós-pagamento, UI desktop-em-browser, zero IA |
| **Onmotor** | BR | R$ [redacted Tier 0]-479 | Múltiplos tiers granular, 5d trial | Stack desconhecida, sem mobile destacado, free só 50 OS/m |
| **Oficina Inteligente** | BR <2a | R$ [redacted Tier 0]-599 | Marketing "120+ recursos", multi-segmento | Sem track record |
| **Manager Full** | BR | R$ [redacted Tier 0]-300 | **Modelo 3D avarias** (único), NFe+NFSe, busca XML SEFAZ | Stack desconhecida, sem IA conversacional |
...
| **WSoft** | BR | R$ [redacted Tier 0] | OS digital + NFe + WhatsApp | Entry-tier; sem IA |
| **NeXT ERP** | BR | R$ [redacted Tier 0]+ | NFC-e SAT, NFSe | Entry-tier |
...
| 3 | **Defeitos múltiplos por OS (JSON array)** | 009 | Fase 1 | 3 | 1 | 3 (Ultracar/Manager Full têm linha-única, não array semântico) | 4 (Mitchell1 tem DVI estruturado) | 5 (Vargas média 3.08 itens/OS) | 3 (Martinho mecânica pesada caminhão basculante — OS troca peça hidráulica + serviço · ADR 0194) | 1 | **26** | Fase 1 |
...
| 10 | **Cleanup tools cliente legacy (revisão pendências + conciliação + dedup PESSOAS)** | 005 | Fase 1-2 | 12 | 3 | n/a (one-off migração) | n/a | 5 (R$ [redacted Tier 0]k+R$ [redacted Tier 0]/m pricing piloto provado) | 5 (Martinho 76,7% inadimplência fóssil) | 3 | **23** | Fase 1 ROI imediato |
| 11 | **Consulta CRLV/Renavam por placa (cache 30d)** | 012 | Fase 2 | 6 | 2 | 3 (vhsys faz; Ultracar via 3rd party) | 1 (USA tem CARFAX equivalente) | 3 (Vargas: caminhões já catalogados) | 4 (Martinho · caminhão basculante de cliente placa-única · sub-vertical 4 ADR 0194) | 3 (API custo R$ [redacted Tier 0]/consulta) | **15** | Fase 2 |
| 12 | **Tabela tempária seed (100 serviços comuns)** | 013 | Fase 2 | 5 | 2 | 3 (Tempario.com R$ [redacted Tier 0]/m standalone; mercado integra ou digita) | 1 (Mitchell1 tem database OEM) | 4 (Vargas precisa pra cálculo MOD recapagem padronizado) | 2 | 2 | **18** | Fase 2 |
...
| 11 (med) | **CRLV consulta** | 15 | Vargas já tem catálogo + Martinho placa-única simples; útil mas não urgência; cobrável add-on R$ [redacted Tier 0]/m não-tier-1 |
...
- ✅ Tempário seed gratis (vs Tempario.com R$ [redacted Tier 0]/m standalone)
