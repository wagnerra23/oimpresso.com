...
| **5** | Diferenciais ROI alto (Jana IA, FIPE, OEM se sinal) | 80h+ | ~6 sem | Fase 4 verde + 3+ pilotos ativos + receita ≥ R$ [redacted Tier 0]k/m módulo | 🔒 |
...
- [ ] **Sinal qualificado ADR 0105 satisfeito**:
  - Cenário A: 1 oficina assina contrato Auto Pro R$ [redacted Tier 0]/m × 3m upfront (R$ [redacted Tier 0] antecipado) — preferido
...
- [ ] Receita reportada R$ [redacted Tier 0]/m × 3 meses upfront cobrado (R$ [redacted Tier 0]+ rec na Modules/RecurringBilling)
...
- [ ] 3+ pilotos ativos pagantes (receita ≥ R$ [redacted Tier 0]/m módulo)
...
- [ ] Mercado validou pricing R$ [redacted Tier 0]/399/799 com conversão ≥10%
...
| ARR módulo (R$/ano) | R$ [redacted Tier 0]k | R$ [redacted Tier 0]k | **R$ [redacted Tier 0]-72k** | <R$ [redacted Tier 0]k = pivotar |
...
**Convergente com [ADR 0022](../../decisions/0022-meta-5mi-ano-financeira.md):** Modules/OficinaAuto contribui R$ [redacted Tier 0]-72k ARR de R$ [redacted Tier 0]M total no M12 pós-ativação (0,5%-1,5%). Multi-vertical é tese — oficina diversifica, não substitui ComVis/Vestuário.
