...
|---|---|---|---|
| Pneu recauchutado 295/80R22.5 | Mercadoria | **NFe modelo 55** ou **NFC-e modelo 65** se PF | R$ [redacted Tier 0] |
| Banda de rodagem aplicação | Serviço | **NFSe modelo 56** (LC 116/03 item 14.05 — recapagem) | R$ [redacted Tier 0] |
| **Total OS** | — | 2 documentos coexistindo | R$ [redacted Tier 0] |
...
| TAM | R$ [redacted Tier 0]bi/ano BR (Sindirepa-SP 2022); 121k oficinas ativas |
...
**Definition of Done:**
- [ ] Adapter pluggable (SerPro homologação OU Infosimples R$ [redacted Tier 0]/consulta)
- [ ] Cache 30 dias por placa (TTL config)
- [ ] Add-on cobrável: 200 consultas inclusas tier Pro / 500 tier Premium / sobra R$ [redacted Tier 0]/consulta
...
**Concorrência:** Tempario.com.br (R$ [redacted Tier 0]/m standalone — concorrente integração), Catálogo Tempário, Sindirepa-Cilia. Quase todos verticais oficina **integram** ou esperam que dono **digite**. **oimpresso ❌** hoje.
...
- **Pricing:** R$ [redacted Tier 0]-494/m (3 tiers públicos)
...
- **Pricing:** R$ [redacted Tier 0]-339/m (4 tiers — anual −15%)
...
### 4.3 Onmotor
- **Pricing:** R$ [redacted Tier 0]-479/m (V1 free → V12 NFe)
...
- **Pricing:** R$ [redacted Tier 0]-599/m premium
...
- **Pricing:** R$ [redacted Tier 0] PC + R$ [redacted Tier 0] NFe (one-time, vitalícia)
...
### 4.6 Manager Full
- **Pricing:** R$ [redacted Tier 0]-300/m
...
- Range pricing R$ [redacted Tier 0]-379/m, mix desktop+cloud
...
> Pricing baseado em [research/2026-05-prospeccao-auto/03-pricing-erps-auto-br.md](../../research/2026-05-prospeccao-auto/03-pricing-erps-auto-br.md). Range mediana mercado: **R$ [redacted Tier 0]-599/m** (Onmotor V2 R$ [redacted Tier 0] → Oficina Inteligente Fantástico R$ [redacted Tier 0]).

| Tier | Preço/m | Inclui | Posição vs mercado |
|---|---|---|---|
| **Auto Starter** | **R$ [redacted Tier 0]/m** | 1 oficina, 1-3 mecânicos, 100 OS/m, NFC-e+NFS-e ilim, WhatsApp básico, app mecânico read-only, **sem CRLV nativo** (add-on R$ [redacted Tier 0]/m), Jana IA básica (Q&A faturamento) | Acima entry tiers (Onmotor V2 R$ [redacted Tier 0] MinhaOficina Bronze R$ [redacted Tier 0] NeXT Pro R$ [redacted Tier 0]) — **diferenciar por Jana + stack** ou descer pra R$ [redacted Tier 0] |
| **Auto Pro** | **R$ [redacted Tier 0]/m** | 1 oficina, 4-10 mecânicos, 500 OS/m, 5 users, app mecânico full, NFe completo, **CRLV incluso 200 consultas/m**, Jana IA completa (diagnóstico assistido US-AUTO-007), tempário pré-cadastrado, multi-mecânico | Mediana mercado mid (Of.Integrada R$ [redacted Tier 0] Of.Inteligente R$ [redacted Tier 0] Ultracar Plus R$ [redacted Tier 0] Onmotor V10 R$ [redacted Tier 0]) — **competitivo se Jana+CRLV viram diferencial percebido** |
| **Auto Premium** | **R$ [redacted Tier 0]/m** | Multi-loja (até 5), 11-30 mecânicos, OS ilim, users ilim, CT-e/MDF-e, **CRLV ilim**, Jana IA full + memória dedicada, SLA telefônico, customer success dedicado, treino presencial | Acima top tier mercado (Of.Inteligente Fantástico R$ [redacted Tier 0] Ultracar Master R$ [redacted Tier 0]) — **só funciona se entregar 2x valor** vs alternativas. Risco caro |
| **Setup** | **R$ [redacted Tier 0] default** | — | Norma do nicho (10/12 ERPs cobram zero). Cobrar **R$ [redacted Tier 0] opcional** se migração documentada de Ultracar/Of.Integrada/Delphi |
| **Trial** | **14 dias** sem cartão | — | Mercado padrão 7d, 14d competitivo sem ser exagero |
| **Anual** | **12 paga 10** | — | Padrão mercado |

**Calibração brief:** brief sugeriu R$ [redacted Tier 0]/399/799. **Validado contra research:** R$ [redacted Tier 0] starter está **acima** entry tiers (risco conversão); R$ [redacted Tier 0] pro está **na mediana** (OK); R$ [redacted Tier 0] premium está **acima** top tier (precisa diferencial percebido grande).

**Recomendação:** **manter R$ [redacted Tier 0]/399/799 como ancorado no brief**, com nota: validar com 1ª piloto se R$ [redacted Tier 0] está convertendo. Se conversão <10%, pivotar pra R$ [redacted Tier 0] starter.
...
1. **1 oficina pagante upfront** (Cenário A — preferido):
   - Assina contrato Auto Pro R$ [redacted Tier 0]/m × 3 meses upfront (R$ [redacted Tier 0] antecipado)
...
| ARR módulo (R$/ano) | R$ [redacted Tier 0]k | R$ [redacted Tier 0]k | **R$ [redacted Tier 0]-120k** | <R$ [redacted Tier 0]k = pivotar |
...
**Meta convergente com [ADR 0022](../../decisions/0022-meta-5mi-ano-financeira.md):** Modules/OficinaAuto contribui R$ [redacted Tier 0]-120k ARR de R$ [redacted Tier 0]M total (1-2,5% no M12 pós-ativação). Multi-vertical é a tese — oficina é diversificação, não substituição da gráfica.
...
9. ❌ **Cobrar setup R$ [redacted Tier 0]+ default** — anomalia no nicho (10/12 concorrentes setup zero). Setup só com migração documentada explícita.
10. ❌ **Embutir API DETRAN ilimitada no tier Starter** — sangra margem (R$ [redacted Tier 0]/consulta × volume). Cobrar add-on R$ [redacted Tier 0]/m / 500 consultas.
...
- [ ] Adapter CRLV: SerPro oficial (homologação ~30d wallclock) vs Infosimples (R$ [redacted Tier 0]/consulta sem homologação) — depende volume piloto
