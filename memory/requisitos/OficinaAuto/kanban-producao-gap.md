...
>
> - `resources/js/Pages/Repair/ProducaoOficina/Index.charter.md:14-17` (2026-06-30, musing-elion): *"removido related_prototype: oficina-page.jsx — MIS-ANCHOR. Esta tela serve Repair/JobSheet (vertical genérico), NÃO a OficinaAuto de veículo. oficina-page.jsx é o kanban de VEÍCULO da OficinaAuto → ancora em ServiceOrders/Board"*. Medido hoje: `node scripts/design/ancora.mjs Repair/ProducaoOficina --staging prototipo-ui/cowork` → âncora `repair-page.jsx` (bundle); `… OficinaAuto/ServiceOrders/Board` → `oficina-page.jsx` (`Board.charter.md:5 visual_source`).
