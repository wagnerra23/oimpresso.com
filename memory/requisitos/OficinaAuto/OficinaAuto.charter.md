...
| **Vaultwarden** (não é módulo) | Cofre senhas (cert digital, login fornecedor de peças, API DETRAN) — `vault.oimpresso.com`. Era o módulo `SRS`, atribuição errada; módulo removido (ADR 0357) | consome opcional |
