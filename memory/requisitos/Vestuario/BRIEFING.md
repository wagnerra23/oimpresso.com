...
- **US-VEST-024** Fidelidade R$ 1 = 1 ponto com resgate (18h)
...
|---|---|---|---|
| Linx Microvix Vestuário | grandes redes (>5 lojas) | R$ 800-2500 | preço alto, lock-in, suporte demorado |
| ProMoz | médio-pequeno (1-3 lojas) | R$ 300-700 | falta NFe-de-boleto-pago, BI fraco |
| Vendizap | micro (catálogo WhatsApp) | R$ 50-150 | sem PDV físico, sem fiscal robusto |
| Bling Loja | horizontal raso | R$ 150-400 | sem profundidade matriz tam×cor |
| F360 | regional sul | R$ 400-800 | UI legacy |
