...
|---|---|---|---|---|
| **Vendizap** | micro vestuário (catálogo WhatsApp) | R$ 50-150 | BR | vendizap.com |
| **Linx Microvix** | grandes redes moda/franquias | R$ 800-2500 | BR | linx.com.br/microvix |
| **ProMoz** | médio-pequeno (1-3 lojas) | R$ 300-700 | BR | promoz.com.br |
| **Shopify POS Apparel** | global benchmark omnichannel | USD 89-389 | Global | shopify.com/pos/apparel |
| **Bling Loja** | ERP horizontal raso | R$ 150-400 | BR | bling.com.br |
| **F360** | nicho regional sul | R$ 400-800 | BR | f360.com.br |
...
| C12 | **Fidelidade R$ 1 = 1 ponto + resgate** | 0 | 0 | 0 | ⛔ **GAP P1** US-VEST-024 — Linx "Cartão Fidelidade" |
...
### G5 — Fidelidade R$1=1pt + resgate desconto (P1, 18h, US-VEST-024)
...
- **Q4-2026**: 5 clientes Vestuario MRR ≥ R$ 3k
