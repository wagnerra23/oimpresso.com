...
5. **Operação de vestuário real**: ticket médio R$ 100-500, pico 14h-17h SP, "Cliente Balcão" + nomes PF (Jociane, Edna, Guilherme, etc.), 2 esquemas de invoice convivendo (`2026/NNNN` + `17NNN`).
...
### US-VEST-024 · Programa fidelidade (R$ 1 = 1 ponto) com resgate em desconto `p1`
...
**Contexto.** Diferencial sazonal (Dia das Mães, Natal). Cliente compra "vale R$ 100" → recebedor usa em qualquer compra futura. UltimatePOS não tem nativo.
...
|------|------|---------|---------------|---------|
| **Linx Microvix Vestuário** | grandes redes (>5 lojas) | R$ 800-2500/m | profundidade SKU, multi-loja, PCP roupa, BI Linx | preço alto, lock-in caro, suporte demorado |
| **ProMoz** | médio-pequeno (1-3 lojas) | R$ 300-700/m | UI simples, treinamento bom | falta NFe-de-boleto-pago, BI fraco |
| **Vendizap** | micro (catálogo WhatsApp) | R$ 50-150/m | onboarding instant (5min) | sem PDV físico, sem fiscal robusto |
| **Bling Loja** | horizontal raso | R$ 150-400/m | integração marketplace | nada vertical (sem matriz tam×cor profunda) |
| **F360** | nicho moda regional | R$ 400-800/m | foco regional sul | UI legacy |
...
- **Q4-2026**: 5 clientes Vestuario MRR somado ≥ R$ 3k (validação P5 ADR 0121)
- **2027-Q4**: 15 clientes Vestuario, MRR ≥ R$ 10k (lifecycle = "ativo" ADR 0121)
