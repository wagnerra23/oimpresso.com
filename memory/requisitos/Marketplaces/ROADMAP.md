...
**Pré-requisito Fase 4:** 1+ cliente piloto pagando R$ 49/m add-on Marketplace Start (revenue real).
...
**Pré-requisito Fase 5:** 3+ clientes pagando add-on + revenue R$ 500-1.500/m comprovado.
...
- ARR add-on R$ 40-80k contributing pra [ADR 0022 meta R$ 5M/ano](../../decisions/0022-meta-5mi-ano-financeira.md)
...
| Fase 3 → 4 | 1+ cliente pagando R$ 49/m add-on Marketplace Start; recon split 0 discrepância; sync 0 loop infinito |
| Fase 4 → 5 | 3+ clientes pagando add-on; revenue R$ 500-1.500/m; Shopee+Amazon paridade arquitetural ML |
| Pós-Fase 5 | 8-15 clientes; ARR R$ 40-80k; Jana 95%+ relatórios; pipeline ComVis ML funcional |
...
- **3+ clientes pagantes Marketplace add-on** (R$ 49-399/m)
- **ARR add-on R$ 40-80k** (1-1.6% da meta R$ 5M/ano [ADR 0022](../../decisions/0022-meta-5mi-ano-financeira.md))
