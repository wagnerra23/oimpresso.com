# Governance — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/governance/`

## Resumo

- Telas Inertia tsx: **6**
- Charters `.charter.md`: **6** (cobertura: 100%)
...
|---|:---:|:---:|---|---:|:---:|
| `Audit.tsx` | OK | - | live | 2 | opcional |
| `Dashboard.tsx` | OK | - | live | 2 | opcional |
| `DriftAlerts.tsx` | OK | - | live | 2 | opcional |
| `ModuleGrades/Index.tsx` | OK | - | live | 2 | opcional |
| `ModuleGrades/Show.tsx` | OK | - | live | 2 | opcional |
| `Policies.tsx` | OK | - | live | 2 | opcional |
