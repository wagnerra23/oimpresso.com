...
- ~~Module grade v3 (rubrica ADR 0155) e a tela que a lê~~ — **capacidade aposentada** (ADR 0399). A tela, o controller e as rotas saíram na Onda 2; o `ModuleGradeCommand` e o `ModuleGradeService` ainda existem e saem na Onda 3.
