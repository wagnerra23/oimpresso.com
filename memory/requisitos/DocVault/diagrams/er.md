# Entity-Relationship · DocVault

Diagrama ER das tabelas criadas pelo módulo DocVault. Sintaxe Mermaid — renderizável no GitHub, VS Code e no viewer do DocVault.
