# ADR ARQ-0011 (DocVault) · Sidebar e TopNav como duas fontes independentes
...
- **TopNav opcional por página** — DocVault (tabs internas ricas) não precisa, PontoWR2 ganha nav do Blade original.
