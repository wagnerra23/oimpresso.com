...
Manter **MySQL 8** como único banco relacional do projeto. DocVault usa `docs_sources`, `docs_evidences`, `docs_requirements`, `docs_links` em MySQL sem exceção.
...
- **MySQL + PostgreSQL híbrido** (Postgres só pro DocVault): descartado — 2 bancos = 2x operação.
