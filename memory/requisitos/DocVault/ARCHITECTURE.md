...
- **Ativação**: `DocVault: true` em `modules_statuses.json`
...
├───────────────────────────────────────────────────────────┤
│ Console (7 Commands)                                      │
│ Modules/DocVault/Console/Commands/                        │
...
```
Dev → php artisan docvault:audit-module DocVault --save
  ...
  → se --save, grava memory/requisitos/DocVault/audits/2026-04-24.md
```
