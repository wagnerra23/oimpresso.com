...
- `Modules/Governance/Services/ModuleGradeService.php` — engine de avaliação — arquivo deletado em 2026-09-15, ADR 0399, junto com o `ModuleGradeSnapshotCommand`, que o injetava)
