...
pii: false
---
# ⚰️ `Chat.md` — FÓSSIL (spec plana pré-diretório, subtraída)
...
>
> **Dono vivo:** [`memory/requisitos/Chat/` (módulo legado ⚠️ — sucessor conversacional é a Jana)](Chat/) — SPEC/BRIEFING/charter atuais moram lá.
>
