...
|---|---|---|---|---|
| **Mubisys** | [mubisys.com](https://mubisys.com/) | Líder vertical comunicação visual BR (Mubi Sistemas / PG Consultoria) — orçamento + produção + financeiro + estoque + app mobile + MubiDrive (~150TB DAM) | gráficas SP/PR (centenas) | sob consulta (R$ 250-600/m estimado) |
| **Zênite Sistemas (GE 3.0)** | [zsl.com.br](https://www.zsl.com.br/) | 25+ anos, 2.000+ gráficas BR — Lite/Smart/Standard/Full — orçamento+PCP+NFe+estoque+CRM | 2.000+ gráficas nacional | escalonado por porte (R$ 200-1.500/m) |
...
capacidades:
  ...
  - id: importer-firebird-officeimpresso
    ...
    score: P0
    descricao: "Migração one-shot 6 gráficas legacy Delphi → oimpresso sem digitação 80h × R$30."
  ...
  - id: instalacao-nr35-checklist-agenda
    ...
    score: P1
    descricao: "Evita re-trabalho ferramenta esquecida (2 OS/mês × R$2,5k). Visua único especialista."
  ...
  - id: provador-orcamento-online-publico
    ...
    score: P2
    descricao: "8 lead/m × 20% conv × ticket R$ 350. Calcme/Alfa entregam."
...
- Taxa conversão orçamento→OS aprovada — meta `≥ 35%` (Gold baseline R$ 6,1M GMV)
