...
piloto_confirmado: "Gold (CNAE 1813-0/01, R$ 6,1M GMV/ano) — perfil 04-gold-comvis"
...
- ✅ ARR Gold ≥R$ 18k/ano (Pro R$ 599 × 12 + setup, mínimo viável)
- ✅ 0 bug crítico aberto >7d
- ✅ Wagner aprova abrir outreach 2ª piloto

**Riscos críticos Fase 2:**
- 🔴 **Gold é o Gold post-mortem Mubisys?** Wagner valida identidade (registry "Gold" versão 1466 vs CNPJ Três Lagoas/MS) antes de qualquer outreach. Se sim → SKIP pra Extreme (R$ 6,36M GMV "EXTREMA LED").
...
| 3.2 | **Extreme piloto** (gráfica industrial PCP — R$ 6,36M GMV) | — | 6h codável + 26h time | — | todo |
...
| 3.4 | **Zoom piloto** (R$ 3,18M GMV — versão Delphi 1474 mais nova) | — | 6h codável + 26h time | — | todo |
| 3.5 | **Fixar piloto** (R$ 1,23M GMV — mid-tier) | — | 6h codável + 26h time | — | todo |
| 3.6 | **Mhundo piloto** (R$ 754k GMV — pequeno) | — | 6h codável + 26h time | — | todo |
| 3.7 | **Produart piloto** (R$ 733k — "banco antigo" cuidado) — opcional se Wagner aprovar pacote agressivo | — | 6h codável + 26h time | — | todo (condicional) |
...
- ✅ ARR módulo ≥ R$ 30k/ano (baseline ADR 0022)
...
- 🟡 **Concorrência Mubisys** — pós Gold post-mortem (Mubisys ganhou R$ 1,8k/m), pode retaliar com preço R$ 999/m. Mitigação: defender pelo diferencial NFe-automática + Jana, não preço.

---

## Fase 4 — Estado da arte (diferencial competitivo P1)

> **Gate de saída:** Features P1 da MATRIZ-ROI entregues + ARR módulo ≥R$ 60k/ano + 1 case público publicado.
>
...
> **Gate de saída:** 10+ clientes pagantes + ARR módulo ≥R$ 200k/ano + benchmark setor habilitado via Jana ("média margem comvis SC = X%") + status `maduro` ADR 0121.
>
...
|---|--:|---:|---|--:|
| Fase 1 V0 | 24h | 2 sem | 🟢 baixo | R$ 0 |
| Fase 2 Gold piloto | 55h | 8 sem | 🔴 alto (1ª piloto = make-or-break) | R$ 18k/ano |
| Fase 3 Rollout 6 saudáveis | 38h + 130h time | 16 sem | 🟡 médio (capacidade time) | +R$ 60-90k/ano |
| Fase 4 Diferencial P1 | 66h | 12 sem | 🟡 médio (driver NFSe per-município) | +R$ 100k/ano |
| Fase 5 Expansão P2/P3 | 75h condicional | 24+ sem | 🟢 baixo (gated por sinal) | +R$ 80-200k/ano |
| **Total M0-M24** | **~258h codável + ~62 sem wallclock** | | | **~R$ 250-410k ARR M24** |
...
- **M12 (jun/27):** ARR <R$ 30k → considerar `historical` ADR 0121
