...
|---|:-:|:-:|:-:|:-:|:-:|:-:|
| **D1. Receita estimada (GMV faixa)** | 5 (R$ 6M+) | 4 (R$ 6M+ se identidade ≠ Mubisys) | 3 (R$ 3M faixa) | 2 (R$ 1M faixa) | 2 (sub-R$ 1M) | 1 (sub-R$ 1M) |
...
**Pacote recomendado:** Enterprise R$ 1.499/m grandfathered 24m + setup R$ 0 + 30% off 6m + Modules/CV completo (cálculo m² + spool plotter + PCP + NFe-de-boleto) + Jana ilimitada. Compromisso: depoimento escrito.
...
**Pacote recomendado:** Enterprise R$ 1.299/m grandfathered 18m + setup R$ 2.500 (50% off Enterprise) + Modules/CV completo. Q4/26 outubro outreach.
...
- Tier mid permite testar Pro R$ 599/m (vs Enterprise) — calibra modelo comercial sem queimar relacionamento Enterprise
...
**Risco:** GMV pequeno pode não justificar Pro R$ 599 (margem cliente apertada). Avaliar tier R$ 499 em discovery.

**Pacote recomendado:** Pro R$ 499/m grandfathered 12m + setup R$ 499 (entry-level) + Modules/CV lite (essenciais) + NFe + Jana 200 perguntas/m. Q1/27 março outreach.
