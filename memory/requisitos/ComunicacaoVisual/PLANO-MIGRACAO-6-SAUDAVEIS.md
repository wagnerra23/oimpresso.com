...
- **GMV agregado anual** (oimpresso Insights snapshot): **R$ 26,3M/ano** combinado
- **Receita atual oimpresso desses clientes:** **R$ 0** — eles ainda pagam **mensalidade WR Sistemas legacy estimada R$ 350-850/m cada** (não confirmado por banco; estimativa baseada em proposta Mubisys vazada R$ 1.800/m e tier típico OfficeImpresso ~R$ 500-800/m)
- **Receita alvo pós-migração 12m:** R$ 25-50k/mês incremental se 3 fecharem em Enterprise grandfathered
...
- **ROI alvo:** 1 cliente Enterprise R$ 1.499/m × 12 = **R$ 18k/ano novo** + setup R$ 5k = **R$ 23k year-1 por cliente** (cap teórico Enterprise+ R$ 50-100k/ano se add-ons + multi-business)
...
**Riscos específicos:**
- 🔴 **Maior cliente do top — perda massiva.** R$ 7,9M GMV é 30% do agregado. Se migração der ruim, churn de Vargas inviabiliza Modules/ComunicacaoVisual como vertical comercial
...
- **Enterprise R$ 1.499/m grandfathered por 24m** + 50% off primeiros 6m = **R$ 749/m × 6m → R$ 1.499/m × 18m** = R$ 31.482 year-2 incluso
...
### 2. Extreme (R$ 6,36M GMV/ano) — biz_id legacy mapeado: 196 ("EXTREMA LED")
...
### 3. Gold (R$ 6,13M GMV/ano) — biz_id legacy mapeado: ? (Gold no registry, versão 1466)
...
**GMV ano anterior:** R$ 6,13M/ano (atribuído ao Gold do snapshot Insights — confirmar identidade)

**Receita histórica WR Sistemas:** R$ 850/m (se for o mesmo Gold de Três Lagoas/MS — valor confirmado em post-mortem 2026-05-09)
...
**Pacote oferecido:**
- **Hipótese 1 (win-back D+90 Mubisys):** Migration Factory recupera histórico Delphi pré-Mubisys + setup R$ 0 + Enterprise R$ 999/m primeiros 12m (desconto agressivo win-back) — SÓ se cliente sinalizar dor real
...
### 4. Zoom (R$ 3,18M GMV/ano) — biz_id legacy: ? (Zoom no registry, versão 1474 = MAIS NOVA observada)
...
**GMV ano anterior:** R$ 3,18M/ano

**Receita histórica WR Sistemas (estimativa):** ~R$ 700-900/m (cliente premium, paga upgrades regulares)
...
**Pacote:**
- **Setup R$ 2.500** (50% off do Enterprise R$ 5.000)
- **Enterprise R$ 1.299/m grandfathered 18m** (entre Vargas R$ 1.499 e Pro R$ 599)
...
### 5. Fixar (R$ 1,23M GMV/ano) — biz_id legacy: ? (Fixar no registry, versão 1421)

**Status atual:**
- ✅ saudável OfficeImpresso (versão 1421 — meio do parque, sem update recente)
- 🟡 **Tamanho menor** (R$ 1,23M GMV vs Vargas R$ 7,9M) — escala diferente, decisão mais rápida
- Razão social: a confirmar — nome sugere fixação/sinalização

**GMV ano anterior:** R$ 1,23M/ano

**Receita histórica WR Sistemas (estimativa):** ~R$ 400-600/m (cliente menor, tier mid)
...
- 🟡 **Margem operacional menor** — pode bater com R$ 1.499/m Enterprise. Pro R$ 599 mais realista
...
**Pacote:**
- **Setup R$ 999** (50% off Pro R$ 2.500)
- **Pro R$ 599/m grandfathered 12m** (não Enterprise — não justifica)
...
### 6. Mhundo (R$ 754k GMV/ano) — biz_id legacy: ? (Mhundo no registry, versão 1429)
...
**GMV ano anterior:** R$ 754k/ano

**Receita histórica WR Sistemas (estimativa):** ~R$ 350-500/m

**Riscos específicos:**
- 🟢 **Decisão dono-único** — ciclo curto
- 🟡 **GMV pequeno** — pode não justificar Pro R$ 599 (margem apertada)
...
**Pacote:**
- **Setup R$ 499** (entry-level)
- **Pro R$ 499/m grandfathered 12m** (10% off Pro padrão)
...
### 7. Produart (R$ 733k GMV/ano) — biz_id legacy: ? (Produart no registry, versão 1472, "Banco antigo")
...
- Cliente pequeno (R$ 733k GMV)
- Vertical: a confirmar

**GMV ano anterior:** R$ 733k/ano

**Receita histórica WR Sistemas (estimativa):** ~R$ 300-450/m
...
**Pacote:**
- **Setup R$ 0** (oferta agressiva — cliente em tail-end)
...
| **ARR adicional dos migrados** | ≥R$ 100k | sum(monthly_revenue) × 12 dos 3+ migrados |
...
- **Impacto:** -R$ 6,13M GMV do funil (perde 23% do agregado teórico)
...
### 5. Pricing Enterprise R$ 1.499/m bate com Mubisys R$ 1.800/m proposta — concorrência pode reduzir
- **Impacto:** Mubisys pode oferecer R$ 999/m em retaliação pros mesmos prospects
...
- **Plano B:** se 2+ clientes em sequência rejeitarem por preço, validar redução Pro Tier (R$ 599 → R$ 499) com Wagner — não Enterprise
...
- [memory/sales/2026-05/06-pricing-tiers.md](../../sales/2026-05/06-pricing-tiers.md) — tiers oficiais (Starter R$ 299, Pro R$ 599, Enterprise R$ 1.499)
