...
Score 86% justifica pricing competitive com **Conta Azul Master (R$ [redacted Tier 0])**. Proposta:

- **Free:** Modules/Financeiro só (Dashboard + Título + Baixa + Plano Contas seed)
- **Pro R$ [redacted Tier 0]/mês:** + FinanceiroAvancado (Conciliação Inter + DRE BR formal + Fluxo 30d + Margem)
- **Enterprise R$ [redacted Tier 0]/mês:** + Cenários what-if + Dunning IA + Conciliação cartão crédito + Token shareable contador + DRE snapshot congelado

Take rate **0,5% boleto/PIX** (capped R$ [redacted Tier 0]) inalterado (ADR ARQ-0004 Financeiro).
