...
**Gate:** contador externo Larissa aprova DRE 1 mês completo via token shareable. PDF tem cabeçalho fiscal correto (CNPJ [REDACTED-CNPJ]). Fluxo projetado 30d bate ±5% com realizado depois.
