---
id: requisitos-recurring-billing-comparativo-concorrencia
---
...
- 💰 **Preço planejado:** Free / R$ [redacted Tier 0] Pro / R$ [redacted Tier 0] Enterprise + take rate 1% capped R$ [redacted Tier 0]
...
- 💰 1,99% por transação + R$ [redacted Tier 0] mensalidade
...
- 💰 1,99% + R$ [redacted Tier 0] por transação
...
- 💰 1,99% recorrência + R$ [redacted Tier 0]/cobrança
...
- 💰 2,99% PIX/cartão + R$ [redacted Tier 0]
...
- **Take rate 1% capped R$ [redacted Tier 0]** (vs Vindi 1,99% sem cap)

### Preço
- Free 10 cobranças/mês (entrada PME)
- Pro R$ [redacted Tier 0] sem fee de transação (vs Vindi 1,99% transação)
- Enterprise R$ [redacted Tier 0] ilimitado
