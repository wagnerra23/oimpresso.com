...
3. **Boleto registrado Inter sem taxa PJ** — Vindi cobra 1.9% + R$1
...
|---|---|---|
| Vindi (R$ 199+/mês + 1.9%) | NFe auto + ERP nativo + Inter taxa zero | Carteira de cartão tokenizada |
| Iugu (R$ 0 + 2.99%) | Multi-gateway + taxa zero PJ | Antifraude embutido |
| Asaas (R$ 0 + 1.99%) | ERP nativo + Inter como alternativa | Onboarding self-service |
