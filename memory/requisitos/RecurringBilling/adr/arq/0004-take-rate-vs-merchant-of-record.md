...
|---|---|---|---|
| **Starter R$ [redacted Tier 0]** | Tenant (gateway do cliente) | 0% | Tenant (Focus/PlugNotas tenant) |
| **Pro R$ [redacted Tier 0]** | oimpresso (gateway próprio padrão) OU Tenant (opt-out) | 0,8% capped R$ [redacted Tier 0] | oimpresso (próprio) ou Tenant |
| **Enterprise R$ [redacted Tier 0]** | Tenant (cliente Enterprise prefere MoR próprio) | 0% | Tenant |
