...
Cliente assina **plano A R$ [redacted Tier 0]/mês** dia 1. Faz upgrade pro **plano B R$ [redacted Tier 0]/mês** dia 15 (meio do ciclo). Cobrar:

- ❌ R$ [redacted Tier 0] imediato (cobrança dupla)
- ❌ R$ [redacted Tier 0] só no próximo ciclo (cliente recebe upgrade grátis 2 semanas)
- ✅ Crédito de R$ [redacted Tier 0] (15 dias do A não usado) + débito de R$ [redacted Tier 0] (15 dias do B) = +R$ [redacted Tier 0] hoje

Downgrade tem espelho:
- Plano B → A no dia 15: crédito R$ [redacted Tier 0] (B não usado) - débito R$ [redacted Tier 0] (A novo) = +R$ [redacted Tier 0] crédito (aplicado no próximo ciclo)
...
|---|---|---|
| 1 | Upgrade R$ [redacted Tier 0] → R$ [redacted Tier 0] no dia 15 (ciclo 30d) | `diferenca_a_cobrar_hoje = +R$ [redacted Tier 0]` |
| 2 | Downgrade R$ [redacted Tier 0] → R$ [redacted Tier 0] no dia 15 | `credito_proximo_ciclo = +R$ [redacted Tier 0]` |
| 3 | Upgrade em D-1 do vencimento | `diferenca_a_cobrar_hoje ≈ R$ [redacted Tier 0]` (1 dia de B) |
...
```php
test('upgrade R$ [redacted Tier 0] → R$ [redacted Tier 0] no dia 15 cobra R$ [redacted Tier 0] hoje', function () {
...
- **Proração só se diferença > R$ [redacted Tier 0]** — futuro: pode adicionar threshold via config
