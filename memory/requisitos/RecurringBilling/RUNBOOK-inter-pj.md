...
- Em ~2s pode pagar o QR pelo PIX no celular (R$ 1,00) pra disparar o webhook (Smoke 4)
...
Fluxo real:
1. Smoke 3 gera cob imediata R$ 1,00 + retorna `pixCopiaECola`
...
| Diff saldo Banking API vs portal Inter | <R$ 0,01 | Wagner abre portal Inter 1×/dia + compara `saldo_cached` |
