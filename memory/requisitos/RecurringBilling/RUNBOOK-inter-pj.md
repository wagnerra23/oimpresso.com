...
- Em ~2s pode pagar o QR pelo PIX no celular (R$ [redacted Tier 0]) pra disparar o webhook (próximo passo)
...
Smoke webhook real:
1. Smoke 3 acima gera cob imediato R$ [redacted Tier 0] + retorna `pixCopiaECola`
...
| Diff saldo Banking API vs portal Inter (verificação manual) | <R$ [redacted Tier 0] | Wagner abre portal Inter 1×/dia |
