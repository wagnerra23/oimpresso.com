---
id: requisitos-evolution-agent-spec
...
> Data: 2026-04-26
> Owner: Wagner
> Meta vinculada: [`memory/11-metas-negocio.md`](../../11-metas-negocio.md) — R$ [redacted Tier 0]mi/ano
...
|---|---|---|---|
| **Hot** | Metas R$ [redacted Tier 0]mi + ADR 0026 + branch atual + módulo em foco | Sempre no system prompt | ~1k tokens |
