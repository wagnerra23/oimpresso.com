# Purchase — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Purchase/`

## Resumo

- Telas Inertia tsx: **4**
- Charters `.charter.md`: **2** (cobertura: 50%)
...
|---|:---:|:---:|---|---:|:---:|
| `Create.tsx` | OK | - | charter-WIP | 1 | sim |
| `Edit.tsx` | OK | - | charter-WIP | 1 | sim |
| `Index.tsx` | - | - | legacy | 0 | sim |
| `Show.tsx` | - | - | legacy | 0 | sim |
