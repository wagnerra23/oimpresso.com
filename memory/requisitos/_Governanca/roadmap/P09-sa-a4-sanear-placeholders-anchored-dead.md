...
- `memory/requisitos/Jana/SPEC.md:1038` (US-COPI-111) → `Modules/Jana/Http/Resources/RoadmapTaskResource.php` (ausente, `find` não acha em lugar nenhum) + `resources/js/Pages/Admin/Roadmap/Index.tsx` (ausente; o Roadmap real vive em `Modules/Forja/Resources/js/Pages/Forja/Roadmap/Index.tsx`).
