...
> ⚰️ **DESCARTADO 2026-07-01 — feito e revertido, NÃO re-propor.** Este plano **foi executado** em 2026-06-21 ([#3143](https://github.com/wagnerra23/oimpresso.com/pull/3143), flip Wagner-autorizado "pode fazer", janela 14d pulada) → `foundation-ratchet` ficou required por 9 dias → **demovido de volta a advisory** em 2026-06-30 pela **[ADR 0314](../../../decisions/proposals/0314-poda-gates-onda-2-lei-fusoes.md) D-1** ("poda onda 2"), que o classificou **quality/não-Tier-0** ([#3466](https://github.com/wagnerra23/oimpresso.com/pull/3466)). Números da régua: **0 failures em 300+ runs** + **baseline 127/15/75 estático** (nunca disparou, nunca desceu). Registro anti-regressão em [proibições §5](../../../proibicoes.md). **Re-promoção exige reabrir a 0314 pra este item** (emenda + janela + flip), NÃO merge no calado. O 1º dente SDD vivo em L3 é o **GT-G3/P13**. O texto abaixo é o plano histórico da promoção de 2026-06-21 — mantido como registro, não como ação pendente.
