...
| **Onda 7 — Paridade protótipo↔produção** ([W] 2026-09-08: *"todos módulos deveriam estar sincronizado"*) | [onda-7-paridade-prototipo/7a](onda-7-paridade-prototipo/7a-inventario-e-metodo.md) | ⚠️ tasks a criar | 🔜 7a inventário+método escrito; pré-condições verdes (espelho 07/09 · DS drift 0 · preview COMPLETO). Eixo distinto da 0d (aquela é Blade↔React). Fila e ordem = decisão [W] | 7a ~3h; por tela ~1-2h (medição runtime) |
