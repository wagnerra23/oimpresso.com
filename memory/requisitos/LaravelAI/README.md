...
revenue_pricing:
  ...
  pro: "R$ [redacted Tier 0]/mês (add-on aos planos Pro de outros módulos) — chat contextual + 1.000 queries/mês + visualização básica"
  enterprise: "R$ [redacted Tier 0]/mês (add-on Enterprise) — multi-modal + visualização React Flow completa + API Graph + 10.000 queries/mês + custom embeddings tenant"
...
LaravelAI é **multiplier**, não foundation. Tenant que paga R$ [redacted Tier 0]-599 pelos módulos foundation (Financeiro, NfeBrasil, RecurringBilling) **paga +R$ [redacted Tier 0]-599 por LaravelAI** porque transforma a operação:
...
|---|---|---|---|
| Pro (qualquer módulo R$ [redacted Tier 0]-449) | R$ [redacted Tier 0] | R$ [redacted Tier 0]-648 | ~70% (custo: tokens OpenAI ~R$ [redacted Tier 0]/tenant médio) |
| Enterprise (R$ [redacted Tier 0]-999) | R$ [redacted Tier 0] | R$ [redacted Tier 0]-1.598 | ~80% (volume diluí custos) |
...
5. **Decidir pricing**: add-on (R$ [redacted Tier 0]-599) faz sentido vs incluir no Enterprise?
