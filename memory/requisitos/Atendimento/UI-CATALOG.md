# Atendimento — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `Modules/Whatsapp/Resources/js/Pages/Atendimento/`

## Resumo

- Telas Inertia tsx: **9**
- Charters `.charter.md`: **6** (cobertura: 66%)
...
|---|:---:|:---:|---|---:|:---:|
| `CaixaUnificada/Index.tsx` | OK | - | live | 2 | opcional |
| `Channels/Index.tsx` | OK | - | live | 2 | opcional |
| `Channels/Show.tsx` | - | - | legacy | 0 | sim |
| `Csat/Index.tsx` | - | - | legacy | 0 | sim |
| `Inbox/Index.tsx` | OK | - | live | 2 | opcional |
| `JanaTemplates.tsx` | OK | - | live | 2 | opcional |
| `Macros/Index.tsx` | OK | - | live | 2 | opcional |
| `Macros/Variants.tsx` | - | - | legacy | 0 | sim |
| `Metricas/Index.tsx` | OK | - | live | 2 | opcional |
