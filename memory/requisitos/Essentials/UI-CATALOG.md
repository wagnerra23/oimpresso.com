# Essentials — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Essentials/`

## Resumo

- Telas Inertia tsx: **13**
- Charters `.charter.md`: **0** (cobertura: 0%)
- Blade legacy do modulo (Modules/<X>/Resources/views): **87**

## Telas Inertia tsx

| Tela | Charter | review.md | Status | Round | Smoke pendente |
|---|:---:|:---:|---|---:|:---:|
| `Documents/Index.tsx` | - | - | legacy | 0 | sim |
| `Holidays/Index.tsx` | - | - | legacy | 0 | sim |
| `Knowledge/Create.tsx` | - | - | legacy | 0 | sim |
| `Knowledge/Edit.tsx` | - | - | legacy | 0 | sim |
| `Knowledge/Index.tsx` | - | - | legacy | 0 | sim |
| `Knowledge/Show.tsx` | - | - | legacy | 0 | sim |
| `Messages/Index.tsx` | - | - | legacy | 0 | sim |
| `Reminders/Index.tsx` | - | - | legacy | 0 | sim |
| `Settings/Index.tsx` | - | - | legacy | 0 | sim |
| `Todo/Create.tsx` | - | - | legacy | 0 | sim |
| `Todo/Edit.tsx` | - | - | legacy | 0 | sim |
| `Todo/Index.tsx` | - | - | legacy | 0 | sim |
| `Todo/Show.tsx` | - | - | legacy | 0 | sim |


## Blade legacy restantes

`Modules/Essentials/Resources/views/` — 87 arquivos

## Migracao planejada (MWART — [ADR 0104](../../decisions/0104-processo-mwart-canonico-unico-caminho.md))

- Estimativa de telas Blade alvo MWART: **87**
- Prioridade: **alta — Blade count alto (87)**
