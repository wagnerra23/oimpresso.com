...
> Charter: `BaseConhecimento.charter.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/essenciais/BaseConhecimento.charter.md`, removido do git em 2026-09-11 · #7224 · ADR 0397)
...
|---|---|---|
| Árvore categoria → seção → artigo | **Paridade.** Vivo `Knowledge/Index.tsx:121` (categorias/`bookList`), `:161` (seções, com abrir/fechar em `:162` e `:168`) e `:192` (artigos). Protótipo: `aside.ess-kb-nav` (`:148`) com os 3 níveis em `:151-157` (categoria `:151` · seção `:154` · artigo `:156`). | Nada — paridade. |
