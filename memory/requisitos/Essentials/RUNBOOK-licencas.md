...
> `PEDIDO-CL-hrm.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`).
> Alvo visual medido: `EXPORT-HRM-2026-09-04.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/EXPORT-HRM-2026-09-04.md`) §3.
>
> **Escopo desta onda:** a tela de **Licenças**. Presença, Folha e Painel do HRM **não** entram —
> a `emenda de 2026-09-05 do pedido` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`)
