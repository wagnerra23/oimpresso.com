...
> `PEDIDO-CL-hrm.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`, removido do git em 2026-09-11 · #7224 · ADR 0397).
> Alvo visual medido: `EXPORT-HRM-2026-09-04.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/EXPORT-HRM-2026-09-04.md`, removido do git em 2026-09-11 · #7224 · ADR 0397) §3.
>
> **Escopo desta onda:** a tela de **Licenças**. Presença, Folha e Painel do HRM **não** entram —
> a `emenda de 2026-09-05 do pedido` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`, removido do git em 2026-09-11 · #7224 · ADR 0397)
