...
> do pedido `PEDIDO-CL-hrm.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`).
...
- `PEDIDO-CL-hrm.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`) — HRM-O7 PR-9
- `EXPORT-HRM-2026-09-04.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/EXPORT-HRM-2026-09-04.md`) — onda 3
