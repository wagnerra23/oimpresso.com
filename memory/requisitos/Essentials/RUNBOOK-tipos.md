...
> do pedido `PEDIDO-CL-hrm.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`, removido do git em 2026-09-11 · #7224 · ADR 0397).
...
- `PEDIDO-CL-hrm.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/PEDIDO-CL-hrm.md`, removido do git em 2026-09-11 · #7224 · ADR 0397) — HRM-O7 PR-9
- `EXPORT-HRM-2026-09-04.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/hrm/EXPORT-HRM-2026-09-04.md`, removido do git em 2026-09-11 · #7224 · ADR 0397) — onda 3
