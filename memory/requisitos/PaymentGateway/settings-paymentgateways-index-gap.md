...
prototipo: prototipo-ui/cowork/Wagner/pg-payment-gateways-page.jsx
...
<!-- O basename deste arquivo precisa ser slug("Settings/PaymentGateways/Index") + "-gap.md":
     e assim que scripts/design/gerar-contrato.mjs::escolherGap resolve <Mod/Tela> -> gap/map.
     Com outro nome, `node scripts/design/consumir-map.mjs Settings/PaymentGateways/Index` sai
