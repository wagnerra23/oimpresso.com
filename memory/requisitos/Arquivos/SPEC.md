...
**Implementado em:** _pendente_ — a Page existe desde 2026-08-24 (PR #6216: Index.tsx + rota GET /arquivos) e ganhou a vista Trilha + a barra de abas em 2026-08-25 (PR-2, sem rota nova: `tab=trilha` na mesma); a US fecha quando retenção/cofre entrarem (PR-3/4)
