...
- Submit POST `/products/bulk-update` (writer real — `ProductController@bulkUpdate`, `routes/web.php:443`). A rota `mass-update` que este RUNBOOK declarava **nunca existiu**; [W] decidiu repontar a tela em 2026-07-27 — a linha do `.tsx` é aplicada no PR seguinte.
