...
- Submit POST `/products/bulk-update` (writer real — `ProductController@bulkUpdate`, `routes/web.php:443`). A rota `mass-update` que este RUNBOOK declarava **nunca existiu**; [W] decidiu repontar a tela em 2026-07-27 — `.tsx`, charter e este RUNBOOK já apontam pro writer real.
