...
> **Blueprint Cowork:** `prototipo-ui/prototipos/produto-cockpit/` (removido em 2026-05-20, 1070e3759b7); o charter de Produto/Index declara `related_prototype: n/a (herda PT-01 Lista)`. — mesma família visual do Create (form full-width AppShellV2)
