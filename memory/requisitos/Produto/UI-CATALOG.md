# Produto — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Produto/`

## Resumo

- Telas Inertia tsx: **8**
- Charters `.charter.md`: **8** (cobertura: 100%)
...
|---|:---:|:---:|---|---:|:---:|
| `BulkEdit.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Create.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Edit.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Index.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `SellingPrices.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Show.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `StockHistory.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
| `Unificado/Index.tsx` | OK | - | awaiting-smoke-browser | 1 | sim |
