...
| **Edição em massa › o caminho inteiro** | — | **`BulkEdit`** | 🔶 **decisão [W]** — o botão segue atrás de `enable_product_bulk_edit = false` (upstream: *"Will be depreciated in future"*). A rota inexistente `/products/mass-update` foi **corrigida em 2026-07-27** (tela repontada pro `/products/bulk-update`, decisão [W]) — mas isso **não** decide o destino da feature: [W] segue decidindo se ela vive, morre ou vira `/unificado` |
