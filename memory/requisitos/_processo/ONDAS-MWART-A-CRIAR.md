...
>
> **Como foi medido (2026-09-06, `origin/main` 80bc4ef8b9):** `A_CRIAR` de [`scripts/design/detectar-telas.mjs`](../../../scripts/design/detectar-telas.mjs) cruzado com `git grep` em `routes/*.php` + `Modules/*/Routes/*.php`, `Inertia::render|return view(` em cada controller alvo, `git ls-files` das views Blade, `node scripts/design/ancora.mjs` nos gêmeos vivos, PEDIDO-PARA-CODE em `prototipo-ui/design-docs/cowork-inbox/`, SPECs por módulo e o topo de [`08-handoff.md`](../../08-handoff.md). Não repete o comentário do `A_CRIAR`; onde ele diverge do medido, a linha diz. _(path removido em 2026-09-11, 4f51a9ec781 — a árvore vive em `prototipo-ui/cowork/Wagner/cowork-inbox/`: 320 dos 323 blobs idênticos)_
>
