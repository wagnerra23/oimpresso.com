...
- **Protótipo âncora:** `bundle_source: clientes-page.jsx` (declarado no `Index.charter.md`); handoff em `prototipo-ui/prototipos/clientes/HANDOFF_CLIENTES.md`. _(removido em 2026-09-11, PR #7224)_
