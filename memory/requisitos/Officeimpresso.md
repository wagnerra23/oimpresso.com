...
> separada da spec técnica em `memory/modulos/Officeimpresso.md`.
>
> Arquivos deste formato são consumidos pelo módulo **DocVault**
> (`/docs/modulos/Officeimpresso`) que linka user stories com telas React,
...
**Controller(s):** `OfficeimpressoController`  
...
### R-OFFI-001 · Isolamento multi-tenant por business_id

```gherkin
Dado que um usuário pertence ao business A
Quando ele acessa qualquer recurso do módulo Officeimpresso
...
_Regerar: `php artisan module:requirements Officeimpresso`_  
