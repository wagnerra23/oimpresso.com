# Site — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Site/`
...
|---|:---:|:---:|---|---:|:---:|
| `BlogPost.tsx` | - | - | legacy | 0 | sim |
| `Blogs.tsx` | - | - | legacy | 0 | sim |
| `Home.tsx` | - | - | legacy | 0 | sim |
| `Login.tsx` | - | - | legacy | 0 | sim |
| `Page.tsx` | - | - | legacy | 0 | sim |
| `Pricing.tsx` | - | - | legacy | 0 | sim |
| `Register.tsx` | - | - | legacy | 0 | sim |
