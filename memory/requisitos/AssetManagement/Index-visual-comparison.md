...
- Fonte visual: `prototipo-ui/cowork/Wagner/patrimonio-page.jsx` (aba `painel`) — **alvo**, nao decisao
  de produto
- Playbook: `prototipo-ui/cowork/Wagner/cowork-inbox/patrimonio/playbook/07-painel.md` ·
  saidas `_saida-07.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/patrimonio/playbook/_saida-07.md`, removido do git em 2026-09-11 · #7224 · ADR 0397)
  e `_saida-06-painel.md` (`prototipo-ui/cowork/Wagner/cowork-inbox/patrimonio/playbook/_saida-06-painel.md`, removido do git em 2026-09-11 · #7224 · ADR 0397)
