...
| KPIs (4 cards) | Gap: mesmos 4 KPIs (A pagar / Em trânsito / Volume do mês / Fornecedores ativos). O mockup tem sub-linhas (`.ln`) mais ricas: "próx. venc. 09/05", "+12,4% vs. abr/26 · meta R$ [redacted Tier 0]", "3 com compra recorrente · 1 novo". O vivo usa sub-linhas técnicas/neutras… | **Decidir.** mesmos 4 KPIs (A pagar / Em trânsito / Volume do mês / Fornecedores ativos). O mockup tem sub-linhas (`.ln`) mais ricas: "próx. venc. 09/05", "+12,4% vs. abr/26 · meta R$ [redacted Tier 0]", "3 com compra… Construir ou rejeitar por escrito. |
