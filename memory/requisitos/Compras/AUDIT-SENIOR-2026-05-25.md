...
|---|---:|---:|---:|---:|
| ESTABILIZAR (PR-0+PR-1) | 9-14h | 4-7 dias | R$ 1.080-1.680 | +25 pts (38→63) |
| CONSOLIDAR | 11-15h | 5-7 dias | R$ 1.320-1.800 | +12 pts (63→75) |
| EVOLUIR | 24-37h | 12-18 dias | R$ 2.880-4.440 | +10 pts (75→85) |
| **TOTAL roadmap completo** | **44-66h** | **21-32 dias** | **R$ 5.280-7.920** | **+47 pts (38→85)** |

**Custo infra adicional:** R$ 0 (tudo backend Laravel + frontend React, sem novo SaaS).
**Custo LLM ([ADR 0094](../../decisions/0094-constituicao-v2-7-camadas-8-principios.md) §4):** marginal — IA-pair Claude Sonnet 4.x ~R$ 50-150 acumulado em prompts implementação se usar Opus 4.7 só pra revisão/sênior decisions.

**ROI:** Onda ESTABILIZAR sozinha sai do bucket Crítico → Médio (+25 pts em 4-7 dias R$ 1.080-1.680). **Maior ROI projeto inteiro.** Se Wagner cortar orçamento, esta é a onda mínima inadiável (Tier 0 IRREVOGÁVEL).
