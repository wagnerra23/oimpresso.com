...
> 🚨 **Premissa Tier 0 imutável:** protótipo Cowork canon vive em `prototipo-ui/cowork/Wagner/` (NÃO em `_BACKUP-NAO-USAR/` — Wagner ordem 2026-05-20 movendo legados pra quarentena). 3 arquivos canon: `compras-page.jsx` (434 linhas), `compras-page.css` (182 linhas), `Compras.html` (679 linhas, preview standalone idêntico). Loop ADR 0114 funcional pra este módulo desde F1.
...
- **Loop Cowork ↔ Claude Code ([ADR 0114](../../decisions/0114-prototipo-ui-cowork-loop-formalizado.md) + [`memory/reference/prototipo-ui/PROTOCOL.md`](../../../memory/reference/prototipo-ui/PROTOCOL.md)):** loop funcional — protótipo canon vive em `prototipo-ui/cowork/Wagner/` (Wagner ordem 2026-05-20 movendo legados pra `_BACKUP-NAO-USAR/`)
