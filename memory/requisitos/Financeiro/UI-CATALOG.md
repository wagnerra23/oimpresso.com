# Financeiro — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Financeiro/`

## Resumo

- Telas Inertia tsx: **12**
- Charters `.charter.md`: **5** (cobertura: 41%)
- Blade legacy do modulo (Modules/<X>/Resources/views): **2**

## Telas Inertia tsx

| Tela | Charter | review.md | Status | Round | Smoke pendente |
|---|:---:|:---:|---|---:|:---:|
| `AssinaturaAtualizar.tsx` | - | - | legacy | 0 | sim |
| `Boletos/Index.tsx` | OK | - | live | 2 | opcional |
| `Categorias/Index.tsx` | - | - | legacy | 0 | sim |
| `ContasBancarias/Index.tsx` | OK | - | live | 2 | opcional |
| `ContasPagar/Index.tsx` | - | - | legacy | 0 | sim |
| `ContasReceber/Index.tsx` | - | - | legacy | 0 | sim |
| `Dashboard/Index.tsx` | - | - | legacy | 0 | sim |
| `Extrato/Index.tsx` | OK | - | live | 2 | opcional |
| `Fluxo/Index.tsx` | OK | - | live | 2 | opcional |
| `Relatorios/Index.tsx` | - | - | legacy | 0 | sim |
| `Unificado/Index.tsx` | OK | - | live | 2 | opcional |
| `Unificado/Novo.tsx` | - | - | legacy | 0 | sim |


## Blade legacy restantes

`Modules/Financeiro/Resources/views/` — 2 arquivos

## Migracao planejada (MWART — [ADR 0104](../../decisions/0104-processo-mwart-canonico-unico-caminho.md))

- Estimativa de telas Blade alvo MWART: **2**
- Prioridade: **baixa — pouco Blade restante (2)**
