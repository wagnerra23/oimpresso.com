...
|---|---|---|---|
| A | DRE não pegava títulos vencendo em Maio (R$ 0 vs R$ 91.792 Unificado) | `competencia_mes` defasado dos vencimentos (dados legados OfficeImpresso renegociados) | ✅ Onda 17 Fix 1 (SSH update 4 títulos MARTINHO #164 — `competencia_mes='2026-05'`) |
