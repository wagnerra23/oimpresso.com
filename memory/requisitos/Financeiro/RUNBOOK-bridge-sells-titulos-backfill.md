...
- **Total a receber muito baixo** vs realidade (ex R$ 12k visível mas Sells mostra R$ 400k em `payment_status=due`)
...
- Fase 2a: 17.412 fin_titulos retroativos (R$ 3,7M em 5 anos)
- Fase 2b: 15.412 fin_titulo_baixas (R$ 3,2M baixados histórico)
- Fase 2c: recalc → 1.567 abertos + 104 parciais = **R$ 418.986,59 a receber visível pra Larissa**
