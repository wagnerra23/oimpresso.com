---
id: requisitos-financeiro-readme
module: Financeiro
alias: financeiro
status: ativo
...
revenue_pricing:
  ...
  pro: "R$ [redacted Tier 0]/mês — boleto + PIX + OFX + DRE + sem limite + multi-conta bancária"
  enterprise: "R$ [redacted Tier 0]/mês — CNAB direto + multi-empresa consolidado + API + SLA"
revenue_take_rate: "0,5% sobre boleto/PIX emitido (capped R$ [redacted Tier 0] por título) quando usa nosso adapter"
references:
...
Este é o módulo que **transforma o oimpresso de "POS" em "ERP"** aos olhos do cliente. Tenant que paga R$ [redacted Tier 0]/mês pelo POS aceita pagar R$ [redacted Tier 0]-599/mês quando o financeiro economiza 1 hora/dia da Larissa-financeiro e elimina a planilha externa.

| Plano | Preço/mês | Quem assina | Margem (estimada) |
|---|---|---|---|
| **Free** (limite 50 títulos/mês) | R$ [redacted Tier 0] | Microempreendedor / teste | Negativa por usuário, positiva agregado por upgrade |
| **Pro** | R$ [redacted Tier 0] | PME 1-10 funcionários | 70% (custo: gateway + storage) |
| **Enterprise** | R$ [redacted Tier 0] | PME 10-50 funcionários | 80% |
| **Take rate boleto/PIX** | 0,5% (capped R$ [redacted Tier 0]) | Plano Pro+Ent que usa nosso adapter | 90% (sem custo variável significativo) |
