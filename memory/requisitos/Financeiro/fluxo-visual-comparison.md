...
### Q3 — Margem mínima R$ 5k → config.tenant ou hardcode?

**Recomendação:** **Hardcode R$ 5.000,00 em F1**, configurável em F2 via `business_settings.margem_minima_caixa`. Migration trivial (`ALTER TABLE business_settings ADD COLUMN margem_minima_caixa DECIMAL(15,2) DEFAULT 5000`) entra como US-FIN-021.
