...
├─────────────────┼───────────────────┼───────────────────────────┤
│ ☑ 24/04 R$ [redacted Tier 0] │  ✓ 95%  exato     │  #1234 ROTA LIVRE        │
│   "DEP TED"     │  data + valor +   │  R$ [redacted Tier 0] venc 24/04     │
│                 │  fuzzy desc       │  status: aberto           │
├─────────────────┼───────────────────┼───────────────────────────┤
│ ☑ 24/04 R$ [redacted Tier 0] │  ⚠ 72%  fraco     │  #1240 SUPER-FORN        │
│   "PIX FORN"    │  só valor + dia   │  R$ [redacted Tier 0] venc 23/04     │
├─────────────────┼───────────────────┼───────────────────────────┤
│ ☐ 24/04 R$ [redacted Tier 0]    │  ✗ sem match      │  [Criar título manual]   │
...
**Positivas:**
- Larissa vê os 3 lados ao mesmo tempo → erro de match óbvio (valor R$ [redacted Tier 0] ↔ R$ [redacted Tier 0] escapa em tabela linear; em 3 colunas, salta)
...
- Success state: snackbar `sonner` "23 matches confirmados, R$ [redacted Tier 0] baixados"
