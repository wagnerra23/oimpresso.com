...
1. **PME 1-5 funcionários** — quer 1 clique e zero conhecimento bancário. Pega gateway (Asaas / Iugu / Pagar.me) que cobra ~R$ [redacted Tier 0] por boleto pago, retorna URL pronta, webhook automático.
...
- **Take rate** (revenue thesis): 0,5% capped R$ [redacted Tier 0] só faz sentido em GatewayStrategy (oimpresso intermedia). CnabDirect = sem take rate (cliente bancariza direto)
