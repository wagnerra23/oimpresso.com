...
oimpresso hoje cobra **subscription puro** (R$ [redacted Tier 0]/mês plano POS). Para Financeiro virar receita maior, 3 modelos foram considerados:

1. **Subscription puro mais caro** (ex: Pro R$ [redacted Tier 0]/mês)
...
|---|---|---|---|
| **Free** | R$ [redacted Tier 0] | 50 títulos/mês, sem boleto/PIX | n/a |
| **Pro** | R$ [redacted Tier 0]/mês | 500 títulos/mês + 50 boletos | 0,5% capped R$ [redacted Tier 0] por boleto pago além |
| **Enterprise** | R$ [redacted Tier 0]/mês | ilimitado + CNAB direto | 0% take rate (já paga premium) |
...
- Tenant médio: Pro R$ [redacted Tier 0] + ~30 boletos extras (R$ [redacted Tier 0] a R$ [redacted Tier 0]) = R$ [redacted Tier 0]-496/mês
- Tenant grande: Enterprise R$ [redacted Tier 0] fixo (previsível) + sem fee → atrai quem fatura R$ [redacted Tier 0]k+/mês
...
- **Win-win:** se Asaas baixa fee de R$ [redacted Tier 0] → R$ [redacted Tier 0] oimpresso mantém 0,5% e fica com mais margem
- Take rate cap (R$ [redacted Tier 0]) impede cobrança abusiva em boleto de R$ [redacted Tier 0]k+ (cliente VIP)
...
- [ ] **Tier intermediário** R$ [redacted Tier 0] com 1.000 títulos + 200 boletos? Análise de funnel após 3 meses live.
- [ ] **Free plan limit 50** mata adoção? Talvez Free = 100 com boleto/PIX bloqueado (mais permissivo).
- [ ] **Lifetime deal** pra primeiros 100 enterprises (R$ [redacted Tier 0] 1x = 16 meses)? Decisão de growth.
...
- Asaas/Iugu fee structure (R$ [redacted Tier 0]/boleto pago) — input pro cap take rate
