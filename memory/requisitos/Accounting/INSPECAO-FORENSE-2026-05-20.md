...
| 7 | **Lição F3 rejeitada** ([`memory/reference/prototipo-ui/LICOES_F3_FINANCEIRO_REJEITADO.md`](../../../memory/reference/prototipo-ui/LICOES_F3_FINANCEIRO_REJEITADO.md)) — se decidir Inertia-rizar Accounting em vez de deprecar, lições do F3 Financeiro batch rejeitado 2026-05-09 aplicam (6 meta-antipadrões + 15 técnicos) | N/A (não é o caminho) | N/A | Não Inertia-rizar Accounting — caminho é deprecar, não modernizar. Bookmark da lição pra ser citada na nova ADR. | NÃO |
...
- [memory/reference/prototipo-ui/LICOES_F3_FINANCEIRO_REJEITADO.md](../../../memory/reference/prototipo-ui/LICOES_F3_FINANCEIRO_REJEITADO.md) — 6 meta-antipadrões + 15 técnicos
