...
|---|---|---|
| Dados do colaborador | **Paridade literal.** `Show.tsx:179` (`data-contract="espelho-dados-colaborador"`); os 8 rótulos do contrato saem em `:187-196`: Matrícula · CPF · PIS · Escala atual · Carga diária · Admissão · Desligamento. O comentário `:178` registra o porquê legal: *"sem matrícula/CPF/PIS o documento não serve"* à fiscalização. | Nada — paridade. |
