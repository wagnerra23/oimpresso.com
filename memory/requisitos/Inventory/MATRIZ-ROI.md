...
| US-INV-010 | Lookup garantia fornecedor (batch → clientes) | AutoPeças (RMA Mahle) | 4h | Reduz fricção devolução fornecedor — economia R$ 2-5k/mês biz médio | **A** | SAP B1/NetSuite sim; Tiny/Bling NÃO; **gap mercado BR PME** |
...
| US-INV-013 | Alerta cartucho/rolo baixo (% restante) | ComVis (troca M-magenta 5%) | 4h | Evita parada plotter — perda R$ 200-500/dia | **A** | Roland VersaWorks tem; Tiny/Bling NÃO; oimpresso = paridade software gráfico premium |
...
**Economia financeira direta AutoPeças.** RMA Mahle/Bosch automático economiza R$ 2-5k/mês biz médio (5-12% devolução autopeças BR). Tiny/Bling NÃO cobrem. Gap BR PME.
...
|---|---|---|---|---|---|---|---|
| **Tiny (Olist)** | ❌ Simples 1 nível | ✅ Lote+validade | ⚠️ Multi-unit limitado | ⚠️ Logs básicos | ⚠️ FIFO only | ✅ Forte (core feature) | R$ 0–199 |
| **Bling** | ❌ Composição simples | ✅ Lote+validade+NFe | ⚠️ Multi-unit | ⚠️ Logs | ⚠️ Manual | ✅ Forte | R$ 35–500 |
| **Linx Microvix** | ✅ Kits + grade | ✅ Lote | ⚠️ Limitado | ✅ Forte (varejo) | ⚠️ Manual | ⚠️ Parcial | R$ 200–800 |
| **TOTVS Protheus SIGAEST** | ✅ MATA010 + MATA650 | ✅ Lote+sublote+validade rastreio fim-a-fim | ✅ Indústria | ✅ Tabelas SB8/SD5 | ✅ FEFO/FIFO | ⚠️ Add-on caro | R$ 3-15k+ |
| **Sankhya** | ✅ Composição produto | ✅ Lote+explosão automática | ✅ Indústria | ✅ Forte | ✅ FEFO via MP | ⚠️ Limitado | R$ 1-8k+ |
