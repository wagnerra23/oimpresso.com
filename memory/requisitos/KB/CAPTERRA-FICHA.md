...
fonte:
  - prototipo-ui/prototipos/kb/Bench KB.html (v1, 15 dimensões, score 8,27)  # removido em 2026-05-20, 1070e3759b7
  - prototipo-ui/prototipos/kb/Bench KB v2.html (v2, 16 dimensões, score 9,40 — +1,13 após 3 refinos)  # removido em 2026-05-20, 1070e3759b7
...
| Guru | Support (independente) | 7,95 | Verificação, AI Answers, browser ext | Preço (~R$ [redacted Tier 0]/u/mês), hierarquia simples |
...
Bench fonte: `prototipo-ui/prototipos/kb/Bench KB v2.html` (Cowork [CC] self-assessment crítico). _(removido em 2026-05-20, 1070e3759b7)_
...
- **Guru** tem AI Answers + verificação por dono, mas R$ [redacted Tier 0]/user/mês inviabiliza pra PME gráfica. Sem hierarquia profunda nem decision tree. **Continua independente** (ServiceNow comprou Moveworks $2,85B dez/2025, não Guru — correção de bench original).
