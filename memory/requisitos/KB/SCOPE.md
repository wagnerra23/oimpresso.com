...
- ❌ Editar regra imutável de programação → ~~o modulo MemCofre (SRS)~~ — `MemCofre` virou `SRS` ([ADR 0088](../../memory/decisions/0088-module-rename-php-only.md)) e o `SRS` foi REMOVIDO em 2026-07-29 ([ADR 0357](../../memory/decisions/0357-deprecar-srs-sucessor-kb-jana-governance.md)); fronteira a revisar
