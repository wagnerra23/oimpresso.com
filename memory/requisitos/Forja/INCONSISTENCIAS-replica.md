...
>
> Gerado em 2026-09-03 · comando: `node scripts/governance/replica-inconsistencias.mjs --modulo Forja --prototipo …` · **122 aberta(s)** de 122.
...
| 🔴 aberta | `R3` | `Modules/Forja/Resources/js/Pages/Forja/Trabalho/_components/TrabalhoQuadro.tsx` | 14 | → ← ⚠ ✓ | UiLintCommand.php R3 | aplicado |
...
| 🔴 aberta | `R3` | `Modules/Forja/Resources/js/Pages/team-mcp/Forja/_components/ForjaHandoffs.tsx` | 17 | → ⚠ ⚿ ↗ | UiLintCommand.php R3 | aplicado |
...
| 🔴 aberta | `R1` | `Modules/Forja/Resources/js/Pages/team-mcp/Forja/_components/ForjaMcp.tsx` | 1 | #2417 | UiLintCommand.php R1 · conformance-gate | aplicado |
| 🔴 aberta | `R3` | `Modules/Forja/Resources/js/Pages/team-mcp/Forja/_components/ForjaMcp.tsx` | 9 | → | UiLintCommand.php R3 | aplicado |
| 🔴 aberta | `FLEX-CRU` | `Modules/Forja/Resources/js/Pages/team-mcp/Forja/_components/ForjaMcp.tsx` | 1 |  | layout-primitives-guard.mjs | aplicado |
