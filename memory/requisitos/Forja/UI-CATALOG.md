# Forja — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `Modules/Forja/Resources/js/Pages/Forja/`

## Resumo

- Telas Inertia tsx: **7**
- Charters `.charter.md`: **1** (cobertura: 14%)
...
|---|:---:|:---:|---|---:|:---:|
| `Activity/Index.tsx` | - | - | legacy | 0 | sim |
| `Backlog/Index.tsx` | - | - | legacy | 0 | sim |
| `Board/DetailSheet.tsx` | - | - | legacy | 0 | sim |
| `Board/Index.tsx` | OK | - | live | 2 | opcional |
| `Burndown/Index.tsx` | - | - | legacy | 0 | sim |
| `MyWork/Index.tsx` | - | - | legacy | 0 | sim |
| `Roadmap/Index.tsx` | - | - | legacy | 0 | sim |
