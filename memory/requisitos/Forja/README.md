...
>
> Promovido a módulo próprio em 2026-05-04 ([ADR 0070](../../decisions/0070-jira-style-task-management-current-md-removed.md)). UI redesign PMG-001..007 ([ADR 0100](../../memory/decisions/0100-project-mgmt-ui-redesign-roadmap.md)).
...
│   └── Admin/
│       └── ProjectsController.php   ← REFATORADO D4 Wave 16: usa ProjectService + ForjaAuditService
├── Services/                         ← NOVO Wave 16
│   ├── ProjectService.php           (CRUD mcp_projects scoped por business_id — D4 SoC)
│   └── ForjaAuditService.php  (Spatie activity_log "project-mgmt" + PiiRedactor — D7 LGPD)
├── Config/
│   ├── config.php
│   └── retention.php                ← NOVO Wave 16: política LGPD declarativa (D7.c)
└── Tests/Feature/
    ├── BoardControllerTest.php
    ├── ScaffoldForjaTest.php
    ├── SearchControllerTest.php
    ├── SmokeRoutesForjaTest.php
...
```bash
# Todo o módulo
./vendor/bin/pest Modules/Forja/Tests/

# Por dimensão Wave 16
./vendor/bin/pest Modules/Forja/Tests/Feature/LgpdComplianceTest.php       # D7
./vendor/bin/pest Modules/Forja/Tests/Feature/CustomerJourneyTest.php       # D5
./vendor/bin/pest Modules/Forja/Tests/Feature/MultiTenantProjectTest.php   # Tier 0
```
