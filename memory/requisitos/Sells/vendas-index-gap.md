...
> | quem cita (`git grep -l`, fora do `doc-id-index.json` e dos logs de refutação do #6897, que citam os dois como itens do lote) | `08-handoff.md` · `handoffs/2026-06-22-2324-*` · `sessions/2026-06-23-arte-handoff-*` · `vendas.map.json` · selftest do `scripts/design/gerar-contrato.mjs:153` (fixture) | só o mesmo selftest (`gerar-contrato.mjs:153-158`, nome usado como fixture de desambiguação) e um comentário em `scripts/pr-critic/coleta.mjs:14` |
>
