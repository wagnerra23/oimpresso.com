...
| **Alerta "Cliente vencido: R$ [redacted Tier 0]"** abaixo do cliente | ✅ informação útil (NÃO existe no Create Inertia) |
...
| Cliente vencido alerta | ❌ falta | ✅ inline R$ [redacted Tier 0] |
