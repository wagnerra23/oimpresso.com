...
| **8** | **KPI Faturado hoje** | Hero dark green + valor R$ 9,4k + delta "+18% vs ontem · 6 vendas" + sparkline curva azul completa | Hero dark green + valor R$ 0,00 (sem vendas hoje) + "0 vendas" + sparkline montanha simples | **8** | Estilo idêntico · delta+sparkline ricos vs mais simples (dados zerados quebram visual) |
| **9** | **KPI A Receber + ageing bar** | R$ 34,8k + breakdown "3 estouradas · 6 frescas" + ageing bar 0-30/31-60/+60 + **link "→ ver estouradas"** | R$ 74,4k + breakdown "1 estourado · 43 frescos" + ageing bar 0-30/31-60/+60 (sem link) | **8** | Falta link clicável "→ ver estouradas" |
