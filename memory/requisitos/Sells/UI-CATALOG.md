# Sells — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Sells/`
...
|---|:---:|:---:|---|---:|:---:|
| `Create.tsx` | OK | - | live | 2 | opcional |
| `Drafts.tsx` | OK | - | charter-WIP | 1 | sim |
| `Edit.tsx` | OK | - | charter-WIP | 1 | sim |
| `Index.tsx` | OK | - | live | 2 | opcional |
| `Quotations.tsx` | OK | - | charter-WIP | 1 | sim |
| `Show.tsx` | OK | - | charter-WIP | 1 | sim |
| `Subscriptions.tsx` | OK | - | charter-WIP | 1 | sim |
