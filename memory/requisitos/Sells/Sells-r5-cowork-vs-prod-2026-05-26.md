...
|---|---|---|---|---|---|
| 1 | Header h1 + subtitle live | Vendas + métrica agregada | Vendas + "50 vendas · R$75,3k · 1 estouradas" | 10/10 | ✓ |
...
| 3 | Brief greeting paragraph | "Boa tarde, Wagner" + RichSpan com bold/danger | "113 vendas no período · 68 pendentes. Hoje somou R$ 0,00." | 8/10 | menos rich (sem cores semantic strong/danger) |
...
| 5 | Brief anomaly | Texto itálico + ícone alerta | "R$20,00 em 1 vendas vencidas. Top devedor: Wagner Rocha" + AlertCircle | 9/10 | ✓ paridade |
