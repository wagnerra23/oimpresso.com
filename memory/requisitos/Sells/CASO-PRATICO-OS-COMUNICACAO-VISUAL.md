...
|---|---|---|---|---|---|
| Banner lona 380gr 3×2m | mercadoria | R$ 350 | **NFe modelo 55** | NCM 5907.00.00, CFOP 5101, CSOSN 102 | reserva 6m² lona em "aprovado" → consome em "produção concluída" |
| Instalação fachada | serviço | R$ 200 | **NFSe modelo 56 nacional** (`nfse.gov.br/sefin`) | LC 116/2003 item 17.06 (publicidade), ISS 5% Florianópolis | — |
| **Total OS** | — | **R$ 550** | **2 documentos atrelados a 1 transaction** | — | — |
...
invoiced
  ↓ entregar_ao_cliente [instalador]  →  side-effect (opcional): EmitirMDFeJob (>R$ 500 carga)
delivered
...
│ ✅ MDFe 58 nº 12      R$ 550,00   Transporte      │
│                                                     │
...
| **MDFe modelo 58** | transporte do banner (>R$ 500 carga) | opcional, US futura |
...
- Caros (~R$ 800-3000/mês). FSM custom não é exposto na UI — parametrização é via consultoria paga, lock-in alto.
