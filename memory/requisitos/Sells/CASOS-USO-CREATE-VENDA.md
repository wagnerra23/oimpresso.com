...
| CU-05 | Editar linha: qtd/preço/desconto **pt-BR (anti-R$25k)** | must | ✅ | `SellsCreatePageTest` (NumericInputPtBR/numberPtBR) · `ProductLineCardComponentTest` | 🟢 |
...
## CU-05 · Editar linha pt-BR (anti-R$25k) · `must`
...
- **Smoke biz=4:** digitar `12550` → R$ 125,50 (caso real Larissa 2026-05-27)
