---
id: requisitos-sells-show-visual-comparison
...
> **Pattern Reuse declarado:** ADR 0149 aplica — Show é tela DERIVADA de `Sells/Index` (mesma entidade `transactions`). Blueprint Cowork `prototipo-ui/cowork/Wagner/vendas-page.jsx` aprovado em F2 do ADR 0114 cobre Show.
...
`Vendas Cockpit.html` (removido em 2026-09-11, PR #7224 — era em `prototipo-ui/prototipos/vendas-cockpit/`) + `visual-source-fsm-v1.html` — pattern detail view com:
