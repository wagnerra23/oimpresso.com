...
|---|:---:|---|:---:|---|
| **Cognição/RAG** | 90 | BGE-v2-m3 é SOTA self-host multilingual (50-100ms GPU, R$0); upside só Cohere Rerank 4 / Voyage 2.5 (32K ctx vs 8K). Pattern: hybrid+RRF→rerank top-K | 92 | [BSWEN rerankers](https://docs.bswen.com/blog/2026-02-25-best-reranker-models/), [Agentset](https://agentset.ai/blog/best-reranker) |
...
| **G6** | **RAGAS real-mode diário** (hoje semanal/canary) | MÉDIO | 0.3 d/pp* | 3 gates CI existem; cadência conservadora | Subir cadência (~R$1,80/mês) + apertar thresholds | Parcial (custo baixo, **Wagner**) |
