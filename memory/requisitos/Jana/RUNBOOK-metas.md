...
27/08 para `prototipo-ui/design-docs/cowork-inbox/` — inclusive o `JANA-ERRATA-CAMADA-ESQUECIDA`; hoje em `prototipo-ui/cowork/Wagner/cowork-inbox/JANA-ERRATA-CAMADA-ESQUECIDA-2026-08-27.md` _(o path antigo `prototipo-ui/design-docs/cowork-inbox/` foi removido em 2026-09-11, 4f51a9ec781; o CONTEÚDO vive em `prototipo-ui/cowork/Wagner/cowork-inbox/`, blob idêntico)_
