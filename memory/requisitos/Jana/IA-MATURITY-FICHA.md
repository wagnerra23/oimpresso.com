...
1. **PII redaction pré-LLM** (9,5) — `PiiRedactor` BR-specific (CPF/CNPJ/email/tel/CEP) com modo hash determinístico ([app/Support/Privacy/PiiRedactor.php](../../../app/Support/Privacy/PiiRedactor.php)); concorrentes globais não tratam PII BR
