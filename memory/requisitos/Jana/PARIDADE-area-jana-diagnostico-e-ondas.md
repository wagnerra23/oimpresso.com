...
| 2 | `prototipo-ui/cowork/_ds/office-impresso-design-system-019dd02f…/` | **onde o host pede** (`<link>`/`<script>` do `oimpresso.com.html`) — **vazio** | _(alvo não resolve no repo — proveniência não determinada)_
...
`prototipo-ui/cowork/_ds/` como **cache derivado, gitignored**, encerrando a ambiguidade. _(alvo não resolve no repo — proveniência não determinada)_
...
2. **O hue 90 dos textos tem fonte, não é lapso — mas a mensagem do commit e o diff discordam.**
   ...
   exatamente o que o [`prototipo-ui/Design System v4.html:1771-1779`](../../../prototipo-ui/Design%20System%20v4.html) _(alvo não resolve no repo — proveniência não determinada)_
