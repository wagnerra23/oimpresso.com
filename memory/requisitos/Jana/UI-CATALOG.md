# Jana — UI Catalog (auto-gerado bulk W31-10)
...
> Pages dir: `resources/js/Pages/Jana/`

## Resumo

- Telas Inertia tsx: **9**
- Charters `.charter.md`: **7** (cobertura: 77%)
- Blade legacy do modulo (Modules/<X>/Resources/views): **9**

## Telas Inertia tsx

| Tela | Charter | review.md | Status | Round | Smoke pendente |
|---|:---:|:---:|---|---:|:---:|
| `Admin/Custos/Index.tsx` | - | - | legacy | 0 | sim |
| `Admin/Governanca/Index.tsx` | OK | - | live | 2 | opcional |
| `Admin/Qualidade/Index.tsx` | - | - | legacy | 0 | sim |
| `Admin/Roadmap.tsx` | OK | - | live | 2 | opcional |
| `Chat.tsx` | OK | - | live | 2 | opcional |
| `Cockpit.tsx` | OK | - | charter-WIP | 1 | sim |
| `Dashboard.tsx` | OK | - | live | 2 | opcional |
| `Memoria.tsx` | OK | - | live | 2 | opcional |
| `Painel.tsx` | OK | - | live | 2 | opcional |


## Blade legacy restantes

`Modules/Jana/Resources/views/` — 9 arquivos

## Migracao planejada (MWART — [ADR 0104](../../decisions/0104-processo-mwart-canonico-unico-caminho.md))

- Estimativa de telas Blade alvo MWART: **9**
- Prioridade: **baixa — pouco Blade restante (9)**
