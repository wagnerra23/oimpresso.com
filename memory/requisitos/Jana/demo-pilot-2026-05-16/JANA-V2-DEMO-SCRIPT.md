...
4. **Footer auditável:** mostrar metadata footer — "gerado em HH:MM, modelo gpt-4o-mini, custo R$ [redacted Tier 0] fontes: 3 ângulos faturamento + Sells stages + Asaas". Wagner enfatiza: "Você pode auditar de onde veio cada número."
...
|---|---|
| "Quanto custa de OpenAI?" | "Brief diário R$ [redacted Tier 0]/dia. Chat varia uso — média R$ [redacted Tier 0]-15/mês por business piloto." |
