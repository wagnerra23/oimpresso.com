...
| Termo | Definição |
|---|---|
| **Jana** | O módulo inteiro. Também o nome visual na UI. Marca comercial = técnica. |
...
| **Superadmin Jana** | Perfil `copiloto.superadmin` — vê metas de todos businesses + metas da plataforma (`business_id = null`). |
| **Meta da plataforma** | Meta com `business_id = null`. Representa objetivos da oimpresso como SaaS (ex.: R$ [redacted Tier 0]mi/ano). Só superadmin acessa. |
