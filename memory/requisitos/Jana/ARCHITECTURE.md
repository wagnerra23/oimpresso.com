...
> ⚙️ **Gerado por `scripts/governance/system-map.mjs` em 2026-08-11.** NÃO edite à mão.
...
| Checks no baseline versionado de merge | **43** | `governance/required-checks-baseline.json` — o probe vivo é `protection-drift.mjs` |
...
---
_Gerado por `scripts/governance/system-map.mjs` · 2026-08-11 · arquitetura derivada das fontes canônicas._
