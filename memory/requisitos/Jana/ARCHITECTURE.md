...
> ⚙️ **Gerado por `scripts/governance/system-map.mjs` em 2026-08-09.** NÃO edite à mão.
...
| Checks no baseline versionado de merge | **42** | `governance/required-checks-baseline.json` — o probe vivo é `protection-drift.mjs` |
...
---
_Gerado por `scripts/governance/system-map.mjs` · 2026-08-09 · arquitetura derivada das fontes canônicas._
