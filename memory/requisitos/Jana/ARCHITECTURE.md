...
> ⚙️ **Gerado por `scripts/governance/system-map.mjs` em 2026-08-03.** NÃO edite à mão.
...
| Agentes de engenharia | **26** | `.claude/agents/*.md` — outra camada, não runtime PHP |
...
---
_Gerado por `scripts/governance/system-map.mjs` · 2026-08-03 · arquitetura derivada das fontes canônicas._
