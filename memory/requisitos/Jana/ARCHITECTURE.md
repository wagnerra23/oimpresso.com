...
> ⚙️ **Gerado por `scripts/governance/system-map.mjs` em 2026-09-16.** NÃO edite à mão.
...
| Checks no baseline versionado de merge | **47** | `governance/required-checks-baseline.json` — o probe vivo é `protection-drift.mjs` |
...
---
_Gerado por `scripts/governance/system-map.mjs` · 2026-09-16 · arquitetura derivada das fontes canônicas._
