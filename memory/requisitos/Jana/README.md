...
revenue_pricing:
  ...
  starter: "R$ [redacted Tier 0]/mês"
  pro: "R$ [redacted Tier 0]/mês"
  enterprise: "R$ [redacted Tier 0]/mês"
...
Módulo nascido da meta **R$ [redacted Tier 0]mi/ano** da oimpresso (ADR 0022 + `memory/11-metas-negocio.md`). A visão é que cada business do UltimatePOS — e a plataforma oimpresso como um todo — tenha seu próprio Jana.
...
| Meta da plataforma oimpresso (R$ [redacted Tier 0]mi/ano) | `null` | Superadmin |
...
|---|---|---|
| **Starter** | R$ [redacted Tier 0]/mês | Chat com IA limitado (50 msgs/mês), metas manuais, alerta in-app |
| **Pro** | R$ [redacted Tier 0]/mês | Chat ilimitado + sugestão IA de metas, 3 canais de alerta (in-app/email), integrações Financeiro/POS/Ponto |
| **Enterprise** | R$ [redacted Tier 0]/mês | Tudo do Pro + visão cross-business (grupos), prioridade na fila de IA, analytics profundas, consultoria de metas por WhatsApp |
