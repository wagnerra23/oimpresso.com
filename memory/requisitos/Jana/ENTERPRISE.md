...
> **Status:** Production-deployed. Tier 5-6 LongMemEval estimado. R$ [redacted Tier 0]/mês recorrente.
...
- ✅ Custo recorrente R$ [redacted Tier 0]/mês até comprovar tese (Meilisearch self-hosted) — concorrentes que adotam Mem0/Letta pagam $25-300/mês desde dia 1
...
6. **Custo recorrente travado em R$ [redacted Tier 0]/mês** — Mem0 só ativa via 5 triggers documentados (ADR 0036)
...
**Custo:** ~R$ [redacted Tier 0]-0,05/mensagem (depende do plan OpenAI/Anthropic)
...
**Custo:** ~R$ [redacted Tier 0]/turno (gpt-4o-mini structured output)
...
| Item | Tier atual (0 clientes pagantes) | Tier 1A (R$ [redacted Tier 0]-599/mês) | Tier 5+ (50 clientes) |
|---|---|---|---|
| Hostinger Cloud Startup | já pago | já pago | provavelmente VPS dedicado |
| Meilisearch self-host | R$ [redacted Tier 0] | R$ [redacted Tier 0] | R$ [redacted Tier 0] (mesmo servidor) |
| OpenAI/Anthropic API tokens | R$ [redacted Tier 0] (dry_run) | ~R$ [redacted Tier 0]-50/cliente/mês | ~R$ [redacted Tier 0]-2500/mês total |
| `laravel/ai`, `boost`, `scout`, `horizon`, `telescope`, `pail` | R$ [redacted Tier 0] (OSS MIT) | R$ [redacted Tier 0] | R$ [redacted Tier 0] |
| Mem0 (sprint 8+ condicional) | R$ [redacted Tier 0] | R$ [redacted Tier 0] | R$ [redacted Tier 0]-18.000/ano se trigger ativar |
| **Total recorrente** | **R$ [redacted Tier 0]** | **~R$ [redacted Tier 0]-500/mês** | **~R$ [redacted Tier 0]-30000/mês** (10% do MRR) |
