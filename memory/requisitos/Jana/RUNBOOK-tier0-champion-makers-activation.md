...
**Flip — passo 1: ligar real mode (custo ~R$1,80/mês per-PR Jana ou ~R$0,24/mês weekly):**
```bash
...
|---|---|---|---|
| **A. Manter degradação graciosa** | nada — #2070 já cobre | R$ 0 | ✅ **default por ora** — o risco (perder recall por minutos) é baixo e já tratado |
