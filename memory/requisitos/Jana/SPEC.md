...
**Implementado em:** `docker/langfuse/docker-compose.yml` · `Modules/Jana/Services/Telemetry/LangfuseClient.php` · `Modules/Jana/Jobs/Telemetry/LangfuseTraceJob.php` · verificado@1939ebd (2026-06-22) — compose movido de infra/ct100/langfuse para docker/langfuse; client movido de Ai\Services para Services\Telemetry
...
**Implementado em:** _parcial_ · `Modules/Jana/Http/Controllers/Admin/RoadmapController.php` · `resources/js/Pages/Jana/Admin/Roadmap.tsx` · `resources/js/Pages/Jana/Admin/Roadmap.charter.md` · verificado@1939ebd (2026-06-22) — falta: tela consolidada num único Roadmap.tsx (sem split RoadmapGantt/SubIssuesPanel) e serialização inline no controller (RoadmapTaskResource nunca criado); page sob Pages\Jana\Admin não Pages\Admin\Roadmap\Index
...
**Implementado em:** _parcial_ · `Modules/Jana/Mcp/Tools/HandoffDraftTool.php` · `Modules/Jana/Mcp/OimpressoMcpServer.php` · verificado@1939ebd (2026-06-22) — falta: orquestração LLM (git log + handoff-diff + gpt-4o-mini) vive dentro do próprio Tool; HandoffDrafterService nunca extraído como Service; McpServer movido de Providers para Mcp
...
**Implementado em:** `scripts/memory-schemas/adr.schema.json` · `scripts/memory-schemas/spec.schema.json` · `scripts/memory-schemas/runbook.schema.json` · `scripts/memory-schemas/session.schema.json` · `scripts/memory-schemas/handoff.schema.json` · `scripts/memory-schemas/charter.schema.json` · `scripts/memory-schemas/README.md` · `.github/workflows/memory-schema-gate.yml` · `Modules/Jana/Console/Commands/JanaValidateMemoryCommand.php` · verificado@1939ebd (2026-06-22) — schemas movidos de memory\schemas para scripts\memory-schemas; workflow memory-schema-lint.yml virou memory-schema-gate.yml; command ValidateMemorySchemas virou JanaValidateMemoryCommand (artisan jana:validate-memory)
