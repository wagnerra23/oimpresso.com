...
2. **Corrigir o protótipo de referência**: o blueprint da tela LITE é `ui_kits/cowork-2026-05-09/prod-page.jsx` (6.5 KB grid-first, citado no charter `Refs`), **não** o `produto-app.jsx` denso. Apontar a comparação para o protótipo certo, ou marcar `divergence_from_blueprint` se o protótipo grid não for mantido. _(alvo não resolve no repo — proveniência não determinada)_
