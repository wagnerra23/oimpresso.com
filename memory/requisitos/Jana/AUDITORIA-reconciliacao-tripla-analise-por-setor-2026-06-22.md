...
> **Escopo código:** `memory/reference/prototipo-ui/PROTOCOL.md`, `prototipo-ui/cowork/Wagner/legado/`, `memory/requisitos/**/*-visual-comparison.md`, `resources/js/Pages/Produto/`, `scripts/design/audit/`, `*.charter.md`
...
2. **Corrigir o protótipo de referência**: o blueprint da tela LITE é `ui_kits/cowork-2026-05-09/prod-page.jsx` (6.5 KB grid-first, citado no charter `Refs`), **não** o `produto-app.jsx` denso. Apontar a comparação para o protótipo certo, ou marcar `divergence_from_blueprint` se o protótipo grid não for mantido. _(removido em 2026-05-20, 4fad2f11f60)_
