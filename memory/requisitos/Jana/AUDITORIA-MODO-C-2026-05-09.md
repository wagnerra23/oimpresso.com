...
2. **`Dashboard.tsx:54-70`** — `calcularFarol` assume trajetória linear hardcoded; meta sazonal (faturamento Dezembro) vai acender vermelho injustamente. RUNBOOK-dashboard.md já documenta como pegadinha mas não foi resolvido. Severidade: a meta `R$ 5MM/ano` usa esse cálculo.
