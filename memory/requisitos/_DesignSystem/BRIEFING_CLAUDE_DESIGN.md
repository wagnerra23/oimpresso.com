...
morreu_porque: "Corpo de abr/2026 propõe accent azul 220° + sidebar dark — canon hoje é roxo oklch(0.55 0.15 295) (ADR 0235) + sidebar LIGHT (UI-0009/0014). Histórico negativo: NÃO copiar paleta/sidebar daqui. (Onda 2 inspeção 2026-06-06) ERRATA 2026-08-28: a parte SIDEBAR desta lápide estava errada — dizia canon LIGHT (UI-0009/0014), mas a UI-0023 (2026-07-16) fixou sidebar PRETA/dark-fixo e declarou UI-0009/0014/0019 erradas. O sidebar dark que o corpo propunha estava CERTO; a paleta (accent 220) segue morta. Corrigida em 2026-08-28. ERRATA 2026-09-09: some-se um terceiro eixo morto, o de ARQUITETURA — o corpo pede TaskProvider stub em 3 pontos, e esse contrato (Fase 4 da ADR 0039) nunca foi construído (medido: viewerComponent = 0 linhas em app/ Modules/ resources/, controle positivo AppShellV2 = 334 arquivos). Ver item 6 do bloco CANON ATUAL."
...
> 3. ~~**Sidebar = LIGHT** por padrão (UI-0009 + UI-0014). Onde o corpo disser "sidebar dark", está **revogado** — não escurecer.~~ **ERRATA 2026-08-28: INVERTIDO.** A sidebar é **PRETA (dark-fixo) nos dois modos** ([UI-0023](adr/ui/0023-sidebar-dark-fixo-preto-definitivo-supersede-0019.md), 2026-07-16). Onde o corpo disser "sidebar dark", está **CORRETO**. Este item era instrução ativa pra regressão.
...
> 6. **ERRATA 2026-09-09 — `TaskProvider` NUNCA foi construído.** O corpo abaixo pede em três pontos (`§ Manual de Migração` item 5, o template da `§2`, e o checklist do fim) que cada módulo entregue um **"TaskProvider stub"**. Esse contrato é a **Fase 4 da [ADR 0039](../../decisions/0039-ui-chat-cockpit-padrao.md)**, que segue **⏳ pendente** — ela nunca saiu do papel. Medido em 2026-09-09 contra `origin/main`: `viewerComponent` (o método do contrato) devolve **0 linhas** em `app/ Modules/ resources/`, e `resources/js/Components/Viewers/` tem **0 arquivos** — com `AppShellV2` devolvendo **334 arquivos** nos mesmos paths como controle positivo, provando que a varredura enxerga ali. **Não peça, não gere e não preencha "TaskProvider stub"**: é receita pra um mecanismo inexistente. ⚠️ Não confundir com `Modules/Jana/Services/TaskRegistry/`, que **existe** e é o registry de tasks do MCP ([ADR 0070](../../decisions/0070-jira-style-task-management-current-md-removed.md)) — nome igual, propósito outro.
