...
> **Protótipo visual:** `prototipo-ui/prototipos/pageheader-canon-v3/` (removido em 2026-06-23, 9da73296d34)
...
<PageHeader
  ...
  kpis={[
    ...
    { label: 'Com saldo', value: 2, hint: 'R$ [redacted Tier 0]', alert: true },
...
| **v3.4** | **2026-05-25** | **Paridade /sells: fundo `bg-page-cream` (warm hue 90) · BLOCO 1 transparente herda cream · linha warm `oklch(0.93 0.004 90)` entre BLOCO 1↔2 · border cards KPI warm `oklch(0.9 0.004 90)` · CNPJ coluna `w-44` + `whitespace-nowrap`** | LEARNINGS Decisão #6 + PRs [#1485](https://github.com/wagnerra23/oimpresso.com/pull/1485), [#1486](https://github.com/wagnerra23/oimpresso.com/pull/1486), [#1487](https://github.com/wagnerra23/oimpresso.com/pull/1487) |
| **v3.5** | **2026-05-25** | **Toolbar header BLOCO 3 transparente (espelha `/sells .vd-tabs-row`) · busca à direita com `ml-auto` · filtros à esquerda · linha warm `oklch(0.93 0.004 90)` divisora tabela** | LEARNINGS Decisão #7 + PR [#1488](https://github.com/wagnerra23/oimpresso.com/pull/1488) |
