...
- [ ] **Linha morta de fonte no kit DS v6** (baixa gravidade — o kit está certo) — `prototipo-ui/cowork/Wagner/legado/ds-v6/tokens.css:98` declara `--sans: "Hanken Grotesk"` / `--mono: "JetBrains Mono"`, fontes que **nunca entraram no repo** (zero ocorrências fora dessa linha). Mas o resto do kit **já usa IBM Plex**: as 3 páginas (`receita.html`, `showcase.html`, `gabarito-vendas.html`) carregavam IBM Plex Sans/Mono, o [`README` do kit](../../../prototipo-ui/_arquivo/ds/ds-v6-README.md) declara IBM Plex, e a linha 245 do **próprio** `tokens.css` re-aponta `--sans: var(--font-sans)`. Ou seja: **resíduo de uma linha**, não divergência de projeto. Como o kit é export do Cowork ([regra de ouro](../../../memory/reference/prototipo-ui/README.md#regra-de-ouro)), a limpeza é lá e re-exporta; registrado em [`CODE_NOTES.md`](../../../memory/reference/prototipo-ui/CODE_NOTES.md) 2026-08-11. _(Emenda 2026-09-11: na faxina do DS, o kit `prototipo-ui/cowork/Wagner/legado/ds-v6/` saiu da árvore ativa — `README`/`REUSE_MAPPING`/`COMPARISON` foram pra `_arquivo/ds/`, e `receita`/`showcase` apagados. Sobrevivem no espelho `prototipo-ui/cowork/Wagner/legado/ds-v6/`: `tokens.css` (com a linha residual descrita acima, **intacta**) e `gabarito-vendas.html`. O resíduo segue sendo limpeza do lado Cowork.)_ _(Errata 2026-09-15: a frase "Sobrevivem no espelho" CADUCOU — `tokens.css` foi removido em 2026-09-11, d86c977a8dd, e `gabarito-vendas.html` junto; o `ds-v6-README` removido em 2026-09-11, 4f51a9ec781, depois da emenda acima. A limpeza do lado Cowork deixou de ser pendencia.)_
