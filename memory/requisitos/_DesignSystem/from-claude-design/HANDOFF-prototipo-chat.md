...
### Médio prazo — Fase 3 (Clientes, Orçamentos, Produtos)
6. **Página Clientes** — listagem (reutilizar pattern da OS) + drawer detalhe com histórico de OS, financeiro resumido, contatos.
7. **Página Orçamentos** — quase igual à OS mas com fluxo: rascunho → enviado → aprovado/rejeitado → vira OS.
8. **Página Produtos (catálogo)** — grid de cards com preço/unidade/categoria, drawer com insumos e markup.
