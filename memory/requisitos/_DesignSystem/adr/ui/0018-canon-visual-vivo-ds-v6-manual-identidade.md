...
- **Link quebrado em UI-0010** (aponta `ui_kits/cowork-2026-04-27/` que foi renomeada pra _(nunca versionado no repo — artefato externo do Cowork; medido no histórico completo: 0 commits)_
