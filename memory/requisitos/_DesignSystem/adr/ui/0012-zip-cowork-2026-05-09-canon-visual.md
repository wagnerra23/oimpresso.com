...
| **`vendas-page.jsx` + `vendas-extras.jsx`** ⭐ NOVO | **Sells/Create + Sells/Index** | P0 — pino F1 em [`sells-create/`](../../../../../prototipo-ui/prototipos/sells-create/) | _(removido em 2026-09-11, 4f51a9ec781)_
...
**P0:**
1. **Sells/Create** + **Sells/Index** — `vendas-page.jsx` + `vendas-extras.jsx` referência. Pino F1 em [`sells-create/`](../../../../../prototipo-ui/prototipos/sells-create/) (deste PR). Wagner abre F0 em `COWORK_NOTES.md`. _(removido em 2026-09-11, 4f51a9ec781)_
...
4. **Financeiro/{Fluxo,PlanoContas,DRE,Conciliacao}** — pinos F1 em `prototipo-ui/prototipos/financeiro-*/`. Bloqueados em backend (ver READMEs). _(removido em 2026-09-11, 4f51a9ec781)_
