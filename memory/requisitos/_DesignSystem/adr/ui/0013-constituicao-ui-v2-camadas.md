...
- **Refs**:
  ...
  - [memory/reference/prototipo-ui/PROTOCOL.md](../../../../memory/reference/prototipo-ui/PROTOCOL.md) _(removido em 2026-06-08, c3abe6ea51c)_
...
O oimpresso JÁ tem peças mais maduras em algumas dimensões (loop Design↔Code formalizado em [PROTOCOL.md](../../../../memory/reference/prototipo-ui/PROTOCOL.md), CI Module Grades v4, MCP tools), mas **falta a hierarquia formal das 4 camadas** que torna pedido determinístico sem leitura de 12 ADRs. _(removido em 2026-06-08, c3abe6ea51c)_
