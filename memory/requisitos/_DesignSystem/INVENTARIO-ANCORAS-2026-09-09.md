...
1. **A claim de ausência vale para o shell, não para o Cowork vivo.** O
   ...
   **inconclusiva sobre o vivo**.
   ...
   > ferramenta, 1 `.napkin`).
   >
   > Os **13 `.md`** desceram para `prototipo-ui/design-docs/cowork-inbox/` — pelo _(path removido em 2026-09-11, 4f51a9ec781 — a árvore vive em `prototipo-ui/cowork/Wagner/cowork-inbox/`: 320 dos 323 blobs idênticos)_
