...
const OS_LIST = [
  { id:"4821", client:"Acme Comércio Ltda", contact:"Camila Diniz", product:"Banner Lona 440g — 3×2m", qty:1, value:"R$ [redacted Tier 0]", stage:"aprovacao", deadline:"hoje 14:00", urgent:true,  responsible:"Joana Lima",  team:"Arte", created:"21/04 09:14", updated:"hoje 13:55" },
  { id:"4820", client:"TechPro Equipamentos", contact:"Diego Vasconcellos", product:"Adesivos recortados 8×8cm — 200un", qty:200, value:"R$ [redacted Tier 0]", stage:"acabamento", deadline:"hoje 17:00", urgent:true, responsible:"Felipe Acab.", team:"Produção", created:"19/04", updated:"hoje 11:02" },
  { id:"4819", client:"Padaria Estrela", contact:"Renato Lopes", product:"Cardápios A4 frente e verso — 50un", qty:50, value:"R$ [redacted Tier 0]", stage:"expedicao", deadline:"amanhã 09:00", urgent:false, responsible:"Mateus PCP", team:"Expedição", created:"18/04", updated:"ontem 16:20" },
  { id:"4818", client:"Posto BR Centro", contact:"Marcos Vinícius", product:"Lona Front-Light — 5×3m", qty:1, value:"R$ [redacted Tier 0]", stage:"aprovacao", deadline:"qui 11:00", urgent:false, responsible:"Joana Lima", team:"Arte", created:"17/04", updated:"hoje 09:30" },
  { id:"4817", client:"Clínica Vida", contact:"Marcos Saraiva", product:"Placas de sinalização — 12un", qty:12, value:"R$ [redacted Tier 0]", stage:"producao", deadline:"sex 16:00", urgent:false, responsible:"Carla Souza", team:"Produção", created:"16/04", updated:"hoje 08:42" },
  { id:"4816", client:"Mercado União", contact:"João Inst.", product:"Fachada ACM 6×2m + instalação", qty:1, value:"R$ [redacted Tier 0]", stage:"orcado", deadline:"prox semana", urgent:false, responsible:"Bruna Vendas", team:"Comercial", created:"15/04", updated:"15/04" },
  { id:"4815", client:"Escola Aurora", contact:"Pedagógico", product:"Banners faixas 1×3m — 6un", qty:6, value:"R$ [redacted Tier 0]", stage:"entregue", deadline:"entregue ontem", urgent:false, responsible:"Mateus PCP", team:"Expedição", created:"10/04", updated:"ontem 17:50" },
  { id:"4814", client:"Auto Posto Vale", contact:"Sandro", product:"Adesivo bomba — 8un", qty:8, value:"R$ [redacted Tier 0]", stage:"entregue", deadline:"entregue 20/04", urgent:false, responsible:"Felipe Acab.", team:"Expedição", created:"08/04", updated:"20/04" },
  { id:"4813", client:"Acme Comércio Ltda", contact:"Camila Diniz", product:"Cartões de visita 4/4 — 1000un", qty:1000, value:"R$ [redacted Tier 0]", stage:"producao", deadline:"qua 10:00", urgent:false, responsible:"Carla Souza", team:"Produção", created:"15/04", updated:"hoje 07:14" },
  { id:"4812", client:"Restaurante Tomate", contact:"Helena", product:"Cardápio plastificado A3 — 20un", qty:20, value:"R$ [redacted Tier 0]", stage:"acabamento", deadline:"sex 12:00", urgent:false, responsible:"Felipe Acab.", team:"Produção", created:"14/04", updated:"hoje 10:18" },
  { id:"4811", client:"Studio Foto Click", contact:"Beto", product:"Backdrop tecido 3×2,5m", qty:1, value:"R$ [redacted Tier 0]", stage:"aprovacao", deadline:"atrasada 1d", urgent:true, responsible:"Joana Lima", team:"Arte", created:"12/04", updated:"21/04 11:00" },
  { id:"4810", client:"Pet Shop Amigo", contact:"Telma", product:"Placa fachada PVC + iluminação", qty:1, value:"R$ [redacted Tier 0]", stage:"orcado", deadline:"aprovação cliente", urgent:false, responsible:"Bruna Vendas", team:"Comercial", created:"11/04", updated:"19/04" },
  { id:"4809", client:"Imobiliária Norte", contact:"Diretoria", product:"Fachada ACM 4×1,5m", qty:1, value:"R$ [redacted Tier 0]", stage:"producao", deadline:"qui 18:00", urgent:false, responsible:"Carla Souza", team:"Produção", created:"10/04", updated:"hoje 09:00" },
  { id:"4808", client:"Padaria Estrela", contact:"Renato Lopes", product:"Adesivos vitrine — 4 peças", qty:4, value:"R$ [redacted Tier 0]", stage:"rascunho", deadline:"—", urgent:false, responsible:"Bruna Vendas", team:"Comercial", created:"hoje 08:00", updated:"hoje 08:00" },
  { id:"4807", client:"Clínica Vida", contact:"Marcos Saraiva", product:"Adesivos perfurados janela — 3m²", qty:1, value:"R$ [redacted Tier 0]", stage:"cancelado", deadline:"cancelada 18/04", urgent:false, responsible:"Joana Lima", team:"Arte", created:"05/04", updated:"18/04" },
  { id:"4806", client:"Auto Center Júnior", contact:"Junior", product:"Faixa lateral veicular — 2 carros", qty:2, value:"R$ [redacted Tier 0]", stage:"acabamento", deadline:"ter 14:00", urgent:false, responsible:"Felipe Acab.", team:"Produção", created:"09/04", updated:"hoje 13:20" },
  { id:"4805", client:"Buffet Família", contact:"Luana", product:"Painel cenário 2×2m", qty:1, value:"R$ [redacted Tier 0]", stage:"expedicao", deadline:"hoje 18:00", urgent:false, responsible:"Mateus PCP", team:"Expedição", created:"15/04", updated:"hoje 14:00" },
  { id:"4804", client:"Academia Pulse", contact:"Ricardo", product:"Lona perfurada fachada 8×3m", qty:1, value:"R$ [redacted Tier 0]", stage:"producao", deadline:"sex 09:00", urgent:false, responsible:"Carla Souza", team:"Produção", created:"08/04", updated:"hoje 11:50" },
  { id:"4803", client:"Mercado União", contact:"Compras", product:"Etiquetas térmicas 50×30 — 20mil", qty:20000, value:"R$ [redacted Tier 0]", stage:"entregue", deadline:"entregue 19/04", urgent:false, responsible:"Mateus PCP", team:"Expedição", created:"02/04", updated:"19/04" },
  { id:"4802", client:"Loja Bombom", contact:"Dani", product:"Sacolas personalizadas — 500un", qty:500, value:"R$ [redacted Tier 0]", stage:"orcado", deadline:"aguardando", urgent:false, responsible:"Bruna Vendas", team:"Comercial", created:"03/04", updated:"15/04" },
];
