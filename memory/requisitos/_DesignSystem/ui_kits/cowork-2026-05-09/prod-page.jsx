  ...
  return (
    <>
      ...
      <div className="os-stats">
        <div className="os-stat"><b>{stats.total}</b><small>Total</small></div>
        <div className="os-stat"><b className="ok">{stats.ativos}</b><small>Ativos</small></div>
        <div className="os-stat"><b>{stats.cats}</b><small>Categorias</small></div>
        <div className="os-stat"><b>{stats.topPop}</b><small>Populares</small></div>
      </div>
