...
const MENU = [
  ...
  { id: "chat",       icon: "chat",    label: "Chat",           badge: 3 },

  // Officeimpresso (módulo principal)
  ...
  { group: "OUTROS", items: [
    ...
    { id: "copiloto", icon: "help",    label: "Copiloto" },
    { id: "site",     icon: "folder",  label: "Site" },
...
window.MOCK = { COMPANIES, MENU, CONV, ROUTINES, TASKS, ORIGIN_COLORS };
