...
- [ ] Sidebar continua **PRETA (dark-fixo) nos dois modos** ([UI-0023](adr/ui/0023-sidebar-dark-fixo-preto-definitivo-supersede-0019.md)) - não clareou. ~~O item antigo pedia o inverso ("não virou light se ADR-0009 vigente"); a UI-0009 caiu em 2026-08-28~~
...
- [ ] Smoke test em https://oimpresso.com - **biz=1**. ~~Dizia "biz=4 ROTA LIVRE Larissa"~~, que a [ADR 0358](../../decisions/0358-doutrina-de-teste-tenant-98-supersede-0101.md) e a R6 do `proibicoes.md` proíbem **sem exceção** em teste/smoke/exemplo (corrigido 2026-08-28)
