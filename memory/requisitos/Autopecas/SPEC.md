...
| GMV anual | R$ 500k – R$ 10M (Vargas R$ 7,9M está no topo da faixa) |
...
| TAM | ~30-40k autopeças formais BR (Sindipeças); R$ 70bi/ano mercado reposição autopeças BR |
...
4. Cliente decide qualidade vs preço (original Bosch R$ 280 vs similar Nakata R$ 180)
...
- **Vargas** — saudável OfficeImpresso (Delphi versão 1468), R$ 7,9M GMV/ano, 26 anos relação Wagner-Vargas
- **Razão social provável:** "Vargas Acessorios" (CNAE 4530-X autopeças/comércio peças)
- **Sinal qualificado:** ✅ paga R$ 600-850/m WR Sistemas (estimativa) + ✅ Wagner reporta direto + 🟡 build desatualizado (sinal churn latente — janela ação)
- **Risco:** maior cliente legacy, perder = -R$ 850/m + racha narrativa "26 anos relação"
- **Estratégia:** outreach Wagner direto, presencial/Zoom 60min, pacote pioneer Enterprise R$ 1.499/m grandfathered + 50% off 6m + setup R$ 0
...
### 4.2 Lokoz
- Pricing R$ 199-499/m (estimativa)
...
|---|---|---|---|
| **Auto Starter** | **R$ 299/m** | 1 loja, 1-2 balconistas, 100 NFC-e/m, balcão básico, NFe-boleto auto, Jana 200 perguntas/m | A confirmar contra entry tiers |
| **Auto Pro** | **R$ 599/m** | 1 loja, 3-6 balconistas, NFC-e ilim, 5 users, crediário, devolução+garantia, Jana 1000 p/m, WhatsApp Cloud API básico | A confirmar contra mid tiers |
| **Auto Enterprise** | **R$ 1.499/m** | Multi-loja (até 5), users ilim, todas features, Jana ilim+memória dedicada, SLA telefônico, success dedicado, Migration Factory | **Vargas pioneer grandfathered 24m + 50% off 6m → R$ 749/m × 6m → R$ 1.499/m × 18m** |
| **Setup** | **R$ 0 default** (pioneer) / **R$ 2.500-5.000** (Migration Factory regular) | — | Pioneer setup R$ 0 só primeiros 2 clientes |
| **Trial** | **14 dias** sem cartão | — | Padrão |
| **Anual** | **12 paga 10** | — | Padrão |

**Calibração necessária:** research Q4/26 confirma se R$ 299 starter / R$ 599 pro / R$ 1.499 enterprise estão alinhados Auto Manager / Lokoz / Linx Microvix mid-market. Provável ajuste pra R$ 199/399/999 se concorrentes mais agressivos.
...
1. **Vargas assina contrato pioneer** (Cenário A — preferido):
   - Contrato Enterprise R$ 1.499/m grandfathered 24m + 50% off 6m + setup R$ 0 escrito assinado
...
**Convergência [ADR 0022](../../decisions/0022-meta-5mi-ano-financeira.md):** Modules/Autopecas contribui R$ 90-180k ARR de R$ 5M total (1.8-3.6% no M12 pós-ativação). Multi-vertical é tese — autopeças é diversificação Vargas-driven, não substituição.
...
9. ❌ **Cobrar setup R$ 5.000 de Vargas** — pioneer R$ 0. Setup regular só pra clientes 3+ pós-piloto
...
- [ ] Pricing tier final — research Q4/26 confirma R$ 299/599/1499 ou ajusta R$ 199/399/999
