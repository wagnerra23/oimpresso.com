...
| Pages | `Modules/Forja/Resources/js/Pages/Forja/Triage/Index.tsx` + `Inbox/Index.tsx` (+ `.charter.md` + `.review.md`) | igual `Board/Index.tsx`, `MyWork/Index.tsx` |
...
- UI existente a reusar: `Modules/Forja/Resources/js/Pages/Forja/{Board,Backlog,MyWork,Roadmap,Burndown,Activity}/Index.tsx`.
