...
Cliente paga **base pelo núcleo** (ex: Pro R$ 299/m) + **add-on por módulo vertical** (ex: +R$ 99-199/m). Cliente paga proporcional ao que usa. ROTA LIVRE valida hoje: paga R$ 850/m que cobre núcleo + Modules/Vestuario completo.
...
2. **piloto** — 1 cliente real pagando (R$ 99-499/m base)
...
- ❌ rejeitado: perde diferencial vertical, briga preço com Bling (R$ 200/m) impossível com qualidade que oimpresso entrega
...
- **36 meses**: 10 módulos, ARR R$ 5M atingido principalmente via diversificação modular
