...
number: 232
title: "Modelo de Peso Real — classificar memórias, decisões e iniciativas por contribuição à meta (R$5M/ano)"
type: adr
status: proposto
authority: canonical
lifecycle: ativo
...
Adotar o **Peso Real** — uma fórmula-mãe, três sabores (cada tipo tem natureza temporal diferente, mas tudo aponta pra R$5M):

```
PESO_REAL = relevancia_meta(0-100) × modulador_do_tipo
relevancia_meta = quanto o item move/protege R$5M/ano
...
|---|---|---|---|
| ADR 0022 (meta R$5M) | decisão | 100 | **100** |
