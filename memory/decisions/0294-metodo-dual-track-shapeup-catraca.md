---
slug: 0294-metodo-dual-track-shapeup-catraca
number: 294
...
# ADR 0294 — Método de planejamento: dual-track + Shape Up travado por catraca

> Aceito por Wagner 2026-06-20. Originou-se da proposal `2026-06-20-metodo-dual-track-shapeup-catraca` (removida nesta aceitação). Conferida por workflow adversário (`adversario-governanca-planos`, 26 agentes, veredito go-with-fixes — 15 defeitos corrigidos) + CI 100% verde no PR #3064.
...
- **Onda 0 (feita 2026-06-20):** [PLANS-INDEX](../requisitos/_processo/PLANS-INDEX.md) criado; convenção `## Status vivo` definida; esta ADR aceita (PR #3064).
...
- **Onda 3:** retrofit do `## Status vivo` nos 15 planos existentes (status + `reviewed_at`) + triagem dos 3 "revisar".
