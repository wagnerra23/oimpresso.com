...
|---|---|
| "Quanto vendi?" (bruto) | R$ [redacted Tier 0] ✅ correto |
| "Faturamento líquido" | R$ [redacted Tier 0] ❌ deveria descontar devoluções |
| "Quanto entrou no caixa?" | R$ [redacted Tier 0] ❌ deveria mostrar pagamentos recebidos |
...
FATURAMENTO ÚLTIMOS 90 DIAS (3 ângulos por mês):
  ...
  2026-03: bruto R$ [redacted Tier 0] · líquido R$ [redacted Tier 0] · caixa R$ [redacted Tier 0]
```
...
3. ✅ **Larissa testou 3 perguntas em prod** → 3 respostas distintas e corretas:
   ...
   |---|---|---|---|
   | 09:06 | "Quanto vendi?" | **R$ [redacted Tier 0]** (bruto somando 4 meses) | ✅ Bonus: LLM fez aritmética dos 4 valores corretamente |
   | 09:09 | "Quanto entrou no caixa?" | R$ [redacted Tier 0] | ❌ cache `ContextSnapshotService` ainda velho (TTL 10 min) |
   | 09:24 | "Faturamento líquido" | R$ [redacted Tier 0] | ✅ correto pra abril (sem devoluções no mês, bruto=líquido) |
   | 09:24 | "Quanto entrou no caixa?" | **R$ [redacted Tier 0]** | ✅ caixa ≠ bruto, exatamente o gap que MEM-FAT-1 fechou |
   | 09:25 | "Quanto vendi?" (mês corrente) | R$ [redacted Tier 0] (usou termo "bruto") | ✅ |
