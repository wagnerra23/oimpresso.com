...
3. **ComVis 1º piloto ativo demanda multi-papel** — Vargas/Extreme/Gold (depois de ComVis Sprint 1 entregue) pede policy banner R$ [redacted Tier 0] split vendedor+designer+instalador (US-COMM-009 é o gateway)
