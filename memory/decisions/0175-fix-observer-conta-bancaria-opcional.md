...
**Consequência não-prevista**: por **12 dias** (2026-05-08 → 2026-05-20) Larissa lançou 15.932 pagamentos via Sells, todos silenciados, ZERO baixas em `fin_titulo_baixas`. Tela `/financeiro/contas-receber` mostrava R$ 12k a receber em vez de R$ 418k real (drift 35x).
