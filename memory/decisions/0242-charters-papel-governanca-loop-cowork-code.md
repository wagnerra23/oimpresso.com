...
dossier: memory/reference/prototipo-ui/CHARTER_GOVERNANCA_W.md
---
...
- **ADR 0114** + `memory/reference/prototipo-ui/PROTOCOL.md` — o loop em 6 papéis × 7 fases.
...
- `memory/reference/prototipo-ui/PROTOCOL.md` §2 (overlay autônomo) · §10.2 (retorno) · §10.4 (gate de validação + Passo 0)
- Charters: [`CHARTER_GOVERNANCA_W.md`](../../memory/reference/prototipo-ui/CHARTER_GOVERNANCA_W.md) · [`CHARTER_CHAMPION_AGENTES.md`](../../memory/reference/prototipo-ui/CHARTER_CHAMPION_AGENTES.md)
