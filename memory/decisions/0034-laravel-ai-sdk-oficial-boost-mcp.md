...
- Permite Wagner conversar via Claude Desktop e perguntar "cria meta de R$ [redacted Tier 0]k pra ROTA LIVRE" → Claude chama MCP server do oimpresso → roda no app real
