...
pii: false
review_triggers:
  - "Vargas assinar contrato Enterprise pioneer (R$ [redacted Tier 0]/m grandfathered) → mover pra ADR de ativação `em_construcao`"
...
Em 2026-05-10, durante revisão do `PLANO-MIGRACAO-6-SAUDAVEIS.md` (Modules/ComunicacaoVisual), Wagner [W] confirmou erro de classificação: **Vargas** (cliente saudável WR Sistemas, R$ [redacted Tier 0]M GMV/ano, 26 anos de relação, build Delphi versão 1468) **não é comunicação visual**. Wagner falou textualmente:
...
|---|---|
| Cliente paga | ✅ ~R$ [redacted Tier 0]-850/m WR Sistemas há 26 anos (estimativa — confirmar via snapshot financeiro) |
...
Vargas não é especulação — é o maior cliente legacy WR Sistemas (R$ [redacted Tier 0]M GMV, 30% do agregado dos 6+1 saudáveis), com vínculo afetivo que Mubisys/Zênite não têm.
...
1. **Vargas assina contrato pioneer** Enterprise R$ [redacted Tier 0]/m grandfathered (24m), com 50% off primeiros 6m + setup R$ [redacted Tier 0]
...
- TAM: 1 cliente, R$ [redacted Tier 0]-850/m sustentando relação 26y
...
- Pricing tier dedicado (a calibrar — provavelmente Pro R$ [redacted Tier 0]/m + Enterprise R$ [redacted Tier 0]/m menores que OficinaAuto por ser mais commodity)
...
- **Mitigação:** outreach Wagner direto, presencial/Zoom 60min (não cold email); pacote pioneer agressivo (setup R$ [redacted Tier 0] + 50% off 6m); Plano B mantém Vargas no OfficeImpresso
...
**Convergência [ADR 0022](0022-meta-5mi-ano-financeira.md):** Modules/Autopecas contribui R$ [redacted Tier 0]-180k ARR de R$ [redacted Tier 0]M total (1.8-3.6% no M12 pós-ativação). Multi-vertical é tese; autopeças é diversificação Vargas-driven.
