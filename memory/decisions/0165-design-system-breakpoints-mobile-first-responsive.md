...
Skill `tela-smoke-pos-merge` (ADR 0164 fase C) hoje captura screenshot 1440 + 1280. Estender pra **3 viewports padrão**: **375 / 1024 / 1440** (cobre os 3 buckets críticos: mobile, lg target, Larissa atual). Se time MCP entrar e custo browser MCP virar pain (R$10/mês), reduzir pra 2 (mobile + lg).
...
2. **CI Playwright 1.5x mais lento** (3 viewports vs 2) — custo estimado R$3-5/mês browser MCP adicional
