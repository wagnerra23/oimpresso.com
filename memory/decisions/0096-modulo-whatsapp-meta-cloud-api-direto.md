...
1. **Custo 30× menor** no perfil real (50-200 conv/mês ROTA LIVRE). Take Blip R$ 1.500/mês fixo justifica em ~5k conv/mês ou compliance enterprise — não é nosso caso hoje.
...
- Repair finalmente cumpre ADR tech/0001 sem custo de SMS (R$ 0,07 vs R$ 0,30+ SMS).
