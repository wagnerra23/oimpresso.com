...
5. **R$ [redacted Tier 0]/mês cabível** — entra no plano Pro do oimpresso (R$ [redacted Tier 0]/mês) sem comer margem.
...
4. **Custo previsível** — R$ [redacted Tier 0]/mês Z-API enquanto Meta Cloud é aprovado.
...
5. **Ganho marginal não compensa stakes.** R$ [redacted Tier 0]/mês Z-API economizados não justificam o aumento de superfície operacional pro oimpresso.
...
6. **Pricing Pro R$ [redacted Tier 0]/mês inclui suporte Wagner-mediado** se ban acontecer (ele ajuda re-onboarding).
