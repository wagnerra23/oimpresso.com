...
number: 44
title: "Vaultwarden self-hosted como cofre de credenciais"
type: adr
status: aceito
authority: canonical
lifecycle: ativo
...
| **1Password Teams** | UX excelente mas ~R$ [redacted Tier 0]/mês p/ 5 usuários. Não justifica pra esse porte. |
