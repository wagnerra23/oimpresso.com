...
>
> **Budget previsto Wagner:** R$ 5–15k counsel one-time (validação + ajustes regionais) + R$ 3–5k/mês DPO (interno ou retainer externo).
...
- **LGPD — sanções ANPD** (art. 52): advertência, multa simples até 2% do faturamento (limitado a R$ 50 mi por infração), publicização, bloqueio/eliminação de dados, suspensão da atividade.
