...
> **Impacto comercial:** `alto` (libera segmento >R$ [redacted Tier 0]k ARR/12m) · `médio` (R$ [redacted Tier 0]-50k ARR/12m) · `baixo` (<R$ [redacted Tier 0]k ARR/12m).
...
| Iugu | fraco (hipótese: clientes com volume >R$ [redacted Tier 0]k/m pedem split mais barato) `[validar]` | 24h | 3-5d | médio | P3 |
| Stripe | médio (1 prospect Calcme tem cliente internacional Shopify) `[validar]` | 32h | 4-7d | médio | P1 |
| Pagar.me (Stone) | fraco (hipótese: gráficas com >R$ [redacted Tier 0]M/ano) `[validar]` | 24h | 3-5d | médio | P3 |
...
**Tese troca de Asaas:** raríssima. Asaas cobra 0.99% PIX + R$ [redacted Tier 0] boleto, taxa competitiva BR. Iugu/Pagar.me só ganham em volume >R$ [redacted Tier 0]M/m com split negociado. Sinal real precisa vir de cliente atual reclamando taxa, não hipótese.
...
| Sankhya | fraco (enterprise pesado, fora target SMB) | 80h+ | semanas | baixo até R$ [redacted Tier 0]k tier | P3 |
...
| **MDF-e** (parte do mesmo emissor TecnoSpeed) | forte (transporte de carga >R$ [redacted Tier 0]k inter-estadual obriga MDF-e) | já dentro do P0 NFSe | — | alto | **P0** (junto NFSe) |
...
**Spec comercial:**
- Custo Meta: ~R$ [redacted Tier 0]-0.30 por conversation (varia por categoria utility/marketing/auth).
...
**Spec comercial:**
- Custo PlugNotas: ~R$ [redacted Tier 0]/NFSe + R$ [redacted Tier 0]/MDF-e (volume).
- Embute em tier Pro+ (R$ [redacted Tier 0]/m), Enterprise (R$ [redacted Tier 0]/m) inclui ilimitado.
...
> - **Custo dev IA-pair:** R$ [redacted Tier 0]/h `[validar — ADR 0106 baseline mid-market BR PJ pleno]`
> - **Conversão prospect→pago após integração desbloqueada:** 30-50% `[validar com 1º deal]`
> - **Receita Enterprise:** R$ [redacted Tier 0]/m + R$ [redacted Tier 0]k setup ([pricing-tiers](../../sales/2026-05/06-pricing-tiers.md))
...
| **Custo dinheiro up-front** | 248h × R$ [redacted Tier 0]/h = **R$ [redacted Tier 0]** |
| **Custo recorrente (Meta WABA + PlugNotas + manutenção)** | ~R$ [redacted Tier 0]-1.200/m por cliente ativo Pro+ — **margem aceitável dentro do tier R$ [redacted Tier 0]/m** |
| **Receita esperada 12m (cenário base 5 contratos Mubisys destravados)** | 5 × (R$ [redacted Tier 0]k setup + 12m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** |
| **Lucro líquido 12m** | R$ [redacted Tier 0] − R$ [redacted Tier 0] − (12m × ~R$ [redacted Tier 0]k recorrente) = **~R$ [redacted Tier 0]** |
| **ROI 12m** | (114.940 − ~80k total custo) / ~80k = **~44%** primeiro ano; cumulativo cresce 200%+ ano 2 |
| **Payback period** | 1 contrato Enterprise (R$ [redacted Tier 0]k setup já paga 25% do dev). **~30-60 dias** |

**Receita marginal por integração:**
- **WhatsApp Biz:** liberta universal — todos clientes/prospects usam. Sem ele, perde 0% mas precariza UX. Marginal: **+R$ [redacted Tier 0]** receita direta, **-50% churn** estimado.
- **NFSe+MDF-e:** liberta segmento gráfica completa — 50% Mubisys-prospects pedem. Marginal: **+R$ [redacted Tier 0]-60k ARR/12m**.
- **Bling sync:** liberta migração híbrida — 30% Mubisys-prospects bloqueiam contrato sem isso. Marginal: **+R$ [redacted Tier 0]-40k ARR/12m**.
- **Conta Azul sync:** liberta contadores — 70% contadores aceitam recomendar oimpresso se sincroniza. Marginal: **+R$ [redacted Tier 0]-30k ARR/12m** indireto via referral.
- **Mercado Livre:** liberta segmento ecommerce gráfica — 20% pipeline. Marginal: **+R$ [redacted Tier 0]-20k ARR/12m**.

**Total marginal P0 12m:** ~R$ [redacted Tier 0]-150k ARR adicional (sensível à conversão real).
...
| R8 | **Custo Meta WABA explode (>R$ [redacted Tier 0]k/cliente/m)** | baixo | médio | Monitorar `whatsapp_message_cost` por cliente, repassar via tier ou cobrar marginal |
...
- [ ] Premissas custo R$ [redacted Tier 0]/h e conversão 30-50% aceitas (ou ajustar)
