...
| Métrica | Valor |
|---|---|
| GMV agregado dos 32 clientes | **R$ [redacted Tier 0] / ano** |
| Receita atual da WR Sistemas com esses 32 | ~R$ [redacted Tier 0]k / ano |
...
- Cliente OfficeImpresso ativo trocando de sistema pagando **R$ [redacted Tier 0]/m** (Martinho Caçambas)
- Cliente saudável já trocou pra Mubisys pagando **R$ [redacted Tier 0]/m** (Gold Comunicação)
...
| 7M+ | 1 | ~7,9M | **Cliente Alpha** — único cliente >R$ [redacted Tier 0]M GMV/ano (saudável) |
| **Total** | **30** | **~39,6M** | (2 clientes não-classificáveis somam diferença pra R$ [redacted Tier 0]M) |

**Concentração:** 6 clientes (banda R$ [redacted Tier 0]M+) detêm **~75% do GMV agregado** dos 32. Pricing flat (R$ [redacted Tier 0]/599/899/1499) ignora essa concentração e deixa 5–10x dinheiro na mesa.
...
- **Preço:** R$ [redacted Tier 0] — gratuito 30 dias
- **% implícito:** 0%
...
### Starter Vertical
- **GMV alvo:** até R$ [redacted Tier 0]k/ano
- **Preço:** R$ [redacted Tier 0]/m fixo
...
- **Cliente exemplo:** "Cliente Mu" (~R$ [redacted Tier 0]k GMV) — borderline; pricing flat captura sem perder
- **Não inclui:** Jana IA Pro, multi-business, API write, customização

### Pro Vertical
- **GMV alvo:** R$ [redacted Tier 0]k – 2M/ano
- **Preço:** R$ [redacted Tier 0]/m fixo
- **% implícito:** 0,4% – 1,4%
...
- **Cliente exemplo:** "Cliente Sigma" (~R$ [redacted Tier 0]M GMV) — fit perfeito; paga 0,6% GMV
- **Upsell:** quando cliente cruza R$ [redacted Tier 0]M GMV (medido por nossas vendas registradas), oferta automática Pro Plus

### Pro Plus Vertical
- **GMV alvo:** R$ [redacted Tier 0]M – 5M/ano
- **Preço:** R$ [redacted Tier 0]/m fixo + créditos Jana IA inclusos
- **% implícito:** 0,4% – 0,9%
...
- **Cliente exemplo:** "Cliente Zeta" (~R$ [redacted Tier 0]M GMV) — fit; paga 0,57% GMV ≈ ticket Mubisys
- **Reposicionamento:** este é o tier "Mubisys-equivalent" do oimpresso

### Enterprise Vertical
- **GMV alvo:** R$ [redacted Tier 0]M – 10M/ano
- **Preço:** R$ [redacted Tier 0] – R$ [redacted Tier 0]/m (negociado por contrato 12–24m)
- **% implícito:** 0,5% – 1,0%
...
- **Cliente exemplo:** "Cliente Beta/Gamma/Delta/Epsilon" (R$ [redacted Tier 0]–6,4M GMV) — todos 4 caem aqui; pricing 0,6–0,9% do GMV deles
...
### Power Vertical
- **GMV alvo:** > R$ [redacted Tier 0]M/ano
- **Preço:** R$ [redacted Tier 0] – R$ [redacted Tier 0]/m + setup R$ [redacted Tier 0]–30k
- **% implícito:** 0,5% – 1,2%
...
- **Cliente exemplo:** "Cliente Alpha" (~R$ [redacted Tier 0]M GMV — único cliente >R$ [redacted Tier 0]M na base atual). Piso da banda; convite voluntário pra Power se ele crescer pra >R$ [redacted Tier 0]M
...
- Receita atual: ~R$ [redacted Tier 0]k/ano
- Risco: cada cliente saudável que sai (Gold já saiu) = perda de R$ [redacted Tier 0]k–15k/ano + sinal de churn pros outros
...
| **Subtotal saudáveis migrados (7 de 8)** | — | — | — | **R$ [redacted Tier 0]/ano** |
| Reativação 6 churned via Pro (R$ [redacted Tier 0] × 12) | — | — | — | **R$ [redacted Tier 0]/ano** |
| 19 clientes em Starter (resto da base) | — | — | — | **R$ [redacted Tier 0]/ano** |
| **TOTAL projetado** | — | — | — | **~R$ [redacted Tier 0]k/ano só dos 32** |

**Plus:** novos prospects via Snapshot Free (lead magnet) — meta 10 novos/ano em Pro = +R$ [redacted Tier 0]k.

**Receita 12m projetada:** **R$ [redacted Tier 0]k (base atual recalibrada) + R$ [redacted Tier 0]k (novos) = ~R$ [redacted Tier 0]k/ano**

> **Nota:** parece menor que R$ [redacted Tier 0]k atual — mas R$ [redacted Tier 0]k inclui receita de TODOS os 32 (incluindo 20 churn que provavelmente vão sair de qualquer jeito). O delta real é: R$ [redacted Tier 0]k SUSTENTÁVEL vs R$ [redacted Tier 0]k FRÁGIL com churn iminente.

### Cenário 3: "Migração agressiva" (todos saudáveis migram em 6m)
- Subtotal saudáveis: R$ [redacted Tier 0]/ano (assumindo Alpha aceita Power R$ [redacted Tier 0]k)
- Churn pool reativado 50%: R$ [redacted Tier 0]/ano
- Novos via lead magnet: R$ [redacted Tier 0]k/ano
- **Total:** ~R$ [redacted Tier 0]k/ano + base flat dos pequenos R$ [redacted Tier 0]k = **R$ [redacted Tier 0]k/ano em 6m + crescimento sustentável**
...
|---|---|---|
| Cliente saudável reage mal a 4–5x preço (ex: Beta paga R$ [redacted Tier 0] hoje, vai pagar R$ [redacted Tier 0]?) | **Alta** | **Grandfather pricing** pros 6 saudáveis atuais por 12m; oferta de upgrade VOLUNTÁRIO com features novas (NFe automática, Jana IA ilimitada, multi-business) que SÓ existem no Enterprise+ |
...
| Concorrentes (Mubisys etc) usarem isso como argumento ("oimpresso aumentou 5x") | Média-baixa | Posicionar como "alinhamento de mercado" — Mubisys já cobra R$ [redacted Tier 0]; Enterprise vertical R$ [redacted Tier 0] entrega 4x mais features (Jana IA + NFe automática + multi-business) |
| Cliente Alpha (R$ [redacted Tier 0]M GMV) considera in-house | Baixa | Power tier negociado por contrato; entregar dev dedicado 40h/ano amortiza custo migração in-house |
| Reduzir base de 32 pra ~12 clientes (concentração) | Alta-aceita | É feature, não bug — 12 clientes pagantes a R$ [redacted Tier 0]k/ano = R$ [redacted Tier 0]k > 32 clientes a R$ [redacted Tier 0]k com churn iminente |
...
- **90d:** 1+ saudável aceita Enterprise (R$ [redacted Tier 0]+/m) → HIPÓTESE VALIDADA
- **180d:** receita média/cliente saudável sobe de ~R$ [redacted Tier 0]/m pra **R$ [redacted Tier 0]+/m** (21x)
- **360d:** receita anual estável ≥R$ [redacted Tier 0]k com base ≤25 clientes (concentração saudável)
