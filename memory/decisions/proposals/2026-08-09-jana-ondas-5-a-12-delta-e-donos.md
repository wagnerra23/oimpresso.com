...
redigido no git** — `Modules/Jana/Resources/views/superadmin/metas.blade.php:13` (path historico — a view foi removida em 2026-09-03, quando a tela virou Inertia `Jana/Plataforma`; era verdade na data deste registro)
