...
| **Investimento R$ caixa** | R$ 30-60k (brand reset, landing nova, anúncios setoriais, presença Encontros Reparadores) | R$ 40-80k (2 brands ativas, marketing dividido) | R$ 50-100k (brand nova "oimpresso Mecânica", setup CNPJ separado opcional, landing dedicada) | R$ 0-5k (manutenção atual) |
| **Receita esperada 12m** | R$ 0-15k MRR (ramp-up zero — primeiros 6m são discovery+entrevista; 6m últimos = 2-3 pilotos pagos R$ 199-399) | R$ 30-50k ARR (com.visual pulled-back: 3 clientes em vez de 4-5; auto 1-2 pilotos) | R$ 5-20k MRR auto + R$ 30-50k ARR com.visual (com.visual desacelera ~25% por atenção dividida Wagner) | **R$ 100k+ ARR** (compromisso roadmap 5 clientes com.visual em 12m) |
| **Receita esperada 24m** | R$ 60-150k ARR (10-25 clientes auto pagando R$ 200-400/m — assumindo CAC sob controle, o que não está validado) | R$ 80-180k ARR (4 com.visual + 6-10 auto) | R$ 80-200k ARR (5-7 com.visual + 6-10 auto separado) | R$ 200k+ ARR (7 com.visual stretch + Mubisys-migration unlock 8-10 clientes) |
...
- **Marketing dividido = CAC dobrado.** 2 landings, 2 SEO playbooks, 2 grupos LinkedIn target, 2 case studies. Com R$ 0-5k marketing budget atual, dividir = ambos morrem.
...
- **Custo organizacional duplo.** Brand nova exige landing, copy, SEO, presença setorial separada (Sebrae auto, Sindirepa, Encontros Reparadores). R$ 50-100k caixa real + 400h wallclock. Sem retorno previsível.
...
- ≥3 oficinas auto fizeram outreach inbound em 90 dias OU 1 oficina aceitou piloto pago R$ 199-399/m por 6 meses (ADR 0105 critério rígido seção 8.4 R30)
...
2. **ROI 12m de C4 (R$ 100k+ ARR) > ROI 12m de C1 (R$ 0-15k MRR ramp-up zero) e > C2 (R$ 30-50k pulled-back) e > C3 (R$ 5-20k auto + 30-50k com.visual desacelerado).** Em 12 meses, ficar focado entrega 2-5x mais ARR que qualquer alternativa.
...
| **1 dono de oficina auto ICP refinado aceitar piloto pago R$ 199-399/m por 6 meses** (critério rígido R30 §8.4) | C3 (Spin-off MVP) — criar SPEC `Modules/Repair` extensão Auto + ADR de pivô | 4 cycles (8 semanas) |
...
**Revisão programada:** **mai/2027 (cycle 46 retro anual)** — re-rodar esta análise com dados reais de 12m de roadmap executado. Se nenhum gatilho disparou e Cenário 4 entregou KPIs (5+ clientes, ARR R$ 100k+), confirmar foco. Se underperform, reabrir tese com novos inputs.
