...
| Período | ARR v1 (com DaaS) | ARR v2 (sem DaaS) | % meta R$ [redacted Tier 0]M |
|---------|------------------:|-------------------:|-------------:|
| Hoje | R$ [redacted Tier 0]k | R$ [redacted Tier 0]k | 10% |
| 12m | R$ [redacted Tier 0]k | R$ [redacted Tier 0]k | 14% |
| 24m | R$ [redacted Tier 0]-2.5M | **R$ [redacted Tier 0]-1.6M** | 20-32% |
| 36m | R$ [redacted Tier 0]-5M | R$ [redacted Tier 0]-3M | 40-60% |
| 48m | — | **R$ [redacted Tier 0]-5M** | 90-100% |
...
1. **🟡 Counsel LGPD externo** (R$ [redacted Tier 0]-15k one-time, escopo MENOR sem Pilar 5) — Eliana faz first-pass nos 3 docs draftados; counsel só second opinion
...
- [ ] Investir R$ [redacted Tier 0]-60k counsel LGPD externo Q3/26 (escopo menor)?
...
| Item | Valor |
|------|------:|
| Counsel one-time (validar 3 docs sem cláusula tier 3) | R$ [redacted Tier 0]-10k |
| DPIA documentada simplificada (sem DaaS externo) | R$ [redacted Tier 0]-5k |
| ~~DPO retainer mensal~~ | ~~R$ [redacted Tier 0]~~ (Eliana operacional informal) |
| Audit anual externa (se quiser, opcional sem DaaS) | R$ [redacted Tier 0]-25k |
| **Total ano 1** | **R$ [redacted Tier 0]-40k** ⭐ vs R$ [redacted Tier 0]-110k v1 |

**Economia: R$ [redacted Tier 0]-70k/ano vs plano original.**
...
**Próximo passo**: Eliana lê os 3 docs jurídicos draftados → counsel externo (boutique R$ [redacted Tier 0]-10k) faz second opinion rápida → começar Sprint 1 schema multi-vertical.
