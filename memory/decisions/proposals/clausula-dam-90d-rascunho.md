...
X.6 Caso o atraso ultrapasse **150 (cento e cinquenta) dias**, a CONTRATADA reembolsará à CONTRATANTE **integralmente o valor de R$ 5.000,00 (cinco mil reais)** referente à taxa de setup, independentemente da rescisão.
...
| Exposição máxima oimpresso (12m) | ~R$ 2.700 (6m × 30% × R$ 1.499) | ~R$ 5.396 (12m × 30%) | ~R$ 8.994 + R$ 5k setup ≈ **R$ 13.994** |
...
6. **Foro de eleição** — sugerir comarca de **Joinville/SC ou São Paulo/SP**? Câmara de arbitragem (CAM-CCBC, CIESP-FIESP) pra contratos > R$ 50k? Custo arbitragem >> contrato ainda — provavelmente foro comum melhor pra ticket Enterprise inicial.
