...
│ R$ 187k                    R$ 850                34 dias     │
│ ↑ acima da média (P62)     P50                  ↑ acima P50  │
│                                                              │
│ Mediana SC com.visual: R$ 165k | P75: R$ 245k | P90: R$ 420k │
│                                                              │
...
- Receita: feature gateia tier "Pro" R$ 199/m → 10 clientes adesão = R$ 23.880/ano
...
│ R$ 510k ± 28%   ← intervalo amplo       │
└─────────────────────────────────────────┘

┌─── Forecast Pro (modelo coletivo) ─────┐
│ R$ 547k ± 9%    ← 3x mais preciso       │
...
**ROI:**
- Pricing: feature "Forecast Pro" R$ 199/m
...
- Receita ano cheio (target 30 clientes Pro): R$ 71.640
...
```
💡 Insight Jana
Outras 5 gráficas do seu porte (R$ 150-200k/m, com.visual SC)
...
Avery DENNISON paga R$ 0,80 por impressão de oferta
em gráfica que comprou ≥R$ 5k em vinil adesivo nos últimos 12m.

Audiência elegível: 18 gráficas (k-anon ≥5 ✅)
Oferta: 15% desconto vinil 651 + frete grátis pedido ≥R$ 3k
...
Vinil 651 com 15% off + frete grátis (pedido ≥R$ 3k)
...
- Receita estimada ano 1 com 3 fornecedores: R$ 80k-120k
...
- Tier "Pro" launch (R$ 199/m) gateando Mecanismos 1+3+4
- 🎯 Marco: 10 clientes Pro, R$ 24k ARR network features
...
- 🎯 Marco: 1 fornecedor pagante (R$ 5k+/m), R$ 100k ARR network features
...
| Custos infra ML CT 100 explodir | MÉDIA | Budget mensal R$ 200 GPU/CPU; alertas em `jana:health-check` |
...
4. **Definir budget** infra ML CT 100 (sugestão: R$ 200/m piloto, escala conforme uso)
5. **Definir tier Pro** R$ 199/m vs incluído em tier topo
