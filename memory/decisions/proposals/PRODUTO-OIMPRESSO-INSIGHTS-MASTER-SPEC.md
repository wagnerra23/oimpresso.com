...
- 5 tiers + Free + Power (R$ 0 → R$ 2.999/m)
- **Sweet spot**: Pro R$ 299 (gráfica média) · Premium R$ 599 (cresce + voice)
...
**Add-ons modulares**: NFSe (R$ 79), Forecast Pro (R$ 149), Lead Intelligence Fornecedores (R$ 8-20k pra fornecedor pagar).

**Insight crítico**: 6 saudáveis hoje pagam R$ 850/m (0,17% GMV deles). Pricing por GMV proposto = **R$ 3-5k/m em Enterprise**. Grandfather 12m + upgrade voluntário com features novas.
...
**ARR fim ano 1 (jun/27)**: R$ 700k-1M (vs R$ 487k atual = +50-100%)
...
**ARR fim ano 2 (jun/28)**: R$ 1,5-2,5M (cenário realista — 30-50% da meta R$ 5M)
...
- **Metabase** self-host CT 100 — BI multi-tenant nativo (substitui R$ 0 vs Looker R$ 2k+/m)
- **PostHog** self-host CT 100 — behavioral analytics (substitui Mixpanel R$ 2k+/m)
...
| Linha | ARR adicional |
|-------|--------------:|
| Upgrade saudáveis (3 viram Enterprise) | R$ 100k |
| Win-back churned (1-2 voltam) | R$ 60k |
| Snapshot Tier 1-3 (10 clientes) | R$ 50k |
| Performance fee (1-2 contratos Recovery) | R$ 50k |
...
1. **Counsel LGPD externo** revisa cláusula contratual + DPA + termo v3 — **gate inegociável** (R$ 5-15k one-time)
2. **DPO formalizado** (interno ou retainer R$ 3-5k/m)
