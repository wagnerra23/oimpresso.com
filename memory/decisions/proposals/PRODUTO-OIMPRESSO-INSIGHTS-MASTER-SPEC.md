...
- Relatórios setoriais ad-hoc (R$ [redacted Tier 0]-50k/relatório)
...
**ARR projetado DaaS 24m realista**: R$ [redacted Tier 0]-400k
...
| DaaS interno (Snapshot+Insights Pro) | R$ [redacted Tier 0]k-400k |
| DaaS externo (API + relatórios) | R$ [redacted Tier 0]k-400k |
| Performance fees | R$ [redacted Tier 0]-300k |
| **Total ano 2 (jun/28)** | **R$ [redacted Tier 0]-2,5M (30-50% meta R$ [redacted Tier 0]M)** |

### Para chegar em R$ [redacted Tier 0]M (ano 3)
- 100+ clientes ERP Pro/Premium = R$ [redacted Tier 0]M
- 50+ Snapshot Tier 3 + 20 Data Partner = R$ [redacted Tier 0]M
- 5+ fintechs + 5 fornecedores + 3 seguradoras = R$ [redacted Tier 0]M
- Relatórios setoriais + ad-hoc = R$ [redacted Tier 0]k
- Performance fees recorrentes = R$ [redacted Tier 0]k
- **Total R$ [redacted Tier 0]M atingível em ~3 anos com network effect maduro**
...
- [ ] OK pra investir R$ [redacted Tier 0]-100k em counsel LGPD + DPO no Q3/26?
