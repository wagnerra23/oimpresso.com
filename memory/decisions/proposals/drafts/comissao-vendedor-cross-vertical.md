...
| Opção | Prós | Contras |
|---|---|---|
| **A — Sempre bruto (`transaction.total_amount`)** | simples, retrocompat UPos exata | vendedor "ganha" sobre taxa marketplace que oimpresso paga — distorção real (pneu R$ [redacted Tier 0] ML taxa R$ [redacted Tier 0] = oimpresso recebe R$ [redacted Tier 0] mas paga 5% × R$ [redacted Tier 0] = R$ [redacted Tier 0]; margem real ~3.5%) |
...
- Tiny: tiers escalonados R$ [redacted Tier 0]-10k/10k-20k/>20k + accelerator sobre excedente meta
