...
- **Tiny ERP** (Olist) líder marketplace BR — 40+ integrações + 100 ecosystem, R$ [redacted Tier 0]-639/m
- **Bling** 300k+ users, 250+ marketplaces, R$ [redacted Tier 0]+/m, bugs sync alto volume reportados
...
| Pricing tier | ✅ "+R$ [redacted Tier 0] → 1 mkt / +R$ [redacted Tier 0] → 3 mkts" | ❌ R$ X+Y+Z somar |
...
Larissa (ROTA LIVRE) ou OfficeImpresso típico SMB faz regime caixa, não competência. Inflar AR com R$ [redacted Tier 0]k "Mercado Pago vai pagar em 60d" distorce DRE + cash flow.
...
- Aprovar pricing tier add-on (R$ [redacted Tier 0] / R$ [redacted Tier 0] / R$ [redacted Tier 0])
...
| ARR módulo (add-on R$/ano) | R$ [redacted Tier 0]-4.8k | R$ [redacted Tier 0]-25k | **R$ [redacted Tier 0]-80k** | <R$ [redacted Tier 0]k = pivotar |
