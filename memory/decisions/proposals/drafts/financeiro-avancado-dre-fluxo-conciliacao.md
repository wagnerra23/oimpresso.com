...
[_ANALISE-FINANCEIRA-CROSS-CLIENTE.md](../../research/clientes-legacy-officeimpresso/_ANALISE-FINANCEIRA-CROSS-CLIENTE.md) (2026-05-11): cliente Martinho (R$ 6,3M receita 12m) tem **R$ 4,8M em inadimplência** (76,7%) — sem dunning automática, migração isolada não agrega ROI.
...
| Permission/license commercial | ⚠ tudo gratuito ou nada | ✅ upsell Pro/Enterprise (R$ 199 Pro inclui Avançado) |
...
- Dunning automática **ataca direto** problema Martinho R$ 4,8M inadimplência (ADR feature wish — 0105 cliente como sinal)
...
4. **Construir só conciliação (sem DRE/projeção/margem):** rejeitada — perde alavanca diferencial; dunning sem DRE não justifica preço Pro R$ 199
