...
**Opção A (1 linha pai):** NFe55 mostra "Kit Bomba VW Gol G6 — 1× — R$ 350" com NCM e CFOP do kit. Simples cliente; perde rastreabilidade fiscal componentes; lote per componente impossível na NFe.
...
**Custo:** R$ 79–199/mês per business + custo API integration + lock-in vendor.
