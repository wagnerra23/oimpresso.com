...
| Preço fechado por serviço | Simples atendente cotar (R$ 200 alinhamento independente de quanto demora) | Não captura serviço complexo realista; mecânico bom rola prejuízo |
...
5. **Cleanup tools US-OFICINA-005 (já no SPEC)** — prioridade P0 emergente que pode comer capacidade pra US-OFICINA-006..010 FSM. Trade-off: cleanup gera receita imediata (R$ 15k+R$400/m piloto) mas atrasa fundação canônica
6. **App PWA fase 4 pode nunca acontecer** se piloto Vargas/Martinho fechar contrato R$ 399/m mas não exigir mobile (mecânicos chefão usa laptop)
