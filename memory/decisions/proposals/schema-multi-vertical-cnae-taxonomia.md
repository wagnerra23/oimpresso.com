...
> Fonte: CNAE 2.3 + análise mercado SaaS BR — focado nos verticais com **>10k empresas ativas** e ticket compatível com oimpresso (R$ [redacted Tier 0]-2k/mês).
...
3. Sistema retorna: "Gráficas SP do seu porte cobram **R$ [redacted Tier 0]/m²** em lona (P50) — você cobra R$ [redacted Tier 0]/m² (P25 do mercado)"
...
2. Larissa (mesmo vertical, sem NFC-e) recebe banner: "Outras gráficas SP estão emitindo NFC-e — economiza R$ [redacted Tier 0]k/mês em ICMS-ST"
