...
Vestuario com 1 PDV + sem ecommerce → Starter R$ [redacted Tier 0]/mo
Vestuario com 5 PDV + ecommerce      → Pro R$ [redacted Tier 0]/mo
ComunicacaoVisual <500 pedidos/mo    → Starter R$ [redacted Tier 0]/mo
ComunicacaoVisual instalação + m²    → Pro R$ [redacted Tier 0]/mo
...
```
Plano sugerido: Pro
R$ [redacted Tier 0]/mo · cancela quando quiser
...
2. **MEI fluxo simplificado** — vale criar tier especial Starter MEI R$ [redacted Tier 0]/mo? (revenue vs complexidade)
