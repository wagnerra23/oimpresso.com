...
**Sinal qualificado** ([ADR 0105](../0105-cliente-como-sinal-guiar-sem-mandar.md)): base OfficeImpresso real (snapshot Firebird multi-cliente) — R$ 17.358.591 em A receber vencidas + R$ 13.445.321 em A pagar vencidas + 132k clientes finais nos bancos. Não é hipótese.
...
1. **Reduz fricção de venda.** Cliente legacy pagando R$ 850/m por OfficeImpresso há 8-12 anos não vai assinar oimpresso R$ 1.499 + setup R$ 5k mesmo com upgrade óbvio. Performance fee remove o "vou pensar" — não tem custo upfront, pagamento atrelado a resultado mensurável.
...
**Limite honesto:** performance fee é arma comercial pra **conversão e expansão**, não substitui ARR. Cliente em performance fee puro é volátil (mês bom = R$ 50k, mês ruim = R$ 0). Modelo ideal: **oimpresso assinatura base + performance fee como camada adicional**.
...
- **Volume A receber vencido:** R$ 1.130.000 (snapshot Firebird)
- **Mix estimado** (sem amostra real, faixa conservadora): 20% curto + 35% médio + 30% longo + 15% perdido
- **Recovery realista 90d** (mix-weighted): R$ 1.130k × (0,20×80% + 0,35×50% + 0,30×25% + 0,15×5%) = **R$ 466k recuperado**
- **Wagner recebe** (mix-weighted %): R$ 466k × ~8.5% blended = **R$ 39.600 em 90d**
- **Gold recebe líquido:** R$ 426k que estava parado.

**Importante:** essa simulação assume mix médio de mercado. Mix real do Gold pode ser pior (concentrado em >180d) — nesse caso recovery realista cai pra R$ 200-300k, Wagner ganha R$ 25-40k. Vale a conversa, não vale 100% upfront.

### ROI 12m se 5 clientes em Recovery Fee

Premissas conservadoras: 5 clientes × ticket médio recovery R$ 600k vencido × 35% recovery realista (mix médio mercado) × 8% blended fee = **R$ 84k/ano marginal Wagner**, R$ 1,05M devolvido pros clientes.
...
2. **Setup R$ 0** — Wagner absorve custo (estimado R$ 2-5k em horas time).
3. **Mensalidade R$ 0 nos primeiros 6 meses** OU mensalidade base reduzida 50% (cliente escolhe).
...
- **Baseline mensal estimado:** R$ 80k receita bruta (perfil saudável OfficeImpresso médio).
- **Incremento esperado pós-migração** (módulos novos: BoletoNFe, ADS, Repair com app Larissa): conservador +15% no 6º mês, +30% no 12º.
- **Share Wagner mês 7-12** (incremento R$ 12k/m × 30%): **R$ 3.600/m × 6m = R$ 21.600**
- **Share Wagner mês 13-24** (incremento R$ 24k/m × 25% — cruza faixa): **R$ 6.000/m × 12m = R$ 72.000**
- **Share Wagner mês 25-30** (incremento R$ 24k/m × 25%): **R$ 6.000/m × 6m = R$ 36.000**
- **Total 24m Wagner:** **R$ 129.600** vs ARR Pro R$ 7.200/24m = **R$ 7.188 normal**.
- Cliente sente: "passei de R$ 850/m OfficeImpresso travado pra crescimento real onde Wagner ganha junto."

### ROI 12m se 3 clientes em Migration Fee

Premissa: 3 clientes em diferentes meses do ano. No 12º mês cumulativo, médio R$ 4k/m × 3 clientes × 6m maduros (já passaram dos 6 meses grátis) = **R$ 72k receita marginal 12m**.

Realista — 12m é janela curta pra modelo B (modelo é 30m completos). 24m completos ~R$ 350-400k pros 3 clientes somados.
...
2. Se prospect fecha contrato pago (Pro R$ 599+ ou Enterprise) e mantém ≥3 meses ativo:
   - **Cliente atual recebe** 3 meses de mensalidade grátis + R$ 500 cash bonus via Asaas.
...
4. Sem limite de indicações por cliente — quem indicar 5 ganha 15 meses grátis + R$ 2.500 cash.
...
>    b) bônus de R$ 500 (quinhentos reais) creditado via PIX ou conta Asaas;
...
### Caso piloto sugerido — base saudável atual (6 clientes pagando R$ 850/m)
...
- **Cenário Wagner futuro (base 30 clientes daqui 12m):** 30 × 8% = ~2,4 indicações/ano que fecham × R$ 12k LTV (Pro 12m × R$ 999 net) = **R$ 28.800 receita marginal/ano**.
- **Custo Wagner por indicação fechada:** 3 meses grátis (R$ 1.797) + R$ 500 cash = **R$ 2.297/aquisição**.
- **CAC marginal:** R$ 2.297 vs CAC orgânico atual estimado R$ 3-5k = **economia 30-50%**.

### ROI 12m se 6 clientes ativam programa (com base ainda pequena)

Premissa: 6 clientes atuais ativam, geram ~0,5 indicações fechadas no ano (base pequena ainda). **R$ 6k receita marginal 12m**. Modelo C é semente — fica forte quando base passa de 30 clientes.
...
|---|---|---|---|
| **Gold-like** (déficit alto + inadimplência alta + GMV R$ 1M+) | A primeiro (recupera caixa) → B depois (incentiva crescimento) | A em mês 1-3, B kick-off mês 4 | R$ 60-90k/cliente |
| **Vargas-like** (saudável, em crescimento, ticket OfficeImpresso R$ 850/m) | B (cliente quer crescer, não recuperar) | B só | R$ 15-30k/cliente em 12m, R$ 100-130k em 30m |
| **TechPress-like** (legacy inativo, base parada, relação esfriada) | A (re-engaja via valor entregue antes de pedir mensalidade) | A em mês 1-6, oferece B só se cliente engajar | R$ 20-40k/cliente |
| **Saudável estável** (paga R$ 850/m, sem crescimento, sem inadimplência) | C como complemento (vira indicador) | mensalidade base + C | R$ 1-3k/ano cash bonus + 3m grátis |
| **Prospect novo via referral** | C lado prospect (entra com 20% off) → migra pra mensalidade cheia mês 13 | C lock-in 12m | R$ 10-12k LTV ano 1 |

**Cenário Wagner — 6 contratos performance fee em 12m (mix realista):**
- 2 Modelo A puro (Gold-like + TechPress-like): R$ 60k + R$ 30k = **R$ 90k**
- 2 Modelo B puro (Vargas-like): R$ 22k × 2 = **R$ 44k** (12m apenas; modelo matura em 30m)
- 1 Modelo A→B combo (Gold-like avançado): **R$ 75k**
- 1 Modelo C (programa referral semente): **R$ 6k**

**Total ROI 12m: R$ 215k receita marginal.** Cumulativo 24m projetado R$ 480-550k (B madura).

> **Honesto:** receita performance é volátil. Mês com 2 recoveries grandes pode fazer R$ 40k; mês seco R$ 3k. Não substitui ARR — complementa. Se Wagner depender disso pra folha, problema operacional sério.
...
| 6m | Recoveries efetivos (Modelo A) | ≥R$ 200k devolvido pros clientes | <R$ 50k (régua não funciona — recalibrar IA) |
| 6m | Receita marginal Wagner cumulativa | ≥R$ 50k | <R$ 15k |
...
| 12m | Receita marginal Wagner cumulativa | ≥R$ 150k | <R$ 60k |
...
2. Escolher cliente piloto Modelo A — sugestão: Gold Comunicação (sinal mais forte: R$ 1,13M parado).
