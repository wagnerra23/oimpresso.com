...
Reusar `Modules/Repair` economiza **~70 dias** ≈ **R$ [redacted Tier 0]k em custo dev**
(@ ~R$ [redacted Tier 0]k/dia mid-level).
...
2. **Gatilho pra MVP-12 (10 dias Felipe + canary):**
   - 1 oficina paga R$ [redacted Tier 0]-800/mês de mensalidade upfront 3 meses
...
- **Suporte 2 verticais com 5 pessoas = capacidade limitada.** Mitigação:
  focar 1 vertical até R$ [redacted Tier 0]-3M ARR (1 vertical comprovado > 2 mornos).
