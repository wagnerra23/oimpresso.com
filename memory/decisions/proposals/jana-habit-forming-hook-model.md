...
─────────────    ───────────────     ─────────────────────    ──────────────────
Push 8h sexta    1-tap "ver mais"    "achei R$ 12k margem"    Meta cadastrada
...
- **Mockup (WhatsApp 8h sex):**
  ...
  > Faturamento R$ 87.4k (+12% vs semana passada)
  > 1 alerta: cliente Y atrasou R$ 4.2k há 5d
...
- **Mockup (WhatsApp tempo real):**
  > "Larissa, cliente Tinta Forte vence hoje R$ 4.2k e não pagou.
...
- **Mockup:** cliente dirigindo às 7h: "Jana, quanto fechei essa semana?" → resposta áudio 8s "Você fechou R$ 87k, 12% acima da semana passada, com 1 cliente atrasado de R$ 4k".
...
- **Mockup (push qua 17h):**
  > "Achei R$ 12.3k em margem que você está deixando na mesa: lonas 3x4 estão saindo 18% abaixo do mercado.
...
- **Métrica:** % achados que viram ação (ajuste/justificativa) > 35%; receita incremental atribuída a achado > R$ 5k/m por cliente médio
...
- **Mockup:**
  > "Você está acima da média do setor de comunicação visual em ticket médio (R$ 870 vs R$ 640) mas abaixo em recompra 90d (28% vs 41%).
...
- **Mockup (cliente cadastra meta R$ 100k/mês no início):**
  > Push dia 20: "Larissa, faltam R$ 23k pra bater R$ 100k. Em ritmo atual: 87% (R$ 87k projetado). 3 caminhos possíveis: [..]"
...
- **Mockup (WhatsApp Voice 18h):**
  > Áudio 20s: "Bom fim de tarde. Hoje você faturou R$ 12k, gastou R$ 4k, ficou R$ 8k positivo. 1 cliente novo entrou. Amanhã tem 3 OS pra entregar. Boa noite."
...
- **Mockup (1º dia do mês, push):**
  ...
  > R$ 387k faturado (mês recorde 2026)
...
- **Mockup:** depois de 4 semanas com Jana, cliente acorda e pensa "como fechei ontem?" → abre WhatsApp → Jana já está com mensagem proativa: "Bom dia Larissa! Ontem você fechou R$ 14.3k. Hoje tem 4 OS na agenda."
...
|------|-----------|---------------------|-----------|
| **Starter** | R$ 99 | 200 queries, 1 push/dia, sem streak, sem voz | Cliente novo / dúvida / casual |
| **Pro** | R$ 299 | 1.000 queries, 3 push/dia, streak, achado semanal | Cliente engajado pós-mês 3 |
| **Premium** | R$ 599 | Ilimitado, voz in/out, multi-business, comparativo setor | Multi-loja / power user |
| **Enterprise** | R$ 999 | + API, prioridade Brain B (Sonnet), 1:1 onboarding, SLA | Operações > R$ 500k/mês |
