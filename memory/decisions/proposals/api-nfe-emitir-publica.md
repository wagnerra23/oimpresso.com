...
|---|---|---|---|
| **Setup + mensal fixo** | NFe.io: R$ [redacted Tier 0] setup + R$ [redacted Tier 0]-499/m por faixa de notas | Previsível pro cliente | Não escala com sucesso dele |
| **Setup + por NFe emitida** | eNotas: R$ [redacted Tier 0] setup + R$ [redacted Tier 0]-1,49 por NFe | Cliente paga proporcional ao uso | Variável — cliente sazonal pode reclamar |
| **Setup + mensal + overage** | FocusNFe: R$ [redacted Tier 0] setup + R$ [redacted Tier 0]/m até 100 NFe + R$ [redacted Tier 0] excedente | Híbrido — entry baixa + escala | Mais complexo de explicar |

**Proposta inicial sugerida (a confirmar com Wagner):**
- **Setup R$ [redacted Tier 0]** (cobre 6d de dev — payback no 1º cliente)
- **Mensalidade R$ [redacted Tier 0]/m** com até 200 NFe/m incluídas
- **R$ [redacted Tier 0] por NFe excedente**
