...
- 2026-05-09: análise piloto ServidorWR2 revelou achados que Wagner não tinha visibilidade clara (déficit -R$ 68k 12m, R$ 868k em atrasos)
...
> *"Conecte seu OfficeImpresso ao oimpresso. Receba todo dia 5 um dashboard financeiro completo (caixa, AR, AP, alertas) — sem trocar de sistema. R$ 99/m."*
...
### Tier 3 — Migration Ready (R$ 599/m)
- Tudo do Tier 2 +
...
- Pricing-lock: se migrar nos 12m de assinatura, setup R$ 0

## Pricing strategy

- **Trial 30d grátis sem cartão** (Wagner conecta no banco, gera 1 relatório, manda pro cliente)
- **Anual paga 10** (Tier 1 anual: R$ 990/ano)
...
- 5 clientes Tier 1 × R$ 99/m × 12 = R$ 5.940
- 2 clientes Tier 2 × R$ 299/m × 12 = R$ 7.176
- 1 cliente Tier 3 × R$ 599/m × 12 = R$ 7.188
- **Total ARR adicional**: R$ 20.304 (4% da meta R$ 5M)

### Cenário realista (12m)
- 15 Tier 1 × R$ 99/m × 12 = R$ 17.820
- 8 Tier 2 × R$ 299/m × 12 = R$ 28.704
- 3 Tier 3 × R$ 599/m × 12 = R$ 21.564
- **Total ARR adicional**: R$ 68.088 (14% da meta R$ 5M)

### Cenário otimista (12m)
- 30 Tier 1 × R$ 99/m × 12 = R$ 35.640
- 15 Tier 2 × R$ 299/m × 12 = R$ 53.820
- 5 Tier 3 × R$ 599/m × 12 = R$ 35.940
- **Total ARR adicional**: R$ 125.400 (25% da meta R$ 5M)

### Bonus implícito — conversão pra oimpresso.com
- Cada cliente Tier 3 que migrar = + R$ 599-1.499/m receita oimpresso (vs R$ 599 do Snapshot)
- 30% conversion rate em 12m = ~5 migrações × R$ 899 médio × 12m = R$ 53.940 adicionais
- **Total combinado realista**: ~R$ 121k ARR (24% da meta)

## ROI vs custo

- **Custo MVP**: 110h × R$ X/h custo interno = baixo (IA-pair, time existente)
- **Marketing**: ~R$ 5k (página, ads iniciais)
- **Custo recorrente**: VPS pequena pra rodar jobs (R$ 100/m), Asaas billing fee (~3%)
- **Payback**: cenário conservador R$ 20k/ano vs MVP ~R$ 30k custo interno = 18 meses
- **Cenário realista R$ 68k/ano vs custo = 5-6 meses payback**
...
- [ ] Aprovar conceito + tier pricing? (R$ 99/299/599)
