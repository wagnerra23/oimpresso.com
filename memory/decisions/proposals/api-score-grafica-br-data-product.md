...
**Cenário realista 24m: R$ [redacted Tier 0]k ARR adicional** (2 fintechs Starter + 2 fornecedores Pro + 1 seguradora pay-per-use). Validação via 1 piloto fintech de R$ [redacted Tier 0] com data subset.
...
```json
{
  ...
  "components": {
    ...
    "mrr_estimate": {
      "weight": 0.20,
      "value": 680,
      "explain": "MRR estimado R$ [redacted Tier 0]-25k/mês (faixa Pro), volume 2.4k OS/mês"
    },
    "gmv_proxy": {
      "weight": 0.20,
      "value": 750,
      "explain": "GMV proxy R$ [redacted Tier 0]k/mês via boletos pagos a essa gráfica em 12m"
    },
    "delinquency": {
      "weight": 0.15,
      "value": 720,
  ...
  "alerts": [
    {
      "code": "MRR_DECLINE_3M",
      "severity": "warning",
      "message": "MRR caiu 12% nos últimos 3 meses (R$ [redacted Tier 0]k → R$ [redacted Tier 0]k)"
    }
  ],
  "data_freshness": {
...
- **Willingness to pay:** R$ [redacted Tier 0]/consulta (confirmar via piloto)
...
- **Dor:** seguro de equipamento gráfico (plotter R$ [redacted Tier 0]k, impressora UV R$ [redacted Tier 0]k) tem alta sinistralidade — oficina fecha, equipamento "some". Underwriting cego.
- **Volume estimado:** 50-100 consultas/mês por seguradora
- **Willingness to pay:** R$ [redacted Tier 0]/consulta (alto valor unitário)
...
- **Dor:** vendem plotter/impressora R$ [redacted Tier 0]k-800k em 36-60x parceladas; querem prever inadimplência + identificar gráficas crescendo (quem precisa de máquina nova)
- **Volume estimado:** dataset bulk monthly + alertas
- **Willingness to pay:** R$ [redacted Tier 0]/mês unlimited consultas + R$ [redacted Tier 0]k bulk export
...
- **Willingness to pay:** R$ [redacted Tier 0]/mês acesso completo + R$ [redacted Tier 0]k relatório customizado
...
- **Willingness to pay:** R$ [redacted Tier 0]k/ano (relatório + dashboard)
...
- ✅ **DPO designado** (pode ser jurídico externo retainer R$ [redacted Tier 0]-5k/mês)
- ✅ **Auditoria externa anual** (BDO/EY/PwC LGPD) — R$ [redacted Tier 0]-50k/ano
...
|---|---:|---:|---:|---|---|---|---|
| **Trial** | R$ [redacted Tier 0] | R$ [redacted Tier 0] | 100 | ❌ | best-effort | community | discovery, devs avaliando |
| **Starter** | R$ [redacted Tier 0] | R$ [redacted Tier 0] | 5.000 | ❌ | 99% | email 48h | startup fintech early-stage |
| **Pro** | R$ [redacted Tier 0] | R$ [redacted Tier 0] | 50.000 | 1×/mês | 99.5% | email 24h | mid-fintech, fornecedor máquina |
| **Enterprise** | R$ [redacted Tier 0]+ | R$ [redacted Tier 0] | unlimited | sob demanda | 99.9% | dedicated | corp, seguradora, associação |

**Add-ons:**
- Webhook firehose: +R$ [redacted Tier 0]/mês
- SDK custom: R$ [redacted Tier 0] one-time
- Relatório customizado: R$ [redacted Tier 0]-50.000
- Dashboard branded: R$ [redacted Tier 0]/mês
...
### 6.1 Cenário pessimista — R$ [redacted Tier 0]k ARR

| Customer | Tier | ARR |
|---|---|---:|
| 1 fintech | Starter | R$ [redacted Tier 0]k |
| 1 fornecedor insumo | Pro | R$ [redacted Tier 0]k |
| 0 seguradoras | — | R$ [redacted Tier 0] |
| 0 associações | — | R$ [redacted Tier 0] |
| Pay-per-use sparse | — | R$ [redacted Tier 0]k |
| **Total** | | **~R$ [redacted Tier 0]k → R$ [redacted Tier 0]k** (com upsell ano 2) |

Premissa: ciclo de venda longo, validação demora 12m, 2 customers ano 1 + 2 ano 2.

### 6.2 Cenário realista — R$ [redacted Tier 0]k ARR ⭐

| Customer | Tier | ARR |
|---|---|---:|
| 2 fintechs | 1 Starter + 1 Pro | R$ [redacted Tier 0]k |
| 2 fornecedores | 1 Pro + 1 Enterprise base | R$ [redacted Tier 0]k |
| 1 seguradora | Pay-per-use 50/mês × R$ [redacted Tier 0] | R$ [redacted Tier 0]k |
| 0 associações | — | R$ [redacted Tier 0] |
| Add-ons + relatórios custom | — | R$ [redacted Tier 0]k |
| Bulk exports | — | R$ [redacted Tier 0]k |
| **Total** | | **~R$ [redacted Tier 0]k** |
...
### 6.3 Cenário otimista — R$ [redacted Tier 0]k ARR

| Customer | Tier | ARR |
|---|---|---:|
| 5 fintechs | 2 Starter + 2 Pro + 1 Enterprise | R$ [redacted Tier 0]k |
| 3 fornecedores | 2 Pro + 1 Enterprise | R$ [redacted Tier 0]k |
| 2 seguradoras | 1 Enterprise + 1 pay-per-use | R$ [redacted Tier 0]k |
| 1 associação | Custom | R$ [redacted Tier 0]k |
| Bulk + add-ons + custom reports | — | R$ [redacted Tier 0]k |
| Channel revenue share Roland | — | R$ [redacted Tier 0]k |
| **Total** | | **~R$ [redacted Tier 0]k** |
...
- Contratar SDR part-time (R$ [redacted Tier 0]-6k/mês)
...
- **Multa máxima:** 2% faturamento até R$ [redacted Tier 0]M
- **Mitigação:**
  ...
  - Transparência ativa
  - Pólice de seguro cyber/D&O — R$ [redacted Tier 0]-5k/ano cobre R$ [redacted Tier 0]k
...
- **Realidade:** 8-10k gráficas no Brasil, mercado endereçável fintech-side ~R$ [redacted Tier 0]-10M ARR teto
- **Mitigação:**
...
3. **Jurídico externo** lê Art. 7º + dá opinião escrita sobre base legal viável (R$ [redacted Tier 0]-5k one-time)
...
| Quanto investir em jurídico LGPD pré-launch? | (a) R$ [redacted Tier 0]k LIA mínima (b) R$ [redacted Tier 0]k LIA + DPIA (c) R$ [redacted Tier 0]k LIA + DPIA + auditoria |
