...
| **Custo dinheiro up-front (R$)** | R$ [redacted Tier 0] (80h × R$ [redacted Tier 0]/h) | R$ [redacted Tier 0] | R$ [redacted Tier 0] (24h × R$ [redacted Tier 0]/h) | R$ [redacted Tier 0] até 3 contratos |
| **Custo recorrente/mês (storage + manutenção)** | R$ [redacted Tier 0] storage `[5 clientes × 50GB × R$ [redacted Tier 0]/TB ÷ 1024 × 1000]` + R$ [redacted Tier 0] manutenção (5h × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** | R$ [redacted Tier 0] | R$ [redacted Tier 0] storage (cliente paga próprio Drive) + R$ [redacted Tier 0] manutenção 2.5h = **R$ [redacted Tier 0]** | R$ [redacted Tier 0] até gatilho |
...
| **Receita esperada 3m (cenário base 5 prospects qualificados/mês)** | 3 contratos fechados Mubisys × (R$ [redacted Tier 0]k setup + 3m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** | 1 contrato (perde 60% prospects DAM-blockers) × (R$ [redacted Tier 0]k + 3m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** | 2 contratos (atende clients <50GB) × (R$ [redacted Tier 0]k + 3m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** | 3 contratos com cláusula desconto 30% após 90d × (R$ [redacted Tier 0]k + 3m × R$ [redacted Tier 0] × 0.85 médio) = **R$ [redacted Tier 0]** |
| **Receita esperada 12m (recorrente full)** | 5 contratos cumulativos × (R$ [redacted Tier 0]k + 12m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** | 2 contratos × (R$ [redacted Tier 0]k + 12m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0]** | 3-4 contratos × (R$ [redacted Tier 0]k + 12m × R$ [redacted Tier 0]) = **R$ [redacted Tier 0] - R$ [redacted Tier 0]** | 5 contratos × (R$ [redacted Tier 0]k + 12m × R$ [redacted Tier 0] × ~0.92 blended) = **R$ [redacted Tier 0]** |
| **Custo total 12m (dev + storage/manutenção)** | R$ [redacted Tier 0] + 12 × R$ [redacted Tier 0] = **R$ [redacted Tier 0]** | R$ [redacted Tier 0] | R$ [redacted Tier 0] + 12 × R$ [redacted Tier 0] = **R$ [redacted Tier 0]** | R$ [redacted Tier 0] + 9m × R$ [redacted Tier 0] = **R$ [redacted Tier 0]** (build mês 4) |
...
| **Lucro líquido 12m** | **R$ [redacted Tier 0]** | **R$ [redacted Tier 0]** | **R$ [redacted Tier 0]-87.632** | **R$ [redacted Tier 0]** |
| Payback period (até cobrir custo dev) | 1 contrato Enterprise (R$ [redacted Tier 0]k setup já paga 78% do dev). **~30 dias** | n/a | <1 contrato. **~15 dias** | 0d até gatilho; ~30d após build |
...
- Storage médio sobe pra 150GB/cliente → manutenção dobra (R$ [redacted Tier 0]/m) → ainda positivo mas margem cai
...
**Concorrência**
- Mubisys tem 150TB MubiDrive como "moat" público. Replicar feature completa = R$ [redacted Tier 0]k+ dev (playbook estima). MVP S3-wrap não é paridade — é **mínimo viável pra não travar venda**.
...
1. **Alinha 100% com ADR 0105** (cliente como sinal qualificado). Build só dispara quando 3 clientes pagaram = sinal forte qualificado por R$ [redacted Tier 0]k+ em receita comprometida. Não viola princípio do projeto. Defensável em qualquer review interno.

2. **Lucro líquido 12m R$ [redacted Tier 0] vs R$ [redacted Tier 0] do Cenário A** — diferença de apenas R$ [redacted Tier 0] (5%) **mas elimina o risco de capex queimado**. Se zero contrato fechar em 90d, A perde R$ [redacted Tier 0] + 2 dias time alocado errado; D perde R$ [redacted Tier 0] e mantém time em MWART/Repair.
...
- **Setup R$ [redacted Tier 0] do 1º contrato Enterprise** já paga 78% do dev (R$ [redacted Tier 0]). Após **3º contrato Enterprise (estimado mês 2-3)**, custo dev coberto + R$ [redacted Tier 0] lucro antes do build começar.
- **Build dispara mês 3** com 3 clientes pagando (R$ [redacted Tier 0] MRR + R$ [redacted Tier 0]k setup já em caixa).
...
- ✅ 3 contratos Enterprise pagos (setup R$ [redacted Tier 0]k em caixa)
- ✅ Build MVP iniciado mês 3
- ✅ MRR Enterprise ≥ R$ [redacted Tier 0]/m (3 × R$ [redacted Tier 0])
...
**Em 360 dias:**
- ✅ Receita Enterprise cumulativa ≥ R$ [redacted Tier 0]k (~5 contratos médios)
