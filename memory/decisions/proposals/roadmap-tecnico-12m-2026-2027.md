...
- **Goal secondary:** Pricing tiers validados em 4 contratos (R$ [redacted Tier 0]/599/1.499 — testar premium tem demanda)
- **Owner:** [E] (onboarding), [W] (pricing review)

**KPI M3:**
- 4 clientes ERP ativos (era 1 → 4) — bate compromisso 90d (2 + 3) e antecipa 12m
- ARR rodando ≥R$ [redacted Tier 0]k (4 × ~R$ [redacted Tier 0] médio × 12)
- Churn = 0
...
- ARR ≥R$ [redacted Tier 0]k (validar com pricing tiers — ADR proposals/06)
...
7. **Mubisys-migration importer falhar em produção real** (M6): sem 6º+ clientes legacy = ARR não bate R$ [redacted Tier 0]k. **Mitigação:** validar importer em fixture sintética M5 cycle 40 antes de cliente real M6.
...
| **ARR** | ~R$ [redacted Tier 0] (assumindo Larissa não paga assinatura formal hoje) | R$ [redacted Tier 0]k+ | financeiro/asaas |
...
| **Tier mix** | n/a | 50% Pro / 30% Standard / 20% Premium | pricing tiers (R$ [redacted Tier 0]/599/1.499) |
