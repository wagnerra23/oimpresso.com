# Recalibração pricing — sinal real R$ 830-850/m — 2026-05-09

**Status**: proposed (Wagner valida)
**Sinal**: Martinhão da Caçamba (R$ 830/m, ERP de 26 anos, está trocando agora) + Gold Comunicação (R$ 850/m, trocou pelo Mubisys recentemente)
...
|---|---|---|---|---|---|---|
| Starter | R$ 299 | R$ 0 | mensal | 1 | até 3 | 100 manual |
| Pro | R$ 599 | R$ 999 ¹ | 12 meses | 1 | até 10 | 500 auto |
| Enterprise | R$ 1.499 | R$ 5.000 | 24 meses | até 5 | ilimitado | ilimitado |

¹ Setup Pro reduzido R$ 2.500 → R$ 999 default na Rodada 3 (pesquisa horizontais 05).

**Gap detectado:** ticket real validado R$ 830-850/m **fica num vácuo entre Pro (R$ 599, +39%) e Enterprise (R$ 1.499, -43%)**. Pro está R$ 230-250/m abaixo do que dois prospects ICP estão pagando hoje. Enterprise está R$ 650/m acima — fora da janela.

---

## 2) Tabela 4 cenários

| Métrica | A — não-mexer | B — Pro→R$ 799 | C — +Pro Plus R$ 899 | D — add-ons modulares |
|---|---|---|---|---|
| Receita marginal por cliente vs hoje | 0 | +R$ 200/m | +R$ 0 a R$ 300/m (depende de qual tier escolhe) | +R$ 100-300/m (depende de quantos add-ons) |
| Risco perder prospect Bling-graduado (R$ 200-450/m) | nulo | médio (Pro fica 4x Bling) | baixo (Pro segue R$ 599) | baixo (Pro segue R$ 599) |
| Risco perder prospect Mubisys/Zênite-graduado (R$ 800-850/m) | **alto** (Pro parece "barato demais p/ ser sério" + Enterprise parece overkill) | baixo | nulo (sweet spot) | baixo |
...
| Janela ROTA LIVRE (cliente piloto, R$ 599 legacy) | preserva | preserva (Pro mantém R$ 599 só pra ela; novos R$ 799) — cria 2 SKUs internos | preserva (ela segue Pro) | preserva (ela segue Pro sem add-on) |
...
**Problema:** Mubisys tem **1.800 empresas ativas** alegadas (research 02). Se o ticket médio Mubisys é R$ 850/m, o mercado já validou que comunicação visual média paga **R$ 800-850/m por ERP vertical**. Manter Pro em R$ 599 = sinaliza "produto inferior" pra prospect Mubisys-graduado que está acostumado a pagar mais. Conta Azul Performance vai a R$ 720/m e atende empresa >R$ 1,5M/ano sem ser vertical — oimpresso vertical com IA cobrar R$ 599 é **subprecificação ativa**.

**Veredicto:** seguro no curto prazo, deixa dinheiro na mesa no médio. Receita marginal estimada: 0.

### Cenário B — Subir Pro pra R$ 799

**Tese:** alinhamento direto com ticket real. R$ 799 fica R$ 50 abaixo de Gold (R$ 850) e R$ 31 abaixo de Martinhão (R$ 830) — **prospect sente "estou pagando menos que pago hoje"** (gancho psicológico forte na troca).

**Problema #1 — Bling graduado:** prospect saindo de Bling Titânio T2 (R$ 200/m) ou T3 (R$ 350/m) vai sentir Pro R$ 799 como **2.3x-4x** o que paga hoje. Esse era exatamente o segmento que setup R$ 999 default na Rodada 3 tentou descomplicar. Subir pra R$ 799 reverte parte do trabalho.

**Problema #2 — ROTA LIVRE legacy:** ela paga Pro R$ 599 (com 50% off em troca de case). Subir pra R$ 799 cria 2 SKUs internos: "Pro v1 R$ 599 (legacy)" e "Pro v2 R$ 799 (novo)". Gerenciável mas é dívida operacional pra time pequeno.

**Problema #3 — sinal pro mercado:** subir 33% é evento comunicável. Concorrente pode reagir (Mubisys reduz R$ 850 → R$ 749 e nos enquadra; Zênite acelera versão web). Pricing público sobe é decisão de **uma vez só** — não dá pra subir e descer.

**Veredicto:** captura sinal mas **fricciona Bling-graduado** e queima opção. Receita marginal +R$ 200/m por novo cliente Pro, condicional a manter conversão.

### Cenário C — Adicionar tier intermediário "Pro Plus" R$ 899/m

**Tese:** preserva Pro R$ 599 (entry pra Bling-graduado) **E** captura sweet spot R$ 830-850 com tier que justifica diferença concreta.

**Composição sugerida Pro Plus R$ 899:**
- Tudo do Pro
...
- Setup R$ 1.999 (Pro = R$ 999; Enterprise = R$ 5.000)

**Vantagem decisiva:** Pro Plus R$ 899 fica **R$ 49 ACIMA de Gold (R$ 850)** e **R$ 69 ACIMA de Martinhão (R$ 830)**. Em vez de "mais barato que pago hoje" (cenário B), pitch vira **"você paga R$ 850 hoje pra um sistema legacy/sem IA — pague R$ 899 pra ter NFe automática + Jana + multi-business + API"**. Diferença R$ 49-69/m é trivial vs valor entregue.
...
**Veredicto:** **melhor balance** captura sinal sem queimar entry tier. Receita marginal por novo cliente Pro Plus: +R$ 300/m (R$ 899 vs R$ 599 baseline). Receita marginal de upsell Pro→Pro Plus em base existente: opcional (não força).

### Cenário D — Pricing dinâmico add-ons modulares

**Tese:** cliente compõe ticket. Pro R$ 599 base + Jana Premium R$ 199 + Multi-loja R$ 99 = R$ 897 — pousa naturalmente em R$ 830-900.

**Vantagem psicológica:** cliente sente "estou customizando, não pagando tier inflado" — gancho de autonomia.

**Problema #1 — cobrança complexa:** RecurringBilling precisa suportar add-on toggle, prorate em meio de mês, downgrade limpo. Hoje suporta add-on simples (já existe Jana add-on R$ 199 no Starter), mas escalar pra **toggle dinâmico em qualquer tier** é trabalho de engenharia (1-2 sprints) + cobrança financeira mais complexa pra [E] gerir.

**Problema #2 — comparação difícil:** prospect compara "oimpresso R$ 599+R$ 199+R$ 99" com "Mubisys R$ 850 fechado". Cognição extra. Mubisys ganha por **ter um número só**.
...
**Veredicto:** elegante mas **prematuro pro tamanho do time**. Receita marginal +R$ 100-300/m por cliente, condicional a engenharia entregar billing limpo.
...
1. **Captura ticket real validado.** Martinhão (R$ 830) e Gold (R$ 850) ficam R$ 49-69 abaixo de Pro Plus — diferença justificável pelo upgrade concreto (Jana ilimitada + multi-business + API). Cenário A deixa esses prospects irem pra Pro R$ 599 e perdemos R$ 300/m por cliente em runway.
2. **Não fricciona Bling-graduado.** Pro segue R$ 599 — entry tier preservado pra prospect saindo de Bling Titânio R$ 200-350. Cenário B perderia esse segmento.
3. **Reversível.** Se em 90d a conversão Pro Plus for <30% do funil esperado, descontinua silenciosamente (cliente Pro Plus já assinado mantém pricing legacy). Cenário B (subir Pro→R$ 799) é evento público e irreversível — pricing público que sobe e desce queima credibilidade.

### Por que não os outros

- **Não A:** Mubisys/Gold/Martinhão são 3 sinais convergentes (research 02 + 2 prospects ativos hoje) de que **R$ 800-900/m é janela média do mercado**. Não capturar = subprecificação ativa.
...
- Mensal R$ 899 [draft] / Setup R$ 1.999 [draft] / Compromisso 12 meses / Multi-business até 2 / Users até 15 / Vendas/m até 1.500 / NFe/m até 1.000 auto / Suporte WhatsApp 8h / Treinamento 4h ao vivo / Migração guiada premium
...
- **Deck pitch Rodada 3 (slide 9):** trocar coluna Pro/Enterprise por Pro/Pro Plus/Enterprise. Pro Plus em destaque visual ("recomendado pra gráfica >R$ 30k/m faturamento")
- **Site `/precos`:** quiz 3 perguntas direciona pra tier — padrão Bling/Tiny
- **ROI calculator:** adicionar campo "ticket atual ERP" — se >R$ 700/m, recomenda Pro Plus; se <R$ 700, recomenda Pro
...
>
> Vi que você está procurando ERP novo depois de 26 anos com o atual — troca grande, parabéns por revisitar. Sei que você tá olhando opções na faixa que você paga hoje (R$ 830/m).
>
> Acabei de finalizar o tier que cobre seu perfil exato: **Pro Plus R$ 899/m**. R$ 69 a mais do que você paga, mas com:
>
...
>
> Soube que você fechou com Mubisys recente em R$ 850/m. Antes que vire contrato firmado, vale 25 minutos? Tenho duas coisas que Mubisys não tem:
>
...
>
> Pro Plus R$ 899/m. R$ 49 a mais que você fechou. Trial 14d sem cartão. Sem pressão — se ficar com Mubisys, sem stress.
>
> [link calendário] · WhatsApp [W]
>
> — Wagner
...
**Sinal pro mercado/concorrente.** Adicionar tier R$ 899 é evento comunicável — Mubisys, Zênite, e horizontais (Bling/Tiny) podem reagir. Risco realista:
- **Mubisys reduz R$ 850 → R$ 749 e enquadra oimpresso como "premium não justificado"** — improvável (pricing Mubisys não é público hoje, mudar exige call comercial individual; reação demora 60-90d)
...
3. **Manter ROTA LIVRE em Pro v1 R$ 599** sem renegociar — cliente piloto não sente mudança.
...
- [ADR 0022](../0022-meta-5mi-ano-financeira.md) — meta R$ 5M/ano
