...
relates: ADR 0022 (meta R$ [redacted Tier 0]M), ADR 0105 (cliente sinal qualificado), ADR 0094 (Constituição v2)
---
...
### Diagnóstico cru
- ARR atual real: **R$ [redacted Tier 0]k** (10% da meta R$ [redacted Tier 0]M)
- Operação 12m: **déficit -R$ [redacted Tier 0]k** (10/12 meses negativos, recente positiva)
- A receber vencidas (clientes te devendo): R$ [redacted Tier 0]
- A pagar vencidas (você devendo): R$ [redacted Tier 0]
- **GMV agregado dos 37 clientes OfficeImpresso**: R$ [redacted Tier 0] (você recebe 1%)
...
**Ações**:
1. **Win-back 6 churned quentes** (Safety, TechPress, GSX, NewPrintFoz, Fluxo, Estilo) — GMV agregado R$ [redacted Tier 0]M. 1 voltando = +R$ [redacted Tier 0]k/ano. 2 = +R$ [redacted Tier 0]k.
...
3. **Upgrade voluntário 6 saudáveis** com pricing por GMV — Vargas/Extreme/Gold pagam R$ [redacted Tier 0]/m hoje (0,17% do GMV deles), deveriam pagar R$ [redacted Tier 0]-5k/m (0,5-1%). Voluntário com features novas (NFe automática, Jana ilimitada, multi-business) — grandfather 12m pra preservar relação.
4. **Cobrar 50% dos R$ [redacted Tier 0]k a receber vencidas em 90d** = R$ [redacted Tier 0]k entrando.
5. **Renegociar R$ [redacted Tier 0]k a pagar vencidas** — auditar imposto vs fornecedor.

**ROI esperado 90d**: +R$ [redacted Tier 0]-300k cash + redução de 60% churn silencioso + base preparada pra Camada 2.
...
**Ações**:
1. **Migrar 3 saudáveis maiores** (Vargas R$ [redacted Tier 0]M GMV, Extreme R$ [redacted Tier 0]M, Gold R$ [redacted Tier 0]M) pro oimpresso.com com pricing por GMV (cada um vira R$ [redacted Tier 0]-50k/ano = R$ [redacted Tier 0]-150k ARR adicionado).
...
**ROI esperado 180d**: +R$ [redacted Tier 0]-200k ARR + 1 fechamento de lead 2º grau Enterprise + plataforma pronta pra escalar.
...
**ROI esperado 360d**: +R$ [redacted Tier 0]-200k ARR de clientes net-new + 1 partnership oficial + 1 case publicado em revista institucional.
...
**Critério de mudança**:
- 3 oficinas auto pagando piloto R$ [redacted Tier 0]-399/m por 6m com aceite formal = ativa Camada 4
...
❌ **Não atender cliente fora do ICP** — aceitar pagamentos pequenos (<R$ [redacted Tier 0]/m) é dispersão; oferecer Snapshot Free (R$ [redacted Tier 0]/m) como alternativa qualifica antes.
...
- [ ] R$ [redacted Tier 0]k+ recuperado de a receber vencidas
...
|-----------|-----------|
| Receita 12m R$ [redacted Tier 0]k (-R$ [redacted Tier 0]k déficit) | Crescimento exige aquisição, não apenas retenção |
| 60% bancos churned silenciosamente | Reaquecer base é low-hanging fruit antes de cold |
| GMV agregado clientes R$ [redacted Tier 0]M | Pricing por % GMV é caminho racional |
...
| 6 saudáveis com GMV >R$ [redacted Tier 0]k | Esses são âncoras pra migração + caso público |
