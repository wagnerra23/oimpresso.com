...
review_triggers:
  ...
  - "Custo prompt caching > R$ 5k/mês (estimativa economia ~R$ 32k/mês desviou)"
...
- Economia estimada: **~R$ 32k/mês** (cache_read 74%→85%+ target)
...
- Custo backfill 1500 docs: **~R$ 180** (one-shot) + R$ 18/mês steady state
...
- Prompt caching (#901): economia **R$ 32k/mês** estimada (efeito colateral massivo)
...
- **Economia R$ 32k/mês** estimada (prompt caching #901)
...
- **Backfill 1500 docs Contextual** custa R$ 180 one-shot — Wagner aprova orçamento antes de rodar
...
- **Custo backfill R$ 180 one-shot** Wagner aprova manualmente — não auto-trigger
...
2. [PR #901](https://github.com/wagnerra23/oimpresso.com/pull/901) — Prompt caching live Anthropic (D4 #5, +1pp, **R$ 32k/mês economia**)
