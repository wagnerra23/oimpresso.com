...
3. **Service messages unlimited grátis desde nov/2024** ([Chatarmin 2026](https://chatarmin.com/en/blog/whats-app-api-pricing)): Meta removeu cap 1.000 free service conversations/mês. Customer-initiated service msg agora **unlimited free**. **Conclusão:** fluxo conversacional inbound oimpresso entra integral em R$ 0 — JANA Pro custo marginal zero reforçado.

4. **Custo Meta Cloud BR 200 conv/mês** ([Message Central 2026](https://www.messagecentral.com/blog/whatsapp-business-api-pricing-in-brazil)): utility R$ 0,08/conv × 200 = **R$ 16/mês** + service free. **MENOR** que R$ 99/mês fixo Z-API.

5. **BSP enterprise BR 2026** ([Message Central comparison](https://www.messagecentral.com/blog/best-whatsapp-business-api-platform-brazil)): Take Blip ~R$ 1.500+/mês fixo + per-msg markup 20-40%; Twilio USD instável; 360dialog EUR €49/mês mínimo + zero markup. **Overkill 30×** pra perfil 50-200 conv/mês atual.
...
4. **R$ 16/mês 200 conv vs R$ 99 Z-API** — MAIS BARATO no default. Pricing favorece migrar.
...
1. **Take Blip R$ 1.500+/mês** = 30× overkill perfil 50-200 conv/mês atual
...
4. **Reaberto via review_trigger** quando cliente pagante específico pedir (≥ R$ 500/mês recorrente assinado)
...
- **Custo operacional WhatsApp ↓** — R$ 99/mês Z-API economizados + R$ 0 daemon CT 100
...
**Rejeitada por ora** — R$ 1.500+/mês = 30× overkill perfil PME atual. Reaberto via review_trigger quando cliente pagante específico pedir SLA enterprise. **Não fecha porta.**
...
- Custo/conv: R$ 0,08 utility + R$ 0 service (vs R$ 99/mês fixo Z-API)
...
- [Message Central · Brazil API Pricing 2026](https://www.messagecentral.com/blog/whatsapp-business-api-pricing-in-brazil) — R$ 0,08 utility BR
