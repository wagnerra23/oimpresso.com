---
slug: 0303-anchor-lint-wired-testado-sa-a2-bis
number: 303
...
# ADR 0303 — Anchor-lint SA-A2-bis: wired-check (zumbi) + testado-check
...
> _Renumerado **0297 → 0303** ao landar na `main` (duas colisões de sessão paralela): o 0297 já era `0297-excecao-append-only-migracao-legacy-frontmatter-adr` (aceito 2026-06-21); o 0302, próximo livre no início deste trabalho, foi tomado pelo `doneness-lint` ([#3239](https://github.com/wagnerra23/oimpresso.com/pull/3239)) enquanto eu rebaseava. Os commits e o session log da branch `docs/onda-0-rede-seguranca` referem este ADR como "0297"; a identidade canônica é **0303**._
