...
| Economia mensal | R$ [redacted Tier 0]→30 | R$ [redacted Tier 0]→119 |
...
| LLM eval batch / LLM-as-judge RAGAS | OpenAI (R$ [redacted Tier 0]-10/run) | CT 100 `ollama-llm` (Cycle 04+) |
...
- Custo Hostinger subir >R$ [redacted Tier 0]/mês
...
- **Economia:** zero custo recorrente embedding (era R$ [redacted Tier 0]/1M tokens, frequente)
...
- **Custo:** gpt-4o-mini = R$ [redacted Tier 0]/1M input, R$ [redacted Tier 0]/1M output → ~R$ [redacted Tier 0] por conversa Larissa real
...
- **Economia eval:** R$ [redacted Tier 0]-10/run baseline → R$ [redacted Tier 0] (CPU é grátis)
...
|---|---|---|
| Hostinger Cloud Startup | R$ [redacted Tier 0]/mês | R$ [redacted Tier 0] |
| OpenAI embeddings | ~R$ [redacted Tier 0]-15/mês | R$ [redacted Tier 0] (local) |
| OpenAI gpt-4o-mini chat | ~R$ [redacted Tier 0]-100/mês | mantido (R$ [redacted Tier 0]-100) |
| OpenAI eval (50 perguntas/run) | ~R$ [redacted Tier 0]/run × 4 runs/mês = R$ [redacted Tier 0] | R$ [redacted Tier 0] (Ollama 8B local) |
| **Total mensal** | **R$ [redacted Tier 0]-214** | **R$ [redacted Tier 0]-100** |
...
| Custo Hostinger | continua | R$ [redacted Tier 0] (cancelado) |
