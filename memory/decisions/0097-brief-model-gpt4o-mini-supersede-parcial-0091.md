...
- Custo real medido: **$0.0004/brief × 6/dia = $0.024/dia** (~R$ [redacted Tier 0]/mês).
...
| Custo dia (6×) | ~$0.30 (~R$ [redacted Tier 0]) | ~$0.024 (~R$ [redacted Tier 0]) |
| Custo mês | ~$9 (~R$ [redacted Tier 0]) | ~$0.72 (~R$ [redacted Tier 0]) |
