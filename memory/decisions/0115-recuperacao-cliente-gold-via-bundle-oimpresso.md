...
2. **Proposta comercial** — diferenciação vs Mubsys ancorada em [comparativos Capterra](../comparativos/oimpresso_vs_concorrentes_capterra_2026_04_25.md), com pricing on-prem (one-time + manutenção anual) ou SaaS R$ 599/mês (Plano Enterprise — README NfeBrasil)
