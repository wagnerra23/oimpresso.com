...
**Origem:** Custo Claude Code R$ [redacted Tier 0]k/dia solo + necessidade de administrar recursos da equipe + LGPD audit + visão estratégica de "ERP com IA" (ADR 0026)
...
- **R$ [redacted Tier 0]/dia** de gasto médio nos últimos 7 dias (USD 14.007 / 7 = USD 2.000/dia)
...
Equipe de 5 pessoas (Wagner + Felipe + Maíra + Luiz + Eliana) usaria CC também. **Estimativa equipe completa:** R$ [redacted Tier 0]k/dia se padrão for similar.
