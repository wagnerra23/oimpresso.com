---
slug: 0301-separar-cliente-deprecar-crm-pipeline
number: 301
...
# ADR 0301 — Separar Cliente (cadastro) do CRM (pipeline) e deprecar o pipeline

> **Status:** aceito (Wagner 2026-06-22 — "já foi aprovado"). Promovido de proposta a ADR canon. Origem: Wagner 2026-06-22, *"contacts não é o crm"* + escolha "separar e deprecar o CRM".
