...
A gestão desta meta (e de todas as metas de businesses) é instrumentada pelo **Módulo Copiloto** — ver [`memory/requisitos/Jana/README.md`](../requisitos/Copiloto/README.md). Este ADR é a **origem conceitual** do Copiloto: a meta R$ 5mi serve como primeiro registro seed do módulo (`business_id = null`, origem `seed`).
