...
Wagner estabeleceu a meta em 2026-04-24: **R$ [redacted Tier 0] milhões de faturamento anual** na oimpresso (equivalente a ~R$ [redacted Tier 0]k/mês de receita recorrente, se SaaS puro).

## Decisão

A meta oficial da oimpresso passa a ser **R$ [redacted Tier 0] milhões/ano de faturamento**, com horizonte-alvo a definir (**dado pendente — Wagner precisa confirmar prazo: 12 / 24 / 36 meses?**).
...
5. **Custo de aquisição** (marketing, comercial, setup) — hoje provavelmente R$ [redacted Tier 0] porque Wagner traz cliente por rede pessoal.
