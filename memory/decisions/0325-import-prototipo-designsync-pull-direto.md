...
2. `DesignSync.get_file(projectId: 019dcfd3…, path: <âncora>)` → **persistir em arquivo**. ⚠️ *Atualizado 2026-08-13:* o destino deixou de ser o staging do ZIP (`~/Downloads/_cowork-handoff-staging/…`, hoje **legado**) e passou a ser o espelho versionado `prototipo-ui/cowork/Wagner/`, escrito por `cowork-mirror-freshness.mjs --export-from` ([ADR 0374](0374-emenda-0315-espelho-cowork-e-rota-prevista.md)) — **transcrever à mão é proibido**: a escrita sai do dado, por script.
