...
| **Faturamento R$ [redacted Tier 0]M+/mês** (Wagner) / R$ [redacted Tier 0]M/12m (Firebird snapshot 2026-05-11) | Compatível com mecânica pesada autorizada (peça unitária R$ [redacted Tier 0]-80k) — locação caçamba container ticket R$ [redacted Tier 0]-500/dia não gera esse volume |
