...
final class CashRegisterClosedFinanceiroListener
{
    ...
    public function handle(CashRegisterClosed $event): void
    {
        ...
        // Pegadinha #3 — caixa fechado com R$ [redacted Tier 0] (sem movimentação)
...
| **P6** | Caixa vazio (R$ [redacted Tier 0] total) | Larissa abre e fecha sem vender (teste) | Skip silencioso (R6) — não polui Financeiro |
