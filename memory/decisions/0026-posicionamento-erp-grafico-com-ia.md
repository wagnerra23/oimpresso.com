...
| **C** — "ERP genérico moderno BR" | Competir com Bling/Omie | ❌ Não ganha de R$ [redacted Tier 0]/mês do Bling sem queimar caixa |
...
### Math da meta (R$ [redacted Tier 0]mi/ano em 24 meses)

R$ [redacted Tier 0]mi/ano = **R$ [redacted Tier 0]k/mês de MRR**.

Cenário recomendado em [`memory/11-metas-negocio.md`](../11-metas-negocio.md): **Cenário D Misto** = 50 enterprise × R$ [redacted Tier 0]k + 120 médios × R$ [redacted Tier 0]k + 200 pequenos × R$ [redacted Tier 0] = R$ [redacted Tier 0]k/mês.

Pra ticket médio R$ [redacted Tier 0]/mês: **838 clientes ativos**. Com churn 3%/mês e CAC payback 6m, funil de **~50 leads qualificados/mês**. Realidade hoje: 7 clientes ativos. Gap: **800+ clientes em 24 meses = 33 novos/mês líquidos**. Wagner sozinho não escala — pressupõe contratação a partir de R$ [redacted Tier 0]k MRR.
...
- Permite ticket premium (R$ [redacted Tier 0]/mês entre Mubisys e Bling premium) com narrativa que sustenta
...
- **Wagner sozinho** não opera 838 clientes — premissa: contratar CS a partir de R$ [redacted Tier 0]k MRR
...
| Sem suporte/academy/treinamento, churn dispara | Documentar via MemCofre como produto interno; contratar pessoa em R$ [redacted Tier 0]k MRR |
...
| MRR | ⚠️ não medido | R$ [redacted Tier 0]k | R$ [redacted Tier 0]k |
...
- **ADR 0022** (Meta R$ [redacted Tier 0]mi/ano) — este ADR dá a estratégia de execução pra atingir a meta
...
- [Cenários R$ [redacted Tier 0]mi (11-metas)](../11-metas-negocio.md)
