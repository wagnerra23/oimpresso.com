...
**Antes (mapping ingênuo):** R$ 6.052.397 vencido
**Depois (classificação correta):** **R$ 4.535.636 vencido**
...
1. VARGAS LEANDRO COM VAREJISTA — R$ 385.195 (229 parcelas · recorrente 5+ anos)
2. TORK COMERCIO DE PECAS AUTO — R$ 145.511 (167 parcelas)
3. AMS SOLDAS E MAQUINAS — R$ 133.386 (71 parcelas)
4. BUSSOLO E PRUDENCIO LTDA — R$ 118.970 (43 parcelas)
5. FAN COM. DE PEÇAS E IMPLEMENTOS — R$ 117.063 (166 parcelas)

**HIDROPOL R$ 239k e JF CAÇAMBAS R$ 163k SUMIRAM do top** porque dívidas eram parcelas AGRUPADAS já consolidadas. Sistema concorrente cobraria duplicado — nosso classificou correto.
...
2. **Validar Jana respondendo com dados reais** — Wagner reportou que após patch `ContextSnapshotService` profile injeta. Pedir Wagner confirmar 4 perguntas:
   - "qual cliente está mais me devendo?" → deve responder VARGAS R$ 385k
