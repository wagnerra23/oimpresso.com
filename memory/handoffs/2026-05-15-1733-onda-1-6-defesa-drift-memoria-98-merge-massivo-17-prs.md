...
- **Economia estimada R$ 32k/mês** prompt caching Anthropic
...
| [#901](https://github.com/wagnerra23/oimpresso.com/pull/901) | Prompt caching D4 #5 (~R$ 32k/mês economia) | +1pp | 88 | 9/9 |
...
|---|---|---|
| `COPILOTO_PROMPT_CACHE_ENABLED` | **TRUE** | imediato (R$ 32k/mês economia incentiva) |
...
- Custo prompt caching > R$ 5k/mês (estimativa economia desviou)
