...
| **Faturas** `/recurring-billing/faturas` | Sparkline KPI hero (degrade graceful se R$0) · Tour onboarding (TOUR_DONE_KEY compartilhada) · CheatSheet `?` · Atalhos `/?/Esc` · Hooks print extrato (printSubDetail+installPrintStyles) |
