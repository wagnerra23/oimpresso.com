...
**MRR consolidado**: 108 ativos × R$ [redacted Tier 0]/mês × 12 = **R$ [redacted Tier 0]/ano** projetado.

## Estado MCP no momento do fechamento

```
cycles-active: CYCLE-08 Receita Onda A (2026-05-31 → 2026-06-28, 29% decorrido)
  Goal MRR novo carteira: R$ [redacted Tier 0] alvo (R$ [redacted Tier 0]/ano gerado = sinaliza)
...
valor cobrancas total: R$ [redacted Tier 0]
MRR mensal: R$ [redacted Tier 0]
