...
**US-COPI-100** (NarrarSaudeEcosistemaJob, Sprint W20, P2, 30h estimate): Wagner é owner. Mesmo padrão (doing→todo→doing). Próximo passo: criar `Modules/Jana/Jobs/NarrarSaudeEcosistemaJob.php` + Pest test + schedule hourly. Custo gpt-4o-mini ~R$ [redacted Tier 0]/dia (protegido por `jana:health-check custo_brain_b_24h <= R$ [redacted Tier 0]/dia`).
