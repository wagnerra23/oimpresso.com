...
tldr: "Sessão épica (~13 PRs). Começou em '[W] por que não achou a fonte de design quando perguntei?' → o agente tratou design como Figma porque o MCP do Figma injeta ordem always-on; o canon (Cowork=fonte) vivia só em docs. Red-team adversarial MATOU a 1ª proposta (3 nudges = teatro) → rede block-figma L0-L5 (#3213, ADR 0299). 2 pesquisas: Figma NÃO é o protocolo (o protocolo é o MCP; a fonte portável é o token W3C DTCG); o transporte Cowork→code estava em 71%. 3 ondas de maturidade paralelas (#3214 outcome-metrics, #3215 component-registry, #3216 design-gates-CI) + 2 ratificações (#3217 errata ADR 0300, #3218 decision-register) + #3219 ratify ADR 0293 + #3220 DTCG pipeline. Re-grade: +7.9 (64→71.9) — ganho em VERIFICAÇÃO, não consumo (registry/DTCG existem mas não consumidos). Pivot p/ receita → [W] 'o sistema é fraco e inseguro, nota 6' → auditoria de segurança adversarial: client-readiness é 3/10, INSEGURO de verdade (APP_KEY de prod viva no git, IDOR de escrita cross-tenant em dinheiro, webhook Asaas sem auth). Onda 0: #3235 Asaas (aprovado) + #3236 Purchase (aprovado) mergeados; FIX 2 Account REPROVADO + FIX 4 APP_DEBUG bypass → US-FIN-061(P0)/US-INFRA-047. DTCG ATIVADO (#3230) — token agora mora no .tokens.json; quebrou 2 source-greppers (CockpitAccentCanonTest + palette-generate), consertados. 8 tasks criadas. Agendado /schedule 2026-07-06."
decided_by: [W]
cycle: CYCLE-08
prs: [3213, 3214, 3215, 3216, 3217, 3218, 3219, 3220, 3230, 3235, 3236]
related_adrs: ["0299-figma-nao-e-fonte-de-design", "0300-errata-0239-nome-real-fonte-design-system", "0293-governanca-decisao-design-responsavel-registro-veredito", "0249-ds-v6-naming-amends-0235", "0224-hooks-block-vs-advisory-claude-4.8-aware"]
next_steps:
