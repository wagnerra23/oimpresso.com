...
- Cycle **CYCLE-08 Receita — Onda A** (27d restantes; goals: pricing público, 5 migrações-demo, MRR R$2k, ComVis V1, Agrosys de-risk). Este trabalho é **infra de loop de design**, não goal direto do cycle.
