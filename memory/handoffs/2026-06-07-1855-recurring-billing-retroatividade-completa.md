...
- ✅ Criou **109 planos** + **109 assinaturas ativas** (MRR R$ 37.222,55/mês)
- ✅ Construiu **US-RB-003** (PR #2384) — gerador automático `rb:generate-invoices` + scheduler daily 03:00 BRT
- ✅ Retroatividade 2024-2026: **52 subs canceladas** + **3389 invoices históricas** (R$ 1.086.837,74 recebido + R$ 35.288,86 atrasado)
...
- Tela `https://oimpresso.com/recurring-billing/faturas` ao vivo: **3389 faturas · 137 atrasadas · MRR R$ 37.222,55 · CHURN 1.2%**
...
MRR estimado biz=1: **R$ 37.222,55/mês**.
...
**Etapa 2** — 1351 invoices 2024 (1297 paid R$ 444.934,66 · 54 overdue R$ 14.776,26)
**Etapa 3** — 1375 invoices 2025 (1342 paid R$ 459.071,23 · 33 overdue R$ 7.388,22)
**Etapa 4** — 663 invoices 2026 (506 paid R$ 182.831,85 · 50 overdue R$ 13.124,38 · 107 open R$ 36.891,11)
...
| Faturas total | **3.389** |
| Atrasadas | 137 |
| Pago este mês | R$ 0,00 (jun começou) |
| Pendente | R$ 36.891,11 (107 jul/2026 abertas) |
| Atrasado | R$ 35.288,86 |
| Histórico recebido 2024-2026 | **R$ 1.086.837,74** |
| Subs ativas | 109 (MRR R$ 37.222,55) |
| Subs canceladas | 52 |
...
- [ ] Conferir se KPI "PAGO ESTE MÊS R$ 0,00" está coerente (jun começou, ninguém pagou ainda nos primeiros 7 dias — mas alguns títulos da migração têm baixa < jun pra mensalidade jun)
