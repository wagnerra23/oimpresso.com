...
**Custo direto sessão:** R$ [redacted Tier 0] (Max + Hostinger).
**Custo operacional brief produção:** R$ [redacted Tier 0]/brief gpt-4o-mini.
...
- Custo R$ [redacted Tier 0]/brief × 30 dias × 100 clientes = R$ [redacted Tier 0]/mês (margem 99,95% no plano R$ [redacted Tier 0])
