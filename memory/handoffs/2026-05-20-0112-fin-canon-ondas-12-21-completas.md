...
| # | Inconsistência | Fix |
|---|---|---|
| A | DRE não pegava títulos Maio MARTINHO (R$ 0 vs R$ 91.792 Unificado) | Onda 17 SSH: `UPDATE fin_titulos SET competencia_mes='2026-05' WHERE business_id=164 AND vencimento BETWEEN '2026-05-01' AND '2026-05-31' AND status != 'quitado'` — 4 títulos |
