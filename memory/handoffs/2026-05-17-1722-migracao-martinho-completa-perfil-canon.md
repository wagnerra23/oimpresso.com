...
| **Total nominal** | **R$ 212,7M** | quitados + abertos histórico |
...
**História pra Larissa:** R$ 4M aberto na contabilidade → só R$ 391k é cobrança real, R$ 3,6M é histórico fóssil pré-2020 que vira write-off.
...
- [ ] **US-OFICINA-005 cleanup tool** — UI batch write-off dos R$ 3,6M fóssil
