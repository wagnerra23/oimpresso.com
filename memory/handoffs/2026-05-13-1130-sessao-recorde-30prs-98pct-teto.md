...
## Custo IA total adicionado (~R$ 8/mês)

| Feature | Custo/mês |
|---|---:|
| kb-answer (gpt-4o-mini) | ~R$ 3 |
| handoff-fetch-summarized (cache hit) | ~R$ 1 |
| handoff-diff | ~R$ 1 |
| weekly-digest (Reflect-style) | R$ 0.26 |
| RAGAS gate (weekly) | R$ 0.40 |
| A1 summarizer (cap hard R$ 10, realista R$ 2.5-3) | R$ 2.5-3 |
| Langfuse self-host (já live CT 100) | R$ 0 |
