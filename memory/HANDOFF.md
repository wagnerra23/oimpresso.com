...
Protótipo principal: **`oimpresso.com.html`** (entrada única — carrega tudo via babel).

| Arquivo | Função |
|---|---|
| `oimpresso.com.html` | Shell HTML — imports na ordem correta |
...
2. Abrir `oimpresso.com.html` no preview e clicar pelas telas — entender o que existe.
