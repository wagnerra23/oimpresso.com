...
# prototipo-ui/cowork/Wagner/legado/* contém mock data UI Cowork (CNPJs/CPFs fake sequenciais
...
SKIP_DIR_REGEX='^(vendor|node_modules|public|storage|bootstrap/cache|\.git|prototipo-ui/cowork/(Wagner|Felipe)/legado|prototipo-ui/_incoming)/'
