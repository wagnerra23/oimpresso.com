...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
   ...
   // Route::resource('convenio', 'ConvenioController');
    ...
    Route::group(['prefix' => '/convenio'], function(){
        Route::get('/create', 'ConvenioController@create');
        Route::post('/store', 'ConvenioController@store');
        Route::get('/destroy/{id}', 'ConvenioController@destroy');
        Route::get('/edit/{id}', 'ConvenioController@edit');
        Route::post('/update', 'ConvenioController@update');
    });
