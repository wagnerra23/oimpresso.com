...
| ⏳ | TODO | W | **MEM-MCP-1.e: dashboard /copiloto/admin/governanca** — visualização do `mcp_audit_log`, top tools por user, latência p50/p95, denied count por error_code | sex 09-mai | 1 |
