...
| A1 | 1/2 | W | **MEM-MCP-1.d: RBAC Spatie + filtro scope** — `copiloto.mcp.*` permissions + middleware filter por user_role | seg 05-mai | 1 |
| A2 | 2/2 | W | **MEM-MCP-1.c-perf: Otimizar latência cold start** — `route:cache` + reduzir módulos no container (5-30s atual) | seg 05-mai | 0.5 |
