 ...
 *
 * @see Modules\Forja\Http\Requests\BriefFetchToolRequest (tool MCP scope)
 * @see Modules\Forja\Http\Requests\ForceRefreshBriefRequest (refresh cache scope)
 * @see Modules\Forja\Console\Commands\GenerateBriefCommand (CLI canônico hoje)
