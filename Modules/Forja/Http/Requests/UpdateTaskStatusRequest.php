 ...
 * Diferente de FSM (ADR 0143 — Forja usa Kanban free-flow, fsm_n_a=true).
 *
 * @see Modules\Forja\Http\Controllers\BoardController::updateStatus
...
class UpdateTaskStatusRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'status.in'       => 'Status inválido. Valores aceitos: todo, doing, blocked, done (Kanban Forja — ADR 0070).',
