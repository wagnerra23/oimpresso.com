 ...
 * `Modules/Forja/Config/retention.php` (Wave 13, ADR 0105 sinal qualificado
 ...
 *
 * @see Modules\Forja\Config\retention.php (retention canon)
 * @see Modules\Forja\Http\Requests\GenerateBriefRequest (pattern referência)
