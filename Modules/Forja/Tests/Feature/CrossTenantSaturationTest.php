...
use Modules\Forja\Http\Requests\StoreProjectRequest;
use Modules\Forja\Http\Requests\StoreTaskRequest;
use Modules\Forja\Http\Requests\UpdateProjectRequest;
use Modules\Forja\Http\Requests\UpdateTaskRequest;
use Modules\Forja\Http\Requests\UpdateTaskStatusRequest;

uses(Tests\TestCase::class);

/**
 * D1 — Wave 18 saturação multi-tenant cross-tenant Forja (meta 97).
 *
...
it('FormRequests Forja autorizam (middleware auth upstream)', function () {
