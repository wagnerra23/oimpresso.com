...
use Modules\Forja\Http\Requests\CompareBriefRequest;
use Modules\Forja\Http\Requests\ExportBriefMarkdownRequest;
use Modules\Forja\Http\Requests\FetchBriefHistoryRequest;
use Modules\Forja\Http\Requests\InvalidateBriefRequest;
use Modules\Forja\Http\Requests\MarkBriefValidRequest;
use Modules\Forja\Http\Requests\PurgeBriefHistoryRequest;
 ...
 *
 * @see Modules\Forja\Services\BriefGeneratorService::generateWithFallback
 * @see Modules\Forja\Services\BriefGeneratorService::serveCachedWithStaleFlag
 * @see Modules\Forja\Http\Requests\PurgeBriefHistoryRequest
 * @see Modules\Forja\Http\Requests\InvalidateBriefRequest
