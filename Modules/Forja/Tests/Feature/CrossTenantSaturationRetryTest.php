...
use Modules\Forja\Http\Requests\AddCommentRequest;
use Modules\Forja\Http\Requests\AddSubtaskRequest;
use Modules\Forja\Http\Requests\BulkBacklogRequest;
use Modules\Forja\Http\Requests\WatchTaskRequest;

uses(Tests\TestCase::class);

/**
 * D1 + D8.c — Wave 18 RETRY saturação Forja (meta 97 module-grade).
 *
...
it('FormRequests novos Wave 18 RETRY Forja autorizam (middleware auth upstream)', function () {
