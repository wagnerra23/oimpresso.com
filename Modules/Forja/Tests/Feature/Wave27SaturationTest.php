...
/**
 * Wave 27 Forja POLISH ≥90 — D2 CustomerJourney expandido + D9 spans completos + D8 ratio.
 *
...
describe('Wave 27 Forja POLISH', function () {
    ...
    it('D2 CustomerJourney cumulativo: Wave 16 + scenarios extras ≥7 cenários totais', function () {
        $cj = base_path('Modules/Forja/Tests/Feature/CustomerJourneyTest.php');
    ...
    it('D9 spans completos ProjectService: 6 spans project_mgmt.project.*', function () {
        ...
        $src = file_get_contents(base_path('Modules/Forja/Services/ProjectService.php'));
    ...
    it('D9 span ForjaAuditService.log canônico (cobre logTaskStatusChange/Comment via delegate)', function () {
        $src = file_get_contents(base_path('Modules/Forja/Services/ForjaAuditService.php'));
    ...
    it('D8 FormRequests ratio ≥0.85: 9 FormRequests em Http/Requests/ (W18 RETRY)', function () {
        $dir = base_path('Modules/Forja/Http/Requests');
        if (! is_dir($dir)) {
    ...
    it('D6 defer cobertura: 5 Controllers Kanban com Inertia::defer (W16/17)', function () {
        $covered = [
            'Modules/Forja/Http/Controllers/BoardController.php',
            'Modules/Forja/Http/Controllers/BacklogController.php',
            'Modules/Forja/Http/Controllers/MyWorkController.php',
            'Modules/Forja/Http/Controllers/BurndownController.php',
            'Modules/Forja/Http/Controllers/RoadmapController.php',
        ];
    ...
    it('D9 module boundary: Services dentro Modules\\Forja + imports canon', function () {
        expect(ProjectService::class)->toStartWith('Modules\\Forja\\');
        expect(ForjaAuditService::class)->toStartWith('Modules\\Forja\\');

        foreach ([ProjectService::class, ForjaAuditService::class] as $cls) {
    ...
    it('D6 module.json declara fsm_n_a:true (Kanban free-flow ≠ FSM tabular)', function () {
        $path = base_path('Modules/Forja/module.json');
        if (! file_exists($path)) {
