...
## UC-FORJA-15 — Changelog desenha o feed do protótipo (dot + corpo), com selo e módulo de coluna REAL
...
## UC-FORJA-16 — Sessão sem resumo herda o 1º prompt — acaba a parede "Sessão Claude Code"
Status: 🧪 (3 testes de `ForjaChangelogServiceTest` **citam este UC no título** — deriva do 1º prompt por `ts`, vazio honesto sem prompt, corte em 160 + PII redigida. Mesmo motivo do UC-FORJA-15 pra seguir 🧪.)
