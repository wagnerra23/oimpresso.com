...
/**
 * ForjaAuditService — D7.b LGPD audit trail (Wave 16 Governance).
 *
 * Forja **não possui Entities próprias** (opera sobre models Jana:
    ...
    public function __construct(
        ...
        if ($this->businessId <= 0) {
            throw new \InvalidArgumentException(
                'ForjaAuditService exige business_id > 0 (multi-tenant Tier 0 — ADR 0093)'
            );
        }
    }

    /**
     * Registra evento de domínio Forja no activity_log canônico Spatie.
     *
