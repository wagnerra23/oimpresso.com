...
/**
 * Política de retenção de dados — Módulo Forja (D7 LGPD compliance).
 *
 * Declara explicitamente o tempo de retenção das entidades manipuladas pelo
 * módulo Jira-style (Board/Backlog/MyWork/Roadmap/Activity). Forja
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Diferente do Crm (notifica titular externo), Forja notifica owner
