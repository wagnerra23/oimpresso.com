...
/**
 * Instala os git hooks do MemCofre em `.git/hooks/`.
 *
 * Hooks copiados:
...
{
    protected $signature = 'memcofre:install-hooks {--force : Sobrescreve hooks existentes}';

    protected $description = 'Instala git hooks do MemCofre em .git/hooks/';
