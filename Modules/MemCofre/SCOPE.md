---
module: MemCofre
will_repurpose_to: SRS
will_rename_at_phase: 3.7
purpose: "Cofre de documentação viva (estado atual: evidências). Repurpose pra **System Rules Spec (SRS)** — regras imutáveis pra IA programar. Append-only por trigger MySQL. Toda IA L2+ lê SRS antes de qualquer ação no código."
contains:
...
url_prefixes:
  - /memcofre/*
  - (futuro) /srs/* — a partir de Fase 3.7
db_tables_owned:
...
# Modules/MemCofre — Cofre de evidências (futuro: SRS — System Rules Spec)
