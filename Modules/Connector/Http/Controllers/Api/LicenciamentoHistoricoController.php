...
use Carbon\Carbon;
use App\LicenciamentoHistorico;

/**
 * @group Licenciamento Histórico Management
 * @authenticated
 *
 * APIs para gerenciar histórico de licenciamento.
 */
class LicenciamentoHistoricoController extends ApiController
{
    /**
     * Sincronizar histórico de licenciamento
     */
    public function syncLicenciamentoHistorico(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $historico = LicenciamentoHistorico::where('business_id', $business_id)
                    ...
                    if ($historico) {
                        ...
                        $historico = LicenciamentoHistorico::create([
            ...
            Log::error('Erro na sincronização de histórico de licenciamento: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar históricos de licenciamento até uma data específica
     */
    public function getSyncLicenciamentoHistoricoUntilDate(Request $request)
    {
        ...
        try {
            ...
            $historicos = LicenciamentoHistorico::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar histórico de licenciamento: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
