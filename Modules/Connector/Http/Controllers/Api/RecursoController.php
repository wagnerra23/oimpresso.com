...
/**
 * @group Recurso Management
 * @authenticated
 *
 * APIs para gerenciar Recurso.
 */
class RecursoController extends ApiController
{
    /**
     ...
     * }
     */
    public function syncRecurso(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = Recurso::where('business_id', $business_id)
            ...
            Log::error('Erro na sincronização de Recursos: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar Recursos atualizados até uma data
     */
    public function getRecursoUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = Recurso::where('business_id', $business_id)
