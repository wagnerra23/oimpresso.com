...
use Carbon\Carbon;
use App\BalancoProduto;

/**
 * @group BalancoProduto Management
 * @authenticated
 *
 * APIs para gerenciar BalancoProduto.
 */
class BalancoProdutoController extends ApiController
{
    /**
     * Sincronizar BalancoProduto
     *
     ...
     * }
     */
    public function syncBalancoProduto(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = BalancoProduto::where('business_id', $business_id)
                    ...
                    if ($registro) {
                        ...
                        $registro = BalancoProduto::create([
            ...
            Log::error('Erro na sincronização de BalancoProduto: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar BalancoProduto atualizado até uma data
     */
    public function getBalancoProdutoUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = BalancoProduto::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar BalancoProduto: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
