...
use Carbon\Carbon;
use App\CentroTrabalhoPlanocontas;

/**
 * @group Centro Trabalho Plano Contas Management
 * @authenticated
 *
 * APIs para gerenciar Centro Trabalho Plano Contas.
 */
class CentroTrabalhoPlanocontasController extends ApiController
{
    /**
     * Sincronizar Centro Trabalho Plano Contas
     *
     ...
     * }
     */
    public function syncCentroTrabalhoPlanocontas(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = CentroTrabalhoPlanocontas::where('business_id', $business_id)
                    ...
                    if ($registro) {
                        ...
                        $registro = CentroTrabalhoPlanocontas::create([
            ...
            Log::error('Erro na sincronização de Centro Trabalho Plano Contas: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar Centro Trabalho Plano Contas atualizados até uma data
     */
    public function getCentroTrabalhoPlanocontasUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = CentroTrabalhoPlanocontas::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar Centro Trabalho Plano Contas: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
