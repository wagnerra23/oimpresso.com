...
use Carbon\Carbon;
use App\UsuarioExtraex;

class UsuarioExtraexController extends ApiController
{
    public function syncUsuarioExtraex(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $record = UsuarioExtraex::where('business_id', $business_id)
            ...
            Log::error('Erro na sincronização de UsuarioExtraex: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    public function getSyncUsuarioExtraexUntilDate(Request $request)
    {
        ...
        try {
            ...
            $records = UsuarioExtraex::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar registros de UsuarioExtraex: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
