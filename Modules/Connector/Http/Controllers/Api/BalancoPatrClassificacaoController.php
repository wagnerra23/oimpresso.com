...
use Carbon\Carbon;
use App\BalancoPatrClassificacao;

/**
 * @group BalancoPatrClassificacao Management
 * @authenticated
 *
 * APIs para gerenciar Balanco Patr Classificacao.
 */
class BalancoPatrClassificacaoController extends ApiController
{
    /**
     * Sincronizar Balanco Patr Classificacao
     *
     ...
     * }
     */
    public function syncBalancoPatrClassificacao(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = BalancoPatrClassificacao::where('business_id', $business_id)
                    ...
                    if ($registro) {
                        ...
                        $registro = BalancoPatrClassificacao::create([
            ...
            Log::error('Erro na sincronização de Balanco Patr Classificacao: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar Balanco Patr Classificacao atualizado até uma data
     */
    public function getBalancoPatrClassificacaoUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = BalancoPatrClassificacao::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar Balanco Patr Classificacao: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
