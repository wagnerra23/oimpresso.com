...
/**
 * @group Balanco Management
 * @authenticated
 *
 * APIs para gerenciar Balanco.
 */
class BalancoController extends ApiController
{
    /**
     * Sincronizar Balanco
     *
     ...
     * }
     */
    public function syncBalanco(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = Balanco::where('business_id', $business_id)
            ...
            Log::error('Erro na sincronização de Balanco: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar Balancos atualizados até uma data
     */
    public function getBalancoUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = Balanco::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar Balancos: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
