...
/**
 * @group Local Management
 * @authenticated
 *
 * APIs para gerenciar Local.
 */
class LocalController extends ApiController
{
    ...
    public function syncLocal(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = Local::where('business_id', $business_id)
            ...
            Log::error('Erro na sincronização de Locais: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar Locais atualizados até uma data
     */
    public function getLocalUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = Local::where('business_id', $business_id)
