    ...
    public function saveBusiness(Request $request)
    {
        ...
        try {
            ...
            if (!$business) {
                ...
                // Cria owner user com placeholder. Username final eh atribuido
                // mais abaixo apos criar o business (officelocal-<business_id>).
                // (ajustado 2026-04-24: User::createOwnerUser removido em 6.7)
                $tempUsername = 'officeowner_' . substr(md5($dadosEmpresa['CNPJCPF'] . microtime(true)), 0, 10);
                $user = User::create_user([
                    'surname'    => 'Sr',
                    'first_name' => 'Owner',
                    'last_name'  => $dadosEmpresa['RAZAOSOCIAL'] ?? '',
                    'username'   => $tempUsername,
                    'email'      => $tempUsername . '@wr2.com.br',
