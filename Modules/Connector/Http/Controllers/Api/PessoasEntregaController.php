...
use Carbon\Carbon;
use App\PessoasEntrega;

class PessoasEntregaController extends ApiController
{
    public function syncPessoasEntrega(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $record = PessoasEntrega::where('business_id', $business_id)
            ...
            Log::error('Erro na sincronização de PessoasEntrega: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    public function getSyncPessoasEntregaUntilDate(Request $request)
    {
        ...
        try {
            ...
            $records = PessoasEntrega::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar PessoasEntrega: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
