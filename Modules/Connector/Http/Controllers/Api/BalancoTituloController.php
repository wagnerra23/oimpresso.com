...
use Carbon\Carbon;
use App\BalancoTitulo;

/**
 * @group BalancoTitulo Management
 * @authenticated
 *
 * APIs para gerenciar BalancoTitulo.
 */
class BalancoTituloController extends ApiController
{
    /**
     * Sincronizar BalancoTitulo
     *
     ...
     * }
     */
    public function syncBalancoTitulo(Request $request)
    {
        try {
            ...
            foreach ($data as $item) {
                try {
                    $registro = BalancoTitulo::where('business_id', $business_id)
            ...
            Log::error('Erro na sincronização de BalancoTitulo: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Listar BalancoTitulo atualizado até uma data
     */
    public function getBalancoTituloUntilDate(Request $request)
    {
        ...
        try {
            ...
            $registros = BalancoTitulo::where('business_id', $business_id)
            ...
            Log::error('Erro ao buscar BalancoTitulo: ' . $e->getMessage());
            return response()->json([
                'status' => 'error',
