...
/**
 * FormRequest pra atualizar JobSheet (Repair).
 *
 * D8.c Security — Wave S. Extraido de JobSheetController@update.
 *
 * Diferença vs StoreJobSheetRequest:
 * - permission 'job_sheet.edit' (não 'create')
 * - contact_id passa a 'sometimes' (PATCH-friendly)
 * - location_id NÃO faz parte do whitelist do update (apenas store)
 */
class UpdateJobSheetRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $user->can('job_sheet.edit');
    }
