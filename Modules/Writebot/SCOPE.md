---
module: Writebot
will_delete_at_phase: 3.1
purpose: "DEPRECATED — vazio funcional (2 controllers boilerplate). DELETE em Fase 3.1."
contains:
  - "DataController"
  - "InstallController"
not_contains:
...
DEPRECATED — vazio funcional (2 controllers boilerplate). DELETE em Fase 3.1.
