<div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title">@lang( 'boleto::lang.production_details' ) (<b>@lang('purchase.ref_no'):</b> #{{ $production_purchase->ref_no }})</h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4>@lang('boleto::lang.product_details')</h4>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <strong>@lang('boleto::lang.waste_units'):</strong>
                    {{@format_quantity($quantity_wasted)}} {{$unit_name}}
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <h4>@lang('boleto::lang.ingredients')</h4>
                </div>
                <div class="col-md-12">
                    <table class="table table-striped">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="text-right"><strong>@lang('boleto::lang.ingredients_cost')</strong></td>
                                <td><span class="display_currency" data-currency_symbol="true">{{$total_ingredient_price}}</span></td>
                            </tr>
                            <tr>
                                <td colspan="4" class="text-right"><strong>{{__('boleto::lang.production_cost')}}:</strong></td>
                                <td><span class="display_currency" data-currency_symbol="true">{{$total_production_cost}}</span> </td>
                            </tr>
                            <tr><td colspan="4" class="text-right"><strong>{{__('boleto::lang.total_cost')}}:</strong></td>
