...
<section class="content">
	...
	{!! Form::open(['url' => action('\Modules\Boleto\Http\Controllers\ProductionController@update', [$production_purchase->id]), 'method' => 'put', 'id' => 'production_form', 'files' => true ]) !!}
		...
		<div class="row">
			<div class="col-md-12">
				<div id="enter_ingredients_table">
					@include('boleto::recipe.ingredients_for_production')
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input_inline">
						...
						<span>
							{!! Form::select('mfg_production_cost_type',['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage'), 'per_unit' => __('boleto::lang.per_unit')], $production_purchase->mfg_production_cost_type, ['class' => 'form-control', 'id' => 'mfg_production_cost_type']); !!}	
						</span>
					</div>
					<p><strong>
