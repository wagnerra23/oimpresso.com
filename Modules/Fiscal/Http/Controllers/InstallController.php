...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'fiscal';
        $this->appVersion = config('fiscal.module_version');
    }
    ...
    public function index()
    {
        ...
        $action_url = action('\Modules\Fiscal\Http\Controllers\InstallController@install');
    ...
    public function install()
    {
     ...
     //   }
        ...
        Artisan::call('module:migrate', ['module' => "Fiscal"]);
        System::addProperty($this->module_name . '_version', $this->appVersion);

        $output = ['success' => 1,
                    'msg' => 'Módulo Fiscal instalado com sucesso'
                ];
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1,
                        'msg' => 'Módulo Fiscal atualizado com Sucesso para versão ' . $this->appVersion . ' !!'
                    ];
