...
it('UC-FSPED-03 · resolverTributoItem com motor configurado retornando CST 00 + CFOP 6102 + aliq 18% (Lucro Presumido)', function () {
...
it('UC-FSPED-03 · resolverTributoItem fallback quando motor lança NcmObrigatorioException', function () {
    $motorMock = new class extends MotorTributarioService
    {
        public function calcular(ProdutoFiscalContext $produto, int $businessId, string $ufOrigem, string $ufDestino): TributoCalculado
        {
...
it('UC-FSPED-04 · keyTotalizadorC190 não retorna mais hardcode "102" — chave composta CST|CFOP|ALIQ', function () {
    $service = new SpedIcmsIpiGeneratorService;
    $emissao = new \Modules\NfeBrasil\Models\NfeEmissao;
    $emissao->id = 1;
    $emissao->business_id = 1;
