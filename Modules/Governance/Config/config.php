...
return [
    ...
    'drift_checkers' => [
        ...
        \Modules\Governance\Services\Checkers\PlanDriftChecker::class,           // 2026-08-04 — adapter do `jana:plan-drift` (ADR 0294 Onda 2), escrito+testado e com ZERO invocador (0 de 98 comandos no schedule:list de prod)
    ],
