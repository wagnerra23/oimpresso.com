<script type="text/javascript">
	$(document).ready( function() {
        ...
        }, "{{__('boleto::lang.quantity_greater_than_zero')}}");
        ...
        }, "{{__('boleto::lang.waste_qty_less_than_qty')}}");
	...
	$(document).on('change', '#production_form #variation_id, #production_form #location_id', function () {
		...
		if(variation_id && location_id) {
			$.ajax({
	            url: "/boleto/get-recipe-details?variation_id=" + variation_id + "&location_id=" + location_id,
	            dataType: 'json',
