 ...
 *   - RrfReranker (default atual)        — NDCG@10 baseline, ~1ms,    R$ [redacted Tier 0]      algorítmico
 *   - **BgeReranker (este)**             — NDCG@10 +6pp,    100-300ms (CPU CT 100), R$ [redacted Tier 0] self-host
 *   - Cohere Rerank 3.5 cloud            — NDCG@10 +8pp,    100-300ms, $2/1k tokens, dep cloud
 *   - LlmRerankerAdapter (gpt-4o-mini)   — NDCG@10 +5pp,    ~200ms,   R$ [redacted Tier 0]/rerank
 *
