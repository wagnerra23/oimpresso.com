 ...
 *
 * Custo: 1× LLM call/dia/business (~500 tokens out @ gpt-4o-mini = R$ [redacted Tier 0]/dia/biz)
 * Ganho: ~30% redução no system prompt (snapshots prontos vs cálculo dinâmico)
 */
class ProfileDistiller
{
    public function __construct(
        protected \Modules\Jana\Services\ContextSnapshotService $context,
    ) {
    }
    ...
    protected function systemPrompt(): string
    {
        ...
        R$ [redacted Tier 0] bruto / R$ [redacted Tier 0] caixa nos últimos 90 dias.
        Março foi o melhor mês (R$ [redacted Tier 0]k); abril vem caindo 50%. Top clientes: Y, Z, W.
        Meta atual: R$ [redacted Tier 0]k/mês — 39% atingido em abril, projeção de não bater."
        PROMPT;
    }
}
