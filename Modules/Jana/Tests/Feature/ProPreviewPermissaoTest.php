...
it('CONTROLE: o `can()` do dono e FALSE — desde a ADR 0415 a ability E a trava', function () {
    // Até 2026-09-24 este caso asseria `true`: o `Gate::before` liberava o dono e a
    // trava real era o `user_type` do controller. A ADR 0415 tirou `jana.superadmin`
...
it('UC-JPERM-08 · o PREVIEW admin de outro business é 403 pro dono do negócio', function () {
    ...
    // Desde a ADR 0415 quem morde é o MIDDLEWARE (`can:jana.superadmin`), antes do
