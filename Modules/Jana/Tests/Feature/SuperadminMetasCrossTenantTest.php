...
it('CONTROLE: o dono do negócio NÃO passa mais no can(jana.superadmin) — ADR 0415', function () {
    // Até 2026-09-24 este caso asseria `true` (o `Gate::before` liberava o dono em
    // qualquer ability). A ADR 0415 tirou as permissões de plataforma do bypass; a
