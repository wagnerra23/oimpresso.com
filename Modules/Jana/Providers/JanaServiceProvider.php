...
class JanaServiceProvider extends ServiceProvider
{
    ...
    public function boot(Router $router): void
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                ...
                \Modules\Jana\Console\Commands\McpTasksUnassignedCommand::class, // US-INFRA-043 — sentinela US todo sem cycle/owner (furo #2 auditoria 2026-06-21 — invisível no roadmap)
    ...
    public function register(): void
    {
        ...
        // caching sentinels. Cap mensal R$ [redacted Tier 0] Threshold ativação 8KB.
