 ...
 *
 * Custo: ~R$ [redacted Tier 0] por handoff-draft (gpt-4o-mini, ~6k input + ~800 output).
...
class HandoffDraftTool extends Tool
{
    ...
    protected string $description = 'Gera draft de handoff em memory/handoffs/YYYY-MM-DD-HHMM-<slug>.md cruzando handoff-diff (eventos desde data) + último handoff (formato referência) + gpt-4o-mini. Wagner edita antes de commit (ADR 0130 append-only preservado). Custo ~R$ [redacted Tier 0]/draft.';
    ...
    protected function montarSkeletonViaLlm(
        ...
        try {
            ...
            // $0.15/M input + $0.60/M output → ~R$ [redacted Tier 0] com câmbio 5x
