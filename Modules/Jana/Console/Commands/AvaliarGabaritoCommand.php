...
use Modules\Jana\Services\Metricas\GabaritoEvaluator;
 ...
 *
 * Custo / esforço:
 *   - Sem --resposta: 50 perguntas × ~50ms recall = ~2.5s, R$ [redacted Tier 0]
 *   - Com --resposta: 50 perguntas × ~3s LLM = 2.5min, ~R$ [redacted Tier 0]/run
 *
