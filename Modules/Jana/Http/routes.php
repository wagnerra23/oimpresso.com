...
Route::group(['middleware' => ['web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu'], 'prefix' => 'jana', 'namespace' => 'Modules\Jana\Http\Controllers'], function()
{
    ...
    Route::get('/jana', function () {
        return view('superadmin.iframe', ['url' => 'https://jana.wr2.com.br']);
    })->name('superadmin.jana');

    Route::get('/assistenteia', function () {
        return view('superadmin.iframe', ['url' => 'https://jana.wr2.com.br/chat/VO02CdkX9ZDRIhlw']);
    })->name('superadmin.assistenteia');


    Route::get('/n8n', function () {
        return view('superadmin.iframe', ['url' => 'https://n8n.wr2.com.br']);
    })->name('superadmin.n8n');

    Route::get('/flowise', function () {
        return view('superadmin.iframe', ['url' => 'https://flowise.wr2.com.br']);
    })->name('superadmin.flowise');
