 ...
 */
class OportunidadesTool implements Tool, DeclaraPermissao
{
     ...
     *
     * Gateia a TABELA lida: `transaction_sell_lines` — linhas de venda p/ upsell (BriefDiarioService::oportunidadesUpsell).
