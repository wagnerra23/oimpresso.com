 ...
 */
class VendasPeriodoTool implements Tool, DeclaraPermissao
{
     ...
     *
     * Gateia a TABELA lida: `transactions` — totais de venda por período (BriefDiarioService::vendasPeriodo).
