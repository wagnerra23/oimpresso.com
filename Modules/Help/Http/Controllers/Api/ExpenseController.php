...
use Modules\Help\Transformers\ExpenseResource;
use DB;
use App\Transaction;
...
class ExpenseController extends ApiController
{
     ...
     * @response {
	    ...
	    "links": {
	        "first": "http://local.pos.com/help/api/expense?page=1",
	        "last": null,
	        "prev": null,
	        "next": null
	    },
	    "meta": {
	        "current_page": 1,
	        "from": 1,
	        "path": "http://local.pos.com/help/api/expense",
	        "per_page": 10,
	        "to": 1
	    }
	}
    ...
    */
     ...
     * @response {
	    ...
	    "links": {
	        "first": "http://local.pos.com/help/api/expense-refund?page=1",
	        "last": null,
	        "prev": null,
	        "next": null
	    },
	    "meta": {
	        "current_page": 1,
	        "from": 1,
	        "path": "http://local.pos.com/help/api/expense-refund",
	        "per_page": 15,
	        "to": 1
	    }
	}
