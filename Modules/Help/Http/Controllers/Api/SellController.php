...
use App\Variation;
use Modules\Help\Transformers\SellTransactionResource;
...
use DB;
use Modules\Help\Transformers\SellResource;
...
class SellController extends ApiController
{
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/help/api/sell?page=1",
            "last": "http://local.pos.com/help/api/sell?page=6",
            "prev": null,
            "next": "http://local.pos.com/help/api/sell?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/help/api/sell",
            "per_page": 10,
            "to": 10
        }
    }
    ...
    * @response {
        ...
        "links": {
            "first": "http://local.pos.com/help/api/list-sell-return?sell_id=157&page=1",
            "last": null,
            "prev": null,
            "next": null
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/help/api/list-sell-return",
            "per_page": 10,
            "to": 1
        }
    }
