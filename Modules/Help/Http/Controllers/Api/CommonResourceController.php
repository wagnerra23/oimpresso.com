...
use Modules\Help\Transformers\BusinessResource;
use App\Account;
use App\Business;
...
class CommonResourceController extends ApiController
{
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/help/api/product-stock-report?page=1",
            "last": "http://local.pos.com/help/api/product-stock-report?page=22",
            "prev": null,
            "next": "http://local.pos.com/help/api/product-stock-report?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "last_page": 22,
            "path": "http://local.pos.com/help/api/product-stock-report",
            "per_page": 3,
            "to": 3,
            "total": 66
        }
