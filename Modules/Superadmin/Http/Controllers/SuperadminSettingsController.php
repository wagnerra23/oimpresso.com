...
class SuperadminSettingsController extends BaseController
{
    ...
    public function edit()
    {
        ...
        $default_values = [
            ...
            'PAGSEGURO_MAIL' => $is_demo ? null : env('PAGSEGURO_MAIL'),
            'PAGSEGURO_KEY' => $is_demo ? null : env('PAGSEGURO_KEY'),
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $env_settings =  $request->only(['APP_NAME', 'APP_TITLE',
                ...
                'PESAPAL_CONSUMER_KEY', 'PESAPAL_CONSUMER_SECRET', 'PESAPAL_LIVE', 'PUSHER_APP_ID', 'PUSHER_APP_KEY', 'PUSHER_APP_SECRET', 'PUSHER_APP_CLUSTER', 'GOOGLE_MAP_API_KEY', 'PAGSEGURO_KEY', 'PAGSEGURO_MAIL'
            ]);
