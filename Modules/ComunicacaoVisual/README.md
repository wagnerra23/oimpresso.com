...
**Persona:** Larissa-equivalente — dona/operadora de gráfica pequena (1-5 funcionários, ~R$ [redacted Tier 0]k/mês faturamento).

### 3.1 Atender pedido novo
1. Cliente liga: "Preciso de 2 lonas 3m × 1.5m com bastões"
2. Vendedor abre `/com-visual/orcamentos/novo`
3. Sistema calcula: 9m² × R$ [redacted Tier 0]/m² (lona 440g) + bastões R$ [redacted Tier 0]/un × 4 = **R$ [redacted Tier 0]**
