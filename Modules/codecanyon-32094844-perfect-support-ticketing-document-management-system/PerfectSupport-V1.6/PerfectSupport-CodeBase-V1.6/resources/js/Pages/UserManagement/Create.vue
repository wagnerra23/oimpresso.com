<template>
 	<layout :title="__('messages.add_user')">
				            	...
				            	<div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" :class="['form-control', $page.errors.password ? 'is-invalid': '']" id="password" :placeholder="__('messages.password')" v-model="new_user.password" required>
		...
		props: ['roles'],
  		...
  		methods:{
			submitForm(){
                ...
                self.$inertia.post(self.route_ziggy('user-management.store'), self.new_user)
