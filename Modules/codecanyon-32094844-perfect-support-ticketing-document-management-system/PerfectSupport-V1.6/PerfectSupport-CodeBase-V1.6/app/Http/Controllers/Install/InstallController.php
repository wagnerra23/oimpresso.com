...
class InstallController extends Controller
{
    ...
    {
        $db_version = \App\System::getProperty('db_version');
        
        if (empty($db_version) || Comparator::greaterThan($this->appVersion, $db_version)) {
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if (empty($db_version) || Comparator::greaterThan($this->appVersion, $db_version)) {
                ...
                \App\System::setProperty('db_version', $this->appVersion);
