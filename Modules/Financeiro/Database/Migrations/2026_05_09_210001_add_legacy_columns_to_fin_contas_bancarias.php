 ...
 *
 * Decisão: módulo Financeiro é territory próprio (não-core), permite adicionar
 * colunas direto sem bridge table. Diferente de accounts que é core
 * UltimatePOS e precisa de accounts_legacy_map.
 *
 * Idempotência via UNIQUE (business_id, legacy_source, legacy_id) — UPSERT
 * quando re-importar.
 */
