...
use Modules\Chat\Transformers\ProductResource;
use Modules\Chat\Transformers\VariationResource;
...
class ProductController extends ApiController
{
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/chat/api/product?page=1",
            "last": "http://local.pos.com/chat/api/product?page=32",
            "prev": null,
            "next": "http://local.pos.com/chat/api/product?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/chat/api/product",
            "per_page": 10,
            "to": 10
        }
    }
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/chat/api/variation?page=1",
            "last": null,
            "prev": null,
            "next": "http://local.pos.com/chat/api/variation?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/chat/api/variation",
            "per_page": "2",
            "to": 2
        }
    }
