...
use App\Variation;
use Modules\Chat\Transformers\SellTransactionResource;
...
use DB;
use Modules\Chat\Transformers\SellResource;
...
class SellController extends ApiController
{
     ...
     * @response {
        ...
        "links": {
            "first": "http://local.pos.com/chat/api/sell?page=1",
            "last": "http://local.pos.com/chat/api/sell?page=6",
            "prev": null,
            "next": "http://local.pos.com/chat/api/sell?page=2"
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/chat/api/sell",
            "per_page": 10,
            "to": 10
        }
    }
    ...
    * @response {
        ...
        "links": {
            "first": "http://local.pos.com/chat/api/list-sell-return?sell_id=157&page=1",
            "last": null,
            "prev": null,
            "next": null
        },
        "meta": {
            "current_page": 1,
            "from": 1,
            "path": "http://local.pos.com/chat/api/list-sell-return",
            "per_page": 10,
            "to": 1
        }
    }
    */
    public function listSellReturn()
    {
        ...
        if ($perPage == -1) {
            ...
            $sell_returns = $query->simplePaginate($perPage)->appends($filters);
        }
