...
use Modules\Chat\Transformers\CommonResource;
use App\Contact;
...
class ContactController extends ApiController
{
    ...
    */
    public function index()
    {
        ...
        if($type == 'oimpresso'){
            $query->whereNull('contacts.is_sincronizado');
        }     
    ...
    * @bodyParam name string required Name of the contact
    ...
    public function store(Request $request)
    {
        try {
            ...
            $input = $request->only(['type', 'supplier_business_name',
                'prefix', 'name', 'middle_name', 'last_name', 'tax_number', 'pay_term_number', 'pay_term_type', 'mobile', 'landline', 'alternate_number', 'city', 'city_id', 'state', 'country', 'address_line_1', 'address_line_2', 'customer_group_id', 'zip_code', 'contact_id', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 'email', 'shipping_address', 'position', 'dob', 'is_sincronizado']);
