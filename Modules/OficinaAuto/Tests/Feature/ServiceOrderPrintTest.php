...
it('includes correct total in receipt HTML', function () {
    ...
    session(['user.business_id' => PRINT_BIZ_A]);
    // 2 items: R$ [redacted Tier 0] + R$ [redacted Tier 0] = R$ [redacted Tier 0] total
    ...
    // Total R$ [redacted Tier 0] (item1 R$ [redacted Tier 0] + item2 R$ [redacted Tier 0]) — formato pt-BR.
