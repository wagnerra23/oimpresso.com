 ...
 * `can:jana.mcp.memory.manage`; kb.publish.troubleshoot ainda é declarativa.
...
it('POST /kb/decision-trees creates tree + steps in transaction (root_step_id populated)', function () {
    kbActAsUser(bizId: 1, permissions: ['jana.mcp.memory.manage', 'kb.view', 'kb.publish.troubleshoot']);
