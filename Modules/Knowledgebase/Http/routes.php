...
Route::group(
    ['middleware' => 'web', 'prefix' => 'knowledgebase', 'namespace' => 'Modules\Knowledgebase\Http\Controllers'], function () {
        ...
        Route::delete('delete-category/{id}', 'SetupController@destroyCategory')->name('kb.category.destroy');
