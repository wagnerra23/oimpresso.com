...
class InstallController extends Controller
{
    public function __construct()
    {
        ...
        $this->appVersion = config('dashboard.module_version');
    }
    ...
    public function index()
    {
        ...
        $action_url = action('\Modules\Dashboard\Http\Controllers\InstallController@install');
    ...
    public function install()
    {
     ...
     //   }
        ...
        Artisan::call('module:migrate', ['module' => "Dashboard"]);
        System::addProperty($this->module_name . '_version', $this->appVersion);

        $output = ['success' => 1,
                    'msg' => 'Módulo Dshboard instalado com sucesso'
                ];
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1,
                        'msg' => 'Módulo Dashboard atualizado com Sucesso para versão ' . $this->appVersion . ' !!'
                    ];
