<table class="table table-striped table-th-green text-center" id="ingredients_for_unit_recipe_table">
	<thead>
		<tr>
			...
			<th>@lang('boleto::lang.final_quantity') @show_tooltip(__('boleto::lang.final_quantity_tooltip'))</th>
			<th>@lang('boleto::lang.total_price') @show_tooltip(__('boleto::lang.total_price_tooltip'))</th>
		</tr>
	</thead>
	<tbody>
		@php
		...
		@if(!empty($ingredients))
			@foreach($ingredients as $ingredient)
				@if(empty($ingredient['mfg_ingredient_group_id']))
					@include('boleto::recipe.ingredient_row_for_production')
				@else
					@php
	...
	<tfoot>
		<tr>
			<td colspan="4" style="text-align: right;"><strong>@lang('boleto::lang.ingredients_cost')</strong></td>
