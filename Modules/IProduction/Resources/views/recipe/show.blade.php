	...
	<div class="modal-content">
	    ...
	    <div class="modal-body">
	    	<div class="row">
      		...
      		<div class="row">
      			<div class="col-md-12">
      				<table class="table">
						...
						<tfoot>
							<tr>
								<td colspan="3" class="text-right"><strong>@lang('boleto::lang.ingredients_cost')</strong></td>
      		...
      		<div class="row">
      			<div class="col-md-6">
      				<strong>@lang('boleto::lang.wastage'):</strong>
      				{{$recipe->waste_percent ?? 0}} % <br>
      				<strong>@lang('boleto::lang.total_output_quantity'):</strong>
      			...
      			<div class="col-md-6">
      				<strong>@lang('boleto::lang.extra_cost'):</strong>
      				<span ></span>{{@num_format($recipe->extra_cost)}} @if($recipe->production_cost_type == 'percentage') % @elseif ($recipe->production_cost_type == 'per_unit') (@lang('boleto::lang.per_unit')) @endif <br>
      				@php
