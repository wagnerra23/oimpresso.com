@extends('layouts.app')
@section('title', __( 'boleto::lang.boleto_report' ))

@section('content')
@include('boleto::layouts.nav')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang( 'boleto::lang.boleto_report' )
    </h1>
</section>

<!-- Main content -->
<section class="content">
    <div class="print_section"><h2>{{session()->get('business.name')}} - @lang( 'boleto::lang.boleto_report' )</h2></div>
        ...
        <div class="col-xs-6">
            @component('components.widget')
                <table class="table table-striped">
                    <tr>
                        <th>{{ __('boleto::lang.total_production') }}:</th>
                        <td>
                    ...
                    <tr>
                        <th>{{ __('boleto::lang.total_production_cost') }}:</th>
                        <td>
