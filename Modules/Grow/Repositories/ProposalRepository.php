...
class ProposalRepository {
    ...
    public function contactDetails($doc_id = '') {
        ...
        if ($proposal = \Modules\Grow\Models\Proposal::Where('doc_id', $doc_id)->first()) {
            ...
            if ($proposal->docresource_type == 'client') {
                ...
                //first name
                if ($user = \Modules\Grow\Models\User::Where('clientid', $proposal->doc_client_id)->where('account_owner', 'yes')->first()) {
            ...
            if ($proposal->docresource_type == 'lead') {
                //company name
                if ($lead = \Modules\Grow\Models\Lead::Where('lead_id', $proposal->doc_lead_id)->first()) {
    ...
    public function publish($id = '') {
        ...
        //get the project
        if (!$document = \Modules\Grow\Models\Proposal::Where('doc_id', $id)->first()) {
