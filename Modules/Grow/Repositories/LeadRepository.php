...
class LeadRepository {
    ...
    public function search($id = '', $data = []) {
        ...
        if (request('action') == 'search') {
            if ($fields = \Modules\Grow\Models\CustomField::Where('customfields_type', 'leads')->Where('customfields_show_filter_panel', 'yes')->get()) {
    ...
    public function cloneLead($lead = '', $data = []) {
        ...
        if ($data['copy_checklist']) {
            if ($checklists = \Modules\Grow\Models\Checklist::Where('checklistresource_type', 'lead')->Where('checklistresource_id', $lead->lead_id)->get()) {
        ...
        //copy attachements
        if ($data['copy_files']) {
            if ($attachments = \Modules\Grow\Models\Attachment::Where('attachmentresource_type', 'lead')->Where('attachmentresource_id', $lead->lead_id)->get()) {
