...
class ClientRepository {
    ...
    public function search($id = '', $data = []) {
        ...
        if (request('action') == 'search') {
            if ($fields = \Modules\Grow\Models\CustomField::Where('customfields_type', 'clients')->Where('customfields_show_filter_panel', 'yes')->get()) {
    ...
    public function applyCustomFields($id = '') {
        ...
        foreach ($fields as $field) {
            if ($field->customfields_standard_form_status == 'enabled') {
                ...
                \Modules\Grow\Models\Client::where('client_id', $id)
                    ->update([
