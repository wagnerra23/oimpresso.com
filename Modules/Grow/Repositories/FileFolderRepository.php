...
use Modules\Grow\Models\FileFolder;
...
class FileFolderRepository {
    ...
    public function addDefault($project_id) {
        ...
        //get default folder
        $default_folder = \Modules\Grow\Models\FileFolder::Where('filefolder_system', 'yes')->Where('filefolder_default', 'yes')->first();
        ...
        $default_folders = \Modules\Grow\Models\FileFolder::Where('filefolder_system', 'yes')->Where('filefolder_default', 'no')->orderBy('filefolder_name', 'asc')->get();
