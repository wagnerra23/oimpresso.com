...
class CloneInvoiceRepository {
    ...
    public function clone ($data = []) {
        ...
        $invoice = \Modules\Grow\Models\Invoice::Where('bill_invoiceid', $data['invoice_id'])->first();
        ...
        //clone files
        if ($files = \Modules\Grow\Models\File::Where('fileresource_type', 'invoice')->Where('fileresource_id', $invoice->bill_invoiceid)->get()) {
