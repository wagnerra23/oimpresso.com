...
use Modules\Grow\Models\Pinned;
...
class PinnedRepository {
    ...
    public function togglePinned($resource_id = '', $resource_type = '') {
        ...
        if ($pin = \Modules\Grow\Models\Pinned::Where('pinnedresource_id', $resource_id)->Where('pinnedresource_type', $resource_type)->Where('pinned_userid', auth()->id())->first()) {
            $pin->delete();
            return 'unpin';
        }
