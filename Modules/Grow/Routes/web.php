...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')
    ->prefix('grow')->group(function() {
        ...
        Route::group(['prefix' => 'notes'], function () {
            ...
            // Route::any("/search", [Modules\Grow\Http\Controllers\Notes::class, 'index'])->name('grow.notes.index');
        ...
        // Route::get('/grow', [Modules\Grow\Http\Controllers\Notes::class, 'index'])->name('grow.notes.index');
    ...
    Route::get('/grow', [\Modules\Grow\Http\ControllersController::class, 'index'])->name('grow.notes.index'); //Items@index pode abrir as tarefas 

    Route::get('install', [\Modules\Grow\Http\Controllers\InstallController::class, 'index']);
    Route::post('install', [\Modules\Grow\Http\Controllers\InstallController::class, 'install']);
    Route::get('install/uninstall', [\Modules\Grow\Http\Controllers\InstallController::class, 'uninstall']);
    Route::get('install/update', [\Modules\Grow\Http\Controllers\InstallController::class, 'update']);
});
