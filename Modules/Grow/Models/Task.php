...
class Task extends Model {
    ...
    public function project() {
        return $this->belongsTo('Modules\Grow\Models\Project', 'task_projectid', 'project_id');
    }
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'task_creatorid', 'id');
    }
    ...
    public function checklists() {
        return $this->morphMany('Modules\Grow\Models\Checklist', 'checklistresource');
    }
    ...
    public function attachments() {
        return $this->morphMany('Modules\Grow\Models\Attachment', 'attachmentresource');
    }
    ...
    public function timers() {
        return $this->hasMany('Modules\Grow\Models\Timer', 'timer_taskid', 'task_id');
    }
    ...
    public function assigned() {
        return $this->belongsToMany('Modules\Grow\Models\User', 'tasks_assigned', 'tasksassigned_taskid', 'tasksassigned_userid');
    }
    ...
    public function milestone() {
        return $this->belongsTo('Modules\Grow\Models\Milestone', 'task_milestoneid', 'milestone_id');
    }
    ...
    public function projectmanagers() {
        return $this->hasMany('Modules\Grow\Models\ProjectManager', 'projectsmanager_projectid', 'task_projectid');
    }
    ...
    public function assignedrecords() {
        return $this->hasMany('Modules\Grow\Models\TaskAssigned', 'tasksassigned_taskid', 'task_id');
    }
    ...
    public function reminders() {
        return $this->morphMany('Modules\Grow\Models\Reminder', 'reminderresource');
    }
}
