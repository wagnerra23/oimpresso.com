...
class Lead extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'lead_creatorid', 'id');
    }
    ...
    public function leadstatus() {
        return $this->belongsTo('Modules\Grow\Models\LeadStatus', 'lead_status', 'leadstatus_id');
    }
    ...
    public function category() {
        return $this->belongsTo('Modules\Grow\Models\Category', 'lead_categoryid', 'category_id');
    }
    ...
    public function assignedrecords() {
        return $this->hasMany('Modules\Grow\Models\LeadAssigned', 'leadsassigned_leadid', 'lead_id');
    }
    ...
    public function assigned() {
        return $this->belongsToMany('Modules\Grow\Models\User', 'leads_assigned', 'leadsassigned_leadid', 'leadsassigned_userid');
    }
