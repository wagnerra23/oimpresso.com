...
class Client extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'client_creatorid', 'id');
    }
    ...
    public function projects() {
        return $this->hasMany('Modules\Grow\Models\Project', 'project_clientid', 'client_id');
    }
    ...
    public function users() {
        return $this->hasMany('Modules\Grow\Models\User', 'clientid', 'client_id');
    }
    ...
    public function invoices() {
        return $this->hasMany('Modules\Grow\Models\Invoice', 'bill_clientid', 'client_id');
    }
    ...
    public function estimates() {
        return $this->hasMany('Modules\Grow\Models\Estimate', 'bill_clientid', 'client_id');
    }
    ...
    public function category() {
        return $this->belongsTo('Modules\Grow\Models\Category', 'client_categoryid', 'category_id');
    }
    ...
    public function proposals() {
        return $this->hasMany('Modules\Grow\Models\Proposal', 'doc_lead_id', 'lead_id');
    }
    ...
    public function contracts() {
        return $this->hasMany('Modules\Grow\Models\Contract', 'doc_lead_id', 'lead_id');
    }
    ...
    public function expenses() {
        return $this->hasMany('Modules\Grow\Models\Expense', 'expense_clientid', 'client_id');
    }
    ...
    public function payments() {
        return $this->hasMany('Modules\Grow\Models\Payment', 'payment_clientid', 'client_id');
    }
    ...
    public function tickets() {
        return $this->hasMany('Modules\Grow\Models\Ticket', 'ticket_clientid', 'client_id');
    }
