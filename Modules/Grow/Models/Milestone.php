...
class Milestone extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'milestone_creatorid', 'id');
    }
    ...
    public function project() {
        return $this->belongsTo('Modules\Grow\Models\Project', 'milestone_projectid', 'project_id');
    }
    ...
    public function tasks() {
        return $this->hasMany('Modules\Grow\Models\Task', 'task_milestoneid', 'milestone_id');
    }
