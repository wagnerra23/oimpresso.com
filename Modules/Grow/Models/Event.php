...
class Event extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'event_creatorid', 'id');
    }
     ...
     * $note = \Modules\Grow\Models\Note::find(1);
    ...
    public function trackings() {
        return $this->hasMany('Modules\Grow\Models\EventTracking', 'eventtracking_eventid', 'event_id');
    }
