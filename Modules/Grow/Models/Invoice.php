...
class Invoice extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'bill_creatorid', 'id');
    }
    ...
    public function client() {
        return $this->belongsTo('Modules\Grow\Models\Client', 'bill_clientid', 'client_id');
    }
    ...
    public function project() {
        return $this->belongsTo('Modules\Grow\Models\Project', 'bill_projectid', 'project_id');
    }
    ...
    public function category() {
        return $this->belongsTo('Modules\Grow\Models\Category', 'bill_categoryid', 'category_id');
    }
    ...
    public function lineitems() {
        return $this->morphMany('Modules\Grow\Models\Lineitem', 'lineitemresource');
    }
    ...
    public function payments() {
        return $this->hasMany('Modules\Grow\Models\Payment', 'payment_invoiceid', 'bill_invoiceid');
    }
