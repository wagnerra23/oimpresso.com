...
class User extends Authenticatable {
    ...
    public function role() {
        return $this->hasOne('Modules\Grow\Models\Role', 'role_id', 'role_id');
    }
    ...
    public function client() {
        return $this->hasOne('Modules\Grow\Models\Client', 'client_id', 'clientid');
    }
    ...
    public function assignedTasks() {
        return $this->belongsToMany('Modules\Grow\Models\Task', 'tasks_assigned', 'tasksassigned_userid', 'tasksassigned_taskid');
    }
    ...
    public function assignedLeads() {
        return $this->belongsToMany('Modules\Grow\Models\Lead', 'leads_assigned', 'leadsassigned_userid', 'leadsassigned_leadid');
    }
    ...
    public function assignedProjects() {
        return $this->belongsToMany('Modules\Grow\Models\Project', 'projects_assigned', 'projectsassigned_userid', 'projectsassigned_projectid');
    }
    ...
    public function notifications() {
        return $this->hasMany('Modules\Grow\Models\EventTracking', 'eventtracking_userid', 'id');
    }
    ...
    public function messageNotifications() {
        return $this->hasMany('Modules\Grow\Models\MessagesTracking', 'messagestracking_user_unique_id', 'unique_id');
    }
