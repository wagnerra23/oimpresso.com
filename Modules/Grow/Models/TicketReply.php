...
class TicketReply extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'ticketreply_creatorid', 'id');
    }
    ...
    public function ticket() {
        return $this->belongsTo('Modules\Grow\Models\Ticket', 'ticketreply_ticketid', 'ticket_id');
    }
