...
class Ticket extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'ticket_creatorid', 'id');
    }
    ...
    public function client() {
        return $this->belongsTo('Modules\Grow\Models\Client', 'ticket_clientid', 'client_id');
    }
    ...
    public function category() {
        return $this->belongsTo('Modules\Grow\Models\Category', 'ticket_categoryid', 'category_id');
    }
    ...
    public function project() {
        return $this->belongsTo('Modules\Grow\Models\Project', 'ticket_categoryid', 'project_id');
    }
    ...
    public function replies() {
        return $this->hasMany('Modules\Grow\Models\TicketReply', 'ticketreply_ticketid', 'ticket_id');
    }
}
