...
Relation::morphMap([
    'comment' => 'Modules\Grow\Models\Comment',
    'expense' => 'Modules\Grow\Models\Expense',
    'ticket' => 'Modules\Grow\Models\Ticket',
    'ticketreply' => 'Modules\Grow\Models\TicketReply',
]);
...
class Attachment extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'attachment_creatorid', 'id');
    }
