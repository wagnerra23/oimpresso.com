...
class Payment extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'payment_creatorid', 'id');
    }
    ...
    public function invoice() {
        return $this->belongsTo('Modules\Grow\Models\Invoice', 'payment_invoiceid', 'bill_invoiceid');
    }
    ...
    public function client() {
        return $this->belongsTo('Modules\Grow\Models\Client', 'payment_clientid', 'client_id');
    }
    ...
    public function project() {
        return $this->belongsTo('Modules\Grow\Models\Project', 'payment_projectid', 'project_id');
    }
