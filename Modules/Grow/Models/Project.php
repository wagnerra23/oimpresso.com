...
class Project extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'project_creatorid', 'id');
    }
    ...
    public function client() {
        return $this->belongsTo('Modules\Grow\Models\Client', 'project_clientid', 'client_id');
    }
    ...
    public function tasks() {
        return $this->hasMany('Modules\Grow\Models\Task', 'task_projectid', 'project_id');
    }
    ...
    public function invoices() {
        return $this->hasMany('Modules\Grow\Models\Invoice', 'bill_projectid', 'project_id');
    }
    ...
    public function estimates() {
        return $this->hasMany('Modules\Grow\Models\Estimate', 'bill_projectid', 'project_id');
    }
    ...
    public function notes() {
        return $this->morphMany('Modules\Grow\Models\Note', 'noteresource');
    }
    ...
    public function category() {
        return $this->belongsTo('Modules\Grow\Models\Category', 'project_categoryid', 'category_id');
    }
    ...
    public function contracts() {
        return $this->hasMany('Modules\Grow\Models\Contract', 'doc_project_id', 'project_id');
    }
    ...
    public function comments() {
        return $this->morphMany('Modules\Grow\Models\Comment', 'commentresource');
    }
    ...
    public function expenses() {
        return $this->hasMany('Modules\Grow\Models\Expense', 'expense_projectid', 'project_id');
    }
    ...
    public function events() {
        return $this->morphMany('Modules\Grow\Models\Event', 'eventresource');
    }
    ...
    public function files() {
        return $this->morphMany('Modules\Grow\Models\File', 'fileresource');
    }
    ...
    public function payments() {
        return $this->hasMany('Modules\Grow\Models\Payment', 'payment_projectid', 'project_id');
    }
    ...
    public function milestones() {
        return $this->hasMany('Modules\Grow\Models\Milestone', 'milestone_projectid', 'project_id');
    }
    ...
    public function assigned() {
        return $this->belongsToMany('Modules\Grow\Models\User', 'projects_assigned', 'projectsassigned_projectid', 'projectsassigned_userid');
    }
    ...
    public function managers() {
        return $this->belongsToMany('Modules\Grow\Models\User', 'projects_manager', 'projectsmanager_projectid', 'projectsmanager_userid');
    }
    ...
    public function assignedrecords() {
        return $this->hasMany('Modules\Grow\Models\ProjectAssigned', 'projectsassigned_projectid', 'project_id');
    }
    ...
    public function managerrecords() {
        return $this->hasMany('Modules\Grow\Models\ProjectManager', 'projectsmanager_projectid', 'project_id');
    }
    ...
    public function timers() {
        return $this->hasMany('Modules\Grow\Models\Timer', 'timer_projectid', 'project_id');
    }
    ...
    public function tickets() {
        return $this->hasMany('Modules\Grow\Models\Ticket', 'ticket_projectid', 'project_id');
    }
