...
class Expense extends Model {
    ...
    public function creator() {
        return $this->belongsTo('Modules\Grow\Models\User', 'expense_creatorid', 'id');
    }
    ...
    public function category() {
        return $this->belongsTo('Modules\Grow\Models\Category', 'expense_categoryid', 'category_id');
    }
    ...
    public function client() {
        return $this->belongsTo('Modules\Grow\Models\Client', 'expense_clientid', 'client_id');
    }
    ...
    public function project() {
        return $this->belongsTo('Modules\Grow\Models\Project', 'expense_projectid', 'project_id');
    }
