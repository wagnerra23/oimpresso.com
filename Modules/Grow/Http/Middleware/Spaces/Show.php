...
namespace Modules\Grow\Http\Middleware\Spaces;

use Modules\Grow\Models\Space;
use Closure;
use Log;
...
class Show {
    ...
    public function handle($request, Closure $next) {
        ...
        if (!$project = \Modules\Grow\Models\Project::Where('project_uniqueid', $project_uniqueid)->Where('project_type', 'space')->first()) {
            abort(404);
        }
