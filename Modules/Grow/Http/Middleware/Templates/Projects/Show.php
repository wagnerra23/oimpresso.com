...
namespace Modules\Grow\Http\Middleware\Templates\Projects;
use Closure;
use Log;
...
class Show {
    ...
    public function handle($request, Closure $next) {
        ...
        if ($project_id == '' || !$project = \Modules\Grow\Models\Project::Where('project_id', $project_id)->Where('project_type', 'template')->first()) {
            abort(404);
        }
