...
class Reply {
    ...
    public function handle($request, Closure $next) {
        ...
        if ($ticket_id == '' || !$ticket = \Modules\Grow\Models\Ticket::Where('ticket_id', $ticket_id)->first()) {
        ...
        if (auth()->user()->is_team) {
            if ($status = \Modules\Grow\Models\TicketStatus::Where('ticketstatus_use_for_team_replied', 'yes')->first()) {
                request()->merge([
