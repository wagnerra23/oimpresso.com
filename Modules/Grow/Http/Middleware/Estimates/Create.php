...
namespace Modules\Grow\Http\Middleware\Estimates;
use Closure;
use Log;
    ...
    private function fronteEnd() {
        ...
        if (request()->filled('estimateresource_id') && request()->filled('estimateresource_type')) {
            ...
            if (request('estimateresource_type') == 'client') {
                if ($client = \Modules\Grow\Models\Client::Where('client_id', request('estimateresource_id'))->first()) {
            ...
            if (request('estimateresource_type') == 'project') {
                if ($project = \Modules\Grow\Models\Project::Where('project_id', request('estimateresource_id'))->first()) {
