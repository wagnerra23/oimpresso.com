...
namespace Modules\Grow\Http\Middleware\Documents;
use Closure;
use Log;
...
class Edit {
    ...
    public function handle($request, Closure $next) {
        ...
        if (request('doc_type') == 'proposal') {
            ...
            if ($document_id == '' || !$document = \Modules\Grow\Models\Proposal::Where('doc_id', $document_id)->first()) {
        ...
        if (request('doc_type') == 'contract') {
            ...
            //does the documents exist
            if ($document_id == '' || !$document = \Modules\Grow\Models\Contract::Where('doc_id', $document_id)->first()) {
