...
class DownloadAttachment {
    ...
    public function handle($request, Closure $next) {
        ...
        //does the lead exist
        if (!$attachment = \Modules\Grow\Models\Attachment::Where('attachment_uniqiueid', $attachment_uniqueid)->first()) {
        ...
        if ($attachment->attachmentresource_type == 'lead') {
            //get the lead
            if ($lead = \Modules\Grow\Models\Lead::Where('lead_id', $attachment->attachmentresource_id)->first()) {
