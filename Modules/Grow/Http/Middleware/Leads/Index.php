...
namespace Modules\Grow\Http\Middleware\Leads;
...
class Index {
    ...
    private function tableConfig() {
        ...
        if (!$table = \Modules\Grow\Models\TableConfig::Where('tableconfig_userid', auth()->id())->Where('tableconfig_table_name', 'leads')->first()) {
        ...
        //get row
        $table = \Modules\Grow\Models\TableConfig::Where('tableconfig_userid', auth()->id())->Where('tableconfig_table_name', 'leads')->first();
