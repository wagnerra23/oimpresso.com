    ...
    public function handle($request, Closure $next) {
        ...
        if ($attachment->attachmentresource_type == 'expense') {
            ...
            if (auth()->user()->is_client) {
                if ($expense = \Modules\Grow\Models\Expense::Where('expense_id', $attachment->attachmentresource_id)->first()) {
                    if ($project = \Modules\Grow\Models\Project::Where('project_id', $expense->expense_projectid)->first()) {
