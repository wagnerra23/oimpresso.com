...
namespace Modules\Grow\Http\Middleware\Knowledgebase;
use Closure;
use Log;
...
class Edit {
    ...
    public function handle($request, Closure $next) {
        ...
        if ($knowledgebase_id == '' || !$knowledgebase = \Modules\Grow\Models\Knowledgebase::Where('knowledgebase_id', $knowledgebase_id)->first()) {
