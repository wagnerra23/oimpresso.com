...
namespace Modules\Grow\Http\Middleware\Invoices;
...
class Index {
    ...
    public function handle($request, Closure $next) {
        ...
        private function tableConfig() {
            ...
            if (!$table = \Modules\Grow\Models\TableConfig::Where('tableconfig_userid', auth()->id())->Where('tableconfig_table_name', 'invoices')->first()) {
    
                //create for this user and set the visible columns (by setting them to `null`)
                $table = new \Modules\Grow\Models\TableConfig();
            ...
            //get row
            $table = \Modules\Grow\Models\TableConfig::Where('tableconfig_userid', auth()->id())->Where('tableconfig_table_name', 'invoices')->first();
