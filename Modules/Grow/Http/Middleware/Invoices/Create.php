    ...
    private function fronteEnd() {
        ...
        if (request()->filled('invoiceresource_id') && request()->filled('invoiceresource_type')) {
            ...
            if (request('invoiceresource_type') == 'project') {
                if ($project = \Modules\Grow\Models\Project::Where('project_id', request('invoiceresource_id'))->first()) {
            ...
            if (request('invoiceresource_type') == 'client') {
                if ($client = \Modules\Grow\Models\Client::Where('client_id', request('invoiceresource_id'))->first()) {
                    ...
                    $projects = \Modules\Grow\Models\Project::Where('project_clientid', request('invoiceresource_id'))->get();
                    config(
                        [
