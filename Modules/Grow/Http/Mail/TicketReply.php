...
class TicketReply extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \Modules\Grow\Models\EmailTemplate::Where('emailtemplate_name', 'New Ticket Reply')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \Modules\Grow\Models\Ticket || !$this->user instanceof \Modules\Grow\Models\User) {
            return false;
        }
        ...
        if ($ticket_status = \Modules\Grow\Models\TicketStatus::Where('ticketstatus_id', $this->obj->ticket_status)->first()) {
