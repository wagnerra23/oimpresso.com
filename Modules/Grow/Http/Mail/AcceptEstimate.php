...
class AcceptEstimate extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \Modules\Grow\Models\EmailTemplate::Where('emailtemplate_name', 'Estimate Accepted')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \Modules\Grow\Models\Estimate || !$this->user instanceof \Modules\Grow\Models\User) {
            return false;
        }
