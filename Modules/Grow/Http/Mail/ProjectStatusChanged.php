...
class ProjectStatusChanged extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \Modules\Grow\Models\EmailTemplate::Where('emailtemplate_name', 'Project Status Change')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \Modules\Grow\Models\Project || !$this->user instanceof \Modules\Grow\Models\User) {
            return false;
        }
