...
class ProjectFileUploaded extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \Modules\Grow\Models\EmailTemplate::Where('emailtemplate_name', 'Project File Uploaded')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \Modules\Grow\Models\Project || !$this->user instanceof \Modules\Grow\Models\User || !$this->file instanceof \Modules\Grow\Models\File) {
            return false;
        }
