...
class SubscriptionRenewed extends Mailable {
    ...
    public function build() {
        ...
        if (!$template = \Modules\Grow\Models\EmailTemplate::Where('emailtemplate_name', 'SubscriptionRenewed')->where('emailtemplate_type', $this->user->type)->first()) {
        ...
        //validate
        if (!$this->obj instanceof \Modules\Grow\Models\Subscription || !$this->user instanceof \Modules\Grow\Models\User) {
