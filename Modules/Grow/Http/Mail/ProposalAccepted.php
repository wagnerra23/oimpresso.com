...
class ProposalAccepted extends Mailable {
    ...
    public function build() {
        ...
        //email template
        if (!$template = \Modules\Grow\Models\EmailTemplate::Where('emailtemplate_name', 'Proposal Accepted')->first()) {
            return false;
        }

        //validate
        if (!$this->obj instanceof \Modules\Grow\Models\Proposal || !$this->user instanceof \Modules\Grow\Models\User) {
            return false;
        }
