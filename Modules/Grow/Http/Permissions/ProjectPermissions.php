...
class ProjectPermissions {
    ...
    public function check($action = '', $project = '') {
        ...
        if (is_numeric($project)) {
            if (!$project = \Modules\Grow\Models\Project::Where('project_id', $project)->first()) {
        ...
        if ($project instanceof \Modules\Grow\Models\Project || $project instanceof \Illuminate\Pagination\LengthAwarePaginator) {
