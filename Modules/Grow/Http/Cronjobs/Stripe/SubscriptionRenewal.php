    ...
    public function __invoke(
        ...
        if ($webhooks = \Modules\Grow\Models\Webhook::Where('webhooks_gateway_name', 'stripe')
            ...
            foreach ($webhooks as $webhook) {
                ...
                if (!$subscription = \Modules\Grow\Models\Subscription::Where('subscription_gateway_id', $webhook->webhooks_matching_reference)->first()) {
                ...
                if (\Modules\Grow\Models\Payment::Where('payment_transaction_id', $webhook->webhooks_payment_amount)->exists()) {
