...
use Modules\Grow\Http\Responses\User\CommonResponse;
use Modules\Grow\Http\Responses\User\EditAvatarResponse;
...
class User extends Controller {
    ...
    public function updatePasswordAction() {
        ...
        $user = \Modules\Grow\Models\User::Where('id', auth()->id())->first();

        //team member, updating a contact
        if (request()->filled('contact_id') && auth()->user()->is_team) {
            $user = \Modules\Grow\Models\User::Where('id', request('contact_id'))->first();
        }

        //updating a team members password
        if (request()->filled('team_id')) {
            $user = \Modules\Grow\Models\User::Where('id', request('team_id'))->first();
            //check permissions
