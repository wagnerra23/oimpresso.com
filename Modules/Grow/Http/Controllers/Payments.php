...
use Modules\Grow\Http\Requests\Payments\PaymentStoreUpdate;
use Modules\Grow\Http\Responses\Payments\CreateResponse;
use Modules\Grow\Http\Responses\Payments\DestroyResponse;
use Modules\Grow\Http\Responses\Payments\IndexResponse;
use Modules\Grow\Http\Responses\Payments\PinningResponse;
use Modules\Grow\Http\Responses\Payments\ShowResponse;
use Modules\Grow\Http\Responses\Payments\StoreExternalResponse;
use Modules\Grow\Http\Responses\Payments\StoreResponse;
use Modules\Grow\Http\Responses\Payments\ThankYouResponse;
use Modules\Grow\Http\Responses\Payments\UpdateResponse;
use Modules\Grow\Repositories\InvoiceRepository;
use Modules\Grow\Repositories\PaymentRepository;
...
class Payments extends Controller {
    ...
    public function edit($id) {
        ...
        //get the payment
        if (!$payment = \Modules\Grow\Models\Payment::Where('payment_id', $id)->first()) {
            abort(404);
        }
    ...
    public function update(PaymentStoreUpdate $request, $id) {
        ...
        //get the item
        $payment = \Modules\Grow\Models\Payment::Where('payment_id', $id)->first();
    ...
    public function thankYouTap(TapPaymentRepository $taprepo) {
        ...
        //avoid duplicate
        if (\Modules\Grow\Models\Webhook::Where('webhooks_gateway_name', 'tap')
