...
use Modules\Grow\Http\Responses\Events\TopNavResponse;
...
class Events extends Controller {
    ...
    public function topNavEvents() {
        ...
        //count unread
        $unread = \Modules\Grow\Models\EventTracking::where('eventtracking_userid', auth()->id())
    ...
    public function markMyEventRead($id) {
        ...
        if ($event = \Modules\Grow\Models\EventTracking::Where('eventtracking_eventid', $id)
    ...
    public function markAllMyEventRead() {
        ...
        //update all
        \Modules\Grow\Models\EventTracking::where('eventtracking_userid', auth()->id())
