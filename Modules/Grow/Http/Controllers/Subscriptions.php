...
use Modules\Grow\Http\Requests\Subscriptions\SubscriptionValidation;
use Modules\Grow\Http\Responses\Subscriptions\CancelResponse;
use Modules\Grow\Http\Responses\Subscriptions\CreateResponse;
use Modules\Grow\Http\Responses\Subscriptions\DestroyResponse;
use Modules\Grow\Http\Responses\Subscriptions\IndexResponse;
use Modules\Grow\Http\Responses\Subscriptions\InvoicesResponse;
use Modules\Grow\Http\Responses\Subscriptions\PinningResponse;
use Modules\Grow\Http\Responses\Subscriptions\ShowResponse;
use Modules\Grow\Http\Responses\Subscriptions\StoreResponse;
use Modules\Grow\Http\Responses\Subscriptions\StripePaymentResponse;
...
use Modules\Grow\Repositories\StripeRepository;
use Modules\Grow\Repositories\SubscriptionRepository;
...
class Subscriptions extends Controller {
    ...
    public function store(SubscriptionValidation $request) {
        ...
        //log
        $log = new \Modules\Grow\Models\Log();
    ...
    public function setupStripePayment($id) {
        ...
        //get the subscription
        $subscription = \Modules\Grow\Models\Subscription::Where('subscription_id', $id)->first();
    ...
    public function destroy(DestroyRepository $destroyrepo, $id) {
        ...
        //create a web hook
        $webhook = new \Modules\Grow\Models\Webhook();
    ...
    public function cancelSubscription($id) {
        ...
        \Modules\Grow\Models\Subscription::where('subscription_id', $id)
