...
use Modules\Grow\Http\Responses\Templates\Contracts\CreateResponse;
use Modules\Grow\Http\Responses\Templates\Contracts\DestroyResponse;
use Modules\Grow\Http\Responses\Templates\Contracts\EditResponse;
use Modules\Grow\Http\Responses\Templates\Contracts\IndexResponse;
use Modules\Grow\Http\Responses\Templates\Contracts\StoreResponse;
use Modules\Grow\Http\Responses\Templates\Contracts\UpdateResponse;
use Modules\Grow\Repositories\ContractTemplateRepository;
...
class Contracts extends Controller {
    ...
    public function store() {
        ...
        $template = new \Modules\Grow\Models\ContractTemplate();
    ...
    public function update($id) {
        ...
        //get the template
        $template = \Modules\Grow\Models\ContractTemplate::Where('contract_template_id', $id)->first();
    ...
    public function destroy() {
        ...
        foreach (request('ids') as $id => $value) {
            ...
            if ($value == 'on') {
                if ($template = \Modules\Grow\Models\ContractTemplate::Where('contract_template_id', $id)->first()) {
                    //delete client
                    $template->delete();
                }
                //add to array
