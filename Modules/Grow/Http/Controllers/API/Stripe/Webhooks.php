...
namespace Modules\Grow\Http\Controllers\API\Stripe;
...
class Webhooks extends Controller {
    ...
    private function checkoutSessionCompleted($session) {
        ...
        if (\Modules\Grow\Models\Webhook::Where('webhooks_matching_reference', $session->id)->exists()) {
    ...
    private function subscriptionRenewed($session) {
        ...
        //avoid duplicates for the same transaction
        if (\Modules\Grow\Models\Webhook::Where('webhooks_payment_transactionid', $session->charge)->exists()) {
