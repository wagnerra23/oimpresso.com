...
namespace Modules\Grow\Http\Controllers\API\Paystack;
...
class Webhooks extends Controller {
    ...
    public function onetimePayment($payload = []) {
        ...
        if (\Modules\Grow\Models\Payment::Where('payment_transaction_id', $transaction_id)->exists()) {
        ...
        if (\Modules\Grow\Models\Webhook::Where('webhooks_payment_transactionid', $transaction_id)->exists()) {
