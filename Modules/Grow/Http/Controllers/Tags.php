...
use Modules\Grow\Http\Responses\Tags\CreateResponse;
use Modules\Grow\Http\Responses\Tags\DestroyResponse;
use Modules\Grow\Http\Responses\Tags\EditResponse;
use Modules\Grow\Http\Responses\Tags\IndexResponse;
use Modules\Grow\Http\Responses\Tags\StoreResponse;
use Modules\Grow\Http\Responses\Tags\UpdateResponse;
...
class Tags extends Controller {
    ...
    public function store() {
        ...
        if (\Modules\Grow\Models\Tag::where('tag_title', request('tag_title'))
