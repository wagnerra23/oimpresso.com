...
use Modules\Grow\Http\Responses\Contacts\CreateResponse;
use Modules\Grow\Http\Responses\Contacts\DestroyResponse;
use Modules\Grow\Http\Responses\Contacts\EditResponse;
use Modules\Grow\Http\Responses\Contacts\IndexResponse;
use Modules\Grow\Http\Responses\Contacts\ShowResponse;
use Modules\Grow\Http\Responses\Contacts\StoreResponse;
use Modules\Grow\Http\Responses\Contacts\UpdateResponse;
...
class Contacts extends Controller {
    ...
    public function show($id) {
        ...
        //the user
        $contact = \Modules\Grow\Models\User::Where('id', $id)->first();
    ...
    public function store(ClientRepository $clientrepo) {
         ...
         * -----------------------------------------------------------------------------------*/
        if ($user = \Modules\Grow\Models\User::Where('email', request('email'))->Where('type', 'contact')->first()) {
    ...
    public function edit($id) {
        ...
        //the user
        $user = \Modules\Grow\Models\User::Where('id', $id)->first();
    ...
    public function update($id) {
        ...
        if (request('account_owner') == 'on') {
            ...
            $owner = \Modules\Grow\Models\User::Where('clientid', $user->clientid)->where('account_owner', 'yes')->first();
            //update owner
