...
use Modules\Grow\Http\Responses\Messages\FeedResponse;
use Modules\Grow\Http\Responses\Messages\IndexResponse;
use Modules\Grow\Repositories\FileRepository;
use Modules\Grow\Repositories\MessageRepository;
...
class Messages extends Controller {
    ...
    public function index() {
        ...
        //get team members
        $users = \Modules\Grow\Models\User::Where('type', 'team')->Where('status', 'active')->orderBy('first_name', 'asc')->get();
    ...
    public function getFeed() {
        ...
        \Modules\Grow\Models\MessagesTracking::Where('messagestracking_target', request('message_target'))
    ...
    public function storeText() {
        ...
        $validator = Validator::make(request()->all(), [
            ...
            'message_target' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($value && $value != 'team') {
                        if (\Modules\Grow\Models\User::Where('unique_id', $value)->doesntExist()) {
                            return $fail('2');
                        }
                    }
                },
        ...
        //save message
        $message = new \Modules\Grow\Models\Message();
        ...
        if (request('message_target') == 'team') {
            $users = \Modules\Grow\Models\User::Where('type', 'team')->Where('status', 'active')->WhereNotIn('id', [auth()->id()])->get();
            foreach ($users as $user) {
                $tracking = new \Modules\Grow\Models\MessagesTracking();
    ...
    public function destroy($id) {
        ...
        //get the record
        $message = \Modules\Grow\Models\Message::Where('message_unique_id', $id)->first();
        ...
        \Modules\Grow\Models\MessagesTracking::Where('messagestracking_massage_unique_id', $message->message_unique_id)->delete();
    ...
    public function countMessages() {
        ...
        //count records
        $message_count = \Modules\Grow\Models\MessagesTracking::where('messagestracking_user_unique_id', auth()->user()->unique_id)
            ->Where('messagestracking_type', 'read')
    ...
    public function getDeletedMessages() {
        ...
        //count records
        $messages = \Modules\Grow\Models\MessagesTracking::where('messagestracking_user_unique_id', auth()->user()->unique_id)
