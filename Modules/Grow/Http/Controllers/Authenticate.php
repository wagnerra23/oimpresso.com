...
use Modules\Grow\Http\Responses\Authentication\AuthenticateResponse;
...
class Authenticate extends Controller {
    ...
    public function resetPassword() {
        ...
        //validate code
        if (\Modules\Grow\Models\User::Where('forgot_password_token', request('token'))
    ...
    public function logInAction() {
        ...
        //get the user
        if (!$user = \Modules\Grow\Models\User::Where('email', request('email'))->first()) {
        ...
        if (Auth::attempt($credentials, $remember)) {
            ...
            if (auth()->user()->is_client) {
                if ($client = \Modules\Grow\Models\Client::Where('client_id', auth()->user()->clientid)->first()) {
    ...
    public function resetPasswordAction() {
        ...
        $user = \Modules\Grow\Models\User::Where('forgot_password_token', request('token'))->first();
