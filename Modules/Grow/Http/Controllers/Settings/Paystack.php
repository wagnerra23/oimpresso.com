...
use Modules\Grow\Http\Responses\Settings\Paystack\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Paystack\UpdateResponse;
...
class Paystack extends Controller {
    ...
    public function index() {
        ...
        $settings = \Modules\Grow\Models\Settings2::Where('settings2_id', 1)->first();
