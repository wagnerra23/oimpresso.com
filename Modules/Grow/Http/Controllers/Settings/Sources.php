...
use Modules\Grow\Http\Responses\Settings\Sources\CreateResponse;
use Modules\Grow\Http\Responses\Settings\Sources\DestroyResponse;
use Modules\Grow\Http\Responses\Settings\Sources\EditResponse;
use Modules\Grow\Http\Responses\Settings\Sources\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Sources\StoreResponse;
use Modules\Grow\Http\Responses\Settings\Sources\UpdateResponse;
use Modules\Grow\Repositories\LeadSourcesRepository;
        ...
        $validator = Validator::make(request()->all(), [
            'leadsources_title' => [
                ...
                function ($attribute, $value, $fail) {
                    if (\Modules\Grow\Models\LeadSources::where('leadsources_title', $value)
                        ->exists()) {
