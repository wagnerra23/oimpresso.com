...
use Modules\Grow\Http\Responses\Settings\General\IndexResponse;
use Modules\Grow\Http\Responses\Settings\General\UpdateResponse;
...
class General extends Controller {
    ...
    public function update() {
        ...
        if (request('settings_system_language_allow_users_to_change') == 'no') {
            \Modules\Grow\Models\User::where('id', '>', 0)
