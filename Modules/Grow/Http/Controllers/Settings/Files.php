...
use Modules\Grow\Http\Responses\Settings\Files\CreateFolderResponse;
use Modules\Grow\Http\Responses\Settings\Files\DefaultFoldersResponse;
use Modules\Grow\Http\Responses\Settings\Files\DeletefolderResponse;
use Modules\Grow\Http\Responses\Settings\Files\EditFolderResponse;
use Modules\Grow\Http\Responses\Settings\Files\FoldersResponse;
use Modules\Grow\Http\Responses\Settings\Files\GeneralResponse;
use Modules\Grow\Http\Responses\Settings\Files\StoreFolderResponse;
use Modules\Grow\Http\Responses\Settings\Files\UpdateFolderResponse;
...
class Files extends Controller {
            ...
            'filefolder_name' => [
                ...
                function ($attribute, $value, $fail) {
                    if (request()->filled('filefolder_name')) {
                        if (\Modules\Grow\Models\FileFolder::Where('filefolder_name', $value)->Where('filefolder_system', 'yes')->exists()) {
    ...
    public function editFolder($id) {
        ...
        //validate
        if (!$folder = \Modules\Grow\Models\FileFolder::Where('filefolder_id', $id)->Where('filefolder_system', 'yes')->first()) {
            abort(404);
        }
    ...
    public function updateFolder(FileFolderRepository $folderrepo, $id) {
        ...
        if ($folder->filefolder_default == 'yes') {
            \Modules\Grow\Models\FileFolder::where('filefolder_default', 'yes')
                ->update([
