...
use Modules\Grow\Http\Responses\Settings\FormBuilder\BuildFormResponse;
use Modules\Grow\Http\Responses\Settings\FormBuilder\EmbedResponse;
use Modules\Grow\Http\Responses\Settings\FormBuilder\SaveFormResponse;
use Modules\Grow\Http\Responses\Settings\FormBuilder\SettingsResponse;
use Modules\Grow\Http\Responses\Settings\FormBuilder\StyleResponse;
...
class Formbuilder extends Controller {
    ...
    public function availableFormFields() {
        ...
        $fields = \Modules\Grow\Models\CustomField::Where('customfields_type', 'leads')
