...
use Modules\Grow\Http\Responses\Settings\WebmailTemplates\CreateResponse;
use Modules\Grow\Http\Responses\Settings\WebmailTemplates\DestroyResponse;
use Modules\Grow\Http\Responses\Settings\WebmailTemplates\EditResponse;
use Modules\Grow\Http\Responses\Settings\WebmailTemplates\IndexResponse;
use Modules\Grow\Http\Responses\Settings\WebmailTemplates\StoreResponse;
use Modules\Grow\Http\Responses\Settings\WebmailTemplates\UpdateResponse;
use Modules\Grow\Repositories\WebmailTemplatesRepository;
...
class WebmailTemplates extends Controller {
    ...
    public function store() {
        ...
        //count
        $count = \Modules\Grow\Models\WebmailTemplate::get()->count();
