...
use Modules\Grow\Http\Responses\Settings\Taxrates\CreateResponse;
use Modules\Grow\Http\Responses\Settings\Taxrates\DestroyResponse;
use Modules\Grow\Http\Responses\Settings\Taxrates\EditResponse;
use Modules\Grow\Http\Responses\Settings\Taxrates\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Taxrates\StoreResponse;
use Modules\Grow\Http\Responses\Settings\Taxrates\UpdateResponse;
use Modules\Grow\Repositories\TaxrateRepository;
use Validator;
...
class Taxrates extends Controller {
    ...
    public function update($id) {
        ...
        //get the item
        if (!$taxrate = \Modules\Grow\Models\TaxRate::Where('taxrate_id', $id)->first()) {
            abort(404);
        }
    ...
    public function destroy($id) {
        ...
        if (\Modules\Grow\Models\Tax::Where('tax_taxrateid', $id)->exists()) {
