...
use Modules\Grow\Http\Responses\Settings\Tasks\CreatePriorityResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\CreateStatusResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\DestroyStatusResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\EditStatusResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\moveResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\MoveUpdateResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\PrioritiesResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\StatusesResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\StorePriorityResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\StoreStatusResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\UpdateResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\UpdateStatusResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\EditPriorityResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\UpdatePriorityResponse;

use Modules\Grow\Http\Responses\Settings\Tasks\DestroyPriorityResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\movePriorityResponse;
use Modules\Grow\Http\Responses\Settings\Tasks\MovePriorityUpdateResponse;

use Modules\Grow\Repositories\SettingsRepository;
use Modules\Grow\Repositories\TaskPriorityRepository;
...
class Tasks extends Controller {
        ...
        $validator = Validator::make(request()->all(), [
            'taskstatus_title' => [
                ...
                function ($attribute, $value, $fail) {
                    if (\Modules\Grow\Models\TaskStatus::where('taskstatus_title', $value)
    ...
    public function storeStatus() {
        ...
        if ($last = \Modules\Grow\Models\TaskStatus::orderBy('taskstatus_position', 'desc')->first()) {
    ...
    public function move($id) {
        ...
        //client tasksources
        $statuses = \Modules\Grow\Models\TaskStatus::get();
    ...
    public function updateMove($id) {
        ...
        //move the tasks
        \Modules\Grow\Models\Task::where('task_status', $id)->update(['task_status' => request('tasks_status')]);
    ...
    public function updateStagePositions() {
        ...
        foreach (request('sort-stages') as $key => $id) {
            if (is_numeric($id)) {
                \Modules\Grow\Models\TaskStatus::where('taskstatus_id', $id)->update(['taskstatus_position' => $i]);
            }
            $i++;
        }
    ...
    public function destroyStatus($id) {
        ...
        //get record
        if (!\Modules\Grow\Models\TaskStatus::find($id)) {
            abort(409, __('lang.error_request_could_not_be_completed'));
        }
    ...
    public function storePriority() {
        ...
        $validator = Validator::make(request()->all(), [
            'taskpriority_title' => [
                'required',
                function ($attribute, $value, $fail) {
                    if (\Modules\Grow\Models\TaskPriority::where('taskpriority_title', $value)
                        ->exists()) {
        ...
        //get the last row (order by position - desc)
        if ($last = \Modules\Grow\Models\TaskPriority::orderBy('taskpriority_position', 'desc')->first()) {
    ...
    public function destroyPriority($id) {
        ...
        //get record
        if (!\Modules\Grow\Models\TaskPriority::find($id)) {
            abort(409, __('lang.error_request_could_not_be_completed'));
        }
    ...
    public function updatePriorityPositions() {
        ...
        foreach (request('sort-priorities') as $key => $id) {
            if (is_numeric($id)) {
                \Modules\Grow\Models\TaskPriority::where('taskpriority_id', $id)->update(['taskpriority_position' => $i]);
            }
            $i++;
        }
    ...
    public function movePriority($id) {
        ...
        //client tasksources
        $priorities = \Modules\Grow\Models\TaskPriority::get();
    ...
    public function updatePriorityMove($id) {
        ...
        //move the tasks
        \Modules\Grow\Models\Task::where('task_priority', $id)->update(['task_priority' => request('tasks_priority')]);
