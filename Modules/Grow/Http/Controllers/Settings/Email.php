...
use Modules\Grow\Http\Responses\Settings\Email\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Email\LogResponse;
use Modules\Grow\Http\Responses\Settings\Email\QueueResponse;
use Modules\Grow\Http\Responses\Settings\Email\TestEmailResponse;
use Modules\Grow\Http\Responses\Settings\Email\UpdateResponse;
...
class Email extends Controller {
    ...
    public function queueShow() {
        ...
        //get all emails
        $emails = \Modules\Grow\Models\EmailQueue::query()
    ...
    public function queueRead($id) {
        ...
        if (!$email = \Modules\Grow\Models\EmailQueue::Where('emailqueue_id', $id)->first()) {
            abort(404);
        }
    ...
    public function queuePurge() {
        ...
        //delete all rows
        \Modules\Grow\Models\EmailQueue::getQuery()->delete();
    ...
    public function queueReschedule() {
        ...
        //delete all rows
        \Modules\Grow\Models\EmailQueue::where('emailqueue_status', 'processing')
    ...
    public function logShow() {
        ...
        //get all emails
        $emails = \Modules\Grow\Models\EmailLog::query()
    ...
    public function logRead($id) {
        ...
        if (!$email = \Modules\Grow\Models\EmailLog::Where('emaillog_id', $id)->first()) {
            abort(404);
        }
    ...
    public function logPurge() {
        ...
        //delete all rows
        \Modules\Grow\Models\EmailLog::getQuery()->delete();
