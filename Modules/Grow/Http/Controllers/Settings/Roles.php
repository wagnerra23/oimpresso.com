...
use Modules\Grow\Http\Responses\Settings\Roles\CreateResponse;
use Modules\Grow\Http\Responses\Settings\Roles\DestroyResponse;
use Modules\Grow\Http\Responses\Settings\Roles\EditHomePageResponse;
use Modules\Grow\Http\Responses\Settings\Roles\EditResponse;
use Modules\Grow\Http\Responses\Settings\Roles\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Roles\StoreResponse;
use Modules\Grow\Http\Responses\Settings\Roles\UpdateHomePageResponse;
use Modules\Grow\Http\Responses\Settings\Roles\UpdateResponse;
use Modules\Grow\Repositories\RoleRepository;
...
class Roles extends Controller {
    ...
    public function store(ModuleRolesRespository $modulerepo) {
        ...
        //check duplicates
        if (\Modules\Grow\Models\Role::where('role_name', request('role_name'))
            ->exists()) {
    ...
    public function updateHomePage($id) {
        ...
        //update setting
        \Modules\Grow\Models\Role::where('role_id', $id)
    ...
    public function destroy($id) {
        ...
        //get record
        if (!\Modules\Grow\Models\Role::find($id)) {
            abort(409, __('lang.error_request_could_not_be_completed'));
        }
        ...
        //validation: default
        if (\Modules\Grow\Models\User::Where('role_id', $id)->exists()) {
