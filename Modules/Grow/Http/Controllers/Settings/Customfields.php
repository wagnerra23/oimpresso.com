...
use Modules\Grow\Http\Responses\Settings\Customfields\DestroyResponse;
use Modules\Grow\Http\Responses\Settings\Customfields\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Customfields\StandardFormResponse;
use Modules\Grow\Http\Responses\Settings\Customfields\UpdateResponse;
...
class Customfields extends Controller {
    ...
    public function updateClient() {
        ...
        foreach (request('customfields_title') as $key => $value) {
            ...
            if ($value != '') {
                \Modules\Grow\Models\CustomField::where('customfields_id', $key)
                    ->update([
    ...
    public function deleteField($id = '') {
        ...
        if ($field = \Modules\Grow\Models\CustomField::Where('customfields_id', $id)->first()) {
