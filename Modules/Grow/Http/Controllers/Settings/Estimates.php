...
use Modules\Grow\Http\Requests\Settings\Estimates\EstimateAutomationValidation;
use Modules\Grow\Http\Responses\Settings\Estimates\AutomationResponse;
use Modules\Grow\Http\Responses\Settings\Estimates\IndexResponse;
use Modules\Grow\Http\Responses\Settings\Estimates\UpdateResponse;
...
class Estimates extends Controller {
    ...
    public function index() {
        ...
        $settings2 = \Modules\Grow\Models\Settings2::find(1);
