...
use Modules\Grow\Http\Responses\Comments\DestroyResponse;
use Modules\Grow\Http\Responses\Comments\IndexResponse;
use Modules\Grow\Http\Responses\Comments\StoreResponse;
...
class Comments extends Controller {
    ...
    public function index() {
        ...
        if (request()->filled('commentresource_type') && request()->filled('commentresource_id')) {
            \Modules\Grow\Models\EventTracking::where('resource_id', request('commentresource_id'))
        ...
        if (request()->filled('commentresource_type') && request()->filled('commentresource_id')) {
            \Modules\Grow\Models\Comment::where('commentresource_type', request('commentresource_type'))
