...
use Modules\Grow\Http\Responses\Import\Common\StoreResponse;
use Modules\Grow\Http\Responses\Import\Leads\CreateResponse;
use App\Imports\LeadsImport;
use Modules\Grow\Repositories\EventRepository;
use Modules\Grow\Repositories\EventTrackingRepository;
use Modules\Grow\Repositories\ImportExportRepository;
use Modules\Grow\Repositories\LeadAssignedRepository;
use Modules\Grow\Repositories\SystemRepository;
...
class Leads extends Controller {
    ...
    private function processCollection() {
        ...
        $leads = \Modules\Grow\Models\Lead::Where('lead_importid', request('import_ref'))->get();
