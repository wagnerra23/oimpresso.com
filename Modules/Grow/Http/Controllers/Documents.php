...
use Modules\Grow\Http\Responses\Documents\UpdateDetailsResponse;
use Modules\Grow\Http\Responses\Documents\UpdateHeroResponse;
...
class Documents extends Controller {
    ...
    public function updateHero(FileRepository $filerepo, $id) {
        ...
        if (request('doc_type') == 'proposal') {
            $document = \Modules\Grow\Models\Proposal::Where('doc_id', $id)->first();
        }
        if (request('doc_type') == 'contract') {
            $document = \Modules\Grow\Models\Contract::Where('doc_id', $id)->first();
        }
