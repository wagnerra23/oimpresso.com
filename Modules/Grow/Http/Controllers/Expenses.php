...
use Modules\Grow\Http\Requests\Expenses\ExpenseAttachProject;
use Modules\Grow\Http\Requests\Expenses\ExpenseRecurrringSettings;
use Modules\Grow\Http\Requests\Expenses\ExpenseStoreUpdate;
use Modules\Grow\Http\Responses\Common\ChangeCategoryResponse;
use Modules\Grow\Http\Responses\Expenses\AttachDettachResponse;
use Modules\Grow\Http\Responses\Expenses\attachDettachUpdateResponse;
use Modules\Grow\Http\Responses\Expenses\ChangeCategoryUpdateResponse;
use Modules\Grow\Http\Responses\Expenses\CloneResponse;
use Modules\Grow\Http\Responses\Expenses\CreateResponse;
use Modules\Grow\Http\Responses\Expenses\DestroyResponse;
use Modules\Grow\Http\Responses\Expenses\EditResponse;
use Modules\Grow\Http\Responses\Expenses\IndexResponse;
use Modules\Grow\Http\Responses\Expenses\PinningResponse;
use Modules\Grow\Http\Responses\Expenses\RecurringSettingsResponse;
use Modules\Grow\Http\Responses\Expenses\ShowResponse;
use Modules\Grow\Http\Responses\Expenses\StoreResponse;
use Modules\Grow\Http\Responses\Expenses\UpdateResponse;
use Modules\Grow\Http\Responses\Invoices\CreateResponse as CreateInvoiceResponse;
...
use Modules\Grow\Repositories\ExpenseRepository;
...
class Expenses extends Controller {
    ...
    public function store(ExpenseStoreUpdate $request) {
        ...
        if (request('expense_billable') == 'on') {
            if (!$project = \Modules\Grow\Models\Project::Where('project_id', request('expense_projectid'))->first()) {
    ...
    public function show($id) {
        ...
        //get attachment
        $attachments = \Modules\Grow\Models\Attachment::Where('attachmentresource_id', $id)
        ...
        $validator = Validator::make(request()->all(), [
            ...
            'expense_projectid' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($value != '') {
                        if (!\Modules\Grow\Models\Project::find(request('expense_projectid'))) {
    ...
    public function attachDettach() {
        ...
        $expense = \Modules\Grow\Models\Expense::Where('expense_id', request('id'))->first();
    ...
    public function attachDettachUpdate(ExpenseAttachProject $request) {
        ...
        //get the expense
        $expense = \Modules\Grow\Models\Expense::Where('expense_id', request()->route('expense'))->first();
        ...
        if (request()->filled('expense_projectid')) {
            $project = \Modules\Grow\Models\Project::Where('project_id', request('expense_projectid'))->first();
    ...
    public function changeCategoryUpdate(CategoryRepository $categoryrepo) {
        ...
        foreach (request('ids') as $expense_id => $value) {
            if ($value == 'on') {
                $expense = \Modules\Grow\Models\Expense::Where('expense_id', $expense_id)->first();
                //update the category
    ...
    public function recurringSettings($id) {
        ...
        //get the project
        $expense = \Modules\Grow\Models\Expense::Where('expense_id', $id)->first();
 ...
 */
    public function storeClone($id) {
        ...
        if (request('clone_files') == 'on') {
            //get attachments
            $attachments = \Modules\Grow\Models\Attachment::Where('attachmentresource_type', 'expense')
