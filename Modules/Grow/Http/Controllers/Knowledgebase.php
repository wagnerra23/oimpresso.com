...
use Modules\Grow\Http\Responses\knowledgebase\CreateResponse;
use Modules\Grow\Http\Responses\knowledgebase\DestroyResponse;
use Modules\Grow\Http\Responses\knowledgebase\EditResponse;
use Modules\Grow\Http\Responses\knowledgebase\IndexResponse;
use Modules\Grow\Http\Responses\knowledgebase\ShowResponse;
use Modules\Grow\Http\Responses\knowledgebase\StoreResponse;
use Modules\Grow\Http\Responses\knowledgebase\UpdateResponse;
use Modules\Grow\Repositories\KbCategoryRepository;
use Modules\Grow\Repositories\KnowledgebaseRepository;
...
class Knowledgebase extends Controller {
    ...
    public function index() {
        ...
        if ($category = \Modules\Grow\Models\KbCategories::Where('kbcategory_slug', request()->segment(3))->first()) {
    ...
    public function store() {
        ...
        //get the category
        $category = \Modules\Grow\Models\KbCategories::Where('kbcategory_id', request('knowledgebase_categoryid'))->first();
        ...
        //get tge article
        $article = \Modules\Grow\Models\Knowledgebase::Where('knowledgebase_id', $knowledgebase_id)->first();
    ...
    public function show($id) {
        ...
        //get article
        $knowledgebase = \Modules\Grow\Models\Knowledgebase::Where('knowledgebase_slug', request('knowledgebase_slug'))->first();

        //get this category
        $category = \Modules\Grow\Models\KbCategories::Where('kbcategory_id', $knowledgebase->knowledgebase_categoryid)->first();
    ...
    public function update($id) {
        ...
        if (!$article = \Modules\Grow\Models\Knowledgebase::Where('knowledgebase_id', $id)->first()) {
            abort(404);
        }

        //get the category
        if (!$category = \Modules\Grow\Models\KbCategories::Where('kbcategory_id', $article->knowledgebase_categoryid)->first()) {
            abort(409);
        }
