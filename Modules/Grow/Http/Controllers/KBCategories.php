...
use Modules\Grow\Http\Responses\KBCategories\CreateResponse;
use Modules\Grow\Http\Responses\KBCategories\DestroyResponse;
use Modules\Grow\Http\Responses\KBCategories\EditResponse;
use Modules\Grow\Http\Responses\KBCategories\IndexResponse;
use Modules\Grow\Http\Responses\KBCategories\StoreResponse;
use Modules\Grow\Http\Responses\KBCategories\UpdateResponse;
...
class KBCategories extends Controller {
    ...
    public function edit($id) {
        ...
        //get the item
        $category = \Modules\Grow\Models\Category::Where('category_id', $id)->first();
