...
class Feed extends Controller {
    ...
    public function projectAssignedUsers(ProjectPermissions $projectpermissions) {
        ...
        //fetch the project
        if (!$project = \Modules\Grow\Models\Project::Where('project_id', request('project_id'))->first()) {
    ...
    public function projectClientUsers() {
        ...
        //get client users
        $client_users = \Modules\Grow\Models\User::Where('clientid', $project->project_clientid)->orderBy('first_name', 'asc')->get();
