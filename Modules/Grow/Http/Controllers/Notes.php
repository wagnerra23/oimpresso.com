...
use Modules\Grow\Http\Responses\Notes\CreateResponse;
use Modules\Grow\Http\Responses\Notes\DestroyResponse;
use Modules\Grow\Http\Responses\Notes\EditResponse;
use Modules\Grow\Http\Responses\Notes\IndexResponse;
use Modules\Grow\Http\Responses\Notes\ShowResponse;
use Modules\Grow\Http\Responses\Notes\StoreResponse;
use Modules\Grow\Http\Responses\Notes\UpdateResponse;
use Modules\Grow\Http\Permissions\NotePermissions;
use Modules\Grow\Repositories\AttachmentRepository;
use Modules\Grow\Repositories\CategoryRepository;
use Modules\Grow\Repositories\NoteRepository;
...
class Notes extends Controller {
    ...
    public function destroy($id) {
        ...
        $note = \Modules\Grow\Models\Note::Where('note_id', $id)->first();
    ...
    private function applyPermissions($note = '') {
        ...
        if ($note instanceof \Modules\Grow\Models\Note) {
            //delete permissions
