...
use Modules\Grow\Http\Responses\Home\HomeResponse;
...
use Modules\Grow\Repositories\StatsRepository;
...
class Home extends Controller {
    ...
    public function csAffiliateDashboard() {
        ...
        //get events
        $events = \Modules\Grow\Models\Custom\CSEvent::Where('cs_event_affliateid', auth()->id())->orderBy('cs_event_id', 'DESC')
            ->take(100)
            ->get();

        //get projects
        $projects = \Modules\Grow\Models\Custom\CSAffiliateProject::leftJoin('projects', 'projects.project_id', '=', 'cs_affiliate_projects.cs_affiliate_project_projectid')
            ->selectRaw('*')
        ...
        $profits['today'] = \Modules\Grow\Models\Custom\CSAffiliateEarning::where('cs_affiliate_earning_commission_approval_date', $today)
        ...
        $profits['this_month'] = \Modules\Grow\Models\Custom\CSAffiliateEarning::where('cs_affiliate_earning_commission_approval_date', '>=', $start)
        ...
        //Profits - all time
        $profits['all_time'] = \Modules\Grow\Models\Custom\CSAffiliateEarning::where('cs_affiliate_earning_affiliateid', auth()->id())
            ->where('cs_affiliate_earning_status', 'paid')
            ->sum('cs_affiliate_earning_amount');

        //Profits - pending
        $profits['pending'] = \Modules\Grow\Models\Custom\CSAffiliateEarning::where('cs_affiliate_earning_affiliateid', auth()->id())
