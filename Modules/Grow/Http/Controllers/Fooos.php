...
use Modules\Grow\Http\Requests\Fooo\StoreUpdate;
use Modules\Grow\Http\Responses\Fooos\CreateResponse;
use Modules\Grow\Http\Responses\Fooos\DestroyResponse;
use Modules\Grow\Http\Responses\Fooos\EditResponse;
use Modules\Grow\Http\Responses\Fooos\IndexResponse;
use Modules\Grow\Http\Responses\Fooos\ShowResponse;
use Modules\Grow\Http\Responses\Fooos\StoreResponse;
use Modules\Grow\Http\Responses\Fooos\UpdateResponse;
use Modules\Grow\Repositories\FoooRepository;
...
class Fooos extends Controller {
    ...
    public function edit($id) {
        ...
        $fooo = \Modules\Grow\Models\Fooo::Where('fooo_id', $id)->first();
    ...
    public function destroy() {
        ...
        foreach (request('ids') as $id => $value) {
            ...
            if ($value == 'on') {
                if ($fooo = \Modules\Grow\Models\Fooo::Where('fooo_id', $id)->first()) {
                    //delete the foo
                    $fooo->delete();
                }
