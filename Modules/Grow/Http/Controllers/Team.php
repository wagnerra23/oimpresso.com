...
use Modules\Grow\Http\Responses\Team\CreateResponse;
use Modules\Grow\Http\Responses\Team\EditResponse;
use Modules\Grow\Http\Responses\Team\IndexResponse;
use Modules\Grow\Http\Responses\Team\StoreResponse;
use Modules\Grow\Http\Responses\Team\UpdateResponse;
...
class Team extends Controller {
    ...
    public function destroy($id) {
        ...
        \Modules\Grow\Models\ProjectAssigned::Where('projectsassigned_userid', $id)->delete();

        //delete task assignments
        \Modules\Grow\Models\TaskAssigned::Where('tasksassigned_userid', $id)->delete();

        //delete lead assignments
        \Modules\Grow\Models\LeadAssigned::Where('leadsassigned_userid', $id)->delete();

        //delete project manager
        \Modules\Grow\Models\ProjectManager::Where('projectsmanager_userid', $id)->delete();

        //delete calendar events
        \Modules\Grow\Models\CalendarEvent::Where('calendar_event_creatorid', $id)->delete();
