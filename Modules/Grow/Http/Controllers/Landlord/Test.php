...
namespace Modules\Grow\Http\Controllers\Landlord;
    ...
    public function index() {
        ...
        foreach ($customers as $customer) {
            ...
            try {
                ...
                $default_folder = \Modules\Grow\Models\FileFolder::On('tenant')->Where('filefolder_id', 1)->first();

                //get all the customers projects
                $projects = \Modules\Grow\Models\Project::On('tenant')->get();
                ...
                foreach ($projects as $project) {
                    ...
                    \Modules\Grow\Models\File::On('tenant')->where('fileresource_type', 'project')
