...
namespace Modules\Grow\Http\Requests\Subscriptions;
        ...
        $rules += [
            ...
            'subscription_projectid' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($value != '') {
                        if (!\Modules\Grow\Models\Project::where('project_clientid', request('subscription_clientid'))->find(request('subscription_projectid'))) {
