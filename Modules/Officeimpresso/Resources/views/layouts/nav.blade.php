    ...
    <nav class="navbar navbar-default bg-white m-4">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ auth()->user()->can('superadmin') ? action([\Modules\Officeimpresso\Http\Controllers\LicencaComputadorController::class, 'computadores']) : action([\Modules\Officeimpresso\Http\Controllers\ClientController::class, 'index']) }}">
