...
contains:
  ...
  - "Services/PaymentGatewayService — implementa PaymentGatewayContract; for(Account) resolve credential; idempotência (Onda 4a)"
  - "Services/Drivers/InterDriver — Inter API v3 OAuth2+mTLS (boleto + cancelar + consultar + healthCheck + processWebhook); Onda 4a"
  - "BoletoService (Onda 4d)"
  - "PixService (Onda 4b)"
  - "CardService (Onda 4c)"
  - "RemessaCnabService (Onda 4d)"
  - "RetornoCnabService (Onda 4d)"
  - "PaymentGatewayCredentialResolver (Onda 4d)"
  - "Drivers planejados: C6Driver (4b), AsaasDriver (4b), PixAutomaticoBcbDriver (4d), PesaPalDriver (deprecated Onda 5)"
not_contains:
