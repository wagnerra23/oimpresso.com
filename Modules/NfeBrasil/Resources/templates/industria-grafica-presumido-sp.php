 ...
 *
 * Cliente típico: gráfica de médio porte (R$ [redacted Tier 0]M-78M/ano) que produz
...
return [
    ...
    'uf'         => 'SP',
    'modelo_nfe' => '55',
    'recomendado_para' => 'Indústria gráfica R$ [redacted Tier 0]M-78M/ano em Lucro Presumido.',
    'tributacao_default' => [
        'cst'             => '00',
        'cfop'            => '5101',
        'aliquota_icms'   => 0.18,
