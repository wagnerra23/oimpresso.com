...
use Modules\Copiloto\Entities\Mcp\McpCycleGoal;
...
use Modules\Copiloto\Entities\Mcp\McpTaskDependency;
...
it('task started_at + completed_at autopopulam via TaskCrudService update', function () {
    ...
    $svc = new \Modules\Copiloto\Services\TaskRegistry\TaskCrudService();
