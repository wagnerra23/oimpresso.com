...
class IngestController extends Controller
{
    ...
    {
        return Inertia::render('DocVault/Ingest', [
            'source_types' => $this->optionsFromConfig('docvault.source_types'),
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($request->hasFile('upload')) {
            ...
            $disk = config('docvault.upload.disk', 'public');
            $dir = config('docvault.upload.directory', 'docvault');
        ...
        return redirect()->route('docvault.dashboard')
