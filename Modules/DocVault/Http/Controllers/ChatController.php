...
use Modules\DocVault\Entities\DocChatMessage;
use Modules\DocVault\Services\ChatAssistant;
...
class ChatController extends Controller
{
    public function index(Request $request, RequirementsFileReader $reader): Response
    {
        ...
        return Inertia::render('DocVault/Chat', [
            'session_id'  => $sessionId,
            'history'     => $history,
            'recent'      => $recent,
            'modules'     => $modules,
            'ai_enabled'  => (bool) config('docvault.ai.enabled', false),
        ]);
    }
