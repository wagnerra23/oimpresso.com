...
return [
    ...
    'items' => [
        ...
        ['label' => 'Triagem',          'href' => '/project-mgmt/triage',   'icon' => 'Inbox',         'can' => 'jana.mcp.usage.all'],
        ['label' => 'Caixa de entrada', 'href' => '/project-mgmt/inbox',    'icon' => 'Bell',          'can' => 'jana.mcp.usage.all'],
        ['label' => 'Board',            'href' => '/project-mgmt/board',    'icon' => 'KanbanSquare',  'can' => 'jana.mcp.usage.all'],
        ['label' => 'Backlog',          'href' => '/project-mgmt/backlog',  'icon' => 'List',          'can' => 'jana.mcp.usage.all'],
        ['label' => 'Roadmap',          'href' => '/project-mgmt/roadmap',  'icon' => 'CalendarRange', 'can' => 'jana.mcp.usage.all'],
        ['label' => 'Activity',         'href' => '/project-mgmt/activity', 'icon' => 'Activity',      'can' => 'jana.mcp.usage.all'],
        ['label' => 'Burndown',         'href' => '/project-mgmt/burndown', 'icon' => 'TrendingDown',  'can' => 'jana.mcp.usage.all'],
    ],
];
