...
- **F0 brief:** `memory/reference/prototipo-ui/COWORK_NOTES.amendment-paymentgateway-batch.md`
- **F1.5 critique:** 3 JSONs + REPORT.md em `prototipo-ui/cowork/Wagner/legado/payment-gateway-ui/critiques/`
