...
Titulo R000014                                            ×
─────────────────────────────────────────────────────────
Atrasado ×15d em atraso  R$ 190,02
ConferirPer-user audit
◇
Valor fora do padrão 57% abaixo da média histórica Média histórica R$ 438,12 ...
...
```
...
Sintoma: textos colados sem espaço (`ConferirPer-user audit`, `MédiaR$ 438,12`, `Atrasados22`). Isso só acontece quando as classes não têm padding/gap/grid CSS.
