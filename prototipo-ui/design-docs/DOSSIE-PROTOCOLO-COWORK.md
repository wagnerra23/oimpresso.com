# DOSSIÊ — PROTOCOLO COWORK → CODE (por que se sabe)

> Companheiro de `COLAR-NO-CODE-PROTOCOLO-COWORK-EXPORT.md` (a NORMA — o que se faz). Aqui ficam **evidência, placares e história**: o que foi medido, quando, e o que reprova o método. Separados em 2026-09-08 porque a norma passou de 62 KB e o executor era mandado ler o manual de método inteiro.

> **Numeração preservada** — as seções mantêm o número que tinham na norma (§1, §7, §9, §9-bis, §9-ter, §9-quater), então toda citação antiga continua resolvendo. Nada aqui é instrução: se um parágrafo daqui manda fazer algo, ele está no arquivo errado.

> **Leitura em ordem cronológica:** §1 (o diagnóstico que originou o protocolo) → §7 (as duas provas de 03/09) → §9 e §9-bis (estado da arte) → §9-ter (reavaliação 49/60) → **§9-quater (o contra-placar, que reprova o método e é a peça mais importante daqui)**.
...
## 14 · Histórico de ciclos (arquivo do `github.md`, movido em 2026-09-08)

> `github.md` acumulou 70.636 chars de narrativa de ciclo — virou o maior arquivo da raiz e deixou de ser o recibo parseável que o produto lê. Os 9 blocos abaixo saíram de lá **na íntegra**, em ordem original. Nada foi reescrito; o que vale como estado atual é o `github.md`, não isto.
