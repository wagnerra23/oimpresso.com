...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    // P7 — /manage-modules removido: a tela viva é /modulos (Inertia,
    // ModuleManagementController). O Blade resources/views/install/modules/index.blade.php
    // dependia dos assets AdminLTE quebrados. O redirect legado continua em
    // LegacyMenuAdapter.php ('/manage-modules' => '/modulos'), então link antigo não quebra.
    // uploadModule (instalar módulo por arquivo .zip) FICA — /modulos não cobre upload de
    // código; é Non-Goal declarado no charter.
