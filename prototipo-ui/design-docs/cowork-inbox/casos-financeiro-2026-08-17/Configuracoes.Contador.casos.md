...
## UC-CTD-02 — Consentimento LGPD é opt-in obrigatório
Status: ⬜ (sem prova — checkbox obrigatório, Art. 7º II)
...
Status: ⬜ (sem prova — front usa `advisor_cnpj_mascarado` do backend)
