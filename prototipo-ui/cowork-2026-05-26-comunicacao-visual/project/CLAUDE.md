...
**Todas as telas/módulos do ERP vivem DENTRO de `Oimpresso ERP - Chat.html`** como rotas do shell Cockpit V2. Esse é o único HTML que o Wagner abre. **Proibido criar `.html` novo** pra módulo, tela ou variação.
...
3. Registrar `<script type="text/babel" src="...">` em `Oimpresso ERP - Chat.html`
