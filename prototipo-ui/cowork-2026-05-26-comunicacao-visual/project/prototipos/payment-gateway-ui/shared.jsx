...
const DRIVERS = {
  ...
  pesapal: { key:'pesapal', nome:'PesaPal',      sigla:'PP', dot:'bg-purple-500',  bg:'bg-purple-50',  fg:'text-purple-700',  border:'border-purple-200',
             tipos:['card'], ambientes:['production'], cred:'api_key + consumer_secret',
             deprecated:true, deprecatedReason:'Migrar pra Asaas (cartão BR nativo + 3DS)' },
};
...
const GATEWAYS = [
  ...
  { id:11, nome:'PesaPal · Legacy',        driver:'pesapal', ambiente:'production', ativo:false, account_id:null, last_check:'2026-04-20T10:00:00', health:'down',     latencia:null, created_at:'2024-08-02', warn:'Deprecated — sem cobrança ativa há 32d' },
];
