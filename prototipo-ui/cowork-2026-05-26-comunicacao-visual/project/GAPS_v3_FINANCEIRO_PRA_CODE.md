...
- KPI strip: textos `Saldo previsto · maio R$ [redacted Tier 0]R$ [redacted Tier 0] realizado · R$ [redacted Tier 0] pendenteRecebido R$ [redacted Tier 0] 0 entradas confirmadasA receber R$ [redacted Tier 0] 0 títulos...` — falta grid/borders/cards.
