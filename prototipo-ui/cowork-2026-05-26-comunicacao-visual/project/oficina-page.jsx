...
const OS_LIST = [
  { id: "8821", stage: "recepcao",    plate: "RBA-2H78", veh: "Honda Civic 2019",     km: "84.220",  client: "Marcos Aleixo",        symptom: "Barulho nas rodas dianteiras em curva",        recurso: null,    mech: null, deadline: "Hoje 17h",  urgent: false, value: "R$ [redacted Tier 0]",    arrived: "08:14" },
  { id: "8822", stage: "recepcao",    plate: "FZJ-4F12", veh: "VW Saveiro 2021",       km: "62.140",  client: "Frota Boa Esperança",  symptom: "Revisão 60.000 km + troca de óleo",            recurso: null,    mech: null, deadline: "Amanhã",    urgent: false, value: "R$ [redacted Tier 0]",    arrived: "09:02" },
  { id: "8819", stage: "diagnostico", plate: "QXM-1B33", veh: "Fiat Strada 2022",      km: "31.580",  client: "Construtora Lince",    symptom: "Luz de injeção acendendo intermitente",        recurso: "elev1", mech: "m2", deadline: "Hoje 18h",  urgent: true,  value: "R$ [redacted Tier 0]",  progress: 45, etaDiag: "30 min" },
  ...
  { id: "8810", stage: "pecas",       plate: "OWD-5R09", veh: "Toyota Hilux 2020",     km: "97.300",  client: "Agropecuária Vale",    symptom: "Troca de pastilhas + disco dianteiro",         recurso: null,    mech: "m1", deadline: "Amanhã 14h",urgent: false, value: "R$ [redacted Tier 0]",partsStatus: "encomendado", partsLabel: "Disco BR-2188 chega 09/05 manhã" },
  { id: "8807", stage: "pecas",       plate: "MNT-3T55", veh: "Renault Sandero 2017",  km: "134.500", client: "Eduardo Pessoa",       symptom: "Suspensão dianteira completa",                  recurso: null,    mech: "m3", deadline: "Sex 17h",   urgent: false, value: "R$ [redacted Tier 0]",partsStatus: "approval",    partsLabel: "Aguardando OK do cliente no orçamento" },
  { id: "8804", stage: "pecas",       plate: "KKQ-7H44", veh: "Chevrolet Onix 2023",   km: "18.650",  client: "Marina Tavares",       symptom: "Filtro de combustível + velas",                 recurso: null,    mech: "m2", deadline: "Hoje 16h",  urgent: true,  value: "R$ [redacted Tier 0]",  partsStatus: "ok",          partsLabel: "Peças no balcão · pronto p/ executar" },
  { id: "8801", stage: "execucao",    plate: "PLT-2C18", veh: "Hyundai HB20 2019",     km: "76.400",  client: "Roberto Coelho",       symptom: "Substituição de correia dentada",               recurso: "elev2", mech: "m1", deadline: "Hoje 19h",  urgent: true,  value: "R$ [redacted Tier 0]",  progress: 35, etaDone: "2h 40min" },
  { id: "8799", stage: "execucao",    plate: "BCY-9G07", veh: "Jeep Renegade 2021",    km: "42.110",  client: "Patrícia Lemos",       symptom: "Alinhamento + balanceamento + pneus",           recurso: "box1",  mech: "m3", deadline: "Hoje 18h",  urgent: false, value: "R$ [redacted Tier 0]",progress: 60, etaDone: "1h 10min" },
  { id: "8795", stage: "execucao",    plate: "ZTH-6L91", veh: "VW Gol 2016",           km: "162.800", client: "Auto Escola Norte",    symptom: "Junta do cabeçote",                             recurso: "elev1", mech: "m4", deadline: "Sex 12h",   urgent: false, value: "R$ [redacted Tier 0]",progress: 18, etaDone: "8h" },
  { id: "8788", stage: "pronto",      plate: "VRP-5K27", veh: "Nissan Versa 2020",     km: "55.300",  client: "Helena Bastos",        symptom: "Revisão 50.000 km",                              recurso: null,    mech: "m2", deadline: "Aguarda 1d",urgent: false, value: "R$ [redacted Tier 0]",  finishedAt: "Ontem 17:42", paid: false },
  { id: "8786", stage: "pronto",      plate: "WBL-3D88", veh: "Fiat Mobi 2019",        km: "89.100",  client: "Tiago Ramires",        symptom: "Bateria + alternador",                           recurso: null,    mech: "m1", deadline: "Aguarda 2d",urgent: false, value: "R$ [redacted Tier 0]",finishedAt: "07/05 16:10", paid: true },
];
        ...
        <div className="prod-drawer-body">
          {showVendaCard && (
            <div className="ofc-venda-card" data-comment-anchor="ofc-venda-card">
              ...
              <div className="ofc-venda-actions">
                ...
                {vendaFromOs.fiscal?.nfe?.status === "ok" && <button className="ofc-venda-cta">DANFE NF-e</button>}
                {vendaFromOs.fiscal?.nfse?.status === "ok" && <button className="ofc-venda-cta">DANFS-e</button>}
                <button className="ofc-venda-cta">Ver no Caixa do dia</button>
              </div>
            </div>
          )}
          ...
          <div className="ofc-drawer-section">
            ...
            <ul className="ofc-dvi-list">
              ...
              <li className="warn">
                <span className="dot"/>
                <div><b>Freios dianteiros · pastilhas</b><small>3mm · vida útil 60% · R$ [redacted Tier 0]</small></div>
                <span className="th">📷</span>
              </li>
              <li className="bad">
                <span className="dot"/>
                <div><b>Correia dentada · trincada</b><small>recomenda troca imediata · R$ [redacted Tier 0] + 2h MO</small></div>
                <span className="th">📷</span>
              </li>
              <li className="ok">
                <span className="dot"/>
