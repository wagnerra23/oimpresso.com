...
const MOCK_RESPONSES = {
  vendas_hoje: {
    ...
    finalBlocks: [
      ...
      { role: 'assistant', kind: 'markdown',
        markdown: 'Hoje você teve **7 vendas** totalizando **R$ [redacted Tier 0]** [1]. 3 foram à vista e 4 a prazo [2].',
        sources: [
      ...
      { role: 'assistant', kind: 'data_table',
        ...
        rows: [
          { id: '#1234', cliente: 'Maria Silva', total: 'R$ [redacted Tier 0]', forma: 'Pix' },
          { id: '#1235', cliente: 'João Souza', total: 'R$ [redacted Tier 0]', forma: 'Cartão' },
          { id: '#1236', cliente: 'Ana Costa', total: 'R$ [redacted Tier 0]', forma: 'À prazo' },
          { id: '#1237', cliente: 'Carlos Lima', total: 'R$ [redacted Tier 0]', forma: 'Pix' },
          { id: '#1238', cliente: 'Pedro Alves', total: 'R$ [redacted Tier 0]', forma: 'Pix' },
          { id: '#1239', cliente: 'Beatriz F.',  total: 'R$ [redacted Tier 0]', forma: 'À prazo' },
          { id: '#1240', cliente: 'Marcos R.',   total: 'R$ [redacted Tier 0]', forma: 'À prazo' },
        ],
      },
    ],
  },
  ...
  inadimplentes: {
    ...
    finalBlocks: [
      ...
      { role: 'assistant', kind: 'markdown',
        markdown: 'Top **5 clientes inadimplentes** [1] totalizando **R$ [redacted Tier 0]** em atraso.',
        sources: [
      ...
      { role: 'assistant', kind: 'data_table',
        ...
        rows: [
          { cliente: 'Construtora ABC',  total: 'R$ [redacted Tier 0]', dias: '45' },
          { cliente: 'Padaria Estrela',  total: 'R$ [redacted Tier 0]', dias: '32' },
          { cliente: 'Pet Shop Bichinho', total: 'R$ [redacted Tier 0]', dias: '28' },
          { cliente: 'Lava Jato Rápido', total: 'R$ [redacted Tier 0]', dias: '21' },
          { cliente: 'Bar do Joaquim',   total: 'R$ [redacted Tier 0]', dias: '15' },
        ],
      },
    ],
  },
  ...
  cancelar_venda: {
    ...
    finalBlocks: [
      ...
      { role: 'assistant', kind: 'action_card',
        ...
        summary: 'Cancelar venda #1234 (R$ [redacted Tier 0]) — Maria Silva. Isso vai liberar estoque (3 peças) e disparar refund se já houver pagamento.',
