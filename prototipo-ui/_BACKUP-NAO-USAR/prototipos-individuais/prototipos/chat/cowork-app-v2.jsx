...
const MOCK_THREADS = [
  {
    id: 't1',
    title: 'Vendas do dia',
    preview: '7 vendas, R$ [redacted Tier 0] — 3 à vista, 4 a prazo',
    time: '14:32',
    owner_id: 1,
    ...
    msgs: [
      ...
      { role: 'assistant', kind: 'markdown', markdown: 'Hoje você teve **7 vendas** totalizando **R$ [redacted Tier 0]** [1]. 3 foram à vista e 4 a prazo [2].',
                                              sources: [
  ...
  },
  {
    ...
    preview: '5 clientes totalizando R$ [redacted Tier 0] em atraso',
    time: 'ontem',
    owner_id: 1,
    shared_with_team: true,
    archived_at: null,
