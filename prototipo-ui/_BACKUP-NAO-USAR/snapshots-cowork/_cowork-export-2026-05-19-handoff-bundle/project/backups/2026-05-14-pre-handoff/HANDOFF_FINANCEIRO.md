...
1. **Marcar pago/recebido em 1 clique** — botão "✓ Recebi/Paguei" inline na linha, sem confirmação. Emite evento + atualiza status + tenta auto-conciliar com BankStatementLine ±R$ [redacted Tier 0] ±2 dias.
...
- [ ] Limite mínimo de caixa (R$ [redacted Tier 0] hardcoded no Fluxo) — virar config do tenant?
