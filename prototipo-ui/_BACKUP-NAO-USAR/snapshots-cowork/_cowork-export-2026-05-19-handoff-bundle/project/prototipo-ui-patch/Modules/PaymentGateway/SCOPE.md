...
Extraído de `Modules/RecurringBilling` (ADR 0144) pra desacoplar **infra de cobrança** (este módulo) de **lógica de recorrência** (RecurringBilling).
...
- **v0.1.0** (2026-05-19) — SCOPE.md inicial, ADR 0144 proposto. Módulo registrado mas **não habilitado** (Onda 0 do roadmap).
