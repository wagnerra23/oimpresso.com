...
// ─── MOCK ───
const SUPPLIERS = {
  "SUP-001": { name: "Lonas & Vinis Ltda",       doc: "[REDACTED]", city: "São Paulo · SP" },
  "SUP-002": { name: "Tintas Coral - Distrib.",  doc: "[REDACTED]", city: "Guarulhos · SP" },
  "SUP-003": { name: "Papel & Cia Atacado",      doc: "[REDACTED]", city: "Osasco · SP" },
  "SUP-004": { name: "Importadora Têxtil RH",    doc: "[REDACTED]", city: "Americana · SP" },
};
