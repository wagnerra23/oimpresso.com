  ...
  return (
    <>
      ...
      <div className="os-stats">
        <div className="os-stat"><b>{stats.ativos}</b><small>Em aberto</small></div>
        <div className="os-stat"><b>{stats.totalAtivo}</b><small>Valor em aberto</small></div>
        <div className="os-stat"><b className="ok">{stats.ganhos}</b><small>Aprovados</small></div>
        <div className="os-stat"><b>{stats.totalGanho}</b><small>Valor aprovado</small></div>
        <div className="os-stat"><b>{stats.conversao}%</b><small>Conversão</small></div>
      </div>
