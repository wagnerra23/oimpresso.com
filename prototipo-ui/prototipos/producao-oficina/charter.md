...
- [ ] ⬜ Foto real de entrada no card (hoje é placeholder textual) `D-08`
- [ ] 💡 **Cor da borda por SLA** (verde/âmbar/vermelho conforme prazo), não só "urgente" booleano `D-04`

### C. KPIs (faixa superior)
- [x] ✅ 6 KPIs: Recepção · Diagnóstico · Aguardando peças · Execução · Urgentes · Valor em curso
- [ ] ⬜ KPI clicável = filtra o quadro (hoje é só leitura) `D-05`
...
- [ ] ⬜ Persistir visão/foco escolhido (lembrar na volta) `D-06`
...
- [x] ✅ Imprimir fila
- [ ] 💡 Atalho de teclado: `N` nova OS · `/` foca busca · setas navegam cards `D-07`
