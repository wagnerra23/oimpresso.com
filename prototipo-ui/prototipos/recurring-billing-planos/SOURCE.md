...
- precedente de forma: [`prototipos/nfe-tributacao/SOURCE.md`](../nfe-tributacao/SOURCE.md) ([#7145](https://github.com/wagnerra23/oimpresso.com/pull/7145)) · irmãos: [`payment-gateway-cnab`](../payment-gateway-cnab/SOURCE.md) · [`transaction-payment`](../transaction-payment/SOURCE.md)
