...
2026-05-18 11:00 [CL] CICLO KB-9.75 v2 ENCERRADO em 1 sessão — 8 PRs mergeados: #1064 sync + #1065 docs + #1066 fix 47 shared files (regressão runtime detectada via brave-mcp-primeiro-sempre) + #1067 feedback reincidência + #1068 Onda 5 Financeiro R1 Curadoria + #1069 Onda 6 R2 IA + #1070 Onda 7 R3 Output+CrossLink + #1071 fix sells filter hint stale (bug "vendas até dia 14" reportado por cliente). Auditoria Sells/_components/ revelou 7/7 SaleAi/Audit/Comments/Linkifier/Message/Presentation/Transcript já mounted — Roadmap 7 ondas → 3 ondas reais (economia ~40h trabalho). Ondas 5/6/7 Financeiro: 9 components TS + 3 CSS escopados .fin-curadoria + 27 testes Pest (165 assertions) verdes + charter Financeiro/Unificado v1→v4.
2026-05-18 11:05 [W] confirmou pill amber "Filtro antigo escondendo vendas novas" apareceu em prod após Quick Sync — bug "vendas até 14" resolvido sem alterar backend (causa raiz: localStorage[oimpresso.sells.dateTo] stuck pós-PR#1034).
2026-05-18 11:10 [CL] instalou 3 feedbacks canon: feedback-auditar-components-antes-de-onda + feedback-sync-cowork-shared-files-completos + feedback-localstorage-filter-stale-hint (memory/reference/).
