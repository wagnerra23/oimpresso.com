...
| `prototipo-ui/contrato/` tem 31, nenhum de governança | 31 · zero | **exato** |
...
`prototipo-ui/design-docs/contrato-cowork/` (estágio) em vez de `prototipo-ui/contrato/` (vigente), e
`prototipo-ui/contrato/` + o workflow entram em `nao_toca`. Medido em 2026-09-08, isso é o certo:
