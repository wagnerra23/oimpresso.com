...
|---|---|---|---|
| Header title + subtitle | "Cobrança recorrente · 13 ATIVAS · MRR R$ [redacted Tier 0]" | (verifica) | ✅/❌ |
...
- ✅ Visual-comparison cirúrgico "4 KPI grid 4col gap=10px, primeiro card bg `var(--text)` dark + sparkline verde + valor `R$ [redacted Tier 0]` mono 18px"
