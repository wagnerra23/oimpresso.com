...
messages: [
  ...
  { from:"jana", kind:"data_table", caption:"5 devedores ativos",
    ...
    rows:[
      ["VARGAS LEANDRO","R$ 385.195","229"],
      ["TORK COMERCIO","R$ 145.511","167"],
      ["AMS SOLDAS","R$ 133.386","71"],
      ["BUSSOLO E PRUDENCIO","R$ 118.970","43"],
      ["FAN COM PECAS","R$ 117.063","166"],
    ]},
  { from:"jana", kind:"markdown",
    text:"Top 5 concentra **R$ 901k** (~20% inadimplência). VARGAS sozinho concentra **8,5%** [1] mas é cliente recorrente (229 parcelas) [2].",
    sources:[
...
- ✅ Mock data Martinho Caçambas crível (R$ 4,5M inadimplência, frota 91 caçambas)
