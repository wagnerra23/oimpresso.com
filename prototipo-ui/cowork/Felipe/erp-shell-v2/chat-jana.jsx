...
function getJanaData(company) {
  ...
  return {
    ...
    kpis: [
      ...
      { label:"A receber vencido", value:"R$ 4,5M", deltaCls:"red big",          icon:"🚨",
    ...
    acoes: [
      { id:"a1", icon:"📨", tone:"rose", title:"Régua WhatsApp · 8 clientes >90d sem contato",
        sub:"Potencial recuperação: R$ 287k · HITL aprovação cada msg",
        cta:{ label:"Disparar", tone:"danger" } },
      { id:"a2", icon:"❤️", tone:"violet", title:"Reativação · 8 clientes \"ouro\" inativos",
        sub:"LTV combinado R$ 612k · oferta retorno personalizada",
    ...
    chat: {
      messages: [
        ...
        { from:"jana", kind:"list-card", title:"Top 5 devedores ativos (sem agrupados duplicados):",
          items:[
            "1. **VARGAS LEANDRO COM. VAREJISTA** — R$ 385.195 (229 parcelas)",
            "2. **TORK COMERCIO DE PECAS AUTO** — R$ 145.511 (167 parcelas)",
            "3. **AMS SOLDAS E MAQUINAS** — R$ 133.386 (71 parcelas)",
            "4. **BUSSOLO E PRUDENCIO** — R$ 118.970 (43 parcelas)",
            "5. **FAN COM. DE PECAS E IMPLEMENTOS** — R$ 117.063 (166 parcelas)",
          ],
          footnote:"Total top 5: R$ 901k (~20% inadimplência). VARGAS sozinho concentra 8,5% — risco alto, mas é cliente recorrente (229 parcelas) então tem relacionamento.",
          actions:[
