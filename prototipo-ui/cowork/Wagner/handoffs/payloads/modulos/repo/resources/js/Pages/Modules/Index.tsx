                      ...
                      <tr key={m.name} className="border-b border-border hover:bg-muted/40">
                        ...
                        <td className="px-4 py-2.5">
                          ...
                          <div className="text-[11px] text-muted-foreground/70 leading-tight mt-0.5">
                            {m.alias} · v{m.version}
                            {/* P3 — DataController é quem monta o item de sidebar. Módulo ativo
                                sem ele é o sintoma clássico "instalei e não aparece no menu"
                                (.claude/skills/criar-modulo/SKILL.md); a prop já vinha e a tela
                                ignorava. */}
                            {m.active && !m.has_datacontroller && (
                              <span
                                className="ml-2 text-warning-fg"
                                title="Sem DataController — o módulo não monta item na sidebar"
                              >
                                sem menu
                              </span>
                            )}
