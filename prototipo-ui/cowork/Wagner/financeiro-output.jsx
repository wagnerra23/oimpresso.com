...
(() => {
  ...
  function FinTroubleButton({ row }) {
    ...
    const suggested = useMemo(() => {
      if (!row) return null;
      // Caso 01 (O Adversário): título liquidado/conciliado não tem divergência a "Resolver".
      // Em estado terminal, o botão vira guia neutra — não alarme âmbar contradizendo o verde.
    ...
    return (
      <>
        <button className={"fin-trouble-btn" + (sg ? "" : " fin-trouble-btn--guide")} onClick={() => setOpen(true)}>
