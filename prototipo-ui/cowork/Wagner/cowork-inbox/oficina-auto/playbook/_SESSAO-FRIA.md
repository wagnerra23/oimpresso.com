...
```
/onda oficina-auto --thread 01
```
> O diretório é **`oficina-auto`** (literal). Não use o nome do módulo (`OficinaAuto`): o `/onda` só passa o argumento pra minúsculo, e `oficinaauto` não é esta pasta.
...
|---|---|---|---|---|---|
| **01** | Vehicles: placa via MercosulPlate nas 4 telas | CL | `01-vehicles-mercosulplate.md` | — | — |
