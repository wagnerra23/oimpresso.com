...
> 1 thread = 1 sessão nova = 1 PR. Gerado pelo [CC] em 2026-09-23 a partir do bloco json do `00-INDICE.md` (sha 752041ac450d). Se o índice mudar, **o índice manda**, não esta folha.

## Prompt de abertura — cole no chip novo, trocando só o NN

```
/onda ancora --thread 01
```
> O diretório é **`ancora`** (literal). Não use o nome do módulo (`ancora`): o `/onda` só passa o argumento pra minúsculo.
...
|---|---|---|---|---|---|
| **01** | perna do bundle resolve no LUGAR_FIXO sem --staging | CL | `01-bundle-sem-staging.md` | — | — |
| **02** | query ambigua deixa de sortear charter | CL | `02-query-ambigua.md` | thread 01 | — |
| **03** | --list prova o arquivo e mede o fallback component | CL | `03-list-prova-arquivo.md` | thread 02 | — |
