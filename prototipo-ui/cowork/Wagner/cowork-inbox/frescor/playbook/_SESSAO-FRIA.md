...
```
/onda frescor --thread 01
```
> O diretório é **`frescor`** (literal). Não use o nome do módulo (`Frescor`): o `/onda` só passa o argumento pra minúsculo.
...
|---|---|---|---|---|---|
| **01** | FRESCOR: 8 linhas + caminho da Caixa + regra de validade | CL | `01-atualizar-quadro.md` | — | — |
