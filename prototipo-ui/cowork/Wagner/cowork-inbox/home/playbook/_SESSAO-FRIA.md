...
> 1 thread = 1 sessão nova = 1 PR. Gerado pelo [CC] em 2026-09-23 a partir do bloco json do `00-INDICE.md` (sha 4dc1176f68df). Se o índice mudar, **o índice manda**, não esta folha.
...
/onda home --thread 01
```
> O diretório é **`home`** (literal). Não use o nome do módulo (`Home`): o `/onda` só passa o argumento pra minúsculo.
...
|---|---|---|---|---|---|
| **01** | Charter: arquétipo PT-04 → PT-05 (Dashboard) | CL | `01-pt05.md` | — | — |
