...
fonte_f1: prototipo-ui/cowork/notificacoes/notificacoes-page.jsx
contrato: prototipo-ui/contrato/notificacoes.contract.json
---
...
## Contrato visual
Âncoras `data-contract`: `lista-modelos · cabecalho-modelo · editor-canal · tags-disponiveis · envio-automatico · previa` (+ `aviso-logo` condicional). Ordem top→down conforme `notificacoes.contract.json`.
