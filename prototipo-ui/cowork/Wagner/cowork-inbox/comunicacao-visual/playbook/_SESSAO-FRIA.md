...
```
/onda comunicacao-visual --thread 01
```
> O diretório é **`comunicacao-visual`** (literal). Não use o nome do módulo (`ComunicacaoVisual`): o `/onda` só passa o argumento pra minúsculo, e `comunicacaovisual` não é esta pasta.
...
|---|---|---|---|---|---|
| **01** | Charter fora da realidade (R7) + refinos R1–R6 | CL | `01-refinos.md` | — | — |
