...
prefixo_tocado: app/Providers/AuthServiceProvider.php · tests/Feature/Roles/GateBeforePlataformaTest.php · 2 testes da Jana · memory/decisions/0414-*
---
...
## Decisão proposta — opção B (ADR 0414)
