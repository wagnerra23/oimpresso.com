...
```
/onda acessos --thread 01
```
> O diretório é **`acessos`** (literal). Não use o nome do módulo (`Acessos`): o `/onda` só passa o argumento pra minúsculo.
...
|---|---|---|---|---|---|
| **01** | /roles em Inertia (hoje Blade) | CL | `01-roles.md` | — | — |
