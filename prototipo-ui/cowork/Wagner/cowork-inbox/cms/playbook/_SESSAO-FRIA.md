...
/onda cms --thread 01
```
> O diretório é **`cms`** (literal). Não use o nome do módulo (`Cms`): o `/onda` só passa o argumento pra minúsculo.
...
|---|---|---|---|---|---|
| **01** | Admin de conteúdo do site em Inertia (F3) | CL | `01-admin-content.md` | — | — |
