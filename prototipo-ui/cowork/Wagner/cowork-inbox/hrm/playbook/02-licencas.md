...
dono: "[CL]"
base: 159e572dd448
prefixo: resources/js/Pages/Essentials/Licencas.tsx OU Licencas/Index.tsx (+ charter/casos ao lado — flat × pasta decide o criar-tela.mjs) · EssentialsLeaveController.php (@index · @getUserLeaveSummary) · governance/design/contracts/essentials-licencas.contract.json · Tests/Feature/HrmLicencaTest.php (ESTENDER, não recriar) · e2e/essentials-licencas.spec.ts · .github/workflows/essentials-pest.yml (lane)
...
ARQUIVOS A EDITAR : resources/js/Pages/Essentials/Licencas{.tsx|/Index.tsx}  (CRIAR — via criar-tela.mjs Essentials/Licencas PT-01, que carimba tsx+charter+casos+e2e+contrato JUNTOS e decide flat × pasta)
                    ...
                    governance/design/contracts/essentials-licencas.contract.json (o gerador carimba; o hrm-licencas.contract.json do cowork-inbox/hrm/ é INSUMO das seções/copy/estados — não copiar por cima)
...
- `governance/design/contracts/essentials-licencas.contract.json` válido em `contract.schema.json` e **vigente** · `e2e/essentials-licencas.spec.ts`
