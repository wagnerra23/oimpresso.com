...
```
/onda programa-doc --thread 01
```
> O diretório é **`programa-doc`** (literal). Não use o nome do módulo (`ProgramaDoc`): o `/onda` só passa o argumento pra minúsculo, e `programadoc` não é esta pasta.
...
|---|---|---|---|---|---|
| **01** | Charter + casos do Programa | CL | `01-trio.md` | — | — |
| **02** | Tela do Programa em React/Inertia | CL | `02-tela.md` | thread 01 | — |
