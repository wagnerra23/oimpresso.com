...
## UC-ADVD-02 — Falta de consentimento LGPD é inequívoca
Status: 🧪 (`Onda31AdvisorPortalTest` — `has_consent` por cliente)
...
## UC-ADVD-05 — Sem números cross-client
Status: ⬜ (sem prova — Non-Goal do charter)
