...
## UC-NOV-01 — A rota legada não é o caminho da criação
Status: ⬜ (a prova existe do outro lado: auditor de intenção `scripts/auditar-intencao-fluxo.mjs` sobre a Unificada)
