...
function CobrancaPage() {
  ...
  const breadcrumb = useMemo(() => {
    // Localização já é dada pelo PageHeaderNav; aqui só o contexto de filtro ativo.
    const parts = ['Maio 2026 · ROTA LIVRE'];
  ...
  return (
    <div className="h-full bg-stone-50 flex flex-col font-sans" data-screen-label="01 Cobrança">
      ...
      {window.PageHeaderNav && <window.PageHeaderNav route={window.__route || 'cobranca'} />}
