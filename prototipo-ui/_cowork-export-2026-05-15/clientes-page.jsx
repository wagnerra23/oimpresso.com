        ...
        <div className="os-drawer-body">
          ...
          <div className="cli-section">
            ...
            <div className="cli-fin">
              ...
              <div className="cli-fin-row"><span>Inadimplência</span><b className="danger">R$ [redacted Tier 0]</b></div>
            </div>
          </div>
        </div>
    ...
    <div className="os-page cli-page">
      <div className="os-page-h">
        <div className="os-page-h-l">
          <h1>Clientes</h1>
          <p>Cadastro, histórico de OS e situação financeira</p>
        </div>
        <div className="os-page-h-r">
          <button className="os-btn ghost"><I.upload size={13}/> Importar</button>
          <button className="os-btn primary"><I.plus size={13}/> Novo cliente</button>
        </div>
      </div>

      <div className="os-stats">
        <div className="os-stat"><small>Cadastrados</small><b>{totals.total}</b></div>
        <div className="os-stat"><small>Com OS aberta</small><b>{totals.active}</b></div>
        <div className={`os-stat ${totals.late > 0 ? "warn" : ""}`}><small>Com atraso</small><b>{totals.late}</b></div>
        <div className="os-stat"><small>Faturamento total</small><b className="mono">{fmtBRL(totals.revenue)}</b></div>
      </div>
