...
@section('content')
    ...
    <div class="col-md-12 col-xs-12" style="padding-bottom: 30px;">
        @component('components.widget', ['class' => 'box-primary', 'header' => '<h4 class="text-center">Demo Shops <small><i> Demos are for example purpose only, this application <u>can be used in many other similar businesses.</u></i></small></h4>'])
            ...
            <a href="?demo_type=nfe" target="_blank" class="btn btn-app" data-toggle="tooltip" title="Emiss�o de Nota fiscal Eletr�nica" style="color:white !important; background-color: #2dce89">
                    <i class="fas fa-network-wired"></i>
                    NF-e</a>

            <a href="?demo_type=nfse" target="_blank" class="btn btn-app" data-toggle="tooltip" title="Emiss�o de Nota fiscal Servi�o Eletr�nica" style="color:white !important; background-color: #2dce89">
                    <i class="fas fa-network-wired"></i>
                    NFS-e</a>

            <a href="?demo_type=boleto" target="_blank" class="btn btn-app" data-toggle="tooltip" title="Impress�o de Boletos" style="color:white !important; background-color: #2dce89">
                    <i class="fas fa-network-wired"></i>
                    Boletos</a>
        @endcomponent   
    </div>
