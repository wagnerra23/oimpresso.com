...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        <a class="btn btn-lg btn-primary" target="_blank" href="{{url('/nfe/renderizar/')}}/{{$transaction->id}}" id="submit_user_button">Renderizar</a>
        <a class="btn btn-lg btn-danger" target="_blank" href="{{url('/nfe/gerarXml/')}}/{{$transaction->id}}" id="submit_user_button">Gerar XML</a>
