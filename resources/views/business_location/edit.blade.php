            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('cnpj', $location->cnpj, ['class' => 'form-control', 'placeholder' => '00.000.000/0000-00']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('inscricao_estadual', 'Inscrição Estadual:') !!}
                        {!! Form::text('inscricao_estadual', $location->inscricao_estadual, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('inscricao_municipal', 'Inscrição Municipal:') !!}
                        {!! Form::text('inscricao_municipal', $location->inscricao_municipal, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('razao_social', $location->razao_social, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {!! Form::label('nome_fantasia', 'Nome Fantasia:') !!}
                        {!! Form::text('nome_fantasia', $location->nome_fantasia, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="col-sm-12">
