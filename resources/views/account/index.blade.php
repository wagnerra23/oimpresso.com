        ...
        <div class="col-sm-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#convenio" data-toggle="tab">
                            <i class="fa fa-list"></i> <strong>
                            @lang('lang_v1.convenio') </strong>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="convenio">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary btn-modal pull-right" 
                                    data-href="{{action('ConvenioController@store')}}"
                                    data-container="#convenio_modal">
                                    <i class="fa fa-plus"></i> @lang( 'messages.add' )</button>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered" id="convenios_table" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>@lang( 'lang_v1.name' )</th>
                                            <th>@lang( 'messages.action' )</th>
                                    ...
                                    <tbody>
                                        @foreach($convenios as $convenio)
                                            <tr class="convenio_{{$convenio->id}}">
                                                <th>{{$convenio->convenio_descricao}}</th>
                                                <td>
                                                    
                                                    {!! Form::open(['url' => action('ConvenioController@destroy', $convenio->id), 'method' => 'delete' ]) !!}
                                                    <button type="button" class="btn btn-primary btn-modal btn-xs" 
                                                    data-href="{{action('ConvenioController@edit', $convenio->id)}}"
                                                    data-container="#convenio_modal">
                                                    <i class="fa fa-edit"></i> @lang( 'messages.edit' )</button>
