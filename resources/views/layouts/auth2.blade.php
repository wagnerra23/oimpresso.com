...
<body>
    ...
    <div class="container-fluid">
        <div class="row eq-height-row">
            <div class="col-md-7 col-sm-7 col-xs-12 left-col eq-height-col" >
            ...
            <div class="col-md-5 col-sm-5 col-xs-12 right-col eq-height-col" style="padding-right: 60px; padding-left: 60px">
                <div class="row">
                   ...
                   {{-- <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                    @if(!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                        ...
                        @if(config('constants.allow_registration'))
                            ...
                            @if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif" class="btn bg-maroon btn-flat" ><b>{{ __('business.not_yet_registered')}}</b> {{ __('business.register_now') }}</a> --}}
                            {{-- <!-- pricing url -->
                 ...
                 <div >
                    <div style="text-align:center">
                        <img src="uploads/business_logos/logo.png" class="img-rounded" alt="Logo" width="350" style="padding-top: 50px;">
                    </div>
                </div>
                @yield('content')
                </div>
