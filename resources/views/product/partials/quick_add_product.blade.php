    ...
    <div class="col-sm-6">
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input required value="" required class="form-control" placeholder="CFOP Estadual" name="cfop_interno" type="number" id="cfop_interno">
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input required value="" required class="form-control" placeholder="CFOP Inter estadual" name="cfop_externo" type="number" id="cfop_externo">
        </div>
      </div>
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input required value="" required class="form-control" placeholder="NCM" name="ncm" type="number" id="ncm">
        </div>
      </div>
