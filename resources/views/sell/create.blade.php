...
<section class="content no-print">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="form-group">
				{!! Form::label('balance', __('lang_v1.use_advance_balance') . '?' ) !!}
				<div class="input-group">
					<span class="input-group-addon">
						<i class="fa fa-info"></i>
					</span>
					{!! Form::text('balance', @num_format(0.00), ['class' => 'form-control input_number balance', 'id' => 'advance_balance']); !!}
				</div>
			</div>
		</div>
		<div class="clearfix"></div>
...
{{-- <button type="button" class="btn btn-primary btn-xs pull-right add_payment_modal no-print"
...
<div class="modal fade" id="paymentmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	@include('sell.payment_row', ['row_index' => 0])
</div> --}}
...
<script type="text/javascript">
	$(document).ready( function(){
		...
		// $('form#transaction_payment_add_form')
		// 	.submit(function(e) {
		// 		e.preventDefault();
			
		// 	$.ajax({
		// 		url: '/payments/paymentadd',
		// 		type: "post",
		// 		data: $("#transaction_payment_add_form").serialize()
		// 		dataType: 'json',
