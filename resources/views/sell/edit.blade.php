...
<div class="col-md-12">
	<div class="form-group">
		...
		{!! Form::textarea('sale_note', $transaction->sale_note, ['class' => 'form-control', 'rows' => 3]); !!}
	</div>
</div>
@endcomponent
...
<div class="col-sm-4">
	<div class="form-group">
		...
		{!! Form::select('transportadora_id', $transportadoras, $transaction->transportadora_id , ['class' => 'form-control select2','placeholder' => 'Transportadora', 'data-default' => 'percentage']); !!}
