...
| UC-PAINEL-07 | "Atrasado" na faixa de presença sai da escala do colaborador, nunca de horário fixo | must | RN-001 (`ApuracaoService`) + decisão [W] 2026-08-27 | `PontoDashboardContratoTest` | ✅ verde na lane |
| UC-PAINEL-08 | A faixa espera a mesma tolerância que o KPI "Atrasos hoje" filtra | must | `pontowr2.clt.tolerancia_maxima_diaria_minutos` + decisão [W] 2026-08-27 | `PontoDashboardContratoTest` | ✅ verde na lane |
