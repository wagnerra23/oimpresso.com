...
export const MOCK_NODES: KbNode[] = [
  ...
  },
  {
    ...
    excerpt: 'Rotina de 8 minutos no início do turno. Faltar 2 dias seguidos entope a cabeça (R$ 9.800 de reposição).',
    body_blocks: [
  ...
  },
  {
    ...
    body_blocks: [
      ...
      { kind: 'list', items: ['Token de API expirou → re-autentique em Config → Inter.', 'Cliente sem CPF/CNPJ → boleto NÃO emite. Atualize o cadastro.', 'Valor abaixo de R$5,00 → Inter rejeita. Use cobrança recorrente ou Pix.'] },
    ],
    source_doc_id: null, source_entity_type: null, source_entity_id: null,
    is_editable: true, status: 'ok', pinned: false,
...
export const MOCK_PATHS: KbPath[] = [
  ...
  },
  {
    ...
    description: 'Rotinas de produção que evitam quebra de máquina (R$ 9.800 reposição da cabeça Roland).',
