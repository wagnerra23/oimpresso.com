...
prototypes: []   # 2026-08-13: era "prototipo-ui/.../fiscal-page.jsx §8 FiscalCockpit" — path NÃO existe (0 protótipo fiscal no repo, medido); âncora viva = `related_prototype` acima. Mesmo caso do Nfe.charter.md (reconciliação 2026-07-27).
---
