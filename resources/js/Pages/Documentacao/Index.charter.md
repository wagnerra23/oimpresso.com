...
related_prototype: prototipo-ui/cowork/Wagner/documentacao-page.jsx
tier: B
charter_version: 3
---
...
> **v3 (2026-09-24, US-DOC-001 onda 2b):** a `.tsx` saiu do stub e virou a tela real. Âncora de
> forma trocada de `n/a` para o protótipo `documentacao-page.jsx`, que não existia em 2026-08-06
> (o RUNBOOK §12 registrava "verificado: não existe") e hoje existe no espelho. Lentes numa faixa
> abaixo do header (`PageHeader below`), rail com ordinal, coluna de leitura e "Nesta página".
> **Desvio consciente do protótipo:** lá a lente vive no cliente (localStorage); aqui continua
> decidida no servidor (query + cookie), porque é o contrato AR-DOC-013 e mantém a URL
> compartilhável. **Nada em Non-Goals/Anti-hooks mudou** — seguem os declarados por [W].
