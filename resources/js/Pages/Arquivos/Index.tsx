// Arquivos/Index — carimbado do PT-01 Lista por criar-tela.mjs (UI-0013).
...
export default function Index({ paginator }: Props) {
  ...
  return (
    <AppShellV2>
      <PageHeader title="Arquivos" subtitle="TODO: descrição da lista" />
