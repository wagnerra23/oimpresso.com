...
- **Aceite:** Dado uma venda de 3 unidades a R$ 49,90 (total R$ 149,70) · Quando o payload `form` chega · Então `transaction.final_total` = 149,70 e a linha traz quantidade 3 e preço 49,90 — os mesmos valores do banco, sem cair em fallback.
