...
related_prototype: prototipo-ui/cowork/Wagner/vendas-create-page.jsx (ancora medida em 2026-09-07 — mesmo Canon ADR 0110 do charter e mesma mecanica de pills + scroll-spy. E FONTE de design, NAO autorizacao de mudanca — a tela viva e a do cliente ROTA LIVRE biz=4 e toca VALOR e ESTOQUE)
owner: wagner
status: live
...
> (`tests/Feature/Guards/UcGuardsTest.php`) via [`scripts/design/audit/uc-registry.json`](../../../../scripts/design/audit/uc-registry.json).
