...
//        prototipo-ui/cowork/Wagner/vendas-flow.jsx:1228 VdOrcamentoPrint (canon visual)
      ...
      <div className="vd-orc-page" onClick={(e) => e.stopPropagation()}>
        ...
        <section className="vd-orc-cond">
          ...
          <ul>
            ...
            <li>
              <b>Arte e revisão:</b> 1 (uma) revisão inclusa. Revisões adicionais R$ [redacted Tier 0]
              cada.
            </li>
            <li>
