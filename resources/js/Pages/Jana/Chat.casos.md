...
## Revalidação de 2026-08-26 — UC-09 e UC-10 saíram do 🧪 e o arquivo entrou na lane
...
(§5 2026-08-02 + emenda 08-12): a prova é o **CONTADOR** da lane subir de `6 skipped, 268 passed`
(run [32986918160](https://github.com/wagnerra23/oimpresso.com/actions/runs/32986918160), main) para
**270 passed** — e isso é fato de CI, que só existe depois deste PR rodar.
