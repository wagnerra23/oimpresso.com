...
import { MessageSquare, TrendingUp, TrendingDown, Minus, ExternalLink, Sparkles, Settings, Download } from 'lucide-react'
  ...
  return (
    <>
      ...
      <div className="px-6 pt-6 shrink-0">
        <JanaCockpit
          // Metas volta pra posição da âncora: logo depois dos KPIs, antes das
          // análises. Estava no fim da página, depois das ações — [W] 2026-08-17:
          // "layout esta diferente".
          aposKpis={
            <>
        {/* METAS — face PRIMÁRIA do painel, logo abaixo dos KPIs, como na âncora.
            Este comentário dizia "bloco secundário … não é mais a face primária":
            era verdade enquanto o bloco vivia no fim da página, e deixou de ser
            no momento em que ele subiu. Corrigido junto, não depois.
            Sem `p-6`/`shrink-0`: agora está DENTRO do cockpit, que já vive em
            `px-6 pt-6` — repetir o padding dobrava a margem, e `shrink-0` só fazia
            sentido enquanto era filho direto do flex-column da `.main-body`. */}
