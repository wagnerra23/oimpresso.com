...
//
// Refs:
//  - prototipo-ui/cowork/Wagner/financeiro-output.jsx — FinChecklistFechamento (canonical)
//
...
const STEPS: FechamentoStep[] = [
  // Reconcile (4)
  { id: 'extrato-inter', group: 'reconcile', label: 'Bater extrato Inter com lançamentos',  hint: 'Conciliação OFX · diferenças >R$ [redacted Tier 0] anotar' },
  ...
  { id: 'wagner-conferir', group: 'review', label: 'Wagner confere lançamentos > R$ [redacted Tier 0]k',       hint: 'Toggle Conferido em cada um' },
