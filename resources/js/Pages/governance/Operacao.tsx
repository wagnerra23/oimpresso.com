// governance/Operacao — carimbado do PT-01 Lista por criar-tela.mjs (UI-0013).
...
export default function Operacao({ paginator }: Props) {
  ...
  return (
    <AppShellV2>
      <PageHeader title="Operacao" description="TODO: descrição da lista" />
