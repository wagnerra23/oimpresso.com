...
export default function MemCofreDashboard({ stats, modules, recent_sources, coverage_summary, pages_total }: Props) {
  return (
    <>
      <Head title="Cofre de Memórias — Dashboard" />
