...
function App() {
  ...
  else if (route === "cobranca") content = <window.CobrancaPage/>;
  else if (route === "payment-gateways") content = <window.PaymentGatewaysPage/>;
  else if (route === "sells-pg-preview") content = <window.SellsCobrancaPreviewPage/>;
