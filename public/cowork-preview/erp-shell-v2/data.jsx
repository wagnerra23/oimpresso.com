...
const MENU = [
  ...
  { group: "FINANCEIRO", items: [
    ...
    { id: "boletos",    icon: "receipt", label: "Boletos" },
    { id: "compras",    icon: "archive", label: "Compras" },
    { id: "fluxo",      icon: "chart",   label: "Fluxo de caixa" },
    { id: "dre",        icon: "chart",   label: "DRE / Relatórios" },
  ...
  // Fiscal (NF-e/NFS-e/DF-e/Eventos/SPED/Certificado)
  { group: "FISCAL", items: [
    { id: "fiscal",          icon: "chart",   label: "Cockpit fiscal" },
    { id: "nfe",             icon: "receipt", label: "NF-e · NFC-e" },
    { id: "nfse",            icon: "doc",     label: "NFS-e (serviço)" },
    { id: "dfe",             icon: "audit",   label: "Manifesto destinatário" },
    { id: "fiscal_eventos",  icon: "refresh", label: "Eventos (CC-e, cancel.)" },
    { id: "fiscal_config",   icon: "shield",  label: "Certificado & config." },
    { id: "sped",            icon: "archive", label: "SPED & livros" },
  ]},
...
const TASKS = [
  ...
  },
  {
    ...
    subtitle:"R$ [redacted Tier 0] · vence amanhã",
    when:"hoje", group:"hoje", urgent:false, unread:true,
    assigned:"você", from:"workflow",
    data: {
      nf:"1240", supplier:"Avery Brasil", amount:"R$ [redacted Tier 0]",
  ...
  },
  {
    ...
    subtitle:"R$ [redacted Tier 0] · venceu ontem",
    when:"atrasada 1d", group:"atrasadas", urgent:true, unread:true,
    assigned:"você", from:"workflow",
    data: {
      nf:"—", supplier:"CPFL Energia", amount:"R$ [redacted Tier 0]",
...
const GROUP_META = {
  ...
  "FINANCEIRO":        { icon:"cash",      label:"Financeiro",  hue: 145, desc:"Caixa, boletos, compras, contabilidade" },
  "FISCAL":            { icon:"receipt",   label:"Fiscal",      hue: 25,  desc:"NF-e, NFC-e, NFS-e, DF-e, eventos, SPED, certificado" },
